...
func (d *jsiiProxy_DataAzurermStorageManagementPolicyRuleActionsSnapshotOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAzurermStorageManagementPolicyRuleActionsSnapshotOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
