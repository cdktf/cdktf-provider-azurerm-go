...
type ContainerAppJobSecret struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.12.0/docs/resources/container_app_job#identity ContainerAppJob#identity}
	Identity *string `field:"optional" json:"identity" yaml:"identity"`
	// The Key Vault Secret ID. Could be either one of `id` or `versionless_id`.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.12.0/docs/resources/container_app_job#key_vault_secret_id ContainerAppJob#key_vault_secret_id}
