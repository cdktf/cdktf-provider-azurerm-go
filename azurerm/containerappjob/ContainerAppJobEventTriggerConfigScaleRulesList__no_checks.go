...
func (c *jsiiProxy_ContainerAppJobEventTriggerConfigScaleRulesList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_ContainerAppJobEventTriggerConfigScaleRulesList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_ContainerAppJobEventTriggerConfigScaleRulesList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
