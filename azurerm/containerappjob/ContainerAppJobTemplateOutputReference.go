...
func (c *jsiiProxy_ContainerAppJobTemplateOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ContainerAppJobTemplateOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
