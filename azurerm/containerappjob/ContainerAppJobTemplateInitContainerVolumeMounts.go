...
type ContainerAppJobTemplateInitContainerVolumeMounts struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.12.0/docs/resources/container_app_job#path ContainerAppJob#path}
