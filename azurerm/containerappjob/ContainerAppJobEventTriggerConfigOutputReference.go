...
func (c *jsiiProxy_ContainerAppJobEventTriggerConfigOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ContainerAppJobEventTriggerConfigOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
