...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "recommendationId", GoGetter: "RecommendationId"},
			_jsii_.MemberProperty{JsiiProperty: "recommendationIdInput", GoGetter: "RecommendationIdInput"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_AdvisorSuppressionTimeoutsOutputReference{}
