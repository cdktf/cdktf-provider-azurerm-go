...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/siterecoveryreplicatedvm/internal"
...
func NewSiteRecoveryReplicatedVmManagedDiskTargetDiskEncryptionDiskEncryptionKeyList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SiteRecoveryReplicatedVmManagedDiskTargetDiskEncryptionDiskEncryptionKeyList {
	...
	if err := validateNewSiteRecoveryReplicatedVmManagedDiskTargetDiskEncryptionDiskEncryptionKeyListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SiteRecoveryReplicatedVmManagedDiskTargetDiskEncryptionDiskEncryptionKeyList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SiteRecoveryReplicatedVmManagedDiskTargetDiskEncryptionDiskEncryptionKeyList) Resolve(context cdktf.IResolveContext) interface{} {
