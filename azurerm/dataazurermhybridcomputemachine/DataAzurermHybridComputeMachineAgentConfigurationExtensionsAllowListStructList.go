...
func (d *jsiiProxy_DataAzurermHybridComputeMachineAgentConfigurationExtensionsAllowListStructList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
