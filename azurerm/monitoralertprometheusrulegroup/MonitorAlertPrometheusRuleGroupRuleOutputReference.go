...
func (m *jsiiProxy_MonitorAlertPrometheusRuleGroupRuleOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MonitorAlertPrometheusRuleGroupRuleOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
