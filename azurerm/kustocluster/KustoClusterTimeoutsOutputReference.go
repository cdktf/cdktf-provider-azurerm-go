...
func NewKustoClusterTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) KustoClusterTimeoutsOutputReference {
	...
	if err := validateNewKustoClusterTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (k *jsiiProxy_KustoClusterTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (k *jsiiProxy_KustoClusterTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
