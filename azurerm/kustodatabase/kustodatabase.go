...
import (
	...
	"github.com/hashicorp/cdktf-provider-azurerm-go/azurerm/v3/kustodatabase/internal"
...
type KustoDatabaseConfig struct {
	// Experimental.
	...
	HotCachePeriod *string `field:"optional" json:"hotCachePeriod" yaml:"hotCachePeriod"`
	// Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/kusto_database#id KustoDatabase#id}.
	//
	...
	SoftDeletePeriod *string `field:"optional" json:"softDeletePeriod" yaml:"softDeletePeriod"`
	// timeouts block.
	//
	...
	Timeouts *KustoDatabaseTimeouts `field:"optional" json:"timeouts" yaml:"timeouts"`
}
...
type KustoDatabaseTimeoutsOutputReference interface {
	cdktf.ComplexObject
...
// The jsii proxy struct for KustoDatabaseTimeoutsOutputReference
type jsiiProxy_KustoDatabaseTimeoutsOutputReference struct {
	internal.Type__cdktfComplexObject
}

func (j *jsiiProxy_KustoDatabaseTimeoutsOutputReference) ComplexObjectIndex() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"complexObjectIndex",
...
func (j *jsiiProxy_KustoDatabaseTimeoutsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_KustoDatabaseTimeoutsOutputReference) Create() *string {
	var returns *string
	_jsii_.Get(
		j,
		"create",
...
func (j *jsiiProxy_KustoDatabaseTimeoutsOutputReference) CreateInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createInput",
...
func (j *jsiiProxy_KustoDatabaseTimeoutsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_KustoDatabaseTimeoutsOutputReference) Delete() *string {
	var returns *string
	_jsii_.Get(
		j,
		"delete",
...
func (j *jsiiProxy_KustoDatabaseTimeoutsOutputReference) DeleteInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"deleteInput",
...
func (j *jsiiProxy_KustoDatabaseTimeoutsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_KustoDatabaseTimeoutsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_KustoDatabaseTimeoutsOutputReference) Read() *string {
	var returns *string
	_jsii_.Get(
		j,
		"read",
...
func (j *jsiiProxy_KustoDatabaseTimeoutsOutputReference) ReadInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"readInput",
...
func (j *jsiiProxy_KustoDatabaseTimeoutsOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_KustoDatabaseTimeoutsOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_KustoDatabaseTimeoutsOutputReference) Update() *string {
	var returns *string
	_jsii_.Get(
		j,
		"update",
...
func (j *jsiiProxy_KustoDatabaseTimeoutsOutputReference) UpdateInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updateInput",
...
func NewKustoDatabaseTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) KustoDatabaseTimeoutsOutputReference {
	_init_.Initialize()
...
func NewKustoDatabaseTimeoutsOutputReference_Override(k KustoDatabaseTimeoutsOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_KustoDatabaseTimeoutsOutputReference) SetComplexObjectIndex(val interface{}) {
	_jsii_.Set(
		j,
		"complexObjectIndex",
		val,
...
func (j *jsiiProxy_KustoDatabaseTimeoutsOutputReference) SetComplexObjectIsFromSet(val *bool) {
	_jsii_.Set(
		j,
		"complexObjectIsFromSet",
		val,
...
func (j *jsiiProxy_KustoDatabaseTimeoutsOutputReference) SetCreate(val *string) {
	_jsii_.Set(
		j,
		"create",
		val,
...
func (j *jsiiProxy_KustoDatabaseTimeoutsOutputReference) SetDelete(val *string) {
	_jsii_.Set(
		j,
		"delete",
		val,
...
func (j *jsiiProxy_KustoDatabaseTimeoutsOutputReference) SetInternalValue(val interface{}) {
	_jsii_.Set(
		j,
		"internalValue",
		val,
...
func (j *jsiiProxy_KustoDatabaseTimeoutsOutputReference) SetRead(val *string) {
	_jsii_.Set(
		j,
		"read",
		val,
...
func (j *jsiiProxy_KustoDatabaseTimeoutsOutputReference) SetTerraformAttribute(val *string) {
	_jsii_.Set(
		j,
		"terraformAttribute",
		val,
...
func (j *jsiiProxy_KustoDatabaseTimeoutsOutputReference) SetTerraformResource(val cdktf.IInterpolatingParent) {
	_jsii_.Set(
		j,
		"terraformResource",
		val,
...
func (j *jsiiProxy_KustoDatabaseTimeoutsOutputReference) SetUpdate(val *string) {
	_jsii_.Set(
		j,
		"update",
		val,
...
func (k *jsiiProxy_KustoDatabaseTimeoutsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (k *jsiiProxy_KustoDatabaseTimeoutsOutputReference) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
	var returns *map[string]interface{}
...
func (k *jsiiProxy_KustoDatabaseTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (k *jsiiProxy_KustoDatabaseTimeoutsOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
	var returns *map[string]*bool
...
func (k *jsiiProxy_KustoDatabaseTimeoutsOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
	var returns *[]*string
...
func (k *jsiiProxy_KustoDatabaseTimeoutsOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
	var returns *float64
...
func (k *jsiiProxy_KustoDatabaseTimeoutsOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
	var returns *[]*float64
...
func (k *jsiiProxy_KustoDatabaseTimeoutsOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
	var returns *map[string]*float64
...
func (k *jsiiProxy_KustoDatabaseTimeoutsOutputReference) GetStringAttribute(terraformAttribute *string) *string {
	var returns *string
...
func (k *jsiiProxy_KustoDatabaseTimeoutsOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
	var returns *map[string]*string
...
func (k *jsiiProxy_KustoDatabaseTimeoutsOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (k *jsiiProxy_KustoDatabaseTimeoutsOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (k *jsiiProxy_KustoDatabaseTimeoutsOutputReference) ResetCreate() {
	_jsii_.InvokeVoid(
		k,
		"resetCreate",
		nil, // no parameters
...
func (k *jsiiProxy_KustoDatabaseTimeoutsOutputReference) ResetDelete() {
	_jsii_.InvokeVoid(
		k,
		"resetDelete",
		nil, // no parameters
...
func (k *jsiiProxy_KustoDatabaseTimeoutsOutputReference) ResetRead() {
	_jsii_.InvokeVoid(
		k,
		"resetRead",
		nil, // no parameters
...
func (k *jsiiProxy_KustoDatabaseTimeoutsOutputReference) ResetUpdate() {
	_jsii_.InvokeVoid(
		k,
		"resetUpdate",
		nil, // no parameters
...
func (k *jsiiProxy_KustoDatabaseTimeoutsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
	var returns interface{}
...
func (k *jsiiProxy_KustoDatabaseTimeoutsOutputReference) ToString() *string {
	var returns *string
