...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "hotCachePeriodInput", GoGetter: "HotCachePeriodInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetHotCachePeriod", GoMethod: "ResetHotCachePeriod"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetSoftDeletePeriod", GoMethod: "ResetSoftDeletePeriod"},
			...
			_jsii_.MemberProperty{JsiiProperty: "softDeletePeriodInput", GoGetter: "SoftDeletePeriodInput"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_KustoDatabaseTimeoutsOutputReference{}
