...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/kustodatabase/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.103.0/docs/resources/kusto_database azurerm_kusto_database}.
...
func (j *jsiiProxy_KustoDatabase) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_KustoDatabase) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_KustoDatabase) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_KustoDatabase) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_KustoDatabase) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.103.0/docs/resources/kusto_database azurerm_kusto_database} Resource.
...
func (j *jsiiProxy_KustoDatabase)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_KustoDatabase)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_KustoDatabase)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func KustoDatabase_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (k *jsiiProxy_KustoDatabase) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (k *jsiiProxy_KustoDatabase) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (k *jsiiProxy_KustoDatabase) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
