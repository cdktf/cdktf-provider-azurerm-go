...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/confidentialledger/internal"
...
func NewConfidentialLedgerTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) ConfidentialLedgerTimeoutsOutputReference {
	...
	if err := validateNewConfidentialLedgerTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_ConfidentialLedgerTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ConfidentialLedgerTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
