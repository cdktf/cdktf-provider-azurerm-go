...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/botchannelemail/internal"
...
func NewBotChannelEmailTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) BotChannelEmailTimeoutsOutputReference {
	...
	if err := validateNewBotChannelEmailTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (b *jsiiProxy_BotChannelEmailTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BotChannelEmailTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
