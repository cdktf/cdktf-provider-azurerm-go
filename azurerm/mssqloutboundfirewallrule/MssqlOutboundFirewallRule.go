...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/mssqloutboundfirewallrule/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.105.0/docs/resources/mssql_outbound_firewall_rule azurerm_mssql_outbound_firewall_rule}.
...
func (j *jsiiProxy_MssqlOutboundFirewallRule) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.105.0/docs/resources/mssql_outbound_firewall_rule azurerm_mssql_outbound_firewall_rule} Resource.
func NewMssqlOutboundFirewallRule(scope constructs.Construct, id *string, config *MssqlOutboundFirewallRuleConfig) MssqlOutboundFirewallRule {
	...
	if err := validateNewMssqlOutboundFirewallRuleParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_MssqlOutboundFirewallRule)SetCount(val interface{}) {
...
func MssqlOutboundFirewallRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateMssqlOutboundFirewallRule_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func MssqlOutboundFirewallRule_IsConstruct(x interface{}) *bool {
	...
	if err := validateMssqlOutboundFirewallRule_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (m *jsiiProxy_MssqlOutboundFirewallRule) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_MssqlOutboundFirewallRule) HasResourceMove() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_MssqlOutboundFirewallRule) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (m *jsiiProxy_MssqlOutboundFirewallRule) MoveFromId(id *string) {
...
func (m *jsiiProxy_MssqlOutboundFirewallRule) MoveTo(moveTarget *string, index interface{}) {
...
func (m *jsiiProxy_MssqlOutboundFirewallRule) MoveToId(id *string) {
...
func (m *jsiiProxy_MssqlOutboundFirewallRule) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (m *jsiiProxy_MssqlOutboundFirewallRule) ToHclTerraform() interface{} {
	var returns interface{}
