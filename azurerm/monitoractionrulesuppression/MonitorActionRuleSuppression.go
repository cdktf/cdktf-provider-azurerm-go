...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/monitoractionrulesuppression/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.114.0/docs/resources/monitor_action_rule_suppression azurerm_monitor_action_rule_suppression}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.114.0/docs/resources/monitor_action_rule_suppression azurerm_monitor_action_rule_suppression} Resource.
func NewMonitorActionRuleSuppression(scope constructs.Construct, id *string, config *MonitorActionRuleSuppressionConfig) MonitorActionRuleSuppression {
	...
	if err := validateNewMonitorActionRuleSuppressionParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func MonitorActionRuleSuppression_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateMonitorActionRuleSuppression_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func MonitorActionRuleSuppression_IsConstruct(x interface{}) *bool {
	...
	if err := validateMonitorActionRuleSuppression_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func MonitorActionRuleSuppression_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateMonitorActionRuleSuppression_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func MonitorActionRuleSuppression_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateMonitorActionRuleSuppression_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (m *jsiiProxy_MonitorActionRuleSuppression) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_MonitorActionRuleSuppression) PutSuppression(value *MonitorActionRuleSuppressionSuppression) {
	if err := m.validatePutSuppressionParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		m,
...
func (m *jsiiProxy_MonitorActionRuleSuppression) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (m *jsiiProxy_MonitorActionRuleSuppression) ToHclTerraform() interface{} {
	var returns interface{}
