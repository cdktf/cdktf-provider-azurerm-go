...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/monitoractionrulesuppression/internal"
...
func NewMonitorActionRuleSuppressionConditionTargetResourceTypeOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) MonitorActionRuleSuppressionConditionTargetResourceTypeOutputReference {
	...
	if err := validateNewMonitorActionRuleSuppressionConditionTargetResourceTypeOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
