...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "floatingIpEnabledInput", GoGetter: "FloatingIpEnabledInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "frontendPortEnd", GoGetter: "FrontendPortEnd"},
			_jsii_.MemberProperty{JsiiProperty: "frontendPortEndInput", GoGetter: "FrontendPortEndInput"},
			_jsii_.MemberProperty{JsiiProperty: "frontendPortStart", GoGetter: "FrontendPortStart"},
			_jsii_.MemberProperty{JsiiProperty: "frontendPortStartInput", GoGetter: "FrontendPortStartInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetFloatingIpEnabled", GoMethod: "ResetFloatingIpEnabled"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetIdleTimeoutInMinutes", GoMethod: "ResetIdleTimeoutInMinutes"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetTcpResetEnabled", GoMethod: "ResetTcpResetEnabled"},
			_jsii_.MemberMethod{JsiiMethod: "resetTimeouts", GoMethod: "ResetTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "resourceGroupName", GoGetter: "ResourceGroupName"},
			_jsii_.MemberProperty{JsiiProperty: "resourceGroupNameInput", GoGetter: "ResourceGroupNameInput"},
			_jsii_.MemberMethod{JsiiMethod: "synthesizeAttributes", GoMethod: "SynthesizeAttributes"},
			_jsii_.MemberProperty{JsiiProperty: "tcpResetEnabled", GoGetter: "TcpResetEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "tcpResetEnabledInput", GoGetter: "TcpResetEnabledInput"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_LbNatPoolTimeoutsOutputReference{}
