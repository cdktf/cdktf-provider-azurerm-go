...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/iotcentralapplication/internal"
...
func NewIotcentralApplication(scope constructs.Construct, id *string, config *IotcentralApplicationConfig) IotcentralApplication {
	...
	if err := validateNewIotcentralApplicationParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func IotcentralApplication_IsConstruct(x interface{}) *bool {
	...
	if err := validateIotcentralApplication_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func IotcentralApplication_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateIotcentralApplication_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func IotcentralApplication_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateIotcentralApplication_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
