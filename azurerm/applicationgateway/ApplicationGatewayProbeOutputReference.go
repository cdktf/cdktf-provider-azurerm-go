...
func NewApplicationGatewayProbeOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ApplicationGatewayProbeOutputReference {
	...
	if err := validateNewApplicationGatewayProbeOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_ApplicationGatewayProbeOutputReference)SetMinimumServers(val *float64) {
	if err := j.validateSetMinimumServersParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_ApplicationGatewayProbeOutputReference)SetPickHostNameFromBackendHttpSettings(val interface{}) {
	if err := j.validateSetPickHostNameFromBackendHttpSettingsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (a *jsiiProxy_ApplicationGatewayProbeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApplicationGatewayProbeOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
