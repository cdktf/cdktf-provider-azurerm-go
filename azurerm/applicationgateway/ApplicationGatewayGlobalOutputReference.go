...
func NewApplicationGatewayGlobalOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) ApplicationGatewayGlobalOutputReference {
	...
	if err := validateNewApplicationGatewayGlobalOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_ApplicationGatewayGlobalOutputReference)SetRequestBufferingEnabled(val interface{}) {
	if err := j.validateSetRequestBufferingEnabledParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_ApplicationGatewayGlobalOutputReference)SetResponseBufferingEnabled(val interface{}) {
	if err := j.validateSetResponseBufferingEnabledParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (a *jsiiProxy_ApplicationGatewayGlobalOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApplicationGatewayGlobalOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
