...
func NewApplicationGatewayPrivateEndpointConnectionOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ApplicationGatewayPrivateEndpointConnectionOutputReference {
	...
	if err := validateNewApplicationGatewayPrivateEndpointConnectionOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApplicationGatewayPrivateEndpointConnectionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApplicationGatewayPrivateEndpointConnectionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
