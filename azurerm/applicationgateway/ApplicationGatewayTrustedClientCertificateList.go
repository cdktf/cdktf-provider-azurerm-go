...
func NewApplicationGatewayTrustedClientCertificateList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApplicationGatewayTrustedClientCertificateList {
	...
	if err := validateNewApplicationGatewayTrustedClientCertificateListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApplicationGatewayTrustedClientCertificateList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApplicationGatewayTrustedClientCertificateList) Resolve(context cdktf.IResolveContext) interface{} {
