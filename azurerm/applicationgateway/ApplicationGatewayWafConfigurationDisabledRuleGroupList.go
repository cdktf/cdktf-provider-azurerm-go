...
func NewApplicationGatewayWafConfigurationDisabledRuleGroupList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApplicationGatewayWafConfigurationDisabledRuleGroupList {
	...
	if err := validateNewApplicationGatewayWafConfigurationDisabledRuleGroupListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApplicationGatewayWafConfigurationDisabledRuleGroupList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApplicationGatewayWafConfigurationDisabledRuleGroupList) Resolve(context cdktf.IResolveContext) interface{} {
