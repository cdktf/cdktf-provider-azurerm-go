...
func NewApplicationGatewayPrivateEndpointConnectionList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApplicationGatewayPrivateEndpointConnectionList {
	...
	if err := validateNewApplicationGatewayPrivateEndpointConnectionListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApplicationGatewayPrivateEndpointConnectionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApplicationGatewayPrivateEndpointConnectionList) Resolve(context cdktf.IResolveContext) interface{} {
