...
func NewApplicationGatewayHttpListenerCustomErrorConfigurationOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ApplicationGatewayHttpListenerCustomErrorConfigurationOutputReference {
	...
	if err := validateNewApplicationGatewayHttpListenerCustomErrorConfigurationOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_ApplicationGatewayHttpListenerCustomErrorConfigurationOutputReference)SetCustomErrorPageUrl(val *string) {
	if err := j.validateSetCustomErrorPageUrlParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (a *jsiiProxy_ApplicationGatewayHttpListenerCustomErrorConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApplicationGatewayHttpListenerCustomErrorConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
