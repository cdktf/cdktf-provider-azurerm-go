...
func NewConsumptionBudgetManagementGroupFilterDimensionOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ConsumptionBudgetManagementGroupFilterDimensionOutputReference {
	...
	if err := validateNewConsumptionBudgetManagementGroupFilterDimensionOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_ConsumptionBudgetManagementGroupFilterDimensionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ConsumptionBudgetManagementGroupFilterDimensionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
