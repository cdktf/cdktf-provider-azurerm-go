...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "dataEncrypted", GoGetter: "DataEncrypted"},
			_jsii_.MemberProperty{JsiiProperty: "dataEncryptedInput", GoGetter: "DataEncryptedInput"},
			_jsii_.MemberProperty{JsiiProperty: "dependsOn", GoGetter: "DependsOn"},
			_jsii_.MemberProperty{JsiiProperty: "forEach", GoGetter: "ForEach"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberProperty{JsiiProperty: "friendlyUniqueId", GoGetter: "FriendlyUniqueId"},
			_jsii_.MemberProperty{JsiiProperty: "geoBackupPolicyEnabled", GoGetter: "GeoBackupPolicyEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "geoBackupPolicyEnabledInput", GoGetter: "GeoBackupPolicyEnabledInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "recoveryDatabaseId", GoGetter: "RecoveryDatabaseId"},
			_jsii_.MemberProperty{JsiiProperty: "recoveryDatabaseIdInput", GoGetter: "RecoveryDatabaseIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDataEncrypted", GoMethod: "ResetDataEncrypted"},
			_jsii_.MemberMethod{JsiiMethod: "resetGeoBackupPolicyEnabled", GoMethod: "ResetGeoBackupPolicyEnabled"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_SynapseSqlPoolRestoreOutputReference{}
