...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/monitoralertprocessingrulesuppression/internal"
...
func NewMonitorAlertProcessingRuleSuppressionConditionMonitorConditionOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) MonitorAlertProcessingRuleSuppressionConditionMonitorConditionOutputReference {
	...
	if err := validateNewMonitorAlertProcessingRuleSuppressionConditionMonitorConditionOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
