...
func NewMonitorAlertProcessingRuleSuppressionConditionTargetResourceTypeOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) MonitorAlertProcessingRuleSuppressionConditionTargetResourceTypeOutputReference {
	...
	if err := validateNewMonitorAlertProcessingRuleSuppressionConditionTargetResourceTypeOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_MonitorAlertProcessingRuleSuppressionConditionTargetResourceTypeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleSuppressionConditionTargetResourceTypeOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
