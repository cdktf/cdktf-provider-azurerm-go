...
func NewMonitorAlertProcessingRuleSuppressionConditionDescriptionOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) MonitorAlertProcessingRuleSuppressionConditionDescriptionOutputReference {
	...
	if err := validateNewMonitorAlertProcessingRuleSuppressionConditionDescriptionOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_MonitorAlertProcessingRuleSuppressionConditionDescriptionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleSuppressionConditionDescriptionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
