...
func NewMonitorAlertProcessingRuleSuppressionScheduleRecurrenceDailyList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MonitorAlertProcessingRuleSuppressionScheduleRecurrenceDailyList {
	...
	if err := validateNewMonitorAlertProcessingRuleSuppressionScheduleRecurrenceDailyListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_MonitorAlertProcessingRuleSuppressionScheduleRecurrenceDailyList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleSuppressionScheduleRecurrenceDailyList) Resolve(context cdktf.IResolveContext) interface{} {
