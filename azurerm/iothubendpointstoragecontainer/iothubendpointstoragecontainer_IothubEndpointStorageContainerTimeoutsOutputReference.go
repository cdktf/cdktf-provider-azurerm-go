...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/iothubendpointstoragecontainer/internal"
...
func NewIothubEndpointStorageContainerTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) IothubEndpointStorageContainerTimeoutsOutputReference {
	...
	if err := validateNewIothubEndpointStorageContainerTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
