...
func NewFirewallPolicyDnsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) FirewallPolicyDnsOutputReference {
	...
	if err := validateNewFirewallPolicyDnsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_FirewallPolicyDnsOutputReference)SetProxyEnabled(val interface{}) {
	if err := j.validateSetProxyEnabledParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (f *jsiiProxy_FirewallPolicyDnsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FirewallPolicyDnsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
