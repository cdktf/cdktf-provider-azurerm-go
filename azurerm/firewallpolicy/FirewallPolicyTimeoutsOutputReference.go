...
func NewFirewallPolicyTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) FirewallPolicyTimeoutsOutputReference {
	...
	if err := validateNewFirewallPolicyTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (f *jsiiProxy_FirewallPolicyTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FirewallPolicyTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
