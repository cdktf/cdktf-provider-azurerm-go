...
func (f *jsiiProxy_FirewallPolicyExplicitProxyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FirewallPolicyExplicitProxyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
