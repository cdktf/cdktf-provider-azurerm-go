...
func NewFirewallPolicyIntrusionDetectionSignatureOverridesList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FirewallPolicyIntrusionDetectionSignatureOverridesList {
	...
	if err := validateNewFirewallPolicyIntrusionDetectionSignatureOverridesListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (f *jsiiProxy_FirewallPolicyIntrusionDetectionSignatureOverridesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FirewallPolicyIntrusionDetectionSignatureOverridesList) Resolve(context cdktf.IResolveContext) interface{} {
