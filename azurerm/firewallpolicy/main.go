...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "childPolicies", GoGetter: "ChildPolicies"},
			...
			_jsii_.MemberProperty{JsiiProperty: "insights", GoGetter: "Insights"},
			_jsii_.MemberProperty{JsiiProperty: "insightsInput", GoGetter: "InsightsInput"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "intrusionDetection", GoGetter: "IntrusionDetection"},
			_jsii_.MemberProperty{JsiiProperty: "intrusionDetectionInput", GoGetter: "IntrusionDetectionInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putThreatIntelligenceAllowlist", GoMethod: "PutThreatIntelligenceAllowlist"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetIntrusionDetection", GoMethod: "ResetIntrusionDetection"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSqlRedirectAllowed", GoMethod: "ResetSqlRedirectAllowed"},
			_jsii_.MemberMethod{JsiiMethod: "resetTags", GoMethod: "ResetTags"},
			_jsii_.MemberMethod{JsiiMethod: "resetThreatIntelligenceAllowlist", GoMethod: "ResetThreatIntelligenceAllowlist"},
			_jsii_.MemberMethod{JsiiMethod: "resetThreatIntelligenceMode", GoMethod: "ResetThreatIntelligenceMode"},
			...
			_jsii_.MemberProperty{JsiiProperty: "ruleCollectionGroups", GoGetter: "RuleCollectionGroups"},
			_jsii_.MemberProperty{JsiiProperty: "sku", GoGetter: "Sku"},
			_jsii_.MemberProperty{JsiiProperty: "skuInput", GoGetter: "SkuInput"},
			_jsii_.MemberProperty{JsiiProperty: "sqlRedirectAllowed", GoGetter: "SqlRedirectAllowed"},
			_jsii_.MemberProperty{JsiiProperty: "sqlRedirectAllowedInput", GoGetter: "SqlRedirectAllowedInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "threatIntelligenceAllowlist", GoGetter: "ThreatIntelligenceAllowlist"},
			_jsii_.MemberProperty{JsiiProperty: "threatIntelligenceAllowlistInput", GoGetter: "ThreatIntelligenceAllowlistInput"},
			_jsii_.MemberProperty{JsiiProperty: "threatIntelligenceMode", GoGetter: "ThreatIntelligenceMode"},
			_jsii_.MemberProperty{JsiiProperty: "threatIntelligenceModeInput", GoGetter: "ThreatIntelligenceModeInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetProxyEnabled", GoMethod: "ResetProxyEnabled"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "firewallLocation", GoGetter: "FirewallLocation"},
			_jsii_.MemberProperty{JsiiProperty: "firewallLocationInput", GoGetter: "FirewallLocationInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "defaultLogAnalyticsWorkspaceId", GoGetter: "DefaultLogAnalyticsWorkspaceId"},
			_jsii_.MemberProperty{JsiiProperty: "defaultLogAnalyticsWorkspaceIdInput", GoGetter: "DefaultLogAnalyticsWorkspaceIdInput"},
			_jsii_.MemberProperty{JsiiProperty: "enabled", GoGetter: "Enabled"},
			_jsii_.MemberProperty{JsiiProperty: "enabledInput", GoGetter: "EnabledInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "logAnalyticsWorkspace", GoGetter: "LogAnalyticsWorkspace"},
			_jsii_.MemberProperty{JsiiProperty: "logAnalyticsWorkspaceInput", GoGetter: "LogAnalyticsWorkspaceInput"},
			_jsii_.MemberMethod{JsiiMethod: "putLogAnalyticsWorkspace", GoMethod: "PutLogAnalyticsWorkspace"},
			_jsii_.MemberMethod{JsiiMethod: "resetLogAnalyticsWorkspace", GoMethod: "ResetLogAnalyticsWorkspace"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "privateRanges", GoGetter: "PrivateRanges"},
			_jsii_.MemberProperty{JsiiProperty: "privateRangesInput", GoGetter: "PrivateRangesInput"},
			_jsii_.MemberMethod{JsiiMethod: "putSignatureOverrides", GoMethod: "PutSignatureOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "putTrafficBypass", GoMethod: "PutTrafficBypass"},
			_jsii_.MemberMethod{JsiiMethod: "resetMode", GoMethod: "ResetMode"},
			_jsii_.MemberMethod{JsiiMethod: "resetPrivateRanges", GoMethod: "ResetPrivateRanges"},
			_jsii_.MemberMethod{JsiiMethod: "resetSignatureOverrides", GoMethod: "ResetSignatureOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetTrafficBypass", GoMethod: "ResetTrafficBypass"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "signatureOverrides", GoGetter: "SignatureOverrides"},
			_jsii_.MemberProperty{JsiiProperty: "signatureOverridesInput", GoGetter: "SignatureOverridesInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
			_jsii_.MemberProperty{JsiiProperty: "trafficBypass", GoGetter: "TrafficBypass"},
			_jsii_.MemberProperty{JsiiProperty: "trafficBypassInput", GoGetter: "TrafficBypassInput"},
		},
		func() interface{} {
