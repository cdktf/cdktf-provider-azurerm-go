...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v3/firewallpolicy/internal"
...
func NewFirewallPolicyIntrusionDetectionSignatureOverridesOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) FirewallPolicyIntrusionDetectionSignatureOverridesOutputReference {
	...
	if err := validateNewFirewallPolicyIntrusionDetectionSignatureOverridesOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
