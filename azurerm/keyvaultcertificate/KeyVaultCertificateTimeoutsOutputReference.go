...
func NewKeyVaultCertificateTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) KeyVaultCertificateTimeoutsOutputReference {
	...
	if err := validateNewKeyVaultCertificateTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (k *jsiiProxy_KeyVaultCertificateTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (k *jsiiProxy_KeyVaultCertificateTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
