...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/keyvaultcertificate/internal"
...
func NewKeyVaultCertificate(scope constructs.Construct, id *string, config *KeyVaultCertificateConfig) KeyVaultCertificate {
	...
	if err := validateNewKeyVaultCertificateParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func KeyVaultCertificate_IsConstruct(x interface{}) *bool {
	...
	if err := validateKeyVaultCertificate_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func KeyVaultCertificate_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateKeyVaultCertificate_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func KeyVaultCertificate_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateKeyVaultCertificate_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (k *jsiiProxy_KeyVaultCertificate) PutCertificate(value *KeyVaultCertificateCertificate) {
	if err := k.validatePutCertificateParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		k,
...
func (k *jsiiProxy_KeyVaultCertificate) PutCertificatePolicy(value *KeyVaultCertificateCertificatePolicy) {
	if err := k.validatePutCertificatePolicyParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		k,
