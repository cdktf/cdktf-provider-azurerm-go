...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v11/cdnfrontdoorroutedisablelinktodefaultdomain/internal"
...
func NewCdnFrontdoorRouteDisableLinkToDefaultDomainTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) CdnFrontdoorRouteDisableLinkToDefaultDomainTimeoutsOutputReference {
	...
	if err := validateNewCdnFrontdoorRouteDisableLinkToDefaultDomainTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
