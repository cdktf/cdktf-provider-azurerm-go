...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/mediaassetfilter/internal"
...
func NewMediaAssetFilterTrackSelectionOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) MediaAssetFilterTrackSelectionOutputReference {
	...
	if err := validateNewMediaAssetFilterTrackSelectionOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
