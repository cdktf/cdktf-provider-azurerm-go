...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/mediaassetfilter/internal"
...
func NewMediaAssetFilter(scope constructs.Construct, id *string, config *MediaAssetFilterConfig) MediaAssetFilter {
	...
	if err := validateNewMediaAssetFilterParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func MediaAssetFilter_IsConstruct(x interface{}) *bool {
	...
	if err := validateMediaAssetFilter_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func MediaAssetFilter_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateMediaAssetFilter_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func MediaAssetFilter_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateMediaAssetFilter_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
