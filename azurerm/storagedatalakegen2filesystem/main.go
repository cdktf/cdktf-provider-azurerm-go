...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "aceInput", GoGetter: "AceInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "defaultEncryptionScopeInput", GoGetter: "DefaultEncryptionScopeInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putAce", GoMethod: "PutAce"},
			_jsii_.MemberMethod{JsiiMethod: "putTimeouts", GoMethod: "PutTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetAce", GoMethod: "ResetAce"},
			_jsii_.MemberMethod{JsiiMethod: "resetDefaultEncryptionScope", GoMethod: "ResetDefaultEncryptionScope"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_StorageDataLakeGen2FilesystemTimeoutsOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
