...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/mssqlserversecurityalertpolicy/internal"
...
func NewMssqlServerSecurityAlertPolicy(scope constructs.Construct, id *string, config *MssqlServerSecurityAlertPolicyConfig) MssqlServerSecurityAlertPolicy {
	...
	if err := validateNewMssqlServerSecurityAlertPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func MssqlServerSecurityAlertPolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateMssqlServerSecurityAlertPolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func MssqlServerSecurityAlertPolicy_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateMssqlServerSecurityAlertPolicy_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func MssqlServerSecurityAlertPolicy_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateMssqlServerSecurityAlertPolicy_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
