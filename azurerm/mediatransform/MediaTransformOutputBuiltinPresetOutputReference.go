...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/mediatransform/internal"
...
func NewMediaTransformOutputBuiltinPresetOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) MediaTransformOutputBuiltinPresetOutputReference {
	...
	if err := validateNewMediaTransformOutputBuiltinPresetOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_MediaTransformOutputBuiltinPresetOutputReference)SetPresetName(val *string) {
	if err := j.validateSetPresetNameParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
