...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "agentPublicKeyCertificate", GoGetter: "AgentPublicKeyCertificate"},
			_jsii_.MemberProperty{JsiiProperty: "agentPublicKeyCertificateInput", GoGetter: "AgentPublicKeyCertificateInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "offering", GoGetter: "Offering"},
		...
		func() interface{} {
			j := jsiiProxy_ArcKubernetesCluster{}
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_ArcKubernetesClusterIdentityOutputReference{}
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_ArcKubernetesClusterTimeoutsOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
