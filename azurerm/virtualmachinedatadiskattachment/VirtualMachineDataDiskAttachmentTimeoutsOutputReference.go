...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/virtualmachinedatadiskattachment/internal"
...
func NewVirtualMachineDataDiskAttachmentTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) VirtualMachineDataDiskAttachmentTimeoutsOutputReference {
	...
	if err := validateNewVirtualMachineDataDiskAttachmentTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (v *jsiiProxy_VirtualMachineDataDiskAttachmentTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VirtualMachineDataDiskAttachmentTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
