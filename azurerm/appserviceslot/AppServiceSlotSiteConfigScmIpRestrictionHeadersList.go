...
func NewAppServiceSlotSiteConfigScmIpRestrictionHeadersList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) AppServiceSlotSiteConfigScmIpRestrictionHeadersList {
	...
	if err := validateNewAppServiceSlotSiteConfigScmIpRestrictionHeadersListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AppServiceSlotSiteConfigScmIpRestrictionHeadersList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_AppServiceSlotSiteConfigScmIpRestrictionHeadersList) Resolve(context cdktf.IResolveContext) interface{} {
