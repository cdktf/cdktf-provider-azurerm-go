...
func NewAppServiceSlotIdentityOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) AppServiceSlotIdentityOutputReference {
	...
	if err := validateNewAppServiceSlotIdentityOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AppServiceSlotIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppServiceSlotIdentityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
