...
func NewAppServiceSlotTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) AppServiceSlotTimeoutsOutputReference {
	...
	if err := validateNewAppServiceSlotTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AppServiceSlotTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppServiceSlotTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
