...
func NewAppServiceSlotSiteConfigCorsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) AppServiceSlotSiteConfigCorsOutputReference {
	...
	if err := validateNewAppServiceSlotSiteConfigCorsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AppServiceSlotSiteConfigCorsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppServiceSlotSiteConfigCorsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
