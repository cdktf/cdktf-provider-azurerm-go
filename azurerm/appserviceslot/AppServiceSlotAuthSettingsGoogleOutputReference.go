...
func NewAppServiceSlotAuthSettingsGoogleOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) AppServiceSlotAuthSettingsGoogleOutputReference {
	...
	if err := validateNewAppServiceSlotAuthSettingsGoogleOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AppServiceSlotAuthSettingsGoogleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppServiceSlotAuthSettingsGoogleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
