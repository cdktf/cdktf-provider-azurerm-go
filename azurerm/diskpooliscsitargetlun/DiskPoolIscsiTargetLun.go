...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/diskpooliscsitargetlun/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.106.1/docs/resources/disk_pool_iscsi_target_lun azurerm_disk_pool_iscsi_target_lun} Resource.
func NewDiskPoolIscsiTargetLun(scope constructs.Construct, id *string, config *DiskPoolIscsiTargetLunConfig) DiskPoolIscsiTargetLun {
	...
	_jsii_.Create(
		"@cdktf/provider-azurerm.diskPoolIscsiTargetLun.DiskPoolIscsiTargetLun",
