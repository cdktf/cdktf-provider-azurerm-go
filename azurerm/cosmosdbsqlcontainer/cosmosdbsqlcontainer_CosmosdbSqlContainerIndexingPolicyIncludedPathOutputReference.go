...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v3/cosmosdbsqlcontainer/internal"
...
func NewCosmosdbSqlContainerIndexingPolicyIncludedPathOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) CosmosdbSqlContainerIndexingPolicyIncludedPathOutputReference {
	...
	if err := validateNewCosmosdbSqlContainerIndexingPolicyIncludedPathOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
