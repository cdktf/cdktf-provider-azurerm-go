...
func NewCosmosdbSqlContainerUniqueKeyOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) CosmosdbSqlContainerUniqueKeyOutputReference {
	...
	if err := validateNewCosmosdbSqlContainerUniqueKeyOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CosmosdbSqlContainerUniqueKeyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CosmosdbSqlContainerUniqueKeyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
