...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/managementgrouppolicyremediation/internal"
...
func NewManagementGroupPolicyRemediationTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) ManagementGroupPolicyRemediationTimeoutsOutputReference {
	...
	if err := validateNewManagementGroupPolicyRemediationTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
