...
func (s *jsiiProxy_SiteRecoveryVmwareReplicatedVmManagedDiskOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SiteRecoveryVmwareReplicatedVmManagedDiskOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
