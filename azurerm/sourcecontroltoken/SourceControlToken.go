...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/sourcecontroltoken/internal"
...
func (j *jsiiProxy_SourceControlToken) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_SourceControlToken)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
