...
func NewApiManagementDiagnosticBackendRequestDataMaskingHeadersList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiManagementDiagnosticBackendRequestDataMaskingHeadersList {
	...
	if err := validateNewApiManagementDiagnosticBackendRequestDataMaskingHeadersListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApiManagementDiagnosticBackendRequestDataMaskingHeadersList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementDiagnosticBackendRequestDataMaskingHeadersList) Resolve(context cdktf.IResolveContext) interface{} {
