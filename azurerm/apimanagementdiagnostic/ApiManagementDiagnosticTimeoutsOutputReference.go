...
func NewApiManagementDiagnosticTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) ApiManagementDiagnosticTimeoutsOutputReference {
	...
	if err := validateNewApiManagementDiagnosticTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApiManagementDiagnosticTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApiManagementDiagnosticTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
