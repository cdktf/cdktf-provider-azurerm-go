...
func NewApiManagementDiagnosticFrontendRequestOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) ApiManagementDiagnosticFrontendRequestOutputReference {
	...
	if err := validateNewApiManagementDiagnosticFrontendRequestOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApiManagementDiagnosticFrontendRequestOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApiManagementDiagnosticFrontendRequestOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
