...
func NewApiManagementDiagnosticFrontendResponseDataMaskingQueryParamsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiManagementDiagnosticFrontendResponseDataMaskingQueryParamsList {
	...
	if err := validateNewApiManagementDiagnosticFrontendResponseDataMaskingQueryParamsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApiManagementDiagnosticFrontendResponseDataMaskingQueryParamsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementDiagnosticFrontendResponseDataMaskingQueryParamsList) Resolve(context cdktf.IResolveContext) interface{} {
