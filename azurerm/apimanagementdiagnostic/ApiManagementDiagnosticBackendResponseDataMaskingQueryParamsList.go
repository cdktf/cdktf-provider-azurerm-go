...
func (a *jsiiProxy_ApiManagementDiagnosticBackendResponseDataMaskingQueryParamsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementDiagnosticBackendResponseDataMaskingQueryParamsList) Resolve(context cdktf.IResolveContext) interface{} {
