...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/apimanagementdiagnostic/internal"
...
func NewApiManagementDiagnosticBackendResponseDataMaskingQueryParamsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ApiManagementDiagnosticBackendResponseDataMaskingQueryParamsOutputReference {
	...
	if err := validateNewApiManagementDiagnosticBackendResponseDataMaskingQueryParamsOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
