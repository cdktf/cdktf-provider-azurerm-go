...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/apimanagementdiagnostic/internal"
...
func NewApiManagementDiagnosticFrontendResponseDataMaskingQueryParamsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ApiManagementDiagnosticFrontendResponseDataMaskingQueryParamsOutputReference {
	...
	if err := validateNewApiManagementDiagnosticFrontendResponseDataMaskingQueryParamsOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
