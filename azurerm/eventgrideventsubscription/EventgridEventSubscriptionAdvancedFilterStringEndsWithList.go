...
func NewEventgridEventSubscriptionAdvancedFilterStringEndsWithList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) EventgridEventSubscriptionAdvancedFilterStringEndsWithList {
	...
	if err := validateNewEventgridEventSubscriptionAdvancedFilterStringEndsWithListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_EventgridEventSubscriptionAdvancedFilterStringEndsWithList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (e *jsiiProxy_EventgridEventSubscriptionAdvancedFilterStringEndsWithList) Resolve(context cdktf.IResolveContext) interface{} {
