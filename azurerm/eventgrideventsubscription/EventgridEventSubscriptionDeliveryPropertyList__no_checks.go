...
func (e *jsiiProxy_EventgridEventSubscriptionDeliveryPropertyList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_EventgridEventSubscriptionDeliveryPropertyList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_EventgridEventSubscriptionDeliveryPropertyList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
