...
func NewEventgridEventSubscriptionAdvancedFilterStringContainsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) EventgridEventSubscriptionAdvancedFilterStringContainsList {
	...
	if err := validateNewEventgridEventSubscriptionAdvancedFilterStringContainsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_EventgridEventSubscriptionAdvancedFilterStringContainsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
