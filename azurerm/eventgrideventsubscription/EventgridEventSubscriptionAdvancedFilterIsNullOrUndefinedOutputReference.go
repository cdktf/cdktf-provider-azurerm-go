...
func NewEventgridEventSubscriptionAdvancedFilterIsNullOrUndefinedOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) EventgridEventSubscriptionAdvancedFilterIsNullOrUndefinedOutputReference {
	...
	if err := validateNewEventgridEventSubscriptionAdvancedFilterIsNullOrUndefinedOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_EventgridEventSubscriptionAdvancedFilterIsNullOrUndefinedOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_EventgridEventSubscriptionAdvancedFilterIsNullOrUndefinedOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
