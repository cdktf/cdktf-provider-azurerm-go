...
func NewEventgridEventSubscriptionAdvancedFilterNumberGreaterThanOrEqualsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) EventgridEventSubscriptionAdvancedFilterNumberGreaterThanOrEqualsList {
	...
	if err := validateNewEventgridEventSubscriptionAdvancedFilterNumberGreaterThanOrEqualsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_EventgridEventSubscriptionAdvancedFilterNumberGreaterThanOrEqualsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (e *jsiiProxy_EventgridEventSubscriptionAdvancedFilterNumberGreaterThanOrEqualsList) Resolve(context cdktf.IResolveContext) interface{} {
