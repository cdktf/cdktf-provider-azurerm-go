...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/eventgrideventsubscription/internal"
...
func NewEventgridEventSubscriptionStorageBlobDeadLetterDestinationOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) EventgridEventSubscriptionStorageBlobDeadLetterDestinationOutputReference {
	...
	if err := validateNewEventgridEventSubscriptionStorageBlobDeadLetterDestinationOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
