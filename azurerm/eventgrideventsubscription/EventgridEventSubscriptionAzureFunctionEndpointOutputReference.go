...
func (e *jsiiProxy_EventgridEventSubscriptionAzureFunctionEndpointOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_EventgridEventSubscriptionAzureFunctionEndpointOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
