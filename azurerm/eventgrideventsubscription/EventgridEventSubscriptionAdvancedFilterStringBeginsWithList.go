...
func NewEventgridEventSubscriptionAdvancedFilterStringBeginsWithList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) EventgridEventSubscriptionAdvancedFilterStringBeginsWithList {
	...
	if err := validateNewEventgridEventSubscriptionAdvancedFilterStringBeginsWithListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_EventgridEventSubscriptionAdvancedFilterStringBeginsWithList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (e *jsiiProxy_EventgridEventSubscriptionAdvancedFilterStringBeginsWithList) Resolve(context cdktf.IResolveContext) interface{} {
