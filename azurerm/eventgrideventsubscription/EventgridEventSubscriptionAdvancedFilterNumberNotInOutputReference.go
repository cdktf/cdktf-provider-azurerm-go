...
func NewEventgridEventSubscriptionAdvancedFilterNumberNotInOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) EventgridEventSubscriptionAdvancedFilterNumberNotInOutputReference {
	...
	if err := validateNewEventgridEventSubscriptionAdvancedFilterNumberNotInOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_EventgridEventSubscriptionAdvancedFilterNumberNotInOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_EventgridEventSubscriptionAdvancedFilterNumberNotInOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
