...
func NewEventgridEventSubscriptionAdvancedFilterStringInList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) EventgridEventSubscriptionAdvancedFilterStringInList {
	...
	if err := validateNewEventgridEventSubscriptionAdvancedFilterStringInListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_EventgridEventSubscriptionAdvancedFilterStringInList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (e *jsiiProxy_EventgridEventSubscriptionAdvancedFilterStringInList) Resolve(context cdktf.IResolveContext) interface{} {
