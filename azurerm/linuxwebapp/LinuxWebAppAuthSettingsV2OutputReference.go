...
func (l *jsiiProxy_LinuxWebAppAuthSettingsV2OutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LinuxWebAppAuthSettingsV2OutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
