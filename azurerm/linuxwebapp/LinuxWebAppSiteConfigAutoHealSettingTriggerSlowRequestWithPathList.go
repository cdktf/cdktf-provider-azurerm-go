...
func (j *jsiiProxy_LinuxWebAppSiteConfigAutoHealSettingTriggerSlowRequestWithPathList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewLinuxWebAppSiteConfigAutoHealSettingTriggerSlowRequestWithPathList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LinuxWebAppSiteConfigAutoHealSettingTriggerSlowRequestWithPathList {
	_init_.Initialize()
...
func NewLinuxWebAppSiteConfigAutoHealSettingTriggerSlowRequestWithPathList_Override(l LinuxWebAppSiteConfigAutoHealSettingTriggerSlowRequestWithPathList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_LinuxWebAppSiteConfigAutoHealSettingTriggerSlowRequestWithPathList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (l *jsiiProxy_LinuxWebAppSiteConfigAutoHealSettingTriggerSlowRequestWithPathList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LinuxWebAppSiteConfigAutoHealSettingTriggerSlowRequestWithPathList) Resolve(_context cdktf.IResolveContext) interface{} {
