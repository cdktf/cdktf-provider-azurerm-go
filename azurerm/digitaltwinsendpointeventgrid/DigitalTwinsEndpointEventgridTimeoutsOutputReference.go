...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/digitaltwinsendpointeventgrid/internal"
...
func NewDigitalTwinsEndpointEventgridTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DigitalTwinsEndpointEventgridTimeoutsOutputReference {
	...
	if err := validateNewDigitalTwinsEndpointEventgridTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DigitalTwinsEndpointEventgridTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DigitalTwinsEndpointEventgridTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
