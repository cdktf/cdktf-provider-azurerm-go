...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v3/synapsesqlpoolworkloadgroup/internal"
...
func NewSynapseSqlPoolWorkloadGroupTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) SynapseSqlPoolWorkloadGroupTimeoutsOutputReference {
	...
	if err := validateNewSynapseSqlPoolWorkloadGroupTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
