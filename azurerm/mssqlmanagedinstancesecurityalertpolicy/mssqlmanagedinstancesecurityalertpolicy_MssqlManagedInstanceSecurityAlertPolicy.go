...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v3/mssqlmanagedinstancesecurityalertpolicy/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://www.terraform.io/docs/providers/azurerm/r/mssql_managed_instance_security_alert_policy azurerm_mssql_managed_instance_security_alert_policy}.
...
func (j *jsiiProxy_MssqlManagedInstanceSecurityAlertPolicy) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://www.terraform.io/docs/providers/azurerm/r/mssql_managed_instance_security_alert_policy azurerm_mssql_managed_instance_security_alert_policy} Resource.
...
func (j *jsiiProxy_MssqlManagedInstanceSecurityAlertPolicy)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
