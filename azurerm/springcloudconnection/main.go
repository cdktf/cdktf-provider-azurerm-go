...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putSecretStore", GoMethod: "PutSecretStore"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSecretStore", GoMethod: "ResetSecretStore"},
			_jsii_.MemberMethod{JsiiMethod: "resetTimeouts", GoMethod: "ResetTimeouts"},
			_jsii_.MemberMethod{JsiiMethod: "resetVnetSolution", GoMethod: "ResetVnetSolution"},
			_jsii_.MemberProperty{JsiiProperty: "secretStore", GoGetter: "SecretStore"},
			_jsii_.MemberProperty{JsiiProperty: "secretStoreInput", GoGetter: "SecretStoreInput"},
			_jsii_.MemberProperty{JsiiProperty: "springCloudId", GoGetter: "SpringCloudId"},
			_jsii_.MemberProperty{JsiiProperty: "springCloudIdInput", GoGetter: "SpringCloudIdInput"},
