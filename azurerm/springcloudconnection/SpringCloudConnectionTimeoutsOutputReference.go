...
func NewSpringCloudConnectionTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) SpringCloudConnectionTimeoutsOutputReference {
	...
	if err := validateNewSpringCloudConnectionTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SpringCloudConnectionTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SpringCloudConnectionTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
