...
func NewHdinsightHbaseClusterMetastoresHiveOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) HdinsightHbaseClusterMetastoresHiveOutputReference {
	...
	if err := validateNewHdinsightHbaseClusterMetastoresHiveOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (h *jsiiProxy_HdinsightHbaseClusterMetastoresHiveOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HdinsightHbaseClusterMetastoresHiveOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
