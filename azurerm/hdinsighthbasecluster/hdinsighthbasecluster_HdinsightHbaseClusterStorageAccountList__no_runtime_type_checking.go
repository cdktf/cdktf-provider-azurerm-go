...
func (h *jsiiProxy_HdinsightHbaseClusterStorageAccountList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_HdinsightHbaseClusterStorageAccountList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_HdinsightHbaseClusterStorageAccountList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
