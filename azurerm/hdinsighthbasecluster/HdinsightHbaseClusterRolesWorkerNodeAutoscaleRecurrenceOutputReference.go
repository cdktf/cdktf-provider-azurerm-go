...
func NewHdinsightHbaseClusterRolesWorkerNodeAutoscaleRecurrenceOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) HdinsightHbaseClusterRolesWorkerNodeAutoscaleRecurrenceOutputReference {
	...
	if err := validateNewHdinsightHbaseClusterRolesWorkerNodeAutoscaleRecurrenceOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (h *jsiiProxy_HdinsightHbaseClusterRolesWorkerNodeAutoscaleRecurrenceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HdinsightHbaseClusterRolesWorkerNodeAutoscaleRecurrenceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
