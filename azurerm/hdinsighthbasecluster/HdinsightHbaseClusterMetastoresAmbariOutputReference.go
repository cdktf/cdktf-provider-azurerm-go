...
func NewHdinsightHbaseClusterMetastoresAmbariOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) HdinsightHbaseClusterMetastoresAmbariOutputReference {
	...
	if err := validateNewHdinsightHbaseClusterMetastoresAmbariOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (h *jsiiProxy_HdinsightHbaseClusterMetastoresAmbariOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HdinsightHbaseClusterMetastoresAmbariOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
