...
func (h *jsiiProxy_HdinsightHbaseClusterStorageAccountGen2OutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HdinsightHbaseClusterStorageAccountGen2OutputReference) Resolve(context cdktf.IResolveContext) interface{} {
