...
func (h *jsiiProxy_HdinsightHbaseClusterRolesZookeeperNodeScriptActionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HdinsightHbaseClusterRolesZookeeperNodeScriptActionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
