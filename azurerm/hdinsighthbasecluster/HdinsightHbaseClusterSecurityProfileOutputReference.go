...
func (h *jsiiProxy_HdinsightHbaseClusterSecurityProfileOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HdinsightHbaseClusterSecurityProfileOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
