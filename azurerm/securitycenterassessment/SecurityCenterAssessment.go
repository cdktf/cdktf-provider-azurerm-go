...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/securitycenterassessment/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.113.0/docs/resources/security_center_assessment azurerm_security_center_assessment} Resource.
...
func SecurityCenterAssessment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSecurityCenterAssessment_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SecurityCenterAssessment) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SecurityCenterAssessment) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SecurityCenterAssessment) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SecurityCenterAssessment) MoveFromId(id *string) {
...
func (s *jsiiProxy_SecurityCenterAssessment) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_SecurityCenterAssessment) MoveToId(id *string) {
...
func (s *jsiiProxy_SecurityCenterAssessment) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SecurityCenterAssessment) ToHclTerraform() interface{} {
	var returns interface{}
