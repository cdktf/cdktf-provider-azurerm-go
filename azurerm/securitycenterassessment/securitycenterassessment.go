...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "additionalDataInput", GoGetter: "AdditionalDataInput"},
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "assessmentPolicyId", GoGetter: "AssessmentPolicyId"},
			_jsii_.MemberProperty{JsiiProperty: "assessmentPolicyIdInput", GoGetter: "AssessmentPolicyIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAdditionalData", GoMethod: "ResetAdditionalData"},
