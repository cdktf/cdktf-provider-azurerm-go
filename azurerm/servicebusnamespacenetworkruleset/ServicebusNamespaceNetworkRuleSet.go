...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/servicebusnamespacenetworkruleset/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.68.0/docs/resources/servicebus_namespace_network_rule_set azurerm_servicebus_namespace_network_rule_set}.
...
func (j *jsiiProxy_ServicebusNamespaceNetworkRuleSet) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.68.0/docs/resources/servicebus_namespace_network_rule_set azurerm_servicebus_namespace_network_rule_set} Resource.
func NewServicebusNamespaceNetworkRuleSet(scope constructs.Construct, id *string, config *ServicebusNamespaceNetworkRuleSetConfig) ServicebusNamespaceNetworkRuleSet {
	...
	if err := validateNewServicebusNamespaceNetworkRuleSetParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_ServicebusNamespaceNetworkRuleSet)SetCount(val interface{}) {
...
func ServicebusNamespaceNetworkRuleSet_IsConstruct(x interface{}) *bool {
	...
	if err := validateServicebusNamespaceNetworkRuleSet_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ServicebusNamespaceNetworkRuleSet_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateServicebusNamespaceNetworkRuleSet_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ServicebusNamespaceNetworkRuleSet_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateServicebusNamespaceNetworkRuleSet_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
