...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "activitiesJsonInput", GoGetter: "ActivitiesJsonInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "moniterMetricsAfterDuration", GoGetter: "MoniterMetricsAfterDuration"},
			_jsii_.MemberProperty{JsiiProperty: "moniterMetricsAfterDurationInput", GoGetter: "MoniterMetricsAfterDurationInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetActivitiesJson", GoMethod: "ResetActivitiesJson"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetMoniterMetricsAfterDuration", GoMethod: "ResetMoniterMetricsAfterDuration"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_DataFactoryPipelineTimeoutsOutputReference{}
