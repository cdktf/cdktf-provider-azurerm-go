...
func NewStorageAccountQueuePropertiesCorsRuleOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) StorageAccountQueuePropertiesCorsRuleOutputReference {
	...
	if err := validateNewStorageAccountQueuePropertiesCorsRuleOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_StorageAccountQueuePropertiesCorsRuleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StorageAccountQueuePropertiesCorsRuleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
