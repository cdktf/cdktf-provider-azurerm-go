...
func (s *jsiiProxy_StorageAccountQueuePropertiesMinuteMetricsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StorageAccountQueuePropertiesMinuteMetricsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
