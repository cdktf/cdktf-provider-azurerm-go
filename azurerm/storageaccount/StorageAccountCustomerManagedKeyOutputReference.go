...
func NewStorageAccountCustomerManagedKeyOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) StorageAccountCustomerManagedKeyOutputReference {
	...
	if err := validateNewStorageAccountCustomerManagedKeyOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_StorageAccountCustomerManagedKeyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StorageAccountCustomerManagedKeyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
