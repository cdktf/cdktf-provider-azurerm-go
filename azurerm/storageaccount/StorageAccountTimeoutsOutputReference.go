...
func NewStorageAccountTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) StorageAccountTimeoutsOutputReference {
	...
	if err := validateNewStorageAccountTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_StorageAccountTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StorageAccountTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
