...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/storageaccount/internal"
...
func NewStorageAccountNetworkRulesPrivateLinkAccessOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) StorageAccountNetworkRulesPrivateLinkAccessOutputReference {
	...
	if err := validateNewStorageAccountNetworkRulesPrivateLinkAccessOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
