...
func NewStorageAccountBlobPropertiesDeleteRetentionPolicyOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) StorageAccountBlobPropertiesDeleteRetentionPolicyOutputReference {
	...
	if err := validateNewStorageAccountBlobPropertiesDeleteRetentionPolicyOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_StorageAccountBlobPropertiesDeleteRetentionPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StorageAccountBlobPropertiesDeleteRetentionPolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
