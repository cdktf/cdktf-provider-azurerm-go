...
type HdinsightInteractiveQueryClusterRolesZookeeperNodeOutputReference interface {
	...
	ScriptActions() HdinsightInteractiveQueryClusterRolesZookeeperNodeScriptActionsList
...
func (j *jsiiProxy_HdinsightInteractiveQueryClusterRolesZookeeperNodeOutputReference) ScriptActions() HdinsightInteractiveQueryClusterRolesZookeeperNodeScriptActionsList {
	var returns HdinsightInteractiveQueryClusterRolesZookeeperNodeScriptActionsList
	_jsii_.Get(
		j,
		"scriptActions",
		&returns,
...
func (j *jsiiProxy_HdinsightInteractiveQueryClusterRolesZookeeperNodeOutputReference) ScriptActionsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"scriptActionsInput",
...
func NewHdinsightInteractiveQueryClusterRolesZookeeperNodeOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) HdinsightInteractiveQueryClusterRolesZookeeperNodeOutputReference {
	...
	if err := validateNewHdinsightInteractiveQueryClusterRolesZookeeperNodeOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (h *jsiiProxy_HdinsightInteractiveQueryClusterRolesZookeeperNodeOutputReference) PutScriptActions(value interface{}) {
...
func (h *jsiiProxy_HdinsightInteractiveQueryClusterRolesZookeeperNodeOutputReference) ResetScriptActions() {
	_jsii_.InvokeVoid(
		h,
		"resetScriptActions",
		nil, // no parameters
