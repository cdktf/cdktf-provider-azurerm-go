...
func NewHdinsightInteractiveQueryClusterMetastoresAmbariOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) HdinsightInteractiveQueryClusterMetastoresAmbariOutputReference {
	...
	if err := validateNewHdinsightInteractiveQueryClusterMetastoresAmbariOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (h *jsiiProxy_HdinsightInteractiveQueryClusterMetastoresAmbariOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HdinsightInteractiveQueryClusterMetastoresAmbariOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
