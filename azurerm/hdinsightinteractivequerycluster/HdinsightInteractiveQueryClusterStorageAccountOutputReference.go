...
func NewHdinsightInteractiveQueryClusterStorageAccountOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) HdinsightInteractiveQueryClusterStorageAccountOutputReference {
	...
	if err := validateNewHdinsightInteractiveQueryClusterStorageAccountOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (h *jsiiProxy_HdinsightInteractiveQueryClusterStorageAccountOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HdinsightInteractiveQueryClusterStorageAccountOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
