...
func NewHdinsightInteractiveQueryClusterMetastoresOozieOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) HdinsightInteractiveQueryClusterMetastoresOozieOutputReference {
	...
	if err := validateNewHdinsightInteractiveQueryClusterMetastoresOozieOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (h *jsiiProxy_HdinsightInteractiveQueryClusterMetastoresOozieOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HdinsightInteractiveQueryClusterMetastoresOozieOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
