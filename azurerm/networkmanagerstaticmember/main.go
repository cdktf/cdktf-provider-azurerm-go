...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "networkGroupId", GoGetter: "NetworkGroupId"},
			_jsii_.MemberProperty{JsiiProperty: "networkGroupIdInput", GoGetter: "NetworkGroupIdInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "targetVirtualNetworkId", GoGetter: "TargetVirtualNetworkId"},
			_jsii_.MemberProperty{JsiiProperty: "targetVirtualNetworkIdInput", GoGetter: "TargetVirtualNetworkIdInput"},
