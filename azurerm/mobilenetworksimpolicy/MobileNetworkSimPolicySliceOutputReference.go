...
func (m *jsiiProxy_MobileNetworkSimPolicySliceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MobileNetworkSimPolicySliceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
