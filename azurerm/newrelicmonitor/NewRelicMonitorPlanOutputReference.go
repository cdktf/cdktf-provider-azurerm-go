...
func (n *jsiiProxy_NewRelicMonitorPlanOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NewRelicMonitorPlanOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
