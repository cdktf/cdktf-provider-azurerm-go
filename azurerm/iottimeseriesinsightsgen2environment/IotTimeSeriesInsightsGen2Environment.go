...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/iottimeseriesinsightsgen2environment/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.110.0/docs/resources/iot_time_series_insights_gen2_environment azurerm_iot_time_series_insights_gen2_environment}.
...
func (j *jsiiProxy_IotTimeSeriesInsightsGen2Environment) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.110.0/docs/resources/iot_time_series_insights_gen2_environment azurerm_iot_time_series_insights_gen2_environment} Resource.
func NewIotTimeSeriesInsightsGen2Environment(scope constructs.Construct, id *string, config *IotTimeSeriesInsightsGen2EnvironmentConfig) IotTimeSeriesInsightsGen2Environment {
	...
	if err := validateNewIotTimeSeriesInsightsGen2EnvironmentParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_IotTimeSeriesInsightsGen2Environment)SetCount(val interface{}) {
...
func (j *jsiiProxy_IotTimeSeriesInsightsGen2Environment)SetIdProperties(val *[]*string) {
	if err := j.validateSetIdPropertiesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_IotTimeSeriesInsightsGen2Environment)SetWarmStoreDataRetentionTime(val *string) {
	if err := j.validateSetWarmStoreDataRetentionTimeParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func IotTimeSeriesInsightsGen2Environment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateIotTimeSeriesInsightsGen2Environment_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func IotTimeSeriesInsightsGen2Environment_IsConstruct(x interface{}) *bool {
	...
	if err := validateIotTimeSeriesInsightsGen2Environment_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func IotTimeSeriesInsightsGen2Environment_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateIotTimeSeriesInsightsGen2Environment_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func IotTimeSeriesInsightsGen2Environment_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateIotTimeSeriesInsightsGen2Environment_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (i *jsiiProxy_IotTimeSeriesInsightsGen2Environment) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_IotTimeSeriesInsightsGen2Environment) HasResourceMove() interface{} {
	var returns interface{}
...
func (i *jsiiProxy_IotTimeSeriesInsightsGen2Environment) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (i *jsiiProxy_IotTimeSeriesInsightsGen2Environment) MoveFromId(id *string) {
...
func (i *jsiiProxy_IotTimeSeriesInsightsGen2Environment) MoveTo(moveTarget *string, index interface{}) {
...
func (i *jsiiProxy_IotTimeSeriesInsightsGen2Environment) MoveToId(id *string) {
...
func (i *jsiiProxy_IotTimeSeriesInsightsGen2Environment) PutStorage(value *IotTimeSeriesInsightsGen2EnvironmentStorage) {
	if err := i.validatePutStorageParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		i,
...
func (i *jsiiProxy_IotTimeSeriesInsightsGen2Environment) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (i *jsiiProxy_IotTimeSeriesInsightsGen2Environment) ToHclTerraform() interface{} {
	var returns interface{}
