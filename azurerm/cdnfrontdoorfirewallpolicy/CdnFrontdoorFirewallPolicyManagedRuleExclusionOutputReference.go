...
func NewCdnFrontdoorFirewallPolicyManagedRuleExclusionOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) CdnFrontdoorFirewallPolicyManagedRuleExclusionOutputReference {
	...
	if err := validateNewCdnFrontdoorFirewallPolicyManagedRuleExclusionOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CdnFrontdoorFirewallPolicyManagedRuleExclusionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CdnFrontdoorFirewallPolicyManagedRuleExclusionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
