...
func NewCdnFrontdoorFirewallPolicyManagedRuleList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CdnFrontdoorFirewallPolicyManagedRuleList {
	...
	if err := validateNewCdnFrontdoorFirewallPolicyManagedRuleListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CdnFrontdoorFirewallPolicyManagedRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CdnFrontdoorFirewallPolicyManagedRuleList) Resolve(context cdktf.IResolveContext) interface{} {
