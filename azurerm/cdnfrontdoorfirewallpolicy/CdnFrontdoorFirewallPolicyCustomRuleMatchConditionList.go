...
func (c *jsiiProxy_CdnFrontdoorFirewallPolicyCustomRuleMatchConditionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CdnFrontdoorFirewallPolicyCustomRuleMatchConditionList) Resolve(context cdktf.IResolveContext) interface{} {
