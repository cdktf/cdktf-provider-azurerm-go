...
func NewCdnFrontdoorFirewallPolicyManagedRuleOverrideRuleExclusionOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) CdnFrontdoorFirewallPolicyManagedRuleOverrideRuleExclusionOutputReference {
	...
	if err := validateNewCdnFrontdoorFirewallPolicyManagedRuleOverrideRuleExclusionOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CdnFrontdoorFirewallPolicyManagedRuleOverrideRuleExclusionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CdnFrontdoorFirewallPolicyManagedRuleOverrideRuleExclusionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
