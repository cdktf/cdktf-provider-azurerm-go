...
func NewLogAnalyticsQueryPackQueryTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) LogAnalyticsQueryPackQueryTimeoutsOutputReference {
	...
	if err := validateNewLogAnalyticsQueryPackQueryTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LogAnalyticsQueryPackQueryTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LogAnalyticsQueryPackQueryTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
