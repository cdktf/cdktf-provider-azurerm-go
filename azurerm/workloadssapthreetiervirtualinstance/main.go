...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "managedResourcesNetworkAccessType", GoGetter: "ManagedResourcesNetworkAccessType"},
			_jsii_.MemberProperty{JsiiProperty: "managedResourcesNetworkAccessTypeInput", GoGetter: "ManagedResourcesNetworkAccessTypeInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetManagedResourcesNetworkAccessType", GoMethod: "ResetManagedResourcesNetworkAccessType"},
