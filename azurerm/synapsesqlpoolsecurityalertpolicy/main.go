...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SynapseSqlPoolSecurityAlertPolicy)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "emailAccountAdminsEnabled", GoGetter: "EmailAccountAdminsEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "emailAccountAdminsEnabledInput", GoGetter: "EmailAccountAdminsEnabledInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "policyState", GoGetter: "PolicyState"},
			_jsii_.MemberProperty{JsiiProperty: "policyStateInput", GoGetter: "PolicyStateInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetEmailAccountAdminsEnabled", GoMethod: "ResetEmailAccountAdminsEnabled"},
			...
			_jsii_.MemberProperty{JsiiProperty: "sqlPoolId", GoGetter: "SqlPoolId"},
			_jsii_.MemberProperty{JsiiProperty: "sqlPoolIdInput", GoGetter: "SqlPoolIdInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurerm.synapseSqlPoolSecurityAlertPolicy.SynapseSqlPoolSecurityAlertPolicyConfig",
		reflect.TypeOf((*SynapseSqlPoolSecurityAlertPolicyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurerm.synapseSqlPoolSecurityAlertPolicy.SynapseSqlPoolSecurityAlertPolicyTimeouts",
		reflect.TypeOf((*SynapseSqlPoolSecurityAlertPolicyTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-azurerm.synapseSqlPoolSecurityAlertPolicy.SynapseSqlPoolSecurityAlertPolicyTimeoutsOutputReference",
		reflect.TypeOf((*SynapseSqlPoolSecurityAlertPolicyTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
