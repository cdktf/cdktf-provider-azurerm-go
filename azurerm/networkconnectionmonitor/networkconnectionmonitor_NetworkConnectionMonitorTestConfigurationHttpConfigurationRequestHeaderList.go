...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v3/networkconnectionmonitor/internal"
...
func NewNetworkConnectionMonitorTestConfigurationHttpConfigurationRequestHeaderList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) NetworkConnectionMonitorTestConfigurationHttpConfigurationRequestHeaderList {
	...
	if err := validateNewNetworkConnectionMonitorTestConfigurationHttpConfigurationRequestHeaderListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
