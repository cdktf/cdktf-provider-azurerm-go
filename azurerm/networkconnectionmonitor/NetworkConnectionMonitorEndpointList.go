...
func NewNetworkConnectionMonitorEndpointList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) NetworkConnectionMonitorEndpointList {
	...
	if err := validateNewNetworkConnectionMonitorEndpointListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (n *jsiiProxy_NetworkConnectionMonitorEndpointList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (n *jsiiProxy_NetworkConnectionMonitorEndpointList) Resolve(context cdktf.IResolveContext) interface{} {
