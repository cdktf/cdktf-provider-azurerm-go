...
func (j *jsiiProxy_DataAzurermLinuxWebAppSiteConfigCorsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataAzurermLinuxWebAppSiteConfigCorsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermLinuxWebAppSiteConfigCorsList {
	_init_.Initialize()
...
func NewDataAzurermLinuxWebAppSiteConfigCorsList_Override(d DataAzurermLinuxWebAppSiteConfigCorsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermLinuxWebAppSiteConfigCorsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermLinuxWebAppSiteConfigCorsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermLinuxWebAppSiteConfigCorsList) Resolve(_context cdktf.IResolveContext) interface{} {
