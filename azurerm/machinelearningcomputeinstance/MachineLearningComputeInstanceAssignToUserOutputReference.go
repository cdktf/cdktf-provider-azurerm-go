...
func NewMachineLearningComputeInstanceAssignToUserOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) MachineLearningComputeInstanceAssignToUserOutputReference {
	...
	if err := validateNewMachineLearningComputeInstanceAssignToUserOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_MachineLearningComputeInstanceAssignToUserOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MachineLearningComputeInstanceAssignToUserOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
