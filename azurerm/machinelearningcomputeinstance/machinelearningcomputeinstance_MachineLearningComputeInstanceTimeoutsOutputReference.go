...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/machinelearningcomputeinstance/internal"
...
func NewMachineLearningComputeInstanceTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) MachineLearningComputeInstanceTimeoutsOutputReference {
	...
	if err := validateNewMachineLearningComputeInstanceTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
