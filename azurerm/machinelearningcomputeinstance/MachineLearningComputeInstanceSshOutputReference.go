...
func NewMachineLearningComputeInstanceSshOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) MachineLearningComputeInstanceSshOutputReference {
	...
	if err := validateNewMachineLearningComputeInstanceSshOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_MachineLearningComputeInstanceSshOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MachineLearningComputeInstanceSshOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
