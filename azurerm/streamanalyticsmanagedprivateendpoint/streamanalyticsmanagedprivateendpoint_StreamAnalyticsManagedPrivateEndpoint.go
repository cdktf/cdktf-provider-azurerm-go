...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/streamanalyticsmanagedprivateendpoint/internal"
...
func NewStreamAnalyticsManagedPrivateEndpoint(scope constructs.Construct, id *string, config *StreamAnalyticsManagedPrivateEndpointConfig) StreamAnalyticsManagedPrivateEndpoint {
	...
	if err := validateNewStreamAnalyticsManagedPrivateEndpointParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_StreamAnalyticsManagedPrivateEndpoint)SetStreamAnalyticsClusterName(val *string) {
	if err := j.validateSetStreamAnalyticsClusterNameParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func StreamAnalyticsManagedPrivateEndpoint_IsConstruct(x interface{}) *bool {
	...
	if err := validateStreamAnalyticsManagedPrivateEndpoint_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func StreamAnalyticsManagedPrivateEndpoint_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateStreamAnalyticsManagedPrivateEndpoint_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func StreamAnalyticsManagedPrivateEndpoint_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateStreamAnalyticsManagedPrivateEndpoint_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
