...
func (d *jsiiProxy_DataAzurermMonitorDataCollectionRuleDataSourcesDataImportList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermMonitorDataCollectionRuleDataSourcesDataImportList) Resolve(context cdktf.IResolveContext) interface{} {
