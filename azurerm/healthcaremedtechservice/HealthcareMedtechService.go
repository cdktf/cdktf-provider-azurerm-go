...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/healthcaremedtechservice/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.112.0/docs/resources/healthcare_medtech_service azurerm_healthcare_medtech_service}.
...
func (j *jsiiProxy_HealthcareMedtechService) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.112.0/docs/resources/healthcare_medtech_service azurerm_healthcare_medtech_service} Resource.
func NewHealthcareMedtechService(scope constructs.Construct, id *string, config *HealthcareMedtechServiceConfig) HealthcareMedtechService {
	...
	if err := validateNewHealthcareMedtechServiceParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_HealthcareMedtechService)SetCount(val interface{}) {
...
func (j *jsiiProxy_HealthcareMedtechService)SetDeviceMappingJson(val *string) {
	if err := j.validateSetDeviceMappingJsonParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func HealthcareMedtechService_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateHealthcareMedtechService_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func HealthcareMedtechService_IsConstruct(x interface{}) *bool {
	...
	if err := validateHealthcareMedtechService_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func HealthcareMedtechService_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateHealthcareMedtechService_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func HealthcareMedtechService_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateHealthcareMedtechService_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (h *jsiiProxy_HealthcareMedtechService) AddMoveTarget(moveTarget *string) {
...
func (h *jsiiProxy_HealthcareMedtechService) HasResourceMove() interface{} {
	var returns interface{}
...
func (h *jsiiProxy_HealthcareMedtechService) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (h *jsiiProxy_HealthcareMedtechService) MoveFromId(id *string) {
...
func (h *jsiiProxy_HealthcareMedtechService) MoveTo(moveTarget *string, index interface{}) {
...
func (h *jsiiProxy_HealthcareMedtechService) MoveToId(id *string) {
...
func (h *jsiiProxy_HealthcareMedtechService) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (h *jsiiProxy_HealthcareMedtechService) ToHclTerraform() interface{} {
	var returns interface{}
