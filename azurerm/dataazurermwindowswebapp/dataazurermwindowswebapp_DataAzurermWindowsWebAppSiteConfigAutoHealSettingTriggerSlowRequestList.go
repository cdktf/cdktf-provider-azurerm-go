...
func (j *jsiiProxy_DataAzurermWindowsWebAppSiteConfigAutoHealSettingTriggerSlowRequestList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataAzurermWindowsWebAppSiteConfigAutoHealSettingTriggerSlowRequestList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermWindowsWebAppSiteConfigAutoHealSettingTriggerSlowRequestList {
	_init_.Initialize()
...
func NewDataAzurermWindowsWebAppSiteConfigAutoHealSettingTriggerSlowRequestList_Override(d DataAzurermWindowsWebAppSiteConfigAutoHealSettingTriggerSlowRequestList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermWindowsWebAppSiteConfigAutoHealSettingTriggerSlowRequestList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermWindowsWebAppSiteConfigAutoHealSettingTriggerSlowRequestList) Resolve(_context cdktf.IResolveContext) interface{} {
