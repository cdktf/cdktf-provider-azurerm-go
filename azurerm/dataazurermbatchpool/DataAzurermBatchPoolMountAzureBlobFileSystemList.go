...
func (d *jsiiProxy_DataAzurermBatchPoolMountAzureBlobFileSystemList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermBatchPoolMountAzureBlobFileSystemList) Resolve(context cdktf.IResolveContext) interface{} {
