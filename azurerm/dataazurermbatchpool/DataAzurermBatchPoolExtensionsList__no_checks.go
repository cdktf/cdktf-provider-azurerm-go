...
func (d *jsiiProxy_DataAzurermBatchPoolExtensionsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}
...
func (d *jsiiProxy_DataAzurermBatchPoolExtensionsList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
