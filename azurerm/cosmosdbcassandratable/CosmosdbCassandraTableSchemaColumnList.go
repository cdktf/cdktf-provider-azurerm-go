...
func NewCosmosdbCassandraTableSchemaColumnList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CosmosdbCassandraTableSchemaColumnList {
	...
	if err := validateNewCosmosdbCassandraTableSchemaColumnListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CosmosdbCassandraTableSchemaColumnList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CosmosdbCassandraTableSchemaColumnList) Resolve(context cdktf.IResolveContext) interface{} {
