...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/cosmosdbcassandratable/internal"
...
func NewCosmosdbCassandraTableSchemaClusterKeyList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CosmosdbCassandraTableSchemaClusterKeyList {
	...
	if err := validateNewCosmosdbCassandraTableSchemaClusterKeyListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CosmosdbCassandraTableSchemaClusterKeyList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CosmosdbCassandraTableSchemaClusterKeyList) Resolve(context cdktf.IResolveContext) interface{} {
