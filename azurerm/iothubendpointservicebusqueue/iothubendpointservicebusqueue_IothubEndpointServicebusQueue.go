...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/iothubendpointservicebusqueue/internal"
...
func NewIothubEndpointServicebusQueue(scope constructs.Construct, id *string, config *IothubEndpointServicebusQueueConfig) IothubEndpointServicebusQueue {
	...
	if err := validateNewIothubEndpointServicebusQueueParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func IothubEndpointServicebusQueue_IsConstruct(x interface{}) *bool {
	...
	if err := validateIothubEndpointServicebusQueue_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func IothubEndpointServicebusQueue_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateIothubEndpointServicebusQueue_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func IothubEndpointServicebusQueue_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateIothubEndpointServicebusQueue_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
