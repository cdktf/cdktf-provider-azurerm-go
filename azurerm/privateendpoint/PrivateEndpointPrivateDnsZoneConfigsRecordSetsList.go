...
func NewPrivateEndpointPrivateDnsZoneConfigsRecordSetsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) PrivateEndpointPrivateDnsZoneConfigsRecordSetsList {
	...
	if err := validateNewPrivateEndpointPrivateDnsZoneConfigsRecordSetsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (p *jsiiProxy_PrivateEndpointPrivateDnsZoneConfigsRecordSetsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (p *jsiiProxy_PrivateEndpointPrivateDnsZoneConfigsRecordSetsList) Resolve(context cdktf.IResolveContext) interface{} {
