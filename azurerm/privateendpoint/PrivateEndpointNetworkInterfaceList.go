...
func NewPrivateEndpointNetworkInterfaceList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) PrivateEndpointNetworkInterfaceList {
	...
	if err := validateNewPrivateEndpointNetworkInterfaceListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (p *jsiiProxy_PrivateEndpointNetworkInterfaceList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (p *jsiiProxy_PrivateEndpointNetworkInterfaceList) Resolve(context cdktf.IResolveContext) interface{} {
