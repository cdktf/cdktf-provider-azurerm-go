...
func NewPrivateEndpointNetworkInterfaceOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) PrivateEndpointNetworkInterfaceOutputReference {
	...
	if err := validateNewPrivateEndpointNetworkInterfaceOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (p *jsiiProxy_PrivateEndpointNetworkInterfaceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PrivateEndpointNetworkInterfaceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
