...
func NewPrivateEndpoint(scope constructs.Construct, id *string, config *PrivateEndpointConfig) PrivateEndpoint {
	...
	if err := validateNewPrivateEndpointParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func PrivateEndpoint_IsConstruct(x interface{}) *bool {
	...
	if err := validatePrivateEndpoint_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func PrivateEndpoint_IsTerraformElement(x interface{}) *bool {
	...
	if err := validatePrivateEndpoint_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func PrivateEndpoint_IsTerraformResource(x interface{}) *bool {
	...
	if err := validatePrivateEndpoint_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (p *jsiiProxy_PrivateEndpoint) PutPrivateServiceConnection(value *PrivateEndpointPrivateServiceConnection) {
	if err := p.validatePutPrivateServiceConnectionParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		p,
