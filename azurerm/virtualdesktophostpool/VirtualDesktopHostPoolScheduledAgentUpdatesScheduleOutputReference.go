...
func NewVirtualDesktopHostPoolScheduledAgentUpdatesScheduleOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) VirtualDesktopHostPoolScheduledAgentUpdatesScheduleOutputReference {
	...
	if err := validateNewVirtualDesktopHostPoolScheduledAgentUpdatesScheduleOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (v *jsiiProxy_VirtualDesktopHostPoolScheduledAgentUpdatesScheduleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VirtualDesktopHostPoolScheduledAgentUpdatesScheduleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
