...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/virtualdesktopscalingplan/internal"
...
func NewVirtualDesktopScalingPlanScheduleList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VirtualDesktopScalingPlanScheduleList {
	...
	if err := validateNewVirtualDesktopScalingPlanScheduleListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
