...
func NewVirtualDesktopScalingPlanHostPoolOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) VirtualDesktopScalingPlanHostPoolOutputReference {
	...
	if err := validateNewVirtualDesktopScalingPlanHostPoolOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_VirtualDesktopScalingPlanHostPoolOutputReference)SetScalingPlanEnabled(val interface{}) {
	if err := j.validateSetScalingPlanEnabledParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (v *jsiiProxy_VirtualDesktopScalingPlanHostPoolOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VirtualDesktopScalingPlanHostPoolOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
