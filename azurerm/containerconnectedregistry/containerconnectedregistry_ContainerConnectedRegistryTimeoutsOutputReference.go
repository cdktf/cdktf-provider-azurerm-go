...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/containerconnectedregistry/internal"
...
func NewContainerConnectedRegistryTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) ContainerConnectedRegistryTimeoutsOutputReference {
	...
	if err := validateNewContainerConnectedRegistryTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
