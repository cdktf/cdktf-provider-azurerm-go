...
func NewLogicAppTriggerRecurrenceTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) LogicAppTriggerRecurrenceTimeoutsOutputReference {
	...
	if err := validateNewLogicAppTriggerRecurrenceTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LogicAppTriggerRecurrenceTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LogicAppTriggerRecurrenceTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
