...
func NewDataAzurermLogicAppStandardSiteCredentialOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataAzurermLogicAppStandardSiteCredentialOutputReference {
	...
	if err := validateNewDataAzurermLogicAppStandardSiteCredentialOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAzurermLogicAppStandardSiteCredentialOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAzurermLogicAppStandardSiteCredentialOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
