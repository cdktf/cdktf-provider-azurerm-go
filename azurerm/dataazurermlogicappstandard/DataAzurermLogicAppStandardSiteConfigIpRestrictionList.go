...
func NewDataAzurermLogicAppStandardSiteConfigIpRestrictionList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermLogicAppStandardSiteConfigIpRestrictionList {
	...
	if err := validateNewDataAzurermLogicAppStandardSiteConfigIpRestrictionListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAzurermLogicAppStandardSiteConfigIpRestrictionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermLogicAppStandardSiteConfigIpRestrictionList) Resolve(context cdktf.IResolveContext) interface{} {
