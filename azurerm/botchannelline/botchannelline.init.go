...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "lineChannel", GoGetter: "LineChannel"},
			_jsii_.MemberProperty{JsiiProperty: "lineChannelInput", GoGetter: "LineChannelInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putLineChannel", GoMethod: "PutLineChannel"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_BotChannelLineLineChannelOutputReference{}
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_BotChannelLineTimeoutsOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
