...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "staticWebAppId", GoGetter: "StaticWebAppId"},
			_jsii_.MemberProperty{JsiiProperty: "staticWebAppIdInput", GoGetter: "StaticWebAppIdInput"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_StaticWebAppCustomDomainTimeoutsOutputReference{}
