...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataAzurermServicebusSubscription)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurerm.dataAzurermServicebusSubscription.DataAzurermServicebusSubscriptionConfig",
		reflect.TypeOf((*DataAzurermServicebusSubscriptionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurerm.dataAzurermServicebusSubscription.DataAzurermServicebusSubscriptionTimeouts",
		reflect.TypeOf((*DataAzurermServicebusSubscriptionTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-azurerm.dataAzurermServicebusSubscription.DataAzurermServicebusSubscriptionTimeoutsOutputReference",
		reflect.TypeOf((*DataAzurermServicebusSubscriptionTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_DataAzurermServicebusSubscriptionTimeoutsOutputReference{}
