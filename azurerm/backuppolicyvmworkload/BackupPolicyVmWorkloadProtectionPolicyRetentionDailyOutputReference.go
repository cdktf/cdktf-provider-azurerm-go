...
func NewBackupPolicyVmWorkloadProtectionPolicyRetentionDailyOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) BackupPolicyVmWorkloadProtectionPolicyRetentionDailyOutputReference {
	...
	if err := validateNewBackupPolicyVmWorkloadProtectionPolicyRetentionDailyOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (b *jsiiProxy_BackupPolicyVmWorkloadProtectionPolicyRetentionDailyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BackupPolicyVmWorkloadProtectionPolicyRetentionDailyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
