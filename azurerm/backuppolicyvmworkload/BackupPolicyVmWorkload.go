...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.100.0/docs/resources/backup_policy_vm_workload azurerm_backup_policy_vm_workload}.
...
func (j *jsiiProxy_BackupPolicyVmWorkload) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.100.0/docs/resources/backup_policy_vm_workload azurerm_backup_policy_vm_workload} Resource.
func NewBackupPolicyVmWorkload(scope constructs.Construct, id *string, config *BackupPolicyVmWorkloadConfig) BackupPolicyVmWorkload {
	...
	if err := validateNewBackupPolicyVmWorkloadParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_BackupPolicyVmWorkload)SetCount(val interface{}) {
...
func BackupPolicyVmWorkload_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateBackupPolicyVmWorkload_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func BackupPolicyVmWorkload_IsConstruct(x interface{}) *bool {
	...
	if err := validateBackupPolicyVmWorkload_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func BackupPolicyVmWorkload_IsTerraformElement(x interface{}) *bool {
	...
	if err := validateBackupPolicyVmWorkload_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func BackupPolicyVmWorkload_IsTerraformResource(x interface{}) *bool {
	...
	if err := validateBackupPolicyVmWorkload_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (b *jsiiProxy_BackupPolicyVmWorkload) AddMoveTarget(moveTarget *string) {
...
func (b *jsiiProxy_BackupPolicyVmWorkload) HasResourceMove() interface{} {
	var returns interface{}
...
func (b *jsiiProxy_BackupPolicyVmWorkload) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (b *jsiiProxy_BackupPolicyVmWorkload) MoveFromId(id *string) {
...
func (b *jsiiProxy_BackupPolicyVmWorkload) MoveTo(moveTarget *string, index interface{}) {
...
func (b *jsiiProxy_BackupPolicyVmWorkload) MoveToId(id *string) {
...
func (b *jsiiProxy_BackupPolicyVmWorkload) PutProtectionPolicy(value interface{}) {
	if err := b.validatePutProtectionPolicyParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		b,
...
func (b *jsiiProxy_BackupPolicyVmWorkload) PutSettings(value *BackupPolicyVmWorkloadSettings) {
	if err := b.validatePutSettingsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		b,
...
func (b *jsiiProxy_BackupPolicyVmWorkload) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (b *jsiiProxy_BackupPolicyVmWorkload) ToHclTerraform() interface{} {
	var returns interface{}
