...
func (a *jsiiProxy_AppServiceSiteConfigScmIpRestrictionHeadersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AppServiceSiteConfigScmIpRestrictionHeadersOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
