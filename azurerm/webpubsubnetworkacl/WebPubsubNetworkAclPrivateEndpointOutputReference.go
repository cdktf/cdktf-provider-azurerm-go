...
func NewWebPubsubNetworkAclPrivateEndpointOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) WebPubsubNetworkAclPrivateEndpointOutputReference {
	...
	if err := validateNewWebPubsubNetworkAclPrivateEndpointOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (w *jsiiProxy_WebPubsubNetworkAclPrivateEndpointOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WebPubsubNetworkAclPrivateEndpointOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
