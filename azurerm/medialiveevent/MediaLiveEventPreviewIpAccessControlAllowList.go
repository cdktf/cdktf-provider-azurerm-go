...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/medialiveevent/internal"
...
func NewMediaLiveEventPreviewIpAccessControlAllowList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MediaLiveEventPreviewIpAccessControlAllowList {
	...
	if err := validateNewMediaLiveEventPreviewIpAccessControlAllowListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_MediaLiveEventPreviewIpAccessControlAllowList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
