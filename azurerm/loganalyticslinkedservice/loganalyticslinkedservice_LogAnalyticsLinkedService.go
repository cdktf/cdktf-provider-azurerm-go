...
import (
	...
	"github.com/hashicorp/cdktf-provider-azurerm-go/azurerm/v3/loganalyticslinkedservice/internal"
...
func (j *jsiiProxy_LogAnalyticsLinkedService) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_LogAnalyticsLinkedService)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
