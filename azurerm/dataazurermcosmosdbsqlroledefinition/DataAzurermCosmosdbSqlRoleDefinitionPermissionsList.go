...
func (d *jsiiProxy_DataAzurermCosmosdbSqlRoleDefinitionPermissionsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermCosmosdbSqlRoleDefinitionPermissionsList) Resolve(context cdktf.IResolveContext) interface{} {
