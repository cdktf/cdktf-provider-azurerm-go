...
func NewVirtualNetworkGatewayVpnClientConfigurationRootCertificateOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) VirtualNetworkGatewayVpnClientConfigurationRootCertificateOutputReference {
	...
	if err := validateNewVirtualNetworkGatewayVpnClientConfigurationRootCertificateOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_VirtualNetworkGatewayVpnClientConfigurationRootCertificateOutputReference)SetPublicCertData(val *string) {
	if err := j.validateSetPublicCertDataParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (v *jsiiProxy_VirtualNetworkGatewayVpnClientConfigurationRootCertificateOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VirtualNetworkGatewayVpnClientConfigurationRootCertificateOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
