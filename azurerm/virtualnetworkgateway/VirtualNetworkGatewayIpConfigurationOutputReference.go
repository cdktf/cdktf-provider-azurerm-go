...
func NewVirtualNetworkGatewayIpConfigurationOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) VirtualNetworkGatewayIpConfigurationOutputReference {
	...
	if err := validateNewVirtualNetworkGatewayIpConfigurationOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (v *jsiiProxy_VirtualNetworkGatewayIpConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VirtualNetworkGatewayIpConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
