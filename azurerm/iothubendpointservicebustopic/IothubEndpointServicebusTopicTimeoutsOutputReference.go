...
func NewIothubEndpointServicebusTopicTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) IothubEndpointServicebusTopicTimeoutsOutputReference {
	...
	if err := validateNewIothubEndpointServicebusTopicTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (i *jsiiProxy_IothubEndpointServicebusTopicTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IothubEndpointServicebusTopicTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
