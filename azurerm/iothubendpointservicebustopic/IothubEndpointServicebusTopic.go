...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/iothubendpointservicebustopic/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.52.0/docs/resources/iothub_endpoint_servicebus_topic azurerm_iothub_endpoint_servicebus_topic}.
...
func (j *jsiiProxy_IothubEndpointServicebusTopic) SubscriptionId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"subscriptionId",
...
func (j *jsiiProxy_IothubEndpointServicebusTopic) SubscriptionIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"subscriptionIdInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.52.0/docs/resources/iothub_endpoint_servicebus_topic azurerm_iothub_endpoint_servicebus_topic} Resource.
...
func (j *jsiiProxy_IothubEndpointServicebusTopic)SetSubscriptionId(val *string) {
...
func (i *jsiiProxy_IothubEndpointServicebusTopic) ResetSubscriptionId() {
	_jsii_.InvokeVoid(
		i,
		"resetSubscriptionId",
		nil, // no parameters
