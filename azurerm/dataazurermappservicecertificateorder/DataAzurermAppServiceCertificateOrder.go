...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.112.0/docs/data-sources/app_service_certificate_order azurerm_app_service_certificate_order}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.112.0/docs/data-sources/app_service_certificate_order azurerm_app_service_certificate_order} Data Source.
func NewDataAzurermAppServiceCertificateOrder(scope constructs.Construct, id *string, config *DataAzurermAppServiceCertificateOrderConfig) DataAzurermAppServiceCertificateOrder {
	...
	_jsii_.Create(
		"@cdktf/provider-azurerm.dataAzurermAppServiceCertificateOrder.DataAzurermAppServiceCertificateOrder",
