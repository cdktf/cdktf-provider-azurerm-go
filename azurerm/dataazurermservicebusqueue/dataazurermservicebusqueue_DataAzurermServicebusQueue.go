...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermservicebusqueue/internal"
...
func (j *jsiiProxy_DataAzurermServicebusQueue) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_DataAzurermServicebusQueue)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
