...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/dataazurermstorageaccountsas/internal"
...
func NewDataAzurermStorageAccountSasTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DataAzurermStorageAccountSasTimeoutsOutputReference {
	...
	if err := validateNewDataAzurermStorageAccountSasTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAzurermStorageAccountSasTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAzurermStorageAccountSasTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
