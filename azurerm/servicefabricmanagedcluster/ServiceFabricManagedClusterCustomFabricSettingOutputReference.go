...
func NewServiceFabricManagedClusterCustomFabricSettingOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ServiceFabricManagedClusterCustomFabricSettingOutputReference {
	...
	if err := validateNewServiceFabricManagedClusterCustomFabricSettingOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_ServiceFabricManagedClusterCustomFabricSettingOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_ServiceFabricManagedClusterCustomFabricSettingOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
