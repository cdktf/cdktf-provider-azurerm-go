...
func NewServiceFabricManagedClusterNodeTypeVmSecretsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ServiceFabricManagedClusterNodeTypeVmSecretsOutputReference {
	...
	if err := validateNewServiceFabricManagedClusterNodeTypeVmSecretsOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_ServiceFabricManagedClusterNodeTypeVmSecretsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_ServiceFabricManagedClusterNodeTypeVmSecretsOutputReference) PutCertificates(value interface{}) {
	if err := s.validatePutCertificatesParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		s,
...
func (s *jsiiProxy_ServiceFabricManagedClusterNodeTypeVmSecretsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
