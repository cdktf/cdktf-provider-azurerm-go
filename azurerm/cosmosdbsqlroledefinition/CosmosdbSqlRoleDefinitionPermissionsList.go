...
func NewCosmosdbSqlRoleDefinitionPermissionsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CosmosdbSqlRoleDefinitionPermissionsList {
	...
	if err := validateNewCosmosdbSqlRoleDefinitionPermissionsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CosmosdbSqlRoleDefinitionPermissionsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CosmosdbSqlRoleDefinitionPermissionsList) Resolve(context cdktf.IResolveContext) interface{} {
