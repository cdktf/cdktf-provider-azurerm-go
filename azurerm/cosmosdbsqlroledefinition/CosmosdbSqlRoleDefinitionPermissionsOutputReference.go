...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/cosmosdbsqlroledefinition/internal"
...
func NewCosmosdbSqlRoleDefinitionPermissionsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) CosmosdbSqlRoleDefinitionPermissionsOutputReference {
	...
	if err := validateNewCosmosdbSqlRoleDefinitionPermissionsOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CosmosdbSqlRoleDefinitionPermissionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CosmosdbSqlRoleDefinitionPermissionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
