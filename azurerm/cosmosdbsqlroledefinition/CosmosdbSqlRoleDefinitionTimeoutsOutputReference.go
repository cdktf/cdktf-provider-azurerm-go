...
func NewCosmosdbSqlRoleDefinitionTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) CosmosdbSqlRoleDefinitionTimeoutsOutputReference {
	...
	if err := validateNewCosmosdbSqlRoleDefinitionTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CosmosdbSqlRoleDefinitionTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CosmosdbSqlRoleDefinitionTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
