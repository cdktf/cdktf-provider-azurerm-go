...
func NewDataFactoryDatasetDelimitedTextSchemaColumnOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataFactoryDatasetDelimitedTextSchemaColumnOutputReference {
	...
	if err := validateNewDataFactoryDatasetDelimitedTextSchemaColumnOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataFactoryDatasetDelimitedTextSchemaColumnOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataFactoryDatasetDelimitedTextSchemaColumnOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
