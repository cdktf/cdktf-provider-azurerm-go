...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/datafactorydatasetdelimitedtext/internal"
...
func NewDataFactoryDatasetDelimitedTextTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DataFactoryDatasetDelimitedTextTimeoutsOutputReference {
	...
	if err := validateNewDataFactoryDatasetDelimitedTextTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
