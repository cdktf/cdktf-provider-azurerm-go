...
func NewHdinsightKafkaClusterDiskEncryptionList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) HdinsightKafkaClusterDiskEncryptionList {
	...
	if err := validateNewHdinsightKafkaClusterDiskEncryptionListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (h *jsiiProxy_HdinsightKafkaClusterDiskEncryptionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (h *jsiiProxy_HdinsightKafkaClusterDiskEncryptionList) Resolve(context cdktf.IResolveContext) interface{} {
