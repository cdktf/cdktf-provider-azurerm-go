...
func NewHdinsightKafkaClusterNetworkOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) HdinsightKafkaClusterNetworkOutputReference {
	...
	if err := validateNewHdinsightKafkaClusterNetworkOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_HdinsightKafkaClusterNetworkOutputReference)SetConnectionDirection(val *string) {
	if err := j.validateSetConnectionDirectionParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (h *jsiiProxy_HdinsightKafkaClusterNetworkOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HdinsightKafkaClusterNetworkOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
