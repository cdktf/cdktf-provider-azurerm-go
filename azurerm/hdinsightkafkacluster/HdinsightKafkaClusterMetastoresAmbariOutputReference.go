...
func NewHdinsightKafkaClusterMetastoresAmbariOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) HdinsightKafkaClusterMetastoresAmbariOutputReference {
	...
	if err := validateNewHdinsightKafkaClusterMetastoresAmbariOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (h *jsiiProxy_HdinsightKafkaClusterMetastoresAmbariOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HdinsightKafkaClusterMetastoresAmbariOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
