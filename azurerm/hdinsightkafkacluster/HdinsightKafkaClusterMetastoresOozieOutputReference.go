...
func NewHdinsightKafkaClusterMetastoresOozieOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) HdinsightKafkaClusterMetastoresOozieOutputReference {
	...
	if err := validateNewHdinsightKafkaClusterMetastoresOozieOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (h *jsiiProxy_HdinsightKafkaClusterMetastoresOozieOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HdinsightKafkaClusterMetastoresOozieOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
