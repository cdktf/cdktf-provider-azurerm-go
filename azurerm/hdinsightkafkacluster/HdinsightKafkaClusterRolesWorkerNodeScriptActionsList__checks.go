...
func (h *jsiiProxy_HdinsightKafkaClusterRolesWorkerNodeScriptActionsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (h *jsiiProxy_HdinsightKafkaClusterRolesWorkerNodeScriptActionsList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
