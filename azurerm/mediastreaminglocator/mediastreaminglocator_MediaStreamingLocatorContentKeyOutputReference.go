...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v3/mediastreaminglocator/internal"
...
func NewMediaStreamingLocatorContentKeyOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) MediaStreamingLocatorContentKeyOutputReference {
	...
	if err := validateNewMediaStreamingLocatorContentKeyOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_MediaStreamingLocatorContentKeyOutputReference)SetContentKeyId(val *string) {
	if err := j.validateSetContentKeyIdParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_MediaStreamingLocatorContentKeyOutputReference)SetLabelReferenceInStreamingPolicy(val *string) {
	if err := j.validateSetLabelReferenceInStreamingPolicyParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
