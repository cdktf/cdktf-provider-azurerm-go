...
func NewConsumptionBudgetResourceGroupFilterOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) ConsumptionBudgetResourceGroupFilterOutputReference {
	...
	if err := validateNewConsumptionBudgetResourceGroupFilterOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_ConsumptionBudgetResourceGroupFilterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ConsumptionBudgetResourceGroupFilterOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
