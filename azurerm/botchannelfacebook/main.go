...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "facebookApplicationId", GoGetter: "FacebookApplicationId"},
			_jsii_.MemberProperty{JsiiProperty: "facebookApplicationIdInput", GoGetter: "FacebookApplicationIdInput"},
			_jsii_.MemberProperty{JsiiProperty: "facebookApplicationSecret", GoGetter: "FacebookApplicationSecret"},
			_jsii_.MemberProperty{JsiiProperty: "facebookApplicationSecretInput", GoGetter: "FacebookApplicationSecretInput"},
