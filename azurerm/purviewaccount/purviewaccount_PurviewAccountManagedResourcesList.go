...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/purviewaccount/internal"
...
func NewPurviewAccountManagedResourcesList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) PurviewAccountManagedResourcesList {
	...
	if err := validateNewPurviewAccountManagedResourcesListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
