...
func NewLbBackendAddressPoolAddressInboundNatRulePortMappingOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) LbBackendAddressPoolAddressInboundNatRulePortMappingOutputReference {
	...
	if err := validateNewLbBackendAddressPoolAddressInboundNatRulePortMappingOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LbBackendAddressPoolAddressInboundNatRulePortMappingOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LbBackendAddressPoolAddressInboundNatRulePortMappingOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
