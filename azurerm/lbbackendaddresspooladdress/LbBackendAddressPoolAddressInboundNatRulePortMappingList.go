...
func NewLbBackendAddressPoolAddressInboundNatRulePortMappingList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LbBackendAddressPoolAddressInboundNatRulePortMappingList {
	...
	if err := validateNewLbBackendAddressPoolAddressInboundNatRulePortMappingListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LbBackendAddressPoolAddressInboundNatRulePortMappingList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LbBackendAddressPoolAddressInboundNatRulePortMappingList) Resolve(context cdktf.IResolveContext) interface{} {
