...
func (j *jsiiProxy_CdnEndpointOriginList) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*CdnEndpointOrigin:
		val := val.(*[]*CdnEndpointOrigin)
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*CdnEndpointOrigin; received %#v (a %T)", val, val)
		}
	}
