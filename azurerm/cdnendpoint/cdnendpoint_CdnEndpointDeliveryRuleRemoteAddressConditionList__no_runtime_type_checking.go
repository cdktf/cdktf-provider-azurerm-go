...
func (c *jsiiProxy_CdnEndpointDeliveryRuleRemoteAddressConditionList) validateResolveParameters(_context cdktf.IResolveContext) error {
	return nil
}
...
func (j *jsiiProxy_CdnEndpointDeliveryRuleRemoteAddressConditionList) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	return nil
}
...
func validateNewCdnEndpointDeliveryRuleRemoteAddressConditionListParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
	return nil
}
