...
func (c *jsiiProxy_CdnEndpointDeliveryRuleUrlRedirectActionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CdnEndpointDeliveryRuleUrlRedirectActionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
