...
func (c *jsiiProxy_CdnEndpointGlobalDeliveryRuleUrlRedirectActionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CdnEndpointGlobalDeliveryRuleUrlRedirectActionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
