...
func (c *jsiiProxy_CdnEndpointDeliveryRuleQueryStringConditionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CdnEndpointDeliveryRuleQueryStringConditionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
