...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v3/dataazurermstorageaccountblobcontainersas/internal"
...
func NewDataAzurermStorageAccountBlobContainerSasTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DataAzurermStorageAccountBlobContainerSasTimeoutsOutputReference {
	...
	if err := validateNewDataAzurermStorageAccountBlobContainerSasTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
