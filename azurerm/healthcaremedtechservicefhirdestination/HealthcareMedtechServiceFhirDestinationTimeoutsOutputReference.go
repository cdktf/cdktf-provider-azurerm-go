...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/healthcaremedtechservicefhirdestination/internal"
...
func NewHealthcareMedtechServiceFhirDestinationTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) HealthcareMedtechServiceFhirDestinationTimeoutsOutputReference {
	...
	if err := validateNewHealthcareMedtechServiceFhirDestinationTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (h *jsiiProxy_HealthcareMedtechServiceFhirDestinationTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HealthcareMedtechServiceFhirDestinationTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
