...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "logicAppId", GoGetter: "LogicAppId"},
			_jsii_.MemberProperty{JsiiProperty: "logicAppIdInput", GoGetter: "LogicAppIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putRunAfter", GoMethod: "PutRunAfter"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetQueries", GoMethod: "ResetQueries"},
			_jsii_.MemberMethod{JsiiMethod: "resetRunAfter", GoMethod: "ResetRunAfter"},
			_jsii_.MemberMethod{JsiiMethod: "resetTimeouts", GoMethod: "ResetTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "runAfter", GoGetter: "RunAfter"},
			_jsii_.MemberProperty{JsiiProperty: "runAfterInput", GoGetter: "RunAfterInput"},
		...
		func() interface{} {
			j := jsiiProxy_LogicAppActionHttp{}
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_LogicAppActionHttpRunAfterList{}
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "actionResult", GoGetter: "ActionResult"},
			_jsii_.MemberProperty{JsiiProperty: "actionResultInput", GoGetter: "ActionResultInput"},
		...
		func() interface{} {
			j := jsiiProxy_LogicAppActionHttpRunAfterOutputReference{}
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_LogicAppActionHttpTimeoutsOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
