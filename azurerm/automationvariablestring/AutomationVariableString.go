...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/automationvariablestring/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.113.0/docs/resources/automation_variable_string azurerm_automation_variable_string}.
...
func (j *jsiiProxy_AutomationVariableString) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.113.0/docs/resources/automation_variable_string azurerm_automation_variable_string} Resource.
func NewAutomationVariableString(scope constructs.Construct, id *string, config *AutomationVariableStringConfig) AutomationVariableString {
	...
	if err := validateNewAutomationVariableStringParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_AutomationVariableString)SetCount(val interface{}) {
...
func AutomationVariableString_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAutomationVariableString_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func AutomationVariableString_IsConstruct(x interface{}) *bool {
	...
	if err := validateAutomationVariableString_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func AutomationVariableString_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateAutomationVariableString_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func AutomationVariableString_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateAutomationVariableString_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (a *jsiiProxy_AutomationVariableString) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AutomationVariableString) HasResourceMove() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_AutomationVariableString) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_AutomationVariableString) MoveFromId(id *string) {
...
func (a *jsiiProxy_AutomationVariableString) MoveTo(moveTarget *string, index interface{}) {
...
func (a *jsiiProxy_AutomationVariableString) MoveToId(id *string) {
...
func (a *jsiiProxy_AutomationVariableString) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (a *jsiiProxy_AutomationVariableString) ToHclTerraform() interface{} {
	var returns interface{}
