...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/keyvaultmanagedhardwaresecuritymoduleroledefinition/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.106.1/docs/resources/key_vault_managed_hardware_security_module_role_definition azurerm_key_vault_managed_hardware_security_module_role_definition}.
...
func (j *jsiiProxy_KeyVaultManagedHardwareSecurityModuleRoleDefinition) VaultBaseUrl() *string {
	var returns *string
	_jsii_.Get(
		j,
		"vaultBaseUrl",
...
func (j *jsiiProxy_KeyVaultManagedHardwareSecurityModuleRoleDefinition) VaultBaseUrlInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"vaultBaseUrlInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.106.1/docs/resources/key_vault_managed_hardware_security_module_role_definition azurerm_key_vault_managed_hardware_security_module_role_definition} Resource.
...
func (j *jsiiProxy_KeyVaultManagedHardwareSecurityModuleRoleDefinition)SetVaultBaseUrl(val *string) {
