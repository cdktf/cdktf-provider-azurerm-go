...
func (d *jsiiProxy_DataAzurermLocalNetworkGatewayBgpSettingsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermLocalNetworkGatewayBgpSettingsList) Resolve(context cdktf.IResolveContext) interface{} {
