...
func (j *jsiiProxy_DataFactoryIntegrationRuntimeAzure) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.100.0/docs/resources/data_factory_integration_runtime_azure azurerm_data_factory_integration_runtime_azure} Resource.
func NewDataFactoryIntegrationRuntimeAzure(scope constructs.Construct, id *string, config *DataFactoryIntegrationRuntimeAzureConfig) DataFactoryIntegrationRuntimeAzure {
	...
	if err := validateNewDataFactoryIntegrationRuntimeAzureParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataFactoryIntegrationRuntimeAzure)SetCleanupEnabled(val interface{}) {
	if err := j.validateSetCleanupEnabledParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_DataFactoryIntegrationRuntimeAzure)SetCount(val interface{}) {
...
func (j *jsiiProxy_DataFactoryIntegrationRuntimeAzure)SetVirtualNetworkEnabled(val interface{}) {
	if err := j.validateSetVirtualNetworkEnabledParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func DataFactoryIntegrationRuntimeAzure_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataFactoryIntegrationRuntimeAzure_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataFactoryIntegrationRuntimeAzure_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataFactoryIntegrationRuntimeAzure_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataFactoryIntegrationRuntimeAzure_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataFactoryIntegrationRuntimeAzure_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataFactoryIntegrationRuntimeAzure_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataFactoryIntegrationRuntimeAzure_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataFactoryIntegrationRuntimeAzure) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DataFactoryIntegrationRuntimeAzure) HasResourceMove() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataFactoryIntegrationRuntimeAzure) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (d *jsiiProxy_DataFactoryIntegrationRuntimeAzure) MoveFromId(id *string) {
...
func (d *jsiiProxy_DataFactoryIntegrationRuntimeAzure) MoveTo(moveTarget *string, index interface{}) {
...
func (d *jsiiProxy_DataFactoryIntegrationRuntimeAzure) MoveToId(id *string) {
...
func (d *jsiiProxy_DataFactoryIntegrationRuntimeAzure) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataFactoryIntegrationRuntimeAzure) ToHclTerraform() interface{} {
	var returns interface{}
