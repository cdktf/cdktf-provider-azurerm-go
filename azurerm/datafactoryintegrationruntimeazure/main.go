...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataFactoryIntegrationRuntimeAzure)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "cdktfStack", GoGetter: "CdktfStack"},
			_jsii_.MemberProperty{JsiiProperty: "cleanupEnabled", GoGetter: "CleanupEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "cleanupEnabledInput", GoGetter: "CleanupEnabledInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetCleanupEnabled", GoMethod: "ResetCleanupEnabled"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetTimeToLiveMin", GoMethod: "ResetTimeToLiveMin"},
			_jsii_.MemberMethod{JsiiMethod: "resetVirtualNetworkEnabled", GoMethod: "ResetVirtualNetworkEnabled"},
			...
			_jsii_.MemberProperty{JsiiProperty: "timeToLiveMin", GoGetter: "TimeToLiveMin"},
			_jsii_.MemberProperty{JsiiProperty: "timeToLiveMinInput", GoGetter: "TimeToLiveMinInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurerm.dataFactoryIntegrationRuntimeAzure.DataFactoryIntegrationRuntimeAzureConfig",
		reflect.TypeOf((*DataFactoryIntegrationRuntimeAzureConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurerm.dataFactoryIntegrationRuntimeAzure.DataFactoryIntegrationRuntimeAzureTimeouts",
		reflect.TypeOf((*DataFactoryIntegrationRuntimeAzureTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-azurerm.dataFactoryIntegrationRuntimeAzure.DataFactoryIntegrationRuntimeAzureTimeoutsOutputReference",
		reflect.TypeOf((*DataFactoryIntegrationRuntimeAzureTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
