...
import (
	...
	"github.com/hashicorp/cdktf-provider-azurerm-go/azurerm/v3/functionapphybridconnection/internal"
...
func (j *jsiiProxy_FunctionAppHybridConnection) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_FunctionAppHybridConnection) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_FunctionAppHybridConnection) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_FunctionAppHybridConnection) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_FunctionAppHybridConnection) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_FunctionAppHybridConnection) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_FunctionAppHybridConnection)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
...
func (j *jsiiProxy_FunctionAppHybridConnection)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_FunctionAppHybridConnection)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_FunctionAppHybridConnection)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (f *jsiiProxy_FunctionAppHybridConnection) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FunctionAppHybridConnection) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
