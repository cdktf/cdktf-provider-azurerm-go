...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSasTtl", GoMethod: "ResetSasTtl"},
			_jsii_.MemberMethod{JsiiMethod: "resetTimeouts", GoMethod: "ResetTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "sasTtl", GoGetter: "SasTtl"},
			_jsii_.MemberProperty{JsiiProperty: "sasTtlInput", GoGetter: "SasTtlInput"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_IothubFileUploadTimeoutsOutputReference{}
