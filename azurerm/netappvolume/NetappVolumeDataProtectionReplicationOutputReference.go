...
func (n *jsiiProxy_NetappVolumeDataProtectionReplicationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NetappVolumeDataProtectionReplicationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
