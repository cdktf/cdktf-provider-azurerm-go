...
import (
	...
	"github.com/hashicorp/cdktf-provider-azurerm-go/azurerm/v3/dataazurermeventhubnamespaceauthorizationrule/internal"
...
func (j *jsiiProxy_DataAzurermEventhubNamespaceAuthorizationRule) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_DataAzurermEventhubNamespaceAuthorizationRule) SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
...
type DataAzurermEventhubNamespaceAuthorizationRuleConfig struct {
	// Experimental.
	...
	// Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/d/eventhub_namespace_authorization_rule#id DataAzurermEventhubNamespaceAuthorizationRule#id}.
	//
	...
	Timeouts *DataAzurermEventhubNamespaceAuthorizationRuleTimeouts `field:"optional" json:"timeouts" yaml:"timeouts"`
}

type DataAzurermEventhubNamespaceAuthorizationRuleTimeouts struct {
...
type DataAzurermEventhubNamespaceAuthorizationRuleTimeoutsOutputReference interface {
	cdktf.ComplexObject
...
// The jsii proxy struct for DataAzurermEventhubNamespaceAuthorizationRuleTimeoutsOutputReference
type jsiiProxy_DataAzurermEventhubNamespaceAuthorizationRuleTimeoutsOutputReference struct {
	internal.Type__cdktfComplexObject
}

func (j *jsiiProxy_DataAzurermEventhubNamespaceAuthorizationRuleTimeoutsOutputReference) ComplexObjectIndex() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"complexObjectIndex",
...
func (j *jsiiProxy_DataAzurermEventhubNamespaceAuthorizationRuleTimeoutsOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataAzurermEventhubNamespaceAuthorizationRuleTimeoutsOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_DataAzurermEventhubNamespaceAuthorizationRuleTimeoutsOutputReference) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataAzurermEventhubNamespaceAuthorizationRuleTimeoutsOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_DataAzurermEventhubNamespaceAuthorizationRuleTimeoutsOutputReference) Read() *string {
	var returns *string
	_jsii_.Get(
		j,
		"read",
...
func (j *jsiiProxy_DataAzurermEventhubNamespaceAuthorizationRuleTimeoutsOutputReference) ReadInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"readInput",
...
func (j *jsiiProxy_DataAzurermEventhubNamespaceAuthorizationRuleTimeoutsOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_DataAzurermEventhubNamespaceAuthorizationRuleTimeoutsOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataAzurermEventhubNamespaceAuthorizationRuleTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DataAzurermEventhubNamespaceAuthorizationRuleTimeoutsOutputReference {
	_init_.Initialize()

	j := jsiiProxy_DataAzurermEventhubNamespaceAuthorizationRuleTimeoutsOutputReference{}

	_jsii_.Create(
		"@cdktf/provider-azurerm.dataAzurermEventhubNamespaceAuthorizationRule.DataAzurermEventhubNamespaceAuthorizationRuleTimeoutsOutputReference",
...
func NewDataAzurermEventhubNamespaceAuthorizationRuleTimeoutsOutputReference_Override(d DataAzurermEventhubNamespaceAuthorizationRuleTimeoutsOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermEventhubNamespaceAuthorizationRuleTimeoutsOutputReference) SetComplexObjectIndex(val interface{}) {
	_jsii_.Set(
		j,
		"complexObjectIndex",
		val,
...
func (j *jsiiProxy_DataAzurermEventhubNamespaceAuthorizationRuleTimeoutsOutputReference) SetComplexObjectIsFromSet(val *bool) {
	_jsii_.Set(
		j,
		"complexObjectIsFromSet",
		val,
...
func (j *jsiiProxy_DataAzurermEventhubNamespaceAuthorizationRuleTimeoutsOutputReference) SetInternalValue(val interface{}) {
	_jsii_.Set(
		j,
		"internalValue",
		val,
...
func (j *jsiiProxy_DataAzurermEventhubNamespaceAuthorizationRuleTimeoutsOutputReference) SetRead(val *string) {
	_jsii_.Set(
		j,
		"read",
		val,
...
func (j *jsiiProxy_DataAzurermEventhubNamespaceAuthorizationRuleTimeoutsOutputReference) SetTerraformAttribute(val *string) {
	_jsii_.Set(
		j,
		"terraformAttribute",
		val,
...
func (j *jsiiProxy_DataAzurermEventhubNamespaceAuthorizationRuleTimeoutsOutputReference) SetTerraformResource(val cdktf.IInterpolatingParent) {
	_jsii_.Set(
		j,
		"terraformResource",
		val,
...
func (d *jsiiProxy_DataAzurermEventhubNamespaceAuthorizationRuleTimeoutsOutputReference) ComputeFqn() *string {
	var returns *string
...
func (d *jsiiProxy_DataAzurermEventhubNamespaceAuthorizationRuleTimeoutsOutputReference) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAzurermEventhubNamespaceAuthorizationRuleTimeoutsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (d *jsiiProxy_DataAzurermEventhubNamespaceAuthorizationRuleTimeoutsOutputReference) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
	var returns *map[string]*bool
...
func (d *jsiiProxy_DataAzurermEventhubNamespaceAuthorizationRuleTimeoutsOutputReference) GetListAttribute(terraformAttribute *string) *[]*string {
	var returns *[]*string
...
func (d *jsiiProxy_DataAzurermEventhubNamespaceAuthorizationRuleTimeoutsOutputReference) GetNumberAttribute(terraformAttribute *string) *float64 {
	var returns *float64
...
func (d *jsiiProxy_DataAzurermEventhubNamespaceAuthorizationRuleTimeoutsOutputReference) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
	var returns *[]*float64
...
func (d *jsiiProxy_DataAzurermEventhubNamespaceAuthorizationRuleTimeoutsOutputReference) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
	var returns *map[string]*float64
...
func (d *jsiiProxy_DataAzurermEventhubNamespaceAuthorizationRuleTimeoutsOutputReference) GetStringAttribute(terraformAttribute *string) *string {
	var returns *string
...
func (d *jsiiProxy_DataAzurermEventhubNamespaceAuthorizationRuleTimeoutsOutputReference) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
	var returns *map[string]*string
...
func (d *jsiiProxy_DataAzurermEventhubNamespaceAuthorizationRuleTimeoutsOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (d *jsiiProxy_DataAzurermEventhubNamespaceAuthorizationRuleTimeoutsOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (d *jsiiProxy_DataAzurermEventhubNamespaceAuthorizationRuleTimeoutsOutputReference) ResetRead() {
	_jsii_.InvokeVoid(
		d,
		"resetRead",
		nil, // no parameters
...
func (d *jsiiProxy_DataAzurermEventhubNamespaceAuthorizationRuleTimeoutsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataAzurermEventhubNamespaceAuthorizationRuleTimeoutsOutputReference) ToString() *string {
	var returns *string
