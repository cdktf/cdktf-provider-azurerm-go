...
func NewSpringCloudServiceConfigServerGitSettingRepositoryList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SpringCloudServiceConfigServerGitSettingRepositoryList {
	...
	if err := validateNewSpringCloudServiceConfigServerGitSettingRepositoryListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SpringCloudServiceConfigServerGitSettingRepositoryList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SpringCloudServiceConfigServerGitSettingRepositoryList) Resolve(context cdktf.IResolveContext) interface{} {
