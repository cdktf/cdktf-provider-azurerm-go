...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*MssqlVirtualNetworkRule)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurerm.mssqlVirtualNetworkRule.MssqlVirtualNetworkRuleConfig",
		reflect.TypeOf((*MssqlVirtualNetworkRuleConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurerm.mssqlVirtualNetworkRule.MssqlVirtualNetworkRuleTimeouts",
		reflect.TypeOf((*MssqlVirtualNetworkRuleTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-azurerm.mssqlVirtualNetworkRule.MssqlVirtualNetworkRuleTimeoutsOutputReference",
		reflect.TypeOf((*MssqlVirtualNetworkRuleTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_MssqlVirtualNetworkRuleTimeoutsOutputReference{}
