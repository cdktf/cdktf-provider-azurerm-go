...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/vpnserverconfiguration/internal"
...
func NewVpnServerConfigurationAzureActiveDirectoryAuthenticationOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) VpnServerConfigurationAzureActiveDirectoryAuthenticationOutputReference {
	...
	if err := validateNewVpnServerConfigurationAzureActiveDirectoryAuthenticationOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
