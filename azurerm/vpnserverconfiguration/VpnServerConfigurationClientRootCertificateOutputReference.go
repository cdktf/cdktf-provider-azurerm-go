...
func NewVpnServerConfigurationClientRootCertificateOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) VpnServerConfigurationClientRootCertificateOutputReference {
	...
	if err := validateNewVpnServerConfigurationClientRootCertificateOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (v *jsiiProxy_VpnServerConfigurationClientRootCertificateOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VpnServerConfigurationClientRootCertificateOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
