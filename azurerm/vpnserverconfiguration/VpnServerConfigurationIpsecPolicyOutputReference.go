...
func (v *jsiiProxy_VpnServerConfigurationIpsecPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VpnServerConfigurationIpsecPolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
