...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "azureActiveDirectoryAuthentication", GoGetter: "AzureActiveDirectoryAuthentication"},
			_jsii_.MemberProperty{JsiiProperty: "azureActiveDirectoryAuthenticationInput", GoGetter: "AzureActiveDirectoryAuthenticationInput"},
			_jsii_.MemberProperty{JsiiProperty: "cdktfStack", GoGetter: "CdktfStack"},
			_jsii_.MemberProperty{JsiiProperty: "clientRevokedCertificate", GoGetter: "ClientRevokedCertificate"},
			_jsii_.MemberProperty{JsiiProperty: "clientRevokedCertificateInput", GoGetter: "ClientRevokedCertificateInput"},
			_jsii_.MemberProperty{JsiiProperty: "clientRootCertificate", GoGetter: "ClientRootCertificate"},
			_jsii_.MemberProperty{JsiiProperty: "clientRootCertificateInput", GoGetter: "ClientRootCertificateInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putAzureActiveDirectoryAuthentication", GoMethod: "PutAzureActiveDirectoryAuthentication"},
			_jsii_.MemberMethod{JsiiMethod: "putClientRevokedCertificate", GoMethod: "PutClientRevokedCertificate"},
			_jsii_.MemberMethod{JsiiMethod: "putClientRootCertificate", GoMethod: "PutClientRootCertificate"},
			_jsii_.MemberMethod{JsiiMethod: "putIpsecPolicy", GoMethod: "PutIpsecPolicy"},
			_jsii_.MemberMethod{JsiiMethod: "putRadius", GoMethod: "PutRadius"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAzureActiveDirectoryAuthentication", GoMethod: "ResetAzureActiveDirectoryAuthentication"},
			_jsii_.MemberMethod{JsiiMethod: "resetClientRevokedCertificate", GoMethod: "ResetClientRevokedCertificate"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetVpnProtocols", GoMethod: "ResetVpnProtocols"},
			...
			_jsii_.MemberProperty{JsiiProperty: "vpnAuthenticationTypes", GoGetter: "VpnAuthenticationTypes"},
			_jsii_.MemberProperty{JsiiProperty: "vpnAuthenticationTypesInput", GoGetter: "VpnAuthenticationTypesInput"},
			_jsii_.MemberProperty{JsiiProperty: "vpnProtocols", GoGetter: "VpnProtocols"},
			_jsii_.MemberProperty{JsiiProperty: "vpnProtocolsInput", GoGetter: "VpnProtocolsInput"},
		},
		func() interface{} {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "saDataSizeKilobytes", GoGetter: "SaDataSizeKilobytes"},
			_jsii_.MemberProperty{JsiiProperty: "saDataSizeKilobytesInput", GoGetter: "SaDataSizeKilobytesInput"},
			_jsii_.MemberProperty{JsiiProperty: "saLifetimeSeconds", GoGetter: "SaLifetimeSeconds"},
			_jsii_.MemberProperty{JsiiProperty: "saLifetimeSecondsInput", GoGetter: "SaLifetimeSecondsInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "serverRootCertificate", GoGetter: "ServerRootCertificate"},
			_jsii_.MemberProperty{JsiiProperty: "serverRootCertificateInput", GoGetter: "ServerRootCertificateInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		},
