...
func NewVpnServerConfigurationClientRevokedCertificateOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) VpnServerConfigurationClientRevokedCertificateOutputReference {
	...
	if err := validateNewVpnServerConfigurationClientRevokedCertificateOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (v *jsiiProxy_VpnServerConfigurationClientRevokedCertificateOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VpnServerConfigurationClientRevokedCertificateOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
