...
func NewVpnServerConfigurationTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) VpnServerConfigurationTimeoutsOutputReference {
	...
	if err := validateNewVpnServerConfigurationTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (v *jsiiProxy_VpnServerConfigurationTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VpnServerConfigurationTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
