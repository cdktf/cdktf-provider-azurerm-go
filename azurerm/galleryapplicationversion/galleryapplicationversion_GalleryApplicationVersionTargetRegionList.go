...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/galleryapplicationversion/internal"
...
func NewGalleryApplicationVersionTargetRegionList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GalleryApplicationVersionTargetRegionList {
	...
	if err := validateNewGalleryApplicationVersionTargetRegionListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
