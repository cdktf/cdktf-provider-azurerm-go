...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "enableHealthCheck", GoGetter: "EnableHealthCheck"},
			_jsii_.MemberProperty{JsiiProperty: "enableHealthCheckInput", GoGetter: "EnableHealthCheckInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "excludeFromLatest", GoGetter: "ExcludeFromLatest"},
			_jsii_.MemberProperty{JsiiProperty: "excludeFromLatestInput", GoGetter: "ExcludeFromLatestInput"},
			_jsii_.MemberProperty{JsiiProperty: "forEach", GoGetter: "ForEach"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberProperty{JsiiProperty: "friendlyUniqueId", GoGetter: "FriendlyUniqueId"},
			_jsii_.MemberProperty{JsiiProperty: "galleryApplicationId", GoGetter: "GalleryApplicationId"},
			_jsii_.MemberProperty{JsiiProperty: "galleryApplicationIdInput", GoGetter: "GalleryApplicationIdInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "manageAction", GoGetter: "ManageAction"},
			_jsii_.MemberProperty{JsiiProperty: "manageActionInput", GoGetter: "ManageActionInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putManageAction", GoMethod: "PutManageAction"},
			_jsii_.MemberMethod{JsiiMethod: "putSource", GoMethod: "PutSource"},
			_jsii_.MemberMethod{JsiiMethod: "putTargetRegion", GoMethod: "PutTargetRegion"},
			_jsii_.MemberMethod{JsiiMethod: "putTimeouts", GoMethod: "PutTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetEnableHealthCheck", GoMethod: "ResetEnableHealthCheck"},
			_jsii_.MemberMethod{JsiiMethod: "resetEndOfLifeDate", GoMethod: "ResetEndOfLifeDate"},
			_jsii_.MemberMethod{JsiiMethod: "resetExcludeFromLatest", GoMethod: "ResetExcludeFromLatest"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "defaultConfigurationLink", GoGetter: "DefaultConfigurationLink"},
			_jsii_.MemberProperty{JsiiProperty: "defaultConfigurationLinkInput", GoGetter: "DefaultConfigurationLinkInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			...
			_jsii_.MemberProperty{JsiiProperty: "mediaLinkInput", GoGetter: "MediaLinkInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetDefaultConfigurationLink", GoMethod: "ResetDefaultConfigurationLink"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "name", GoGetter: "Name"},
			_jsii_.MemberProperty{JsiiProperty: "nameInput", GoGetter: "NameInput"},
			_jsii_.MemberProperty{JsiiProperty: "regionalReplicaCount", GoGetter: "RegionalReplicaCount"},
			_jsii_.MemberProperty{JsiiProperty: "regionalReplicaCountInput", GoGetter: "RegionalReplicaCountInput"},
