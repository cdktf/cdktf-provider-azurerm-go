...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/springcloudbuildpackbinding/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.113.0/docs/resources/spring_cloud_build_pack_binding azurerm_spring_cloud_build_pack_binding}.
...
func (j *jsiiProxy_SpringCloudBuildPackBinding) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.113.0/docs/resources/spring_cloud_build_pack_binding azurerm_spring_cloud_build_pack_binding} Resource.
func NewSpringCloudBuildPackBinding(scope constructs.Construct, id *string, config *SpringCloudBuildPackBindingConfig) SpringCloudBuildPackBinding {
	...
	if err := validateNewSpringCloudBuildPackBindingParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_SpringCloudBuildPackBinding)SetCount(val interface{}) {
...
func (j *jsiiProxy_SpringCloudBuildPackBinding)SetSpringCloudBuilderId(val *string) {
	if err := j.validateSetSpringCloudBuilderIdParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func SpringCloudBuildPackBinding_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSpringCloudBuildPackBinding_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func SpringCloudBuildPackBinding_IsConstruct(x interface{}) *bool {
	...
	if err := validateSpringCloudBuildPackBinding_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_SpringCloudBuildPackBinding) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SpringCloudBuildPackBinding) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SpringCloudBuildPackBinding) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SpringCloudBuildPackBinding) MoveFromId(id *string) {
...
func (s *jsiiProxy_SpringCloudBuildPackBinding) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_SpringCloudBuildPackBinding) MoveToId(id *string) {
...
func (s *jsiiProxy_SpringCloudBuildPackBinding) PutLaunch(value *SpringCloudBuildPackBindingLaunch) {
	if err := s.validatePutLaunchParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		s,
...
func (s *jsiiProxy_SpringCloudBuildPackBinding) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SpringCloudBuildPackBinding) ToHclTerraform() interface{} {
	var returns interface{}
