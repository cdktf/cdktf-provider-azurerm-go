...
func NewVpnSiteTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) VpnSiteTimeoutsOutputReference {
	...
	if err := validateNewVpnSiteTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (v *jsiiProxy_VpnSiteTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VpnSiteTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
