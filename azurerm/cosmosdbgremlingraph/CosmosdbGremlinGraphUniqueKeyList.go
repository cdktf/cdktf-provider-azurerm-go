...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/cosmosdbgremlingraph/internal"
...
func NewCosmosdbGremlinGraphUniqueKeyList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CosmosdbGremlinGraphUniqueKeyList {
	...
	if err := validateNewCosmosdbGremlinGraphUniqueKeyListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CosmosdbGremlinGraphUniqueKeyList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CosmosdbGremlinGraphUniqueKeyList) Resolve(context cdktf.IResolveContext) interface{} {
