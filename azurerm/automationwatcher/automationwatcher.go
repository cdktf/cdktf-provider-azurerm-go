...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "executionFrequencyInSeconds", GoGetter: "ExecutionFrequencyInSeconds"},
			_jsii_.MemberProperty{JsiiProperty: "executionFrequencyInSecondsInput", GoGetter: "ExecutionFrequencyInSecondsInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "scriptRunOn", GoGetter: "ScriptRunOn"},
			_jsii_.MemberProperty{JsiiProperty: "scriptRunOnInput", GoGetter: "ScriptRunOnInput"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_AutomationWatcherTimeoutsOutputReference{}
