...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.54.0/docs/resources/linux_function_app_slot azurerm_linux_function_app_slot}.
...
func (j *jsiiProxy_LinuxFunctionAppSlot) VirtualNetworkBackupRestoreEnabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_LinuxFunctionAppSlot) VirtualNetworkBackupRestoreEnabledInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.54.0/docs/resources/linux_function_app_slot azurerm_linux_function_app_slot} Resource.
...
func (j *jsiiProxy_LinuxFunctionAppSlot)SetVirtualNetworkBackupRestoreEnabled(val interface{}) {
...
func (l *jsiiProxy_LinuxFunctionAppSlot) HasResourceMove() interface{} {
	var returns interface{}
...
func (l *jsiiProxy_LinuxFunctionAppSlot) MoveFromId(id *string) {
...
func (l *jsiiProxy_LinuxFunctionAppSlot) MoveToId(id *string) {
...
func (l *jsiiProxy_LinuxFunctionAppSlot) ResetVirtualNetworkBackupRestoreEnabled() {
	_jsii_.InvokeVoid(
		l,
		"resetVirtualNetworkBackupRestoreEnabled",
		nil, // no parameters
...
func (l *jsiiProxy_LinuxFunctionAppSlot) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (l *jsiiProxy_LinuxFunctionAppSlot) ToHclTerraform() interface{} {
	var returns interface{}
