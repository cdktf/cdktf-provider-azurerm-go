...
func (l *jsiiProxy_LinuxFunctionAppSlotSiteConfigApplicationStackDockerOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LinuxFunctionAppSlotSiteConfigApplicationStackDockerOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
