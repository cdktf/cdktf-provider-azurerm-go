...
func NewVpnGatewayNatRuleTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) VpnGatewayNatRuleTimeoutsOutputReference {
	...
	if err := validateNewVpnGatewayNatRuleTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (v *jsiiProxy_VpnGatewayNatRuleTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VpnGatewayNatRuleTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
