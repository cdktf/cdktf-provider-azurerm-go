...
import (
	...
	"github.com/hashicorp/cdktf-provider-azurerm-go/azurerm/v3/dataazurermeventhubauthorizationrule/internal"
...
func (j *jsiiProxy_DataAzurermEventhubAuthorizationRule) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_DataAzurermEventhubAuthorizationRule)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
