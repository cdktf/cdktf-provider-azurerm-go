...
func init() {
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_DataAzurermSubscriptionsSubscriptionsList{}
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "locationPlacementId", GoGetter: "LocationPlacementId"},
			_jsii_.MemberProperty{JsiiProperty: "quotaId", GoGetter: "QuotaId"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "spendingLimit", GoGetter: "SpendingLimit"},
		...
		func() interface{} {
			j := jsiiProxy_DataAzurermSubscriptionsSubscriptionsOutputReference{}
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_DataAzurermSubscriptionsTimeoutsOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
