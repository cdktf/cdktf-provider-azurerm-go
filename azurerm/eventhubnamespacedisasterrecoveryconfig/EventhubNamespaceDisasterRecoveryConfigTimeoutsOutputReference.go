...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/eventhubnamespacedisasterrecoveryconfig/internal"
...
func NewEventhubNamespaceDisasterRecoveryConfigTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) EventhubNamespaceDisasterRecoveryConfigTimeoutsOutputReference {
	...
	if err := validateNewEventhubNamespaceDisasterRecoveryConfigTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_EventhubNamespaceDisasterRecoveryConfigTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_EventhubNamespaceDisasterRecoveryConfigTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
