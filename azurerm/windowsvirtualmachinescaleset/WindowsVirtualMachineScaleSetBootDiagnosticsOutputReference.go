...
func NewWindowsVirtualMachineScaleSetBootDiagnosticsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) WindowsVirtualMachineScaleSetBootDiagnosticsOutputReference {
	...
	if err := validateNewWindowsVirtualMachineScaleSetBootDiagnosticsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (w *jsiiProxy_WindowsVirtualMachineScaleSetBootDiagnosticsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WindowsVirtualMachineScaleSetBootDiagnosticsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
