...
func (w *jsiiProxy_WindowsVirtualMachineScaleSetAdditionalCapabilitiesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WindowsVirtualMachineScaleSetAdditionalCapabilitiesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
