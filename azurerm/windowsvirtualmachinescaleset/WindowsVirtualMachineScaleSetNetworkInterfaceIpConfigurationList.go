...
func NewWindowsVirtualMachineScaleSetNetworkInterfaceIpConfigurationList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WindowsVirtualMachineScaleSetNetworkInterfaceIpConfigurationList {
	...
	if err := validateNewWindowsVirtualMachineScaleSetNetworkInterfaceIpConfigurationListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (w *jsiiProxy_WindowsVirtualMachineScaleSetNetworkInterfaceIpConfigurationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WindowsVirtualMachineScaleSetNetworkInterfaceIpConfigurationList) Resolve(context cdktf.IResolveContext) interface{} {
