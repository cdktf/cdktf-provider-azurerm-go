...
func (w *jsiiProxy_WindowsVirtualMachineScaleSetSecretList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WindowsVirtualMachineScaleSetSecretList) Resolve(context cdktf.IResolveContext) interface{} {
