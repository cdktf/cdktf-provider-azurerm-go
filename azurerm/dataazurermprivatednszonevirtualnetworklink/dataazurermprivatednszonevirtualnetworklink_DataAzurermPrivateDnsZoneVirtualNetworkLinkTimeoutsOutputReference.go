...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermprivatednszonevirtualnetworklink/internal"
...
func NewDataAzurermPrivateDnsZoneVirtualNetworkLinkTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DataAzurermPrivateDnsZoneVirtualNetworkLinkTimeoutsOutputReference {
	...
	if err := validateNewDataAzurermPrivateDnsZoneVirtualNetworkLinkTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
