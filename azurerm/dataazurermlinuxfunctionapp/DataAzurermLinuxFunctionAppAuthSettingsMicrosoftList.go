...
func (d *jsiiProxy_DataAzurermLinuxFunctionAppAuthSettingsMicrosoftList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermLinuxFunctionAppAuthSettingsMicrosoftList) Resolve(context cdktf.IResolveContext) interface{} {
