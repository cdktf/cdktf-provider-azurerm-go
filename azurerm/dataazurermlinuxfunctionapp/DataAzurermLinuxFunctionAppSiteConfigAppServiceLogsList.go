...
func (d *jsiiProxy_DataAzurermLinuxFunctionAppSiteConfigAppServiceLogsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermLinuxFunctionAppSiteConfigAppServiceLogsList) Resolve(context cdktf.IResolveContext) interface{} {
