...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v3/keyvaultkey/internal"
...
func NewKeyVaultKeyTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) KeyVaultKeyTimeoutsOutputReference {
	...
	if err := validateNewKeyVaultKeyTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
