...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/keyvaultkey/internal"
...
func (k *jsiiProxy_KeyVaultKeyRotationPolicyOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (k *jsiiProxy_KeyVaultKeyRotationPolicyOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
