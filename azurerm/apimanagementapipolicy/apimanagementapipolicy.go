...
import (
	...
	"github.com/hashicorp/cdktf-provider-azurerm-go/azurerm/v3/apimanagementapipolicy/internal"
...
func (j *jsiiProxy_ApiManagementApiPolicy) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_ApiManagementApiPolicy) SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
...
func NewApiManagementApiPolicyTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) ApiManagementApiPolicyTimeoutsOutputReference {
	...
	_jsii_.Create(
		"@cdktf/provider-azurerm.apiManagementApiPolicy.ApiManagementApiPolicyTimeoutsOutputReference",
