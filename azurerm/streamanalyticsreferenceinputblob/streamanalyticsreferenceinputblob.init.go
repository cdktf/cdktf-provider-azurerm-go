...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*StreamAnalyticsReferenceInputBlob)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "storageContainerName", GoGetter: "StorageContainerName"},
			_jsii_.MemberProperty{JsiiProperty: "storageContainerNameInput", GoGetter: "StorageContainerNameInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurerm.streamAnalyticsReferenceInputBlob.StreamAnalyticsReferenceInputBlobConfig",
		reflect.TypeOf((*StreamAnalyticsReferenceInputBlobConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurerm.streamAnalyticsReferenceInputBlob.StreamAnalyticsReferenceInputBlobSerialization",
		reflect.TypeOf((*StreamAnalyticsReferenceInputBlobSerialization)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-azurerm.streamAnalyticsReferenceInputBlob.StreamAnalyticsReferenceInputBlobSerializationOutputReference",
		reflect.TypeOf((*StreamAnalyticsReferenceInputBlobSerializationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurerm.streamAnalyticsReferenceInputBlob.StreamAnalyticsReferenceInputBlobTimeouts",
		reflect.TypeOf((*StreamAnalyticsReferenceInputBlobTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-azurerm.streamAnalyticsReferenceInputBlob.StreamAnalyticsReferenceInputBlobTimeoutsOutputReference",
		reflect.TypeOf((*StreamAnalyticsReferenceInputBlobTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
