...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "billingPlanId", GoGetter: "BillingPlanId"},
		...
		func() interface{} {
			j := jsiiProxy_GraphServicesAccount{}
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_GraphServicesAccountTimeoutsOutputReference{}
