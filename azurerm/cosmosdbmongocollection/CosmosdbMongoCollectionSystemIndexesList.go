...
func (c *jsiiProxy_CosmosdbMongoCollectionSystemIndexesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CosmosdbMongoCollectionSystemIndexesList) Resolve(context cdktf.IResolveContext) interface{} {
