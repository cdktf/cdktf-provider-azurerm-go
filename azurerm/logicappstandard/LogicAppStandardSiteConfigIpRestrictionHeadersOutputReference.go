...
func NewLogicAppStandardSiteConfigIpRestrictionHeadersOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) LogicAppStandardSiteConfigIpRestrictionHeadersOutputReference {
	...
	if err := validateNewLogicAppStandardSiteConfigIpRestrictionHeadersOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LogicAppStandardSiteConfigIpRestrictionHeadersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LogicAppStandardSiteConfigIpRestrictionHeadersOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
