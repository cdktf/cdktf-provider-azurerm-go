...
func (l *jsiiProxy_LogicAppStandardSiteConfigScmIpRestrictionList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (l *jsiiProxy_LogicAppStandardSiteConfigScmIpRestrictionList) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_LogicAppStandardSiteConfigScmIpRestrictionList) validateSetInternalValueParameters(val interface{}) error {
	...
	case []*LogicAppStandardSiteConfigScmIpRestriction:
		val_ := val.([]*LogicAppStandardSiteConfigScmIpRestriction)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
...
func (j *jsiiProxy_LogicAppStandardSiteConfigScmIpRestrictionList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_LogicAppStandardSiteConfigScmIpRestrictionList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
