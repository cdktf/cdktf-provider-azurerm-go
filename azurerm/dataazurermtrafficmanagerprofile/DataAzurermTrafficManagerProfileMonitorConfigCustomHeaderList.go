...
func (d *jsiiProxy_DataAzurermTrafficManagerProfileMonitorConfigCustomHeaderList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermTrafficManagerProfileMonitorConfigCustomHeaderList) Resolve(context cdktf.IResolveContext) interface{} {
