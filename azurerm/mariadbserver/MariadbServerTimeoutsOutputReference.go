...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v11/mariadbserver/internal"
...
func NewMariadbServerTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) MariadbServerTimeoutsOutputReference {
	...
	if err := validateNewMariadbServerTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
