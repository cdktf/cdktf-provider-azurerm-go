...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "appServiceSlotName", GoGetter: "AppServiceSlotName"},
			_jsii_.MemberProperty{JsiiProperty: "appServiceSlotNameInput", GoGetter: "AppServiceSlotNameInput"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_AppServiceActiveSlotTimeoutsOutputReference{}
