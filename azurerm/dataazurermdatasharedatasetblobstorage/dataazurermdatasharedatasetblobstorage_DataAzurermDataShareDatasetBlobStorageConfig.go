...
type DataAzurermDataShareDatasetBlobStorageConfig struct {
	// Experimental.
	...
	// Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/d/data_share_dataset_blob_storage#id DataAzurermDataShareDatasetBlobStorage#id}.
	//
	...
	Timeouts *DataAzurermDataShareDatasetBlobStorageTimeouts `field:"optional" json:"timeouts" yaml:"timeouts"`
}
