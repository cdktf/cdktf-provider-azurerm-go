...
func (d *jsiiProxy_DataAzurermAppConfigurationSecondaryWriteKeyList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermAppConfigurationSecondaryWriteKeyList) Resolve(context cdktf.IResolveContext) interface{} {
