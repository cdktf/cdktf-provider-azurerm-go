...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/iottimeseriesinsightsreferencedataset/internal"
...
func NewIotTimeSeriesInsightsReferenceDataSetTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) IotTimeSeriesInsightsReferenceDataSetTimeoutsOutputReference {
	...
	if err := validateNewIotTimeSeriesInsightsReferenceDataSetTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
