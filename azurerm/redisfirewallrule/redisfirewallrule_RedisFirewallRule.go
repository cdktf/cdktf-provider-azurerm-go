...
import (
	...
	"github.com/hashicorp/cdktf-provider-azurerm-go/azurerm/v3/redisfirewallrule/internal"
...
func (j *jsiiProxy_RedisFirewallRule) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_RedisFirewallRule) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_RedisFirewallRule) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_RedisFirewallRule) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_RedisFirewallRule) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_RedisFirewallRule) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_RedisFirewallRule)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
...
func (j *jsiiProxy_RedisFirewallRule)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_RedisFirewallRule)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_RedisFirewallRule)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (r *jsiiProxy_RedisFirewallRule) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_RedisFirewallRule) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
