...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/devtestglobalvmshutdownschedule/internal"
...
func NewDevTestGlobalVmShutdownSchedule(scope constructs.Construct, id *string, config *DevTestGlobalVmShutdownScheduleConfig) DevTestGlobalVmShutdownSchedule {
	...
	if err := validateNewDevTestGlobalVmShutdownScheduleParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DevTestGlobalVmShutdownSchedule)SetDailyRecurrenceTime(val *string) {
	if err := j.validateSetDailyRecurrenceTimeParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func DevTestGlobalVmShutdownSchedule_IsConstruct(x interface{}) *bool {
	...
	if err := validateDevTestGlobalVmShutdownSchedule_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DevTestGlobalVmShutdownSchedule_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDevTestGlobalVmShutdownSchedule_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DevTestGlobalVmShutdownSchedule_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDevTestGlobalVmShutdownSchedule_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
