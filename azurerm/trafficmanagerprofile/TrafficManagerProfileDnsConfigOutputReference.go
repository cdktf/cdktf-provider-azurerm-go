...
func NewTrafficManagerProfileDnsConfigOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) TrafficManagerProfileDnsConfigOutputReference {
	...
	if err := validateNewTrafficManagerProfileDnsConfigOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_TrafficManagerProfileDnsConfigOutputReference)SetRelativeName(val *string) {
	if err := j.validateSetRelativeNameParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (t *jsiiProxy_TrafficManagerProfileDnsConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (t *jsiiProxy_TrafficManagerProfileDnsConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
