...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/kubernetesclustertrustedaccessrolebinding/internal"
...
func (j *jsiiProxy_KubernetesClusterTrustedAccessRoleBinding) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_KubernetesClusterTrustedAccessRoleBinding) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_KubernetesClusterTrustedAccessRoleBinding) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_KubernetesClusterTrustedAccessRoleBinding) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_KubernetesClusterTrustedAccessRoleBinding) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.103.0/docs/resources/kubernetes_cluster_trusted_access_role_binding azurerm_kubernetes_cluster_trusted_access_role_binding} Resource.
func NewKubernetesClusterTrustedAccessRoleBinding(scope constructs.Construct, id *string, config *KubernetesClusterTrustedAccessRoleBindingConfig) KubernetesClusterTrustedAccessRoleBinding {
	...
	_jsii_.Create(
		"@cdktf/provider-azurerm.kubernetesClusterTrustedAccessRoleBinding.KubernetesClusterTrustedAccessRoleBinding",
...
func (j *jsiiProxy_KubernetesClusterTrustedAccessRoleBinding)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_KubernetesClusterTrustedAccessRoleBinding)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_KubernetesClusterTrustedAccessRoleBinding)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func KubernetesClusterTrustedAccessRoleBinding_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (k *jsiiProxy_KubernetesClusterTrustedAccessRoleBinding) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (k *jsiiProxy_KubernetesClusterTrustedAccessRoleBinding) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (k *jsiiProxy_KubernetesClusterTrustedAccessRoleBinding) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
