...
func NewCdnFrontdoorRuleConditionsRequestSchemeConditionOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) CdnFrontdoorRuleConditionsRequestSchemeConditionOutputReference {
	...
	if err := validateNewCdnFrontdoorRuleConditionsRequestSchemeConditionOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsRequestSchemeConditionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsRequestSchemeConditionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
