...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/cdnfrontdoorrule/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.101.0/docs/resources/cdn_frontdoor_rule azurerm_cdn_frontdoor_rule}.
...
func (j *jsiiProxy_CdnFrontdoorRule) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.101.0/docs/resources/cdn_frontdoor_rule azurerm_cdn_frontdoor_rule} Resource.
...
func (j *jsiiProxy_CdnFrontdoorRule)SetCount(val interface{}) {
...
func CdnFrontdoorRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateCdnFrontdoorRule_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CdnFrontdoorRule) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_CdnFrontdoorRule) HasResourceMove() interface{} {
	var returns interface{}
...
func (c *jsiiProxy_CdnFrontdoorRule) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_CdnFrontdoorRule) MoveFromId(id *string) {
...
func (c *jsiiProxy_CdnFrontdoorRule) MoveTo(moveTarget *string, index interface{}) {
...
func (c *jsiiProxy_CdnFrontdoorRule) MoveToId(id *string) {
...
func (c *jsiiProxy_CdnFrontdoorRule) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_CdnFrontdoorRule) ToHclTerraform() interface{} {
	var returns interface{}
