...
func NewCdnFrontdoorRuleConditionsIsDeviceConditionList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CdnFrontdoorRuleConditionsIsDeviceConditionList {
	...
	if err := validateNewCdnFrontdoorRuleConditionsIsDeviceConditionListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsIsDeviceConditionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsIsDeviceConditionList) Resolve(context cdktf.IResolveContext) interface{} {
