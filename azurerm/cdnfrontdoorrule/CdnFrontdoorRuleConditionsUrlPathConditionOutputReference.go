...
func NewCdnFrontdoorRuleConditionsUrlPathConditionOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) CdnFrontdoorRuleConditionsUrlPathConditionOutputReference {
	...
	if err := validateNewCdnFrontdoorRuleConditionsUrlPathConditionOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsUrlPathConditionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsUrlPathConditionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
