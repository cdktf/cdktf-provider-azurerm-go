...
func (c *jsiiProxy_CdnFrontdoorRuleActionsUrlRedirectActionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CdnFrontdoorRuleActionsUrlRedirectActionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
