...
func NewCdnFrontdoorRuleActionsUrlRewriteActionOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) CdnFrontdoorRuleActionsUrlRewriteActionOutputReference {
	...
	if err := validateNewCdnFrontdoorRuleActionsUrlRewriteActionOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CdnFrontdoorRuleActionsUrlRewriteActionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CdnFrontdoorRuleActionsUrlRewriteActionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
