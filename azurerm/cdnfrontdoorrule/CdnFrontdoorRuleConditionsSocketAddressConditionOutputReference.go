...
func NewCdnFrontdoorRuleConditionsSocketAddressConditionOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) CdnFrontdoorRuleConditionsSocketAddressConditionOutputReference {
	...
	if err := validateNewCdnFrontdoorRuleConditionsSocketAddressConditionOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsSocketAddressConditionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsSocketAddressConditionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
