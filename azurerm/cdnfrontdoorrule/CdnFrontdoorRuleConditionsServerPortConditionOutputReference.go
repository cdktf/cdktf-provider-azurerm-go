...
func NewCdnFrontdoorRuleConditionsServerPortConditionOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) CdnFrontdoorRuleConditionsServerPortConditionOutputReference {
	...
	if err := validateNewCdnFrontdoorRuleConditionsServerPortConditionOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsServerPortConditionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsServerPortConditionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
