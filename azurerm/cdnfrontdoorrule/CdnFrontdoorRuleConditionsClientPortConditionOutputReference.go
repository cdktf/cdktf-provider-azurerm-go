...
func NewCdnFrontdoorRuleConditionsClientPortConditionOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) CdnFrontdoorRuleConditionsClientPortConditionOutputReference {
	...
	if err := validateNewCdnFrontdoorRuleConditionsClientPortConditionOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsClientPortConditionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsClientPortConditionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
