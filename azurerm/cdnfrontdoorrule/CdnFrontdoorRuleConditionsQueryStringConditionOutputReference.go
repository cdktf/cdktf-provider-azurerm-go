...
func NewCdnFrontdoorRuleConditionsQueryStringConditionOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) CdnFrontdoorRuleConditionsQueryStringConditionOutputReference {
	...
	if err := validateNewCdnFrontdoorRuleConditionsQueryStringConditionOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsQueryStringConditionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsQueryStringConditionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
