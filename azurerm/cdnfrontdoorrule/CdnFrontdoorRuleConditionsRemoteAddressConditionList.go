...
func NewCdnFrontdoorRuleConditionsRemoteAddressConditionList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CdnFrontdoorRuleConditionsRemoteAddressConditionList {
	...
	if err := validateNewCdnFrontdoorRuleConditionsRemoteAddressConditionListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsRemoteAddressConditionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsRemoteAddressConditionList) Resolve(context cdktf.IResolveContext) interface{} {
