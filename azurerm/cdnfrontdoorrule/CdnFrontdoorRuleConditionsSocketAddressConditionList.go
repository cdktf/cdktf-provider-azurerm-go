...
func NewCdnFrontdoorRuleConditionsSocketAddressConditionList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CdnFrontdoorRuleConditionsSocketAddressConditionList {
	...
	if err := validateNewCdnFrontdoorRuleConditionsSocketAddressConditionListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsSocketAddressConditionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsSocketAddressConditionList) Resolve(context cdktf.IResolveContext) interface{} {
