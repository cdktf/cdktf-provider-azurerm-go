...
func NewCdnFrontdoorRuleConditionsUrlPathConditionList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CdnFrontdoorRuleConditionsUrlPathConditionList {
	...
	if err := validateNewCdnFrontdoorRuleConditionsUrlPathConditionListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsUrlPathConditionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CdnFrontdoorRuleConditionsUrlPathConditionList) Resolve(context cdktf.IResolveContext) interface{} {
