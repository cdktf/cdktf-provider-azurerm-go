...
func (d *jsiiProxy_DataAzurermDiskEncryptionSetIdentityList) validateGetParameters(index *float64) error {
	return nil
}

func (d *jsiiProxy_DataAzurermDiskEncryptionSetIdentityList) validateResolveParameters(_context cdktf.IResolveContext) error {
	return nil
}

func (j *jsiiProxy_DataAzurermDiskEncryptionSetIdentityList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_DataAzurermDiskEncryptionSetIdentityList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
