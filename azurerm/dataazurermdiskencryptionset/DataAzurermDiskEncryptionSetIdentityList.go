...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/dataazurermdiskencryptionset/internal"
...
func (d *jsiiProxy_DataAzurermDiskEncryptionSetIdentityList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermDiskEncryptionSetIdentityList) Resolve(context cdktf.IResolveContext) interface{} {
