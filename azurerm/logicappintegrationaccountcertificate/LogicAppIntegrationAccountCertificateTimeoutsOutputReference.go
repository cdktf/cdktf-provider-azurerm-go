...
func NewLogicAppIntegrationAccountCertificateTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) LogicAppIntegrationAccountCertificateTimeoutsOutputReference {
	...
	if err := validateNewLogicAppIntegrationAccountCertificateTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LogicAppIntegrationAccountCertificateTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LogicAppIntegrationAccountCertificateTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
