...
func NewLogAnalyticsSolutionPlanOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) LogAnalyticsSolutionPlanOutputReference {
	...
	if err := validateNewLogAnalyticsSolutionPlanOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_LogAnalyticsSolutionPlanOutputReference)SetPromotionCode(val *string) {
	if err := j.validateSetPromotionCodeParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (l *jsiiProxy_LogAnalyticsSolutionPlanOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LogAnalyticsSolutionPlanOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
