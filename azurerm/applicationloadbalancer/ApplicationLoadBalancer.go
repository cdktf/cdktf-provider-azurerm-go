...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/applicationloadbalancer/internal"
...
func (j *jsiiProxy_ApplicationLoadBalancer) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_ApplicationLoadBalancer) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_ApplicationLoadBalancer) LocationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationInput",
...
func (j *jsiiProxy_ApplicationLoadBalancer) PrimaryConfigurationEndpoint() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ApplicationLoadBalancer) ResourceGroupName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceGroupName",
...
func (j *jsiiProxy_ApplicationLoadBalancer) ResourceGroupNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ApplicationLoadBalancer) Tags() *map[string]*string {
...
func (j *jsiiProxy_ApplicationLoadBalancer) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_ApplicationLoadBalancer) Timeouts() ApplicationLoadBalancerTimeoutsOutputReference {
	var returns ApplicationLoadBalancerTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_ApplicationLoadBalancer) TimeoutsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"timeoutsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.103.1/docs/resources/application_load_balancer azurerm_application_load_balancer} Resource.
...
func (j *jsiiProxy_ApplicationLoadBalancer)SetId(val *string) {
...
func (j *jsiiProxy_ApplicationLoadBalancer)SetLocation(val *string) {
...
func (j *jsiiProxy_ApplicationLoadBalancer)SetResourceGroupName(val *string) {
...
func (j *jsiiProxy_ApplicationLoadBalancer)SetTags(val *map[string]*string) {
...
func (a *jsiiProxy_ApplicationLoadBalancer) ResetId() {
	_jsii_.InvokeVoid(
		a,
		"resetId",
		nil, // no parameters
...
func (a *jsiiProxy_ApplicationLoadBalancer) ResetTags() {
	_jsii_.InvokeVoid(
		a,
		"resetTags",
		nil, // no parameters
...
func (a *jsiiProxy_ApplicationLoadBalancer) ResetTimeouts() {
	_jsii_.InvokeVoid(
		a,
		"resetTimeouts",
		nil, // no parameters
