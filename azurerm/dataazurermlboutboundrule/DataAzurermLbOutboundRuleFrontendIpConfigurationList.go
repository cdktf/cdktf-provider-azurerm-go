...
func (j *jsiiProxy_DataAzurermLbOutboundRuleFrontendIpConfigurationList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataAzurermLbOutboundRuleFrontendIpConfigurationList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermLbOutboundRuleFrontendIpConfigurationList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktf/provider-azurerm.dataAzurermLbOutboundRule.DataAzurermLbOutboundRuleFrontendIpConfigurationList",
...
func NewDataAzurermLbOutboundRuleFrontendIpConfigurationList_Override(d DataAzurermLbOutboundRuleFrontendIpConfigurationList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermLbOutboundRuleFrontendIpConfigurationList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermLbOutboundRuleFrontendIpConfigurationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermLbOutboundRuleFrontendIpConfigurationList) Resolve(_context cdktf.IResolveContext) interface{} {
