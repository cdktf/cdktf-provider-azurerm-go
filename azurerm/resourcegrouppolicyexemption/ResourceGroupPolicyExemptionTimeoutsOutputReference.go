...
func NewResourceGroupPolicyExemptionTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) ResourceGroupPolicyExemptionTimeoutsOutputReference {
	...
	if err := validateNewResourceGroupPolicyExemptionTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_ResourceGroupPolicyExemptionTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_ResourceGroupPolicyExemptionTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
