...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/eventgriddomain/internal"
...
func NewEventgridDomainInboundIpRuleList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) EventgridDomainInboundIpRuleList {
	...
	if err := validateNewEventgridDomainInboundIpRuleListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_EventgridDomainInboundIpRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (e *jsiiProxy_EventgridDomainInboundIpRuleList) Resolve(context cdktf.IResolveContext) interface{} {
