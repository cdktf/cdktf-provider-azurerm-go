...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "kustoClusterId", GoGetter: "KustoClusterId"},
			_jsii_.MemberProperty{JsiiProperty: "kustoClusterIdInput", GoGetter: "KustoClusterIdInput"},
