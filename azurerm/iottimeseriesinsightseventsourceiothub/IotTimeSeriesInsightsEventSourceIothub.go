...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/iottimeseriesinsightseventsourceiothub/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.114.0/docs/resources/iot_time_series_insights_event_source_iothub azurerm_iot_time_series_insights_event_source_iothub}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.114.0/docs/resources/iot_time_series_insights_event_source_iothub azurerm_iot_time_series_insights_event_source_iothub} Resource.
...
func IotTimeSeriesInsightsEventSourceIothub_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateIotTimeSeriesInsightsEventSourceIothub_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (i *jsiiProxy_IotTimeSeriesInsightsEventSourceIothub) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_IotTimeSeriesInsightsEventSourceIothub) HasResourceMove() interface{} {
	var returns interface{}
...
func (i *jsiiProxy_IotTimeSeriesInsightsEventSourceIothub) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (i *jsiiProxy_IotTimeSeriesInsightsEventSourceIothub) MoveFromId(id *string) {
...
func (i *jsiiProxy_IotTimeSeriesInsightsEventSourceIothub) MoveTo(moveTarget *string, index interface{}) {
...
func (i *jsiiProxy_IotTimeSeriesInsightsEventSourceIothub) MoveToId(id *string) {
...
func (i *jsiiProxy_IotTimeSeriesInsightsEventSourceIothub) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (i *jsiiProxy_IotTimeSeriesInsightsEventSourceIothub) ToHclTerraform() interface{} {
	var returns interface{}
