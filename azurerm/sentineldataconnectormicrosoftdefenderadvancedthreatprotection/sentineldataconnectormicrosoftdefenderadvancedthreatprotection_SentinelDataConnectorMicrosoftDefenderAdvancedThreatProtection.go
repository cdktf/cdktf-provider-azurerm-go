...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/sentineldataconnectormicrosoftdefenderadvancedthreatprotection/internal"
...
func NewSentinelDataConnectorMicrosoftDefenderAdvancedThreatProtection(scope constructs.Construct, id *string, config *SentinelDataConnectorMicrosoftDefenderAdvancedThreatProtectionConfig) SentinelDataConnectorMicrosoftDefenderAdvancedThreatProtection {
	...
	if err := validateNewSentinelDataConnectorMicrosoftDefenderAdvancedThreatProtectionParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func SentinelDataConnectorMicrosoftDefenderAdvancedThreatProtection_IsConstruct(x interface{}) *bool {
	...
	if err := validateSentinelDataConnectorMicrosoftDefenderAdvancedThreatProtection_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func SentinelDataConnectorMicrosoftDefenderAdvancedThreatProtection_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSentinelDataConnectorMicrosoftDefenderAdvancedThreatProtection_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func SentinelDataConnectorMicrosoftDefenderAdvancedThreatProtection_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSentinelDataConnectorMicrosoftDefenderAdvancedThreatProtection_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
