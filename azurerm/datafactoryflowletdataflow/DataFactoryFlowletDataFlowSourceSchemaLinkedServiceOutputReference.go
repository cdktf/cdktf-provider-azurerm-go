...
func NewDataFactoryFlowletDataFlowSourceSchemaLinkedServiceOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DataFactoryFlowletDataFlowSourceSchemaLinkedServiceOutputReference {
	...
	if err := validateNewDataFactoryFlowletDataFlowSourceSchemaLinkedServiceOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataFactoryFlowletDataFlowSourceSchemaLinkedServiceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataFactoryFlowletDataFlowSourceSchemaLinkedServiceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
