...
func NewDataFactoryFlowletDataFlowSinkSchemaLinkedServiceOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DataFactoryFlowletDataFlowSinkSchemaLinkedServiceOutputReference {
	...
	if err := validateNewDataFactoryFlowletDataFlowSinkSchemaLinkedServiceOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataFactoryFlowletDataFlowSinkSchemaLinkedServiceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataFactoryFlowletDataFlowSinkSchemaLinkedServiceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
