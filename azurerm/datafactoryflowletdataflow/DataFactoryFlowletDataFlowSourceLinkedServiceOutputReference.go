...
func NewDataFactoryFlowletDataFlowSourceLinkedServiceOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DataFactoryFlowletDataFlowSourceLinkedServiceOutputReference {
	...
	if err := validateNewDataFactoryFlowletDataFlowSourceLinkedServiceOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataFactoryFlowletDataFlowSourceLinkedServiceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataFactoryFlowletDataFlowSourceLinkedServiceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
