...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.115.0/docs/resources/data_factory_flowlet_data_flow azurerm_data_factory_flowlet_data_flow}.
...
func (j *jsiiProxy_DataFactoryFlowletDataFlow) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.115.0/docs/resources/data_factory_flowlet_data_flow azurerm_data_factory_flowlet_data_flow} Resource.
func NewDataFactoryFlowletDataFlow(scope constructs.Construct, id *string, config *DataFactoryFlowletDataFlowConfig) DataFactoryFlowletDataFlow {
	...
	if err := validateNewDataFactoryFlowletDataFlowParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataFactoryFlowletDataFlow)SetCount(val interface{}) {
...
func DataFactoryFlowletDataFlow_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataFactoryFlowletDataFlow_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataFactoryFlowletDataFlow_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataFactoryFlowletDataFlow_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func DataFactoryFlowletDataFlow_IsTerraformElement(x interface{}) *bool {
	...
	if err := validateDataFactoryFlowletDataFlow_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func DataFactoryFlowletDataFlow_IsTerraformResource(x interface{}) *bool {
	...
	if err := validateDataFactoryFlowletDataFlow_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataFactoryFlowletDataFlow) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DataFactoryFlowletDataFlow) HasResourceMove() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataFactoryFlowletDataFlow) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (d *jsiiProxy_DataFactoryFlowletDataFlow) MoveFromId(id *string) {
...
func (d *jsiiProxy_DataFactoryFlowletDataFlow) MoveTo(moveTarget *string, index interface{}) {
...
func (d *jsiiProxy_DataFactoryFlowletDataFlow) MoveToId(id *string) {
...
func (d *jsiiProxy_DataFactoryFlowletDataFlow) PutTransformation(value interface{}) {
	if err := d.validatePutTransformationParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		d,
...
func (d *jsiiProxy_DataFactoryFlowletDataFlow) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataFactoryFlowletDataFlow) ToHclTerraform() interface{} {
	var returns interface{}
