...
func NewDataFactoryFlowletDataFlowSinkFlowletOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DataFactoryFlowletDataFlowSinkFlowletOutputReference {
	...
	if err := validateNewDataFactoryFlowletDataFlowSinkFlowletOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataFactoryFlowletDataFlowSinkFlowletOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataFactoryFlowletDataFlowSinkFlowletOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
