...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v3/datafactoryflowletdataflow/internal"
...
func NewDataFactoryFlowletDataFlowTransformationLinkedServiceOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DataFactoryFlowletDataFlowTransformationLinkedServiceOutputReference {
	...
	if err := validateNewDataFactoryFlowletDataFlowTransformationLinkedServiceOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
