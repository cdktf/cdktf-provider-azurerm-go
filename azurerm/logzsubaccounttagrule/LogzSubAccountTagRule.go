...
func (j *jsiiProxy_LogzSubAccountTagRule) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_LogzSubAccountTagRule)SetCount(val interface{}) {
...
func LogzSubAccountTagRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateLogzSubAccountTagRule_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LogzSubAccountTagRule) AddMoveTarget(moveTarget *string) {
...
func (l *jsiiProxy_LogzSubAccountTagRule) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (l *jsiiProxy_LogzSubAccountTagRule) ToHclTerraform() interface{} {
	var returns interface{}
