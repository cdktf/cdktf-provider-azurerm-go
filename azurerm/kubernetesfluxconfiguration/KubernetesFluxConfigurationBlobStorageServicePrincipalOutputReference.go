...
func (k *jsiiProxy_KubernetesFluxConfigurationBlobStorageServicePrincipalOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (k *jsiiProxy_KubernetesFluxConfigurationBlobStorageServicePrincipalOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
