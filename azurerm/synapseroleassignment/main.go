...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSynapseSparkPoolId", GoMethod: "ResetSynapseSparkPoolId"},
			_jsii_.MemberMethod{JsiiMethod: "resetSynapseWorkspaceId", GoMethod: "ResetSynapseWorkspaceId"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_SynapseRoleAssignmentTimeoutsOutputReference{}
