...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "languageFramework", GoGetter: "LanguageFramework"},
			_jsii_.MemberProperty{JsiiProperty: "languageFrameworkInput", GoGetter: "LanguageFrameworkInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetLanguageFramework", GoMethod: "ResetLanguageFramework"},
