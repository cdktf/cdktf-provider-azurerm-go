...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/consumptionbudgetsubscription/internal"
...
func NewConsumptionBudgetSubscriptionFilterDimensionOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ConsumptionBudgetSubscriptionFilterDimensionOutputReference {
	...
	if err := validateNewConsumptionBudgetSubscriptionFilterDimensionOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
