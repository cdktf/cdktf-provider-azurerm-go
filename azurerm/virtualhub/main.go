...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "addressPrefixInput", GoGetter: "AddressPrefixInput"},
			_jsii_.MemberProperty{JsiiProperty: "branchToBranchTrafficEnabled", GoGetter: "BranchToBranchTrafficEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "branchToBranchTrafficEnabledInput", GoGetter: "BranchToBranchTrafficEnabledInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "hubRoutingPreference", GoGetter: "HubRoutingPreference"},
			_jsii_.MemberProperty{JsiiProperty: "hubRoutingPreferenceInput", GoGetter: "HubRoutingPreferenceInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAddressPrefix", GoMethod: "ResetAddressPrefix"},
			_jsii_.MemberMethod{JsiiMethod: "resetBranchToBranchTrafficEnabled", GoMethod: "ResetBranchToBranchTrafficEnabled"},
			_jsii_.MemberMethod{JsiiMethod: "resetHubRoutingPreference", GoMethod: "ResetHubRoutingPreference"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetVirtualRouterAutoScaleMinCapacity", GoMethod: "ResetVirtualRouterAutoScaleMinCapacity"},
			_jsii_.MemberMethod{JsiiMethod: "resetVirtualWanId", GoMethod: "ResetVirtualWanId"},
			...
			_jsii_.MemberProperty{JsiiProperty: "virtualRouterAutoScaleMinCapacity", GoGetter: "VirtualRouterAutoScaleMinCapacity"},
			_jsii_.MemberProperty{JsiiProperty: "virtualRouterAutoScaleMinCapacityInput", GoGetter: "VirtualRouterAutoScaleMinCapacityInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "nextHopIpAddress", GoGetter: "NextHopIpAddress"},
			_jsii_.MemberProperty{JsiiProperty: "nextHopIpAddressInput", GoGetter: "NextHopIpAddressInput"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
