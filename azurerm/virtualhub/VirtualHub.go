...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/virtualhub/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.110.0/docs/resources/virtual_hub azurerm_virtual_hub}.
...
func (j *jsiiProxy_VirtualHub) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.110.0/docs/resources/virtual_hub azurerm_virtual_hub} Resource.
func NewVirtualHub(scope constructs.Construct, id *string, config *VirtualHubConfig) VirtualHub {
	_init_.Initialize()

	if err := validateNewVirtualHubParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_VirtualHub)SetCount(val interface{}) {
...
func (j *jsiiProxy_VirtualHub)SetVirtualWanId(val *string) {
	if err := j.validateSetVirtualWanIdParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func VirtualHub_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateVirtualHub_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func VirtualHub_IsConstruct(x interface{}) *bool {
	...
	if err := validateVirtualHub_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func VirtualHub_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateVirtualHub_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func VirtualHub_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateVirtualHub_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (v *jsiiProxy_VirtualHub) AddMoveTarget(moveTarget *string) {
...
func (v *jsiiProxy_VirtualHub) HasResourceMove() interface{} {
	var returns interface{}
...
func (v *jsiiProxy_VirtualHub) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (v *jsiiProxy_VirtualHub) MoveFromId(id *string) {
...
func (v *jsiiProxy_VirtualHub) MoveTo(moveTarget *string, index interface{}) {
...
func (v *jsiiProxy_VirtualHub) MoveToId(id *string) {
...
func (v *jsiiProxy_VirtualHub) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (v *jsiiProxy_VirtualHub) ToHclTerraform() interface{} {
	var returns interface{}
