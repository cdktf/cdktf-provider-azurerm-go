...
func (h *jsiiProxy_HdinsightHadoopClusterDiskEncryptionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HdinsightHadoopClusterDiskEncryptionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
