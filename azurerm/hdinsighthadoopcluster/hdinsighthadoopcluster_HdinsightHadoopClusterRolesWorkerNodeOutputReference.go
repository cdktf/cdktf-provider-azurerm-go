...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/hdinsighthadoopcluster/internal"
...
type HdinsightHadoopClusterRolesWorkerNodeOutputReference interface {
	...
	ScriptActions() HdinsightHadoopClusterRolesWorkerNodeScriptActionsList
...
func (j *jsiiProxy_HdinsightHadoopClusterRolesWorkerNodeOutputReference) ScriptActions() HdinsightHadoopClusterRolesWorkerNodeScriptActionsList {
	var returns HdinsightHadoopClusterRolesWorkerNodeScriptActionsList
	_jsii_.Get(
		j,
		"scriptActions",
		&returns,
...
func (j *jsiiProxy_HdinsightHadoopClusterRolesWorkerNodeOutputReference) ScriptActionsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"scriptActionsInput",
...
func NewHdinsightHadoopClusterRolesWorkerNodeOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) HdinsightHadoopClusterRolesWorkerNodeOutputReference {
	...
	if err := validateNewHdinsightHadoopClusterRolesWorkerNodeOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (h *jsiiProxy_HdinsightHadoopClusterRolesWorkerNodeOutputReference) PutScriptActions(value interface{}) {
...
func (h *jsiiProxy_HdinsightHadoopClusterRolesWorkerNodeOutputReference) ResetScriptActions() {
	_jsii_.InvokeVoid(
		h,
		"resetScriptActions",
		nil, // no parameters
