...
type HdinsightHadoopClusterRolesHeadNodeOutputReference interface {
	...
	ScriptActions() HdinsightHadoopClusterRolesHeadNodeScriptActionsList
...
func (j *jsiiProxy_HdinsightHadoopClusterRolesHeadNodeOutputReference) ScriptActions() HdinsightHadoopClusterRolesHeadNodeScriptActionsList {
	var returns HdinsightHadoopClusterRolesHeadNodeScriptActionsList
	_jsii_.Get(
		j,
		"scriptActions",
		&returns,
...
func (j *jsiiProxy_HdinsightHadoopClusterRolesHeadNodeOutputReference) ScriptActionsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"scriptActionsInput",
...
func NewHdinsightHadoopClusterRolesHeadNodeOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) HdinsightHadoopClusterRolesHeadNodeOutputReference {
	...
	if err := validateNewHdinsightHadoopClusterRolesHeadNodeOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (h *jsiiProxy_HdinsightHadoopClusterRolesHeadNodeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HdinsightHadoopClusterRolesHeadNodeOutputReference) PutScriptActions(value interface{}) {
...
func (h *jsiiProxy_HdinsightHadoopClusterRolesHeadNodeOutputReference) ResetScriptActions() {
	_jsii_.InvokeVoid(
		h,
		"resetScriptActions",
		nil, // no parameters
...
func (h *jsiiProxy_HdinsightHadoopClusterRolesHeadNodeOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
