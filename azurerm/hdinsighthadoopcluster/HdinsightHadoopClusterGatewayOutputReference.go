...
func NewHdinsightHadoopClusterGatewayOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) HdinsightHadoopClusterGatewayOutputReference {
	...
	if err := validateNewHdinsightHadoopClusterGatewayOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (h *jsiiProxy_HdinsightHadoopClusterGatewayOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HdinsightHadoopClusterGatewayOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
