...
func (j *jsiiProxy_ExpressRoutePortIdentityOutputReference) PrincipalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"principalId",
...
func (j *jsiiProxy_ExpressRoutePortIdentityOutputReference) TenantId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tenantId",
...
func NewExpressRoutePortIdentityOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) ExpressRoutePortIdentityOutputReference {
	...
	if err := validateNewExpressRoutePortIdentityOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_ExpressRoutePortIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_ExpressRoutePortIdentityOutputReference) ResetIdentityIds() {
	_jsii_.InvokeVoid(
		e,
		"resetIdentityIds",
		nil, // no parameters
...
func (e *jsiiProxy_ExpressRoutePortIdentityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
