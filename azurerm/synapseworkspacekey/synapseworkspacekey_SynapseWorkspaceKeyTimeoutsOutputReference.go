...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v3/synapseworkspacekey/internal"
...
func NewSynapseWorkspaceKeyTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) SynapseWorkspaceKeyTimeoutsOutputReference {
	...
	if err := validateNewSynapseWorkspaceKeyTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
