...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "customerManagedKeyName", GoGetter: "CustomerManagedKeyName"},
			_jsii_.MemberProperty{JsiiProperty: "customerManagedKeyNameInput", GoGetter: "CustomerManagedKeyNameInput"},
			_jsii_.MemberProperty{JsiiProperty: "customerManagedKeyVersionlessId", GoGetter: "CustomerManagedKeyVersionlessId"},
			_jsii_.MemberProperty{JsiiProperty: "customerManagedKeyVersionlessIdInput", GoGetter: "CustomerManagedKeyVersionlessIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetCustomerManagedKeyVersionlessId", GoMethod: "ResetCustomerManagedKeyVersionlessId"},
