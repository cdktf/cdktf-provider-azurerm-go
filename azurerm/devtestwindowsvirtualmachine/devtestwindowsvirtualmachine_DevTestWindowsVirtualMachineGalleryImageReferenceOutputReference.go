...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/devtestwindowsvirtualmachine/internal"
...
func NewDevTestWindowsVirtualMachineGalleryImageReferenceOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DevTestWindowsVirtualMachineGalleryImageReferenceOutputReference {
	...
	if err := validateNewDevTestWindowsVirtualMachineGalleryImageReferenceOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
