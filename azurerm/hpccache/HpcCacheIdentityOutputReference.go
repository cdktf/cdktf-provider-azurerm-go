...
func (j *jsiiProxy_HpcCacheIdentityOutputReference) PrincipalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"principalId",
...
func (j *jsiiProxy_HpcCacheIdentityOutputReference) TenantId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tenantId",
...
func NewHpcCacheIdentityOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) HpcCacheIdentityOutputReference {
	...
	if err := validateNewHpcCacheIdentityOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (h *jsiiProxy_HpcCacheIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HpcCacheIdentityOutputReference) ResetIdentityIds() {
	_jsii_.InvokeVoid(
		h,
		"resetIdentityIds",
		nil, // no parameters
...
func (h *jsiiProxy_HpcCacheIdentityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
