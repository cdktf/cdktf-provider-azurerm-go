...
func NewHpcCacheDnsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) HpcCacheDnsOutputReference {
	...
	if err := validateNewHpcCacheDnsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_HpcCacheDnsOutputReference)SetSearchDomain(val *string) {
	if err := j.validateSetSearchDomainParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (h *jsiiProxy_HpcCacheDnsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HpcCacheDnsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
