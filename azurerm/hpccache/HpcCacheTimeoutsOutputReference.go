...
func NewHpcCacheTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) HpcCacheTimeoutsOutputReference {
	...
	if err := validateNewHpcCacheTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (h *jsiiProxy_HpcCacheTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HpcCacheTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
