...
func (j *jsiiProxy_StreamAnalyticsJobIdentityOutputReference) IdentityIds() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"identityIds",
...
func (j *jsiiProxy_StreamAnalyticsJobIdentityOutputReference) IdentityIdsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"identityIdsInput",
...
func NewStreamAnalyticsJobIdentityOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) StreamAnalyticsJobIdentityOutputReference {
	...
	if err := validateNewStreamAnalyticsJobIdentityOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_StreamAnalyticsJobIdentityOutputReference)SetIdentityIds(val *[]*string) {
...
func (s *jsiiProxy_StreamAnalyticsJobIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StreamAnalyticsJobIdentityOutputReference) ResetIdentityIds() {
	_jsii_.InvokeVoid(
		s,
		"resetIdentityIds",
		nil, // no parameters
...
func (s *jsiiProxy_StreamAnalyticsJobIdentityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
