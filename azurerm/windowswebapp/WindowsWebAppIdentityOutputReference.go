...
func NewWindowsWebAppIdentityOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) WindowsWebAppIdentityOutputReference {
	...
	if err := validateNewWindowsWebAppIdentityOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (w *jsiiProxy_WindowsWebAppIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WindowsWebAppIdentityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
