...
type WindowsWebAppSiteConfigOutputReference interface {
	...
	HandlerMapping() WindowsWebAppSiteConfigHandlerMappingList
...
func (j *jsiiProxy_WindowsWebAppSiteConfigOutputReference) HandlerMapping() WindowsWebAppSiteConfigHandlerMappingList {
	var returns WindowsWebAppSiteConfigHandlerMappingList
	_jsii_.Get(
		j,
		"handlerMapping",
		&returns,
...
func (j *jsiiProxy_WindowsWebAppSiteConfigOutputReference) HandlerMappingInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"handlerMappingInput",
...
func NewWindowsWebAppSiteConfigOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) WindowsWebAppSiteConfigOutputReference {
	...
	if err := validateNewWindowsWebAppSiteConfigOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (w *jsiiProxy_WindowsWebAppSiteConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WindowsWebAppSiteConfigOutputReference) PutHandlerMapping(value interface{}) {
...
func (w *jsiiProxy_WindowsWebAppSiteConfigOutputReference) ResetHandlerMapping() {
	_jsii_.InvokeVoid(
		w,
		"resetHandlerMapping",
		nil, // no parameters
...
func (w *jsiiProxy_WindowsWebAppSiteConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
