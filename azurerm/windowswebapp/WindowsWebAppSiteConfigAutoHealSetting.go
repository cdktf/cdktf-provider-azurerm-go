...
type WindowsWebAppSiteConfigAutoHealSetting struct {
	...
	// trigger block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.8.0/docs/resources/windows_web_app#trigger WindowsWebApp#trigger}
