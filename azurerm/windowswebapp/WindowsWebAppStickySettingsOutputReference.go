...
func NewWindowsWebAppStickySettingsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) WindowsWebAppStickySettingsOutputReference {
	...
	if err := validateNewWindowsWebAppStickySettingsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (w *jsiiProxy_WindowsWebAppStickySettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WindowsWebAppStickySettingsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
