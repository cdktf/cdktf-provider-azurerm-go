...
func (w *jsiiProxy_WindowsWebAppLogsApplicationLogsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WindowsWebAppLogsApplicationLogsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
