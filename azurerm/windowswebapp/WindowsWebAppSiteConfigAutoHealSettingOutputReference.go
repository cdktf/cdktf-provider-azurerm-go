...
func NewWindowsWebAppSiteConfigAutoHealSettingOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) WindowsWebAppSiteConfigAutoHealSettingOutputReference {
	...
	if err := validateNewWindowsWebAppSiteConfigAutoHealSettingOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (w *jsiiProxy_WindowsWebAppSiteConfigAutoHealSettingOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WindowsWebAppSiteConfigAutoHealSettingOutputReference) PutTrigger(value *WindowsWebAppSiteConfigAutoHealSettingTrigger) {
	if err := w.validatePutTriggerParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		w,
...
func (w *jsiiProxy_WindowsWebAppSiteConfigAutoHealSettingOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
