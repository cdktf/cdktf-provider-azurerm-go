...
func NewWindowsWebAppTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) WindowsWebAppTimeoutsOutputReference {
	...
	if err := validateNewWindowsWebAppTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (w *jsiiProxy_WindowsWebAppTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WindowsWebAppTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
