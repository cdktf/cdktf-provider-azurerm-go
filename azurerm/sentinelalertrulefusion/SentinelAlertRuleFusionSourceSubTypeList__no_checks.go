...
func (s *jsiiProxy_SentinelAlertRuleFusionSourceSubTypeList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}
...
func (s *jsiiProxy_SentinelAlertRuleFusionSourceSubTypeList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
