...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "autoTracking", GoGetter: "AutoTracking"},
			_jsii_.MemberProperty{JsiiProperty: "autoTrackingInput", GoGetter: "AutoTrackingInput"},
			_jsii_.MemberProperty{JsiiProperty: "cdktfStack", GoGetter: "CdktfStack"},
			_jsii_.MemberProperty{JsiiProperty: "connection", GoGetter: "Connection"},
			_jsii_.MemberProperty{JsiiProperty: "constructNodeMetadata", GoGetter: "ConstructNodeMetadata"},
			_jsii_.MemberProperty{JsiiProperty: "count", GoGetter: "Count"},
			_jsii_.MemberProperty{JsiiProperty: "dependsOn", GoGetter: "DependsOn"},
			_jsii_.MemberProperty{JsiiProperty: "eventHubUri", GoGetter: "EventHubUri"},
			_jsii_.MemberProperty{JsiiProperty: "eventHubUriInput", GoGetter: "EventHubUriInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "minimumElevationDegrees", GoGetter: "MinimumElevationDegrees"},
			_jsii_.MemberProperty{JsiiProperty: "minimumElevationDegreesInput", GoGetter: "MinimumElevationDegreesInput"},
			_jsii_.MemberProperty{JsiiProperty: "minimumVariableContactDuration", GoGetter: "MinimumVariableContactDuration"},
			_jsii_.MemberProperty{JsiiProperty: "minimumVariableContactDurationInput", GoGetter: "MinimumVariableContactDurationInput"},
			_jsii_.MemberMethod{JsiiMethod: "moveFromId", GoMethod: "MoveFromId"},
			_jsii_.MemberMethod{JsiiMethod: "moveTo", GoMethod: "MoveTo"},
			_jsii_.MemberMethod{JsiiMethod: "moveToId", GoMethod: "MoveToId"},
			_jsii_.MemberProperty{JsiiProperty: "name", GoGetter: "Name"},
			_jsii_.MemberProperty{JsiiProperty: "nameInput", GoGetter: "NameInput"},
			_jsii_.MemberProperty{JsiiProperty: "networkConfigurationSubnetId", GoGetter: "NetworkConfigurationSubnetId"},
			_jsii_.MemberProperty{JsiiProperty: "networkConfigurationSubnetIdInput", GoGetter: "NetworkConfigurationSubnetIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetEventHubUri", GoMethod: "ResetEventHubUri"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetMinimumElevationDegrees", GoMethod: "ResetMinimumElevationDegrees"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_OrbitalContactProfileLinksChannelsList{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexList)
			return &j
		},
	)
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "bandwidthMhzInput", GoGetter: "BandwidthMhzInput"},
			_jsii_.MemberProperty{JsiiProperty: "centerFrequencyMhz", GoGetter: "CenterFrequencyMhz"},
			_jsii_.MemberProperty{JsiiProperty: "centerFrequencyMhzInput", GoGetter: "CenterFrequencyMhzInput"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "demodulationConfiguration", GoGetter: "DemodulationConfiguration"},
			_jsii_.MemberProperty{JsiiProperty: "demodulationConfigurationInput", GoGetter: "DemodulationConfigurationInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "modulationConfiguration", GoGetter: "ModulationConfiguration"},
			_jsii_.MemberProperty{JsiiProperty: "modulationConfigurationInput", GoGetter: "ModulationConfigurationInput"},
			_jsii_.MemberProperty{JsiiProperty: "name", GoGetter: "Name"},
			_jsii_.MemberProperty{JsiiProperty: "nameInput", GoGetter: "NameInput"},
			_jsii_.MemberMethod{JsiiMethod: "putEndPoint", GoMethod: "PutEndPoint"},
			_jsii_.MemberMethod{JsiiMethod: "resetDemodulationConfiguration", GoMethod: "ResetDemodulationConfiguration"},
			_jsii_.MemberMethod{JsiiMethod: "resetModulationConfiguration", GoMethod: "ResetModulationConfiguration"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		...
		func() interface{} {
			j := jsiiProxy_OrbitalContactProfileLinksChannelsOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "name", GoGetter: "Name"},
			_jsii_.MemberProperty{JsiiProperty: "nameInput", GoGetter: "NameInput"},
			_jsii_.MemberProperty{JsiiProperty: "polarization", GoGetter: "Polarization"},
			_jsii_.MemberProperty{JsiiProperty: "polarizationInput", GoGetter: "PolarizationInput"},
			_jsii_.MemberMethod{JsiiMethod: "putChannels", GoMethod: "PutChannels"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		...
		func() interface{} {
			j := jsiiProxy_OrbitalContactProfileLinksOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
