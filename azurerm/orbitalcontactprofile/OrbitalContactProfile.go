...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.113.0/docs/resources/orbital_contact_profile azurerm_orbital_contact_profile}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.113.0/docs/resources/orbital_contact_profile azurerm_orbital_contact_profile} Resource.
...
func OrbitalContactProfile_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateOrbitalContactProfile_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (o *jsiiProxy_OrbitalContactProfile) AddMoveTarget(moveTarget *string) {
...
func (o *jsiiProxy_OrbitalContactProfile) HasResourceMove() interface{} {
	var returns interface{}
...
func (o *jsiiProxy_OrbitalContactProfile) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (o *jsiiProxy_OrbitalContactProfile) MoveFromId(id *string) {
...
func (o *jsiiProxy_OrbitalContactProfile) MoveTo(moveTarget *string, index interface{}) {
...
func (o *jsiiProxy_OrbitalContactProfile) MoveToId(id *string) {
...
func (o *jsiiProxy_OrbitalContactProfile) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (o *jsiiProxy_OrbitalContactProfile) ToHclTerraform() interface{} {
	var returns interface{}
