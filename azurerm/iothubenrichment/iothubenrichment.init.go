...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "endpointNames", GoGetter: "EndpointNames"},
			_jsii_.MemberProperty{JsiiProperty: "endpointNamesInput", GoGetter: "EndpointNamesInput"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_IothubEnrichmentTimeoutsOutputReference{}
