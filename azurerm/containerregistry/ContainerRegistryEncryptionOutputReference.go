...
func NewContainerRegistryEncryptionOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ContainerRegistryEncryptionOutputReference {
	...
	if err := validateNewContainerRegistryEncryptionOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_ContainerRegistryEncryptionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ContainerRegistryEncryptionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
