...
func NewContainerRegistryEncryptionList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ContainerRegistryEncryptionList {
	...
	if err := validateNewContainerRegistryEncryptionListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_ContainerRegistryEncryptionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ContainerRegistryEncryptionList) Resolve(context cdktf.IResolveContext) interface{} {
