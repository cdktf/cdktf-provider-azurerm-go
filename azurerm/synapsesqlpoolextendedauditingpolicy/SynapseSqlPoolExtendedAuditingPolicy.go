...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/synapsesqlpoolextendedauditingpolicy/internal"
...
func (j *jsiiProxy_SynapseSqlPoolExtendedAuditingPolicy) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_SynapseSqlPoolExtendedAuditingPolicy)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
