...
func (w *jsiiProxy_WebPubsubHubEventListenerOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WebPubsubHubEventListenerOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
