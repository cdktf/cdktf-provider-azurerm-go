...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "anonymousConnectionsEnabled", GoGetter: "AnonymousConnectionsEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "anonymousConnectionsEnabledInput", GoGetter: "AnonymousConnectionsEnabledInput"},
			_jsii_.MemberProperty{JsiiProperty: "cdktfStack", GoGetter: "CdktfStack"},
			_jsii_.MemberProperty{JsiiProperty: "connection", GoGetter: "Connection"},
			_jsii_.MemberProperty{JsiiProperty: "constructNodeMetadata", GoGetter: "ConstructNodeMetadata"},
			_jsii_.MemberProperty{JsiiProperty: "count", GoGetter: "Count"},
			_jsii_.MemberProperty{JsiiProperty: "dependsOn", GoGetter: "DependsOn"},
			_jsii_.MemberProperty{JsiiProperty: "eventHandler", GoGetter: "EventHandler"},
			_jsii_.MemberProperty{JsiiProperty: "eventHandlerInput", GoGetter: "EventHandlerInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putEventHandler", GoMethod: "PutEventHandler"},
			_jsii_.MemberMethod{JsiiMethod: "putTimeouts", GoMethod: "PutTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetAnonymousConnectionsEnabled", GoMethod: "ResetAnonymousConnectionsEnabled"},
			_jsii_.MemberMethod{JsiiMethod: "resetEventHandler", GoMethod: "ResetEventHandler"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_WebPubsubHubEventHandlerList{}
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSystemEvents", GoMethod: "ResetSystemEvents"},
			_jsii_.MemberMethod{JsiiMethod: "resetUserEventPattern", GoMethod: "ResetUserEventPattern"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "systemEvents", GoGetter: "SystemEvents"},
			_jsii_.MemberProperty{JsiiProperty: "systemEventsInput", GoGetter: "SystemEventsInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
			...
			_jsii_.MemberProperty{JsiiProperty: "userEventPattern", GoGetter: "UserEventPattern"},
			_jsii_.MemberProperty{JsiiProperty: "userEventPatternInput", GoGetter: "UserEventPatternInput"},
		},
		func() interface{} {
