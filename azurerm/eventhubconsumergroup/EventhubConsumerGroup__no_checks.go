...
func (e *jsiiProxy_EventhubConsumerGroup) validateAddMoveTargetParameters(moveTarget *string) error {
	return nil
}
...
func (e *jsiiProxy_EventhubConsumerGroup) validateImportFromParameters(id *string) error {
	return nil
}
...
func (e *jsiiProxy_EventhubConsumerGroup) validateMoveFromIdParameters(id *string) error {
	return nil
}

func (e *jsiiProxy_EventhubConsumerGroup) validateMoveToParameters(moveTarget *string, index interface{}) error {
	return nil
}

func (e *jsiiProxy_EventhubConsumerGroup) validateMoveToIdParameters(id *string) error {
	return nil
}
...
func validateEventhubConsumerGroup_GenerateConfigForImportParameters(scope constructs.Construct, importToId *string, importFromId *string) error {
	return nil
}
...
func validateEventhubConsumerGroup_IsTerraformElementParameters(x interface{}) error {
	return nil
}

func validateEventhubConsumerGroup_IsTerraformResourceParameters(x interface{}) error {
	return nil
}
...
func (j *jsiiProxy_EventhubConsumerGroup) validateSetCountParameters(val interface{}) error {
	return nil
}
