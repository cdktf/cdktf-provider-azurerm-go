...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "jobAgentId", GoGetter: "JobAgentId"},
			_jsii_.MemberProperty{JsiiProperty: "jobAgentIdInput", GoGetter: "JobAgentIdInput"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_MssqlJobTimeoutsOutputReference{}
