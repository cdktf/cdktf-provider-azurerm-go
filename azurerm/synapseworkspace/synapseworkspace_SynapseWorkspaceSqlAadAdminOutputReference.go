...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v3/synapseworkspace/internal"
...
func NewSynapseWorkspaceSqlAadAdminOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) SynapseWorkspaceSqlAadAdminOutputReference {
	...
	if err := validateNewSynapseWorkspaceSqlAadAdminOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
