...
func NewSynapseWorkspaceAadAdminList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SynapseWorkspaceAadAdminList {
	...
	if err := validateNewSynapseWorkspaceAadAdminListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SynapseWorkspaceAadAdminList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
