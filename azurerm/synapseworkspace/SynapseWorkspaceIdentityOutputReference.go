...
func (j *jsiiProxy_SynapseWorkspaceIdentityOutputReference) IdentityIds() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"identityIds",
...
func (j *jsiiProxy_SynapseWorkspaceIdentityOutputReference) IdentityIdsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"identityIdsInput",
...
func NewSynapseWorkspaceIdentityOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) SynapseWorkspaceIdentityOutputReference {
	...
	if err := validateNewSynapseWorkspaceIdentityOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_SynapseWorkspaceIdentityOutputReference)SetIdentityIds(val *[]*string) {
...
func (s *jsiiProxy_SynapseWorkspaceIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SynapseWorkspaceIdentityOutputReference) ResetIdentityIds() {
	_jsii_.InvokeVoid(
		s,
		"resetIdentityIds",
		nil, // no parameters
...
func (s *jsiiProxy_SynapseWorkspaceIdentityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
