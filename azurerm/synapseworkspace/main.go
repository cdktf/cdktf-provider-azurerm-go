...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "computeSubnetId", GoGetter: "ComputeSubnetId"},
			_jsii_.MemberProperty{JsiiProperty: "computeSubnetIdInput", GoGetter: "ComputeSubnetIdInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "dataExfiltrationProtectionEnabled", GoGetter: "DataExfiltrationProtectionEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "dataExfiltrationProtectionEnabledInput", GoGetter: "DataExfiltrationProtectionEnabledInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "githubRepo", GoGetter: "GithubRepo"},
			_jsii_.MemberProperty{JsiiProperty: "githubRepoInput", GoGetter: "GithubRepoInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "linkingAllowedForAadTenantIdsInput", GoGetter: "LinkingAllowedForAadTenantIdsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDataExfiltrationProtectionEnabled", GoMethod: "ResetDataExfiltrationProtectionEnabled"},
			_jsii_.MemberMethod{JsiiMethod: "resetGithubRepo", GoMethod: "ResetGithubRepo"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetIdentity", GoMethod: "ResetIdentity"},
			_jsii_.MemberMethod{JsiiMethod: "resetLinkingAllowedForAadTenantIds", GoMethod: "ResetLinkingAllowedForAadTenantIds"},
			_jsii_.MemberMethod{JsiiMethod: "resetManagedResourceGroupName", GoMethod: "ResetManagedResourceGroupName"},
			_jsii_.MemberMethod{JsiiMethod: "resetManagedVirtualNetworkEnabled", GoMethod: "ResetManagedVirtualNetworkEnabled"},
			...
			_jsii_.MemberProperty{JsiiProperty: "sqlAdministratorLoginPasswordInput", GoGetter: "SqlAdministratorLoginPasswordInput"},
			_jsii_.MemberProperty{JsiiProperty: "sqlIdentityControlEnabled", GoGetter: "SqlIdentityControlEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "sqlIdentityControlEnabledInput", GoGetter: "SqlIdentityControlEnabledInput"},
			_jsii_.MemberProperty{JsiiProperty: "storageDataLakeGen2FilesystemId", GoGetter: "StorageDataLakeGen2FilesystemId"},
			_jsii_.MemberProperty{JsiiProperty: "storageDataLakeGen2FilesystemIdInput", GoGetter: "StorageDataLakeGen2FilesystemIdInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "rootFolderInput", GoGetter: "RootFolderInput"},
			_jsii_.MemberProperty{JsiiProperty: "tenantId", GoGetter: "TenantId"},
			_jsii_.MemberProperty{JsiiProperty: "tenantIdInput", GoGetter: "TenantIdInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "gitUrlInput", GoGetter: "GitUrlInput"},
			_jsii_.MemberProperty{JsiiProperty: "internalValue", GoGetter: "InternalValue"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "lastCommitId", GoGetter: "LastCommitId"},
			...
			_jsii_.MemberProperty{JsiiProperty: "repositoryName", GoGetter: "RepositoryName"},
			_jsii_.MemberProperty{JsiiProperty: "repositoryNameInput", GoGetter: "RepositoryNameInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetGitUrl", GoMethod: "ResetGitUrl"},
			_jsii_.MemberMethod{JsiiMethod: "resetLastCommitId", GoMethod: "ResetLastCommitId"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "rootFolder", GoGetter: "RootFolder"},
			_jsii_.MemberProperty{JsiiProperty: "rootFolderInput", GoGetter: "RootFolderInput"},
