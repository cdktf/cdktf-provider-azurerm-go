...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v3/dataazurermautomationvariableint/internal"
...
func NewDataAzurermAutomationVariableIntTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DataAzurermAutomationVariableIntTimeoutsOutputReference {
	...
	if err := validateNewDataAzurermAutomationVariableIntTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
