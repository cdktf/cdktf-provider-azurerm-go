...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSubplan", GoMethod: "ResetSubplan"},
			...
			_jsii_.MemberProperty{JsiiProperty: "subplan", GoGetter: "Subplan"},
			_jsii_.MemberProperty{JsiiProperty: "subplanInput", GoGetter: "SubplanInput"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_SecurityCenterSubscriptionPricingExtensionList{}
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "additionalExtensionPropertiesInput", GoGetter: "AdditionalExtensionPropertiesInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAdditionalExtensionProperties", GoMethod: "ResetAdditionalExtensionProperties"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_SecurityCenterSubscriptionPricingTimeoutsOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
