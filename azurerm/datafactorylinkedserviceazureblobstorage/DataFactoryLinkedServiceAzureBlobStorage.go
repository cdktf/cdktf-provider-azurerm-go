...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/datafactorylinkedserviceazureblobstorage/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.102.0/docs/resources/data_factory_linked_service_azure_blob_storage azurerm_data_factory_linked_service_azure_blob_storage}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.102.0/docs/resources/data_factory_linked_service_azure_blob_storage azurerm_data_factory_linked_service_azure_blob_storage} Resource.
func NewDataFactoryLinkedServiceAzureBlobStorage(scope constructs.Construct, id *string, config *DataFactoryLinkedServiceAzureBlobStorageConfig) DataFactoryLinkedServiceAzureBlobStorage {
	...
	if err := validateNewDataFactoryLinkedServiceAzureBlobStorageParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataFactoryLinkedServiceAzureBlobStorage)SetSasUri(val *string) {
	if err := j.validateSetSasUriParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_DataFactoryLinkedServiceAzureBlobStorage)SetServiceEndpoint(val *string) {
	if err := j.validateSetServiceEndpointParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func DataFactoryLinkedServiceAzureBlobStorage_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataFactoryLinkedServiceAzureBlobStorage_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataFactoryLinkedServiceAzureBlobStorage_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataFactoryLinkedServiceAzureBlobStorage_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataFactoryLinkedServiceAzureBlobStorage_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataFactoryLinkedServiceAzureBlobStorage_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataFactoryLinkedServiceAzureBlobStorage) HasResourceMove() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataFactoryLinkedServiceAzureBlobStorage) MoveFromId(id *string) {
...
func (d *jsiiProxy_DataFactoryLinkedServiceAzureBlobStorage) MoveToId(id *string) {
...
func (d *jsiiProxy_DataFactoryLinkedServiceAzureBlobStorage) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataFactoryLinkedServiceAzureBlobStorage) ToHclTerraform() interface{} {
	var returns interface{}
