...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/mysqlvirtualnetworkrule/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.100.0/docs/resources/mysql_virtual_network_rule azurerm_mysql_virtual_network_rule}.
...
func (j *jsiiProxy_MysqlVirtualNetworkRule) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.100.0/docs/resources/mysql_virtual_network_rule azurerm_mysql_virtual_network_rule} Resource.
func NewMysqlVirtualNetworkRule(scope constructs.Construct, id *string, config *MysqlVirtualNetworkRuleConfig) MysqlVirtualNetworkRule {
	...
	if err := validateNewMysqlVirtualNetworkRuleParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_MysqlVirtualNetworkRule)SetCount(val interface{}) {
...
func MysqlVirtualNetworkRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateMysqlVirtualNetworkRule_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func MysqlVirtualNetworkRule_IsConstruct(x interface{}) *bool {
	...
	if err := validateMysqlVirtualNetworkRule_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func MysqlVirtualNetworkRule_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateMysqlVirtualNetworkRule_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func MysqlVirtualNetworkRule_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateMysqlVirtualNetworkRule_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (m *jsiiProxy_MysqlVirtualNetworkRule) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_MysqlVirtualNetworkRule) HasResourceMove() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_MysqlVirtualNetworkRule) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (m *jsiiProxy_MysqlVirtualNetworkRule) MoveFromId(id *string) {
...
func (m *jsiiProxy_MysqlVirtualNetworkRule) MoveTo(moveTarget *string, index interface{}) {
...
func (m *jsiiProxy_MysqlVirtualNetworkRule) MoveToId(id *string) {
...
func (m *jsiiProxy_MysqlVirtualNetworkRule) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (m *jsiiProxy_MysqlVirtualNetworkRule) ToHclTerraform() interface{} {
	var returns interface{}
