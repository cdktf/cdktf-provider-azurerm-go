...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v3/mysqlflexibleserverfirewallrule/internal"
...
func NewMysqlFlexibleServerFirewallRuleTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) MysqlFlexibleServerFirewallRuleTimeoutsOutputReference {
	...
	if err := validateNewMysqlFlexibleServerFirewallRuleTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
