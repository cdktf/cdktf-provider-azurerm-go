...
func NewLogicAppWorkflowAccessControlActionOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) LogicAppWorkflowAccessControlActionOutputReference {
	...
	if err := validateNewLogicAppWorkflowAccessControlActionOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LogicAppWorkflowAccessControlActionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LogicAppWorkflowAccessControlActionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
