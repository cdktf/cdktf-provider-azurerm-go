...
func NewLogicAppWorkflowIdentityOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) LogicAppWorkflowIdentityOutputReference {
	...
	if err := validateNewLogicAppWorkflowIdentityOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LogicAppWorkflowIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LogicAppWorkflowIdentityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
