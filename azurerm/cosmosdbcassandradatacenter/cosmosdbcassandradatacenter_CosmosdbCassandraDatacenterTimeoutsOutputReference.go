...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/cosmosdbcassandradatacenter/internal"
...
func NewCosmosdbCassandraDatacenterTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) CosmosdbCassandraDatacenterTimeoutsOutputReference {
	...
	if err := validateNewCosmosdbCassandraDatacenterTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
