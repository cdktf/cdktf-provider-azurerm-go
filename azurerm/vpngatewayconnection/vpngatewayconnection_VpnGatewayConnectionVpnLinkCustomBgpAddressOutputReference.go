...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/vpngatewayconnection/internal"
...
func NewVpnGatewayConnectionVpnLinkCustomBgpAddressOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) VpnGatewayConnectionVpnLinkCustomBgpAddressOutputReference {
	...
	if err := validateNewVpnGatewayConnectionVpnLinkCustomBgpAddressOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
