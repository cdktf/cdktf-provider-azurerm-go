...
func NewVpnGatewayConnectionVpnLinkList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VpnGatewayConnectionVpnLinkList {
	...
	if err := validateNewVpnGatewayConnectionVpnLinkListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (v *jsiiProxy_VpnGatewayConnectionVpnLinkList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VpnGatewayConnectionVpnLinkList) Resolve(context cdktf.IResolveContext) interface{} {
