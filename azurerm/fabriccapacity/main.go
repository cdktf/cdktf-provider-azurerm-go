...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "administrationMembers", GoGetter: "AdministrationMembers"},
			_jsii_.MemberProperty{JsiiProperty: "administrationMembersInput", GoGetter: "AdministrationMembersInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAdministrationMembers", GoMethod: "ResetAdministrationMembers"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_FabricCapacitySkuOutputReference{}
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_FabricCapacityTimeoutsOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
