...
func NewMonitorActionGroupLogicAppReceiverList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MonitorActionGroupLogicAppReceiverList {
	...
	if err := validateNewMonitorActionGroupLogicAppReceiverListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_MonitorActionGroupLogicAppReceiverList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MonitorActionGroupLogicAppReceiverList) Resolve(context cdktf.IResolveContext) interface{} {
