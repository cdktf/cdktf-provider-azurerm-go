...
func NewMonitorActionGroupAzureFunctionReceiverList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MonitorActionGroupAzureFunctionReceiverList {
	...
	if err := validateNewMonitorActionGroupAzureFunctionReceiverListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_MonitorActionGroupAzureFunctionReceiverList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MonitorActionGroupAzureFunctionReceiverList) Resolve(context cdktf.IResolveContext) interface{} {
