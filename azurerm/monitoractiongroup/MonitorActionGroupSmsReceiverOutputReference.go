...
func NewMonitorActionGroupSmsReceiverOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) MonitorActionGroupSmsReceiverOutputReference {
	...
	if err := validateNewMonitorActionGroupSmsReceiverOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_MonitorActionGroupSmsReceiverOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MonitorActionGroupSmsReceiverOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
