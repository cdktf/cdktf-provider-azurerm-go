...
func NewMonitorActionGroupAzureAppPushReceiverOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) MonitorActionGroupAzureAppPushReceiverOutputReference {
	...
	if err := validateNewMonitorActionGroupAzureAppPushReceiverOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_MonitorActionGroupAzureAppPushReceiverOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MonitorActionGroupAzureAppPushReceiverOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
