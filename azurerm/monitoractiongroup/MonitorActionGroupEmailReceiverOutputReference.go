...
func NewMonitorActionGroupEmailReceiverOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) MonitorActionGroupEmailReceiverOutputReference {
	...
	if err := validateNewMonitorActionGroupEmailReceiverOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_MonitorActionGroupEmailReceiverOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MonitorActionGroupEmailReceiverOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
