...
func NewDataAzurermSharedImageVersionsImagesList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermSharedImageVersionsImagesList {
	...
	if err := validateNewDataAzurermSharedImageVersionsImagesListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAzurermSharedImageVersionsImagesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermSharedImageVersionsImagesList) Resolve(context cdktf.IResolveContext) interface{} {
