...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/dataazurermsharedimageversions/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.113.0/docs/data-sources/shared_image_versions azurerm_shared_image_versions} Data Source.
func NewDataAzurermSharedImageVersions(scope constructs.Construct, id *string, config *DataAzurermSharedImageVersionsConfig) DataAzurermSharedImageVersions {
	...
	if err := validateNewDataAzurermSharedImageVersionsParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAzurermSharedImageVersions_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateDataAzurermSharedImageVersions_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataAzurermSharedImageVersions_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAzurermSharedImageVersions_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func DataAzurermSharedImageVersions_IsTerraformDataSource(x interface{}) *bool {
	...
	if err := validateDataAzurermSharedImageVersions_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func DataAzurermSharedImageVersions_IsTerraformElement(x interface{}) *bool {
	...
	if err := validateDataAzurermSharedImageVersions_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAzurermSharedImageVersions) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAzurermSharedImageVersions) ToHclTerraform() interface{} {
	var returns interface{}
