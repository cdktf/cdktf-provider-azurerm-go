...
func NewDataAzurermSharedImageVersionsTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DataAzurermSharedImageVersionsTimeoutsOutputReference {
	...
	if err := validateNewDataAzurermSharedImageVersionsTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAzurermSharedImageVersionsTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAzurermSharedImageVersionsTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
