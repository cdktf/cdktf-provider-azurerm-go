...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/mssqlmanagedinstance/internal"
...
func (j *jsiiProxy_MssqlManagedInstanceIdentityOutputReference) IdentityIds() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"identityIds",
...
func (j *jsiiProxy_MssqlManagedInstanceIdentityOutputReference) IdentityIdsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"identityIdsInput",
...
func NewMssqlManagedInstanceIdentityOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) MssqlManagedInstanceIdentityOutputReference {
	...
	if err := validateNewMssqlManagedInstanceIdentityOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_MssqlManagedInstanceIdentityOutputReference)SetIdentityIds(val *[]*string) {
...
func (m *jsiiProxy_MssqlManagedInstanceIdentityOutputReference) ResetIdentityIds() {
	_jsii_.InvokeVoid(
		m,
		"resetIdentityIds",
		nil, // no parameters
