...
func (d *jsiiProxy_DataAzurermMobileNetworkServicePccRuleQosPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAzurermMobileNetworkServicePccRuleQosPolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
