...
func (d *jsiiProxy_DataAzurermMobileNetworkServicePccRuleQosPolicyMaximumBitRateOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAzurermMobileNetworkServicePccRuleQosPolicyMaximumBitRateOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
