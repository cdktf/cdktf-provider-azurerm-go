...
func (c *jsiiProxy_ContainerAppTemplateContainerLivenessProbeOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ContainerAppTemplateContainerLivenessProbeOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
