...
func (c *jsiiProxy_ContainerAppTemplateVolumeList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}
...
func (c *jsiiProxy_ContainerAppTemplateVolumeList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
