...
type ContainerAppConfig struct {
	...
	// template block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.88.0/docs/resources/container_app#template ContainerApp#template}
