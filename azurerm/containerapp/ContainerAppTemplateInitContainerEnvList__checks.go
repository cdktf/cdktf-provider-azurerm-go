...
func (c *jsiiProxy_ContainerAppTemplateInitContainerEnvList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (c *jsiiProxy_ContainerAppTemplateInitContainerEnvList) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_ContainerAppTemplateInitContainerEnvList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_ContainerAppTemplateInitContainerEnvList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
