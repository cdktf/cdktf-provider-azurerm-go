...
func (j *jsiiProxy_ContainerAppTemplateAzureQueueScaleRuleAuthenticationList) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*ContainerAppTemplateAzureQueueScaleRuleAuthentication; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_ContainerAppTemplateAzureQueueScaleRuleAuthenticationList) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewContainerAppTemplateAzureQueueScaleRuleAuthenticationListParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
