...
type ContainerAppTemplateOutputReference interface {
	...
	Container() ContainerAppTemplateContainerOutputReference
	ContainerInput() *ContainerAppTemplateContainer
	...
	PutContainer(value *ContainerAppTemplateContainer)
...
func (j *jsiiProxy_ContainerAppTemplateOutputReference) Container() ContainerAppTemplateContainerOutputReference {
...
func (j *jsiiProxy_ContainerAppTemplateOutputReference) ContainerInput() *ContainerAppTemplateContainer {
...
func (c *jsiiProxy_ContainerAppTemplateOutputReference) PutContainer(value *ContainerAppTemplateContainer) {
