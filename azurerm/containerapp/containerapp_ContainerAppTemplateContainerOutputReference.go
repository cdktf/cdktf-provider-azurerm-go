...
type ContainerAppTemplateContainerOutputReference interface {
	...
	SetImage(val *string)
	ImageInput() *string
	InternalValue() *ContainerAppTemplateContainer
	SetInternalValue(val *ContainerAppTemplateContainer)
...
func (j *jsiiProxy_ContainerAppTemplateContainerOutputReference) InternalValue() *ContainerAppTemplateContainer {
	var returns *ContainerAppTemplateContainer
	_jsii_.Get(
		j,
		"internalValue",
		&returns,
...
func NewContainerAppTemplateContainerOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) ContainerAppTemplateContainerOutputReference {
	_init_.Initialize()

	if err := validateNewContainerAppTemplateContainerOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func NewContainerAppTemplateContainerOutputReference_Override(c ContainerAppTemplateContainerOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_ContainerAppTemplateContainerOutputReference)SetInternalValue(val *ContainerAppTemplateContainer) {
...
func (c *jsiiProxy_ContainerAppTemplateContainerOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ContainerAppTemplateContainerOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
