...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/sentinelalertrulescheduled/internal"
...
func NewSentinelAlertRuleScheduledEventGroupingOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) SentinelAlertRuleScheduledEventGroupingOutputReference {
	...
	if err := validateNewSentinelAlertRuleScheduledEventGroupingOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
