...
func (s *jsiiProxy_SentinelAlertRuleScheduledIncidentGroupingOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SentinelAlertRuleScheduledIncidentGroupingOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
