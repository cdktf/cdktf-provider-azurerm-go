...
func NewFrontdoorTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) FrontdoorTimeoutsOutputReference {
	...
	if err := validateNewFrontdoorTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (f *jsiiProxy_FrontdoorTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FrontdoorTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
