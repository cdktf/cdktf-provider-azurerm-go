...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/frontdoor/internal"
...
func NewFrontdoorBackendPoolHealthProbeOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) FrontdoorBackendPoolHealthProbeOutputReference {
	...
	if err := validateNewFrontdoorBackendPoolHealthProbeOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_FrontdoorBackendPoolHealthProbeOutputReference)SetProbeMethod(val *string) {
	if err := j.validateSetProbeMethodParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
