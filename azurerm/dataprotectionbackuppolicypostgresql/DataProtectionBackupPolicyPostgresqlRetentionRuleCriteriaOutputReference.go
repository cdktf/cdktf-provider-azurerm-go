...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/dataprotectionbackuppolicypostgresql/internal"
...
func (d *jsiiProxy_DataProtectionBackupPolicyPostgresqlRetentionRuleCriteriaOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataProtectionBackupPolicyPostgresqlRetentionRuleCriteriaOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
