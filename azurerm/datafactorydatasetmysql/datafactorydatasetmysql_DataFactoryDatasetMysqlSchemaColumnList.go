...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/datafactorydatasetmysql/internal"
...
func NewDataFactoryDatasetMysqlSchemaColumnList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataFactoryDatasetMysqlSchemaColumnList {
	...
	if err := validateNewDataFactoryDatasetMysqlSchemaColumnListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
