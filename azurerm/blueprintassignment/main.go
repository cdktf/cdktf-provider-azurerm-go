...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*BlueprintAssignment)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "lockExcludeActions", GoGetter: "LockExcludeActions"},
			_jsii_.MemberProperty{JsiiProperty: "lockExcludeActionsInput", GoGetter: "LockExcludeActionsInput"},
			_jsii_.MemberProperty{JsiiProperty: "lockExcludePrincipals", GoGetter: "LockExcludePrincipals"},
			_jsii_.MemberProperty{JsiiProperty: "lockExcludePrincipalsInput", GoGetter: "LockExcludePrincipalsInput"},
			_jsii_.MemberProperty{JsiiProperty: "lockMode", GoGetter: "LockMode"},
			_jsii_.MemberProperty{JsiiProperty: "lockModeInput", GoGetter: "LockModeInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetLockExcludeActions", GoMethod: "ResetLockExcludeActions"},
			_jsii_.MemberMethod{JsiiMethod: "resetLockExcludePrincipals", GoMethod: "ResetLockExcludePrincipals"},
			_jsii_.MemberMethod{JsiiMethod: "resetLockMode", GoMethod: "ResetLockMode"},
			...
			_jsii_.MemberProperty{JsiiProperty: "targetSubscriptionId", GoGetter: "TargetSubscriptionId"},
			_jsii_.MemberProperty{JsiiProperty: "targetSubscriptionIdInput", GoGetter: "TargetSubscriptionIdInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurerm.blueprintAssignment.BlueprintAssignmentConfig",
		reflect.TypeOf((*BlueprintAssignmentConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurerm.blueprintAssignment.BlueprintAssignmentIdentity",
		reflect.TypeOf((*BlueprintAssignmentIdentity)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-azurerm.blueprintAssignment.BlueprintAssignmentIdentityOutputReference",
		reflect.TypeOf((*BlueprintAssignmentIdentityOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurerm.blueprintAssignment.BlueprintAssignmentTimeouts",
		reflect.TypeOf((*BlueprintAssignmentTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-azurerm.blueprintAssignment.BlueprintAssignmentTimeoutsOutputReference",
		reflect.TypeOf((*BlueprintAssignmentTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
