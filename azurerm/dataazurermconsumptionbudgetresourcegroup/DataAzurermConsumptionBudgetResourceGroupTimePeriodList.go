...
func NewDataAzurermConsumptionBudgetResourceGroupTimePeriodList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermConsumptionBudgetResourceGroupTimePeriodList {
	...
	_jsii_.Create(
		"@cdktf/provider-azurerm.dataAzurermConsumptionBudgetResourceGroup.DataAzurermConsumptionBudgetResourceGroupTimePeriodList",
...
func (d *jsiiProxy_DataAzurermConsumptionBudgetResourceGroupTimePeriodList) Resolve(context cdktf.IResolveContext) interface{} {
