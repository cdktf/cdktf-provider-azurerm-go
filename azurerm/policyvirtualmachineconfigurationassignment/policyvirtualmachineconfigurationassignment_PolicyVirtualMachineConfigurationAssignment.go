...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/policyvirtualmachineconfigurationassignment/internal"
...
func NewPolicyVirtualMachineConfigurationAssignment(scope constructs.Construct, id *string, config *PolicyVirtualMachineConfigurationAssignmentConfig) PolicyVirtualMachineConfigurationAssignment {
	...
	if err := validateNewPolicyVirtualMachineConfigurationAssignmentParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func PolicyVirtualMachineConfigurationAssignment_IsConstruct(x interface{}) *bool {
	...
	if err := validatePolicyVirtualMachineConfigurationAssignment_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func PolicyVirtualMachineConfigurationAssignment_IsTerraformElement(x interface{}) *bool {
	...
	if err := validatePolicyVirtualMachineConfigurationAssignment_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func PolicyVirtualMachineConfigurationAssignment_IsTerraformResource(x interface{}) *bool {
	...
	if err := validatePolicyVirtualMachineConfigurationAssignment_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
