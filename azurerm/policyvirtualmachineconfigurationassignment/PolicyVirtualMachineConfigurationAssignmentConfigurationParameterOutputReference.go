...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/policyvirtualmachineconfigurationassignment/internal"
...
func NewPolicyVirtualMachineConfigurationAssignmentConfigurationParameterOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) PolicyVirtualMachineConfigurationAssignmentConfigurationParameterOutputReference {
	...
	if err := validateNewPolicyVirtualMachineConfigurationAssignmentConfigurationParameterOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (p *jsiiProxy_PolicyVirtualMachineConfigurationAssignmentConfigurationParameterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PolicyVirtualMachineConfigurationAssignmentConfigurationParameterOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
