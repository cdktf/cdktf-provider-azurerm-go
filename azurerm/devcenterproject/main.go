...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "devCenterUri", GoGetter: "DevCenterUri"},
			...
			_jsii_.MemberProperty{JsiiProperty: "maximumDevBoxesPerUser", GoGetter: "MaximumDevBoxesPerUser"},
			_jsii_.MemberProperty{JsiiProperty: "maximumDevBoxesPerUserInput", GoGetter: "MaximumDevBoxesPerUserInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetMaximumDevBoxesPerUser", GoMethod: "ResetMaximumDevBoxesPerUser"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_DevCenterProjectIdentityOutputReference{}
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_DevCenterProjectTimeoutsOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
