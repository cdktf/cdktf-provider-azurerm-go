...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/datafactorylinkedserviceazuredatabricks/internal"
...
func (d *jsiiProxy_DataFactoryLinkedServiceAzureDatabricksInstancePoolOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataFactoryLinkedServiceAzureDatabricksInstancePoolOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
