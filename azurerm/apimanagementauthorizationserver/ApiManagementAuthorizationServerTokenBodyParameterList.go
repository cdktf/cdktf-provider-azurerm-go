...
func NewApiManagementAuthorizationServerTokenBodyParameterList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiManagementAuthorizationServerTokenBodyParameterList {
	...
	if err := validateNewApiManagementAuthorizationServerTokenBodyParameterListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApiManagementAuthorizationServerTokenBodyParameterList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementAuthorizationServerTokenBodyParameterList) Resolve(context cdktf.IResolveContext) interface{} {
