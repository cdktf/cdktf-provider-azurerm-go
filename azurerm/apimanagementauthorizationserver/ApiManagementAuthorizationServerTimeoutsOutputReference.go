...
func NewApiManagementAuthorizationServerTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) ApiManagementAuthorizationServerTimeoutsOutputReference {
	...
	if err := validateNewApiManagementAuthorizationServerTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApiManagementAuthorizationServerTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApiManagementAuthorizationServerTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
