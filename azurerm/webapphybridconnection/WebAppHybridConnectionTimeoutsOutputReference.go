...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/webapphybridconnection/internal"
...
func NewWebAppHybridConnectionTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) WebAppHybridConnectionTimeoutsOutputReference {
	...
	if err := validateNewWebAppHybridConnectionTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (w *jsiiProxy_WebAppHybridConnectionTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WebAppHybridConnectionTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
