...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "continueOnErrorsEnabled", GoGetter: "ContinueOnErrorsEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "continueOnErrorsEnabledInput", GoGetter: "ContinueOnErrorsEnabledInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "forceAnUpdateWhenValueChanged", GoGetter: "ForceAnUpdateWhenValueChanged"},
			_jsii_.MemberProperty{JsiiProperty: "forceAnUpdateWhenValueChangedInput", GoGetter: "ForceAnUpdateWhenValueChangedInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetContinueOnErrorsEnabled", GoMethod: "ResetContinueOnErrorsEnabled"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_KustoScriptTimeoutsOutputReference{}
