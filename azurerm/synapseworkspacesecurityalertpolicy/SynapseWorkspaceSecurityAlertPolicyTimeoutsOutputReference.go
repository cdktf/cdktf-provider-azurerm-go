...
func NewSynapseWorkspaceSecurityAlertPolicyTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) SynapseWorkspaceSecurityAlertPolicyTimeoutsOutputReference {
	...
	if err := validateNewSynapseWorkspaceSecurityAlertPolicyTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SynapseWorkspaceSecurityAlertPolicyTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SynapseWorkspaceSecurityAlertPolicyTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
