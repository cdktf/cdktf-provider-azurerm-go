...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/synapseworkspacesecurityalertpolicy/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.114.0/docs/resources/synapse_workspace_security_alert_policy azurerm_synapse_workspace_security_alert_policy}.
...
func (j *jsiiProxy_SynapseWorkspaceSecurityAlertPolicy) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.114.0/docs/resources/synapse_workspace_security_alert_policy azurerm_synapse_workspace_security_alert_policy} Resource.
func NewSynapseWorkspaceSecurityAlertPolicy(scope constructs.Construct, id *string, config *SynapseWorkspaceSecurityAlertPolicyConfig) SynapseWorkspaceSecurityAlertPolicy {
	...
	if err := validateNewSynapseWorkspaceSecurityAlertPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_SynapseWorkspaceSecurityAlertPolicy)SetCount(val interface{}) {
...
func SynapseWorkspaceSecurityAlertPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSynapseWorkspaceSecurityAlertPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func SynapseWorkspaceSecurityAlertPolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateSynapseWorkspaceSecurityAlertPolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func SynapseWorkspaceSecurityAlertPolicy_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSynapseWorkspaceSecurityAlertPolicy_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func SynapseWorkspaceSecurityAlertPolicy_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSynapseWorkspaceSecurityAlertPolicy_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_SynapseWorkspaceSecurityAlertPolicy) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SynapseWorkspaceSecurityAlertPolicy) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SynapseWorkspaceSecurityAlertPolicy) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SynapseWorkspaceSecurityAlertPolicy) MoveFromId(id *string) {
...
func (s *jsiiProxy_SynapseWorkspaceSecurityAlertPolicy) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_SynapseWorkspaceSecurityAlertPolicy) MoveToId(id *string) {
...
func (s *jsiiProxy_SynapseWorkspaceSecurityAlertPolicy) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SynapseWorkspaceSecurityAlertPolicy) ToHclTerraform() interface{} {
	var returns interface{}
