...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/servicebusqueue/internal"
...
func NewServicebusQueueTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) ServicebusQueueTimeoutsOutputReference {
	...
	if err := validateNewServicebusQueueTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_ServicebusQueueTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_ServicebusQueueTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
