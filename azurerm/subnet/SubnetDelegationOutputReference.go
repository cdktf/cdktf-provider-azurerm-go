...
func NewSubnetDelegationOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) SubnetDelegationOutputReference {
	...
	if err := validateNewSubnetDelegationOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SubnetDelegationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SubnetDelegationOutputReference) PutServiceDelegation(value *SubnetDelegationServiceDelegation) {
	if err := s.validatePutServiceDelegationParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		s,
...
func (s *jsiiProxy_SubnetDelegationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
