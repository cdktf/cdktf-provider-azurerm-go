...
func NewSubnetDelegationList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SubnetDelegationList {
	...
	if err := validateNewSubnetDelegationListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SubnetDelegationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SubnetDelegationList) Resolve(context cdktf.IResolveContext) interface{} {
