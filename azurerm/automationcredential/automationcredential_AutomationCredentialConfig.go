...
type AutomationCredentialConfig struct {
	// Experimental.
	...
	// Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/automation_credential#id AutomationCredential#id}.
	//
	...
	Timeouts *AutomationCredentialTimeouts `field:"optional" json:"timeouts" yaml:"timeouts"`
}
