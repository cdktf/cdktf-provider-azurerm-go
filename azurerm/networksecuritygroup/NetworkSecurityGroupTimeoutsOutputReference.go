...
func NewNetworkSecurityGroupTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) NetworkSecurityGroupTimeoutsOutputReference {
	...
	if err := validateNewNetworkSecurityGroupTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (n *jsiiProxy_NetworkSecurityGroupTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NetworkSecurityGroupTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
