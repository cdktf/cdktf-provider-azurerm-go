...
func NewDataAzurermKubernetesClusterNetworkProfileList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermKubernetesClusterNetworkProfileList {
	...
	if err := validateNewDataAzurermKubernetesClusterNetworkProfileListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAzurermKubernetesClusterNetworkProfileList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterNetworkProfileList) Resolve(context cdktf.IResolveContext) interface{} {
