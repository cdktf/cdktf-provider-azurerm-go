...
func NewDataAzurermKubernetesClusterAgentPoolProfileList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermKubernetesClusterAgentPoolProfileList {
	...
	if err := validateNewDataAzurermKubernetesClusterAgentPoolProfileListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAzurermKubernetesClusterAgentPoolProfileList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterAgentPoolProfileList) Resolve(context cdktf.IResolveContext) interface{} {
