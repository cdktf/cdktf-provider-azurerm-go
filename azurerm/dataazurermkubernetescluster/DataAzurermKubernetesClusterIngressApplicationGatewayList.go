...
func NewDataAzurermKubernetesClusterIngressApplicationGatewayList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermKubernetesClusterIngressApplicationGatewayList {
	...
	if err := validateNewDataAzurermKubernetesClusterIngressApplicationGatewayListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAzurermKubernetesClusterIngressApplicationGatewayList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterIngressApplicationGatewayList) Resolve(context cdktf.IResolveContext) interface{} {
