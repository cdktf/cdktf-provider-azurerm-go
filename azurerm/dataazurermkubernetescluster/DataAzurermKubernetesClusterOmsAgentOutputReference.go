...
func NewDataAzurermKubernetesClusterOmsAgentOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataAzurermKubernetesClusterOmsAgentOutputReference {
	...
	if err := validateNewDataAzurermKubernetesClusterOmsAgentOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAzurermKubernetesClusterOmsAgentOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterOmsAgentOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
