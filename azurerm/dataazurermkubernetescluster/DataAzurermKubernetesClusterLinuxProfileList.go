...
func NewDataAzurermKubernetesClusterLinuxProfileList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermKubernetesClusterLinuxProfileList {
	...
	if err := validateNewDataAzurermKubernetesClusterLinuxProfileListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAzurermKubernetesClusterLinuxProfileList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterLinuxProfileList) Resolve(context cdktf.IResolveContext) interface{} {
