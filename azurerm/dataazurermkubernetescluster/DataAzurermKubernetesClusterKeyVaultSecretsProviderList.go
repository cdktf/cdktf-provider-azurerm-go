...
func NewDataAzurermKubernetesClusterKeyVaultSecretsProviderList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermKubernetesClusterKeyVaultSecretsProviderList {
	...
	if err := validateNewDataAzurermKubernetesClusterKeyVaultSecretsProviderListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAzurermKubernetesClusterKeyVaultSecretsProviderList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterKeyVaultSecretsProviderList) Resolve(context cdktf.IResolveContext) interface{} {
