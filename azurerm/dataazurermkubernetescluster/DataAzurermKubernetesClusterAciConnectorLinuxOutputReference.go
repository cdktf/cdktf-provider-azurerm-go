...
func NewDataAzurermKubernetesClusterAciConnectorLinuxOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataAzurermKubernetesClusterAciConnectorLinuxOutputReference {
	...
	if err := validateNewDataAzurermKubernetesClusterAciConnectorLinuxOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAzurermKubernetesClusterAciConnectorLinuxOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterAciConnectorLinuxOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
