...
func NewDataAzurermKubernetesClusterKeyVaultSecretsProviderSecretIdentityList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermKubernetesClusterKeyVaultSecretsProviderSecretIdentityList {
	...
	if err := validateNewDataAzurermKubernetesClusterKeyVaultSecretsProviderSecretIdentityListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAzurermKubernetesClusterKeyVaultSecretsProviderSecretIdentityList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterKeyVaultSecretsProviderSecretIdentityList) Resolve(context cdktf.IResolveContext) interface{} {
