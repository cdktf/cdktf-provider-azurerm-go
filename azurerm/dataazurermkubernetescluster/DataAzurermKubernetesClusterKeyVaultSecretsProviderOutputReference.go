...
func NewDataAzurermKubernetesClusterKeyVaultSecretsProviderOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataAzurermKubernetesClusterKeyVaultSecretsProviderOutputReference {
	...
	if err := validateNewDataAzurermKubernetesClusterKeyVaultSecretsProviderOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAzurermKubernetesClusterKeyVaultSecretsProviderOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAzurermKubernetesClusterKeyVaultSecretsProviderOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
