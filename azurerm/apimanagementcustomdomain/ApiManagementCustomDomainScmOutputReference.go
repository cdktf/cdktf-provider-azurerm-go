...
func (j *jsiiProxy_ApiManagementCustomDomainScmOutputReference) KeyVaultCertificateId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ApiManagementCustomDomainScmOutputReference) KeyVaultCertificateIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewApiManagementCustomDomainScmOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ApiManagementCustomDomainScmOutputReference {
	...
	if err := validateNewApiManagementCustomDomainScmOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_ApiManagementCustomDomainScmOutputReference)SetKeyVaultCertificateId(val *string) {
...
func (a *jsiiProxy_ApiManagementCustomDomainScmOutputReference) ResetKeyVaultCertificateId() {
	_jsii_.InvokeVoid(
		a,
		"resetKeyVaultCertificateId",
		nil, // no parameters
