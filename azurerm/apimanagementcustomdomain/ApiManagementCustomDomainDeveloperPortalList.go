...
func NewApiManagementCustomDomainDeveloperPortalList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiManagementCustomDomainDeveloperPortalList {
	...
	if err := validateNewApiManagementCustomDomainDeveloperPortalListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApiManagementCustomDomainDeveloperPortalList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementCustomDomainDeveloperPortalList) Resolve(context cdktf.IResolveContext) interface{} {
