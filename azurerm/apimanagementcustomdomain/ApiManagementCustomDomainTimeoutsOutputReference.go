...
func NewApiManagementCustomDomainTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) ApiManagementCustomDomainTimeoutsOutputReference {
	...
	if err := validateNewApiManagementCustomDomainTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApiManagementCustomDomainTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApiManagementCustomDomainTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
