...
func (j *jsiiProxy_ApiManagementCustomDomainPortalOutputReference) KeyVaultCertificateId() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ApiManagementCustomDomainPortalOutputReference) KeyVaultCertificateIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewApiManagementCustomDomainPortalOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ApiManagementCustomDomainPortalOutputReference {
	...
	if err := validateNewApiManagementCustomDomainPortalOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_ApiManagementCustomDomainPortalOutputReference)SetKeyVaultCertificateId(val *string) {
...
func (a *jsiiProxy_ApiManagementCustomDomainPortalOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApiManagementCustomDomainPortalOutputReference) ResetKeyVaultCertificateId() {
	_jsii_.InvokeVoid(
		a,
		"resetKeyVaultCertificateId",
		nil, // no parameters
...
func (a *jsiiProxy_ApiManagementCustomDomainPortalOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
