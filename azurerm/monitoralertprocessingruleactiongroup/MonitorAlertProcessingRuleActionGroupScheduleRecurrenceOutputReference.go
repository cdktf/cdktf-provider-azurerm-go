...
func NewMonitorAlertProcessingRuleActionGroupScheduleRecurrenceOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) MonitorAlertProcessingRuleActionGroupScheduleRecurrenceOutputReference {
	...
	if err := validateNewMonitorAlertProcessingRuleActionGroupScheduleRecurrenceOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_MonitorAlertProcessingRuleActionGroupScheduleRecurrenceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleActionGroupScheduleRecurrenceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
