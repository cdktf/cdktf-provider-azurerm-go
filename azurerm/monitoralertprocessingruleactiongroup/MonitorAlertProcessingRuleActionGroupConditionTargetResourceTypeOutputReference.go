...
func NewMonitorAlertProcessingRuleActionGroupConditionTargetResourceTypeOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) MonitorAlertProcessingRuleActionGroupConditionTargetResourceTypeOutputReference {
	...
	if err := validateNewMonitorAlertProcessingRuleActionGroupConditionTargetResourceTypeOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_MonitorAlertProcessingRuleActionGroupConditionTargetResourceTypeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MonitorAlertProcessingRuleActionGroupConditionTargetResourceTypeOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
