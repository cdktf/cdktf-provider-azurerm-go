...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v3/datafactoryintegrationruntimeazuressis/internal"
...
func NewDataFactoryIntegrationRuntimeAzureSsisExpressCustomSetupComponentList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataFactoryIntegrationRuntimeAzureSsisExpressCustomSetupComponentList {
	...
	if err := validateNewDataFactoryIntegrationRuntimeAzureSsisExpressCustomSetupComponentListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
