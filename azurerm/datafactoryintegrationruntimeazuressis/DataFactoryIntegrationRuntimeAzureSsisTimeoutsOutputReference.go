...
func NewDataFactoryIntegrationRuntimeAzureSsisTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DataFactoryIntegrationRuntimeAzureSsisTimeoutsOutputReference {
	...
	if err := validateNewDataFactoryIntegrationRuntimeAzureSsisTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataFactoryIntegrationRuntimeAzureSsisTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataFactoryIntegrationRuntimeAzureSsisTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
