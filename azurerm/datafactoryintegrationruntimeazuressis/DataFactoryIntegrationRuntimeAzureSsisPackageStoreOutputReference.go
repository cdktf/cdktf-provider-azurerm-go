...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/datafactoryintegrationruntimeazuressis/internal"
...
func NewDataFactoryIntegrationRuntimeAzureSsisPackageStoreOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataFactoryIntegrationRuntimeAzureSsisPackageStoreOutputReference {
	...
	if err := validateNewDataFactoryIntegrationRuntimeAzureSsisPackageStoreOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataFactoryIntegrationRuntimeAzureSsisPackageStoreOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataFactoryIntegrationRuntimeAzureSsisPackageStoreOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
