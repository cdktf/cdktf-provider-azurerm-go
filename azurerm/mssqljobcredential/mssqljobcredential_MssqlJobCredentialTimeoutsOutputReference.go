...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v3/mssqljobcredential/internal"
...
func NewMssqlJobCredentialTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) MssqlJobCredentialTimeoutsOutputReference {
	...
	if err := validateNewMssqlJobCredentialTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
