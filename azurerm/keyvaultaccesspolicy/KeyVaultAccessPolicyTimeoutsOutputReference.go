...
func NewKeyVaultAccessPolicyTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) KeyVaultAccessPolicyTimeoutsOutputReference {
	...
	if err := validateNewKeyVaultAccessPolicyTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (k *jsiiProxy_KeyVaultAccessPolicyTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (k *jsiiProxy_KeyVaultAccessPolicyTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
