...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "blobStorageEventType", GoGetter: "BlobStorageEventType"},
			_jsii_.MemberProperty{JsiiProperty: "blobStorageEventTypeInput", GoGetter: "BlobStorageEventTypeInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "databaseRoutingType", GoGetter: "DatabaseRoutingType"},
			_jsii_.MemberProperty{JsiiProperty: "databaseRoutingTypeInput", GoGetter: "DatabaseRoutingTypeInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "eventgridResourceId", GoGetter: "EventgridResourceId"},
			_jsii_.MemberProperty{JsiiProperty: "eventgridResourceIdInput", GoGetter: "EventgridResourceIdInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "mappingRuleName", GoGetter: "MappingRuleName"},
			_jsii_.MemberProperty{JsiiProperty: "mappingRuleNameInput", GoGetter: "MappingRuleNameInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetBlobStorageEventType", GoMethod: "ResetBlobStorageEventType"},
			_jsii_.MemberMethod{JsiiMethod: "resetDatabaseRoutingType", GoMethod: "ResetDatabaseRoutingType"},
			_jsii_.MemberMethod{JsiiMethod: "resetDataFormat", GoMethod: "ResetDataFormat"},
			_jsii_.MemberMethod{JsiiMethod: "resetEventgridResourceId", GoMethod: "ResetEventgridResourceId"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetManagedIdentityResourceId", GoMethod: "ResetManagedIdentityResourceId"},
			_jsii_.MemberMethod{JsiiMethod: "resetMappingRuleName", GoMethod: "ResetMappingRuleName"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetSkipFirstRecord", GoMethod: "ResetSkipFirstRecord"},
			_jsii_.MemberMethod{JsiiMethod: "resetTableName", GoMethod: "ResetTableName"},
			_jsii_.MemberMethod{JsiiMethod: "resetTimeouts", GoMethod: "ResetTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "resourceGroupName", GoGetter: "ResourceGroupName"},
			_jsii_.MemberProperty{JsiiProperty: "resourceGroupNameInput", GoGetter: "ResourceGroupNameInput"},
			_jsii_.MemberProperty{JsiiProperty: "skipFirstRecord", GoGetter: "SkipFirstRecord"},
			_jsii_.MemberProperty{JsiiProperty: "skipFirstRecordInput", GoGetter: "SkipFirstRecordInput"},
