...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "autoApprovalSubscriptionIds", GoGetter: "AutoApprovalSubscriptionIds"},
			_jsii_.MemberProperty{JsiiProperty: "autoApprovalSubscriptionIdsInput", GoGetter: "AutoApprovalSubscriptionIdsInput"},
			_jsii_.MemberProperty{JsiiProperty: "cdktfStack", GoGetter: "CdktfStack"},
			_jsii_.MemberProperty{JsiiProperty: "connection", GoGetter: "Connection"},
			_jsii_.MemberProperty{JsiiProperty: "constructNodeMetadata", GoGetter: "ConstructNodeMetadata"},
			_jsii_.MemberProperty{JsiiProperty: "count", GoGetter: "Count"},
			_jsii_.MemberProperty{JsiiProperty: "dependsOn", GoGetter: "DependsOn"},
			_jsii_.MemberProperty{JsiiProperty: "destinationIpAddress", GoGetter: "DestinationIpAddress"},
			_jsii_.MemberProperty{JsiiProperty: "destinationIpAddressInput", GoGetter: "DestinationIpAddressInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "loadBalancerFrontendIpConfigurationIds", GoGetter: "LoadBalancerFrontendIpConfigurationIds"},
			_jsii_.MemberProperty{JsiiProperty: "loadBalancerFrontendIpConfigurationIdsInput", GoGetter: "LoadBalancerFrontendIpConfigurationIdsInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "natIpConfiguration", GoGetter: "NatIpConfiguration"},
			_jsii_.MemberProperty{JsiiProperty: "natIpConfigurationInput", GoGetter: "NatIpConfigurationInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAutoApprovalSubscriptionIds", GoMethod: "ResetAutoApprovalSubscriptionIds"},
			_jsii_.MemberMethod{JsiiMethod: "resetDestinationIpAddress", GoMethod: "ResetDestinationIpAddress"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_PrivateLinkServiceNatIpConfigurationList{}
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_PrivateLinkServiceNatIpConfigurationOutputReference{}
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_PrivateLinkServiceTimeoutsOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
