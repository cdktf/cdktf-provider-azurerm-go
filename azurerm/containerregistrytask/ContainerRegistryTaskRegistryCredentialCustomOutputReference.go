...
func NewContainerRegistryTaskRegistryCredentialCustomOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ContainerRegistryTaskRegistryCredentialCustomOutputReference {
	...
	if err := validateNewContainerRegistryTaskRegistryCredentialCustomOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_ContainerRegistryTaskRegistryCredentialCustomOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ContainerRegistryTaskRegistryCredentialCustomOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
