...
func (c *jsiiProxy_ContainerRegistryTaskFileStepOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ContainerRegistryTaskFileStepOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
