...
func NewContainerRegistryTaskTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) ContainerRegistryTaskTimeoutsOutputReference {
	...
	if err := validateNewContainerRegistryTaskTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_ContainerRegistryTaskTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ContainerRegistryTaskTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
