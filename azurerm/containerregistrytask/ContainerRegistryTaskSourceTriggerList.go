...
func NewContainerRegistryTaskSourceTriggerList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ContainerRegistryTaskSourceTriggerList {
	...
	if err := validateNewContainerRegistryTaskSourceTriggerListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_ContainerRegistryTaskSourceTriggerList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ContainerRegistryTaskSourceTriggerList) Resolve(context cdktf.IResolveContext) interface{} {
