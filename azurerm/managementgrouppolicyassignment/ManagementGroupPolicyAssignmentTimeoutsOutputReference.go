...
func NewManagementGroupPolicyAssignmentTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) ManagementGroupPolicyAssignmentTimeoutsOutputReference {
	...
	if err := validateNewManagementGroupPolicyAssignmentTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_ManagementGroupPolicyAssignmentTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_ManagementGroupPolicyAssignmentTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
