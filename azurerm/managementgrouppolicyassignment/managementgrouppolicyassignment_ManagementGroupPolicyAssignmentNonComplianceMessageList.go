...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/managementgrouppolicyassignment/internal"
...
func NewManagementGroupPolicyAssignmentNonComplianceMessageList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ManagementGroupPolicyAssignmentNonComplianceMessageList {
	...
	if err := validateNewManagementGroupPolicyAssignmentNonComplianceMessageListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
