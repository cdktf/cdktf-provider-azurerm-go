...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "mssqlServerId", GoGetter: "MssqlServerId"},
			_jsii_.MemberProperty{JsiiProperty: "mssqlServerIdInput", GoGetter: "MssqlServerIdInput"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_MssqlServerDnsAliasTimeoutsOutputReference{}
