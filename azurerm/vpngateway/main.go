...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetRoutingPreference", GoMethod: "ResetRoutingPreference"},
			_jsii_.MemberMethod{JsiiMethod: "resetScaleUnit", GoMethod: "ResetScaleUnit"},
			_jsii_.MemberMethod{JsiiMethod: "resetTags", GoMethod: "ResetTags"},
			_jsii_.MemberMethod{JsiiMethod: "resetTimeouts", GoMethod: "ResetTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "resourceGroupName", GoGetter: "ResourceGroupName"},
			_jsii_.MemberProperty{JsiiProperty: "resourceGroupNameInput", GoGetter: "ResourceGroupNameInput"},
			_jsii_.MemberProperty{JsiiProperty: "routingPreference", GoGetter: "RoutingPreference"},
			_jsii_.MemberProperty{JsiiProperty: "routingPreferenceInput", GoGetter: "RoutingPreferenceInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "customIps", GoGetter: "CustomIps"},
			_jsii_.MemberProperty{JsiiProperty: "customIpsInput", GoGetter: "CustomIpsInput"},
			_jsii_.MemberProperty{JsiiProperty: "defaultIps", GoGetter: "DefaultIps"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			...
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
			_jsii_.MemberProperty{JsiiProperty: "tunnelIps", GoGetter: "TunnelIps"},
		},
		func() interface{} {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "bgpPeeringAddress", GoGetter: "BgpPeeringAddress"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			...
			_jsii_.MemberMethod{JsiiMethod: "getStringAttribute", GoMethod: "GetStringAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getStringMapAttribute", GoMethod: "GetStringMapAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "instance0BgpPeeringAddress", GoGetter: "Instance0BgpPeeringAddress"},
			_jsii_.MemberProperty{JsiiProperty: "instance0BgpPeeringAddressInput", GoGetter: "Instance0BgpPeeringAddressInput"},
			_jsii_.MemberProperty{JsiiProperty: "instance1BgpPeeringAddress", GoGetter: "Instance1BgpPeeringAddress"},
			_jsii_.MemberProperty{JsiiProperty: "instance1BgpPeeringAddressInput", GoGetter: "Instance1BgpPeeringAddressInput"},
			_jsii_.MemberProperty{JsiiProperty: "internalValue", GoGetter: "InternalValue"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putInstance0BgpPeeringAddress", GoMethod: "PutInstance0BgpPeeringAddress"},
			_jsii_.MemberMethod{JsiiMethod: "putInstance1BgpPeeringAddress", GoMethod: "PutInstance1BgpPeeringAddress"},
			_jsii_.MemberMethod{JsiiMethod: "resetInstance0BgpPeeringAddress", GoMethod: "ResetInstance0BgpPeeringAddress"},
			_jsii_.MemberMethod{JsiiMethod: "resetInstance1BgpPeeringAddress", GoMethod: "ResetInstance1BgpPeeringAddress"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_VpnGatewayIpConfigurationList{}
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_VpnGatewayIpConfigurationOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
