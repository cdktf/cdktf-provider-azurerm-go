...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v3/vpngateway/internal"
...
func NewVpnGatewayTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) VpnGatewayTimeoutsOutputReference {
	...
	if err := validateNewVpnGatewayTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
