...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/mediaservicesaccount/internal"
...
func (j *jsiiProxy_MediaServicesAccountIdentityOutputReference) IdentityIds() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"identityIds",
...
func (j *jsiiProxy_MediaServicesAccountIdentityOutputReference) IdentityIdsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"identityIdsInput",
...
func NewMediaServicesAccountIdentityOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) MediaServicesAccountIdentityOutputReference {
	...
	if err := validateNewMediaServicesAccountIdentityOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_MediaServicesAccountIdentityOutputReference)SetIdentityIds(val *[]*string) {
...
func (m *jsiiProxy_MediaServicesAccountIdentityOutputReference) ResetIdentityIds() {
	_jsii_.InvokeVoid(
		m,
		"resetIdentityIds",
		nil, // no parameters
