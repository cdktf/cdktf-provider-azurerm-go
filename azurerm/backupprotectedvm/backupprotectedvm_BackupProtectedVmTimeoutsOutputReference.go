...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/backupprotectedvm/internal"
...
func NewBackupProtectedVmTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) BackupProtectedVmTimeoutsOutputReference {
	...
	if err := validateNewBackupProtectedVmTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
