...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "containerRegistryTokenId", GoGetter: "ContainerRegistryTokenId"},
			_jsii_.MemberProperty{JsiiProperty: "containerRegistryTokenIdInput", GoGetter: "ContainerRegistryTokenIdInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "password1", GoGetter: "Password1"},
			_jsii_.MemberProperty{JsiiProperty: "password1Input", GoGetter: "Password1Input"},
			_jsii_.MemberProperty{JsiiProperty: "password2", GoGetter: "Password2"},
			_jsii_.MemberProperty{JsiiProperty: "password2Input", GoGetter: "Password2Input"},
			_jsii_.MemberProperty{JsiiProperty: "provider", GoGetter: "Provider"},
			_jsii_.MemberProperty{JsiiProperty: "provisioners", GoGetter: "Provisioners"},
			_jsii_.MemberMethod{JsiiMethod: "putPassword1", GoMethod: "PutPassword1"},
			_jsii_.MemberMethod{JsiiMethod: "putPassword2", GoMethod: "PutPassword2"},
			_jsii_.MemberMethod{JsiiMethod: "putTimeouts", GoMethod: "PutTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetPassword2", GoMethod: "ResetPassword2"},
