...
func NewBotChannelWebChatTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) BotChannelWebChatTimeoutsOutputReference {
	...
	if err := validateNewBotChannelWebChatTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (b *jsiiProxy_BotChannelWebChatTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BotChannelWebChatTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
