...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/elasticcloudelasticsearch/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.112.0/docs/resources/elastic_cloud_elasticsearch azurerm_elastic_cloud_elasticsearch}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.112.0/docs/resources/elastic_cloud_elasticsearch azurerm_elastic_cloud_elasticsearch} Resource.
...
func ElasticCloudElasticsearch_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (e *jsiiProxy_ElasticCloudElasticsearch) ImportFrom(id *string, provider cdktf.TerraformProvider) {
