...
func (e *jsiiProxy_ElasticCloudElasticsearchLogsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_ElasticCloudElasticsearchLogsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
