...
func NewElasticCloudElasticsearchLogsFilteringTagList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ElasticCloudElasticsearchLogsFilteringTagList {
	...
	if err := validateNewElasticCloudElasticsearchLogsFilteringTagListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_ElasticCloudElasticsearchLogsFilteringTagList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (e *jsiiProxy_ElasticCloudElasticsearchLogsFilteringTagList) Resolve(context cdktf.IResolveContext) interface{} {
