...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.106.1/docs/resources/lb_probe azurerm_lb_probe}.
...
func (j *jsiiProxy_LbProbe) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.106.1/docs/resources/lb_probe azurerm_lb_probe} Resource.
func NewLbProbe(scope constructs.Construct, id *string, config *LbProbeConfig) LbProbe {
	_init_.Initialize()

	if err := validateNewLbProbeParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_LbProbe{}
...
func (j *jsiiProxy_LbProbe)SetCount(val interface{}) {
...
func (j *jsiiProxy_LbProbe)SetNumberOfProbes(val *float64) {
	if err := j.validateSetNumberOfProbesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func LbProbe_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateLbProbe_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func LbProbe_IsConstruct(x interface{}) *bool {
	...
	if err := validateLbProbe_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func LbProbe_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateLbProbe_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func LbProbe_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateLbProbe_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (l *jsiiProxy_LbProbe) AddMoveTarget(moveTarget *string) {
...
func (l *jsiiProxy_LbProbe) HasResourceMove() interface{} {
	var returns interface{}
...
func (l *jsiiProxy_LbProbe) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (l *jsiiProxy_LbProbe) MoveFromId(id *string) {
...
func (l *jsiiProxy_LbProbe) MoveTo(moveTarget *string, index interface{}) {
...
func (l *jsiiProxy_LbProbe) MoveToId(id *string) {
...
func (l *jsiiProxy_LbProbe) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (l *jsiiProxy_LbProbe) ToHclTerraform() interface{} {
	var returns interface{}
