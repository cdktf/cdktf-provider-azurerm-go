...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/lbprobe/internal"
...
func NewLbProbeTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) LbProbeTimeoutsOutputReference {
	...
	if err := validateNewLbProbeTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
