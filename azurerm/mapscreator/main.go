...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "mapsAccountId", GoGetter: "MapsAccountId"},
			_jsii_.MemberProperty{JsiiProperty: "mapsAccountIdInput", GoGetter: "MapsAccountIdInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "storageUnits", GoGetter: "StorageUnits"},
			_jsii_.MemberProperty{JsiiProperty: "storageUnitsInput", GoGetter: "StorageUnitsInput"},
