...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/subscriptiontemplatedeployment/internal"
...
func SubscriptionTemplateDeployment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSubscriptionTemplateDeployment_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SubscriptionTemplateDeployment) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SubscriptionTemplateDeployment) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SubscriptionTemplateDeployment) ToHclTerraform() interface{} {
	var returns interface{}
