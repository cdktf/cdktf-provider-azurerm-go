...
func NewEventgridTopicInboundIpRuleOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) EventgridTopicInboundIpRuleOutputReference {
	...
	if err := validateNewEventgridTopicInboundIpRuleOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_EventgridTopicInboundIpRuleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_EventgridTopicInboundIpRuleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
