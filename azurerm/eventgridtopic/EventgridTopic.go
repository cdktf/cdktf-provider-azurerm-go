...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/eventgridtopic/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.107.0/docs/resources/eventgrid_topic azurerm_eventgrid_topic}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.107.0/docs/resources/eventgrid_topic azurerm_eventgrid_topic} Resource.
func NewEventgridTopic(scope constructs.Construct, id *string, config *EventgridTopicConfig) EventgridTopic {
	_init_.Initialize()

	if err := validateNewEventgridTopicParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func EventgridTopic_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateEventgridTopic_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func EventgridTopic_IsConstruct(x interface{}) *bool {
	...
	if err := validateEventgridTopic_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (e *jsiiProxy_EventgridTopic) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_EventgridTopic) HasResourceMove() interface{} {
	var returns interface{}
...
func (e *jsiiProxy_EventgridTopic) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (e *jsiiProxy_EventgridTopic) MoveFromId(id *string) {
...
func (e *jsiiProxy_EventgridTopic) MoveTo(moveTarget *string, index interface{}) {
...
func (e *jsiiProxy_EventgridTopic) MoveToId(id *string) {
...
func (e *jsiiProxy_EventgridTopic) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (e *jsiiProxy_EventgridTopic) ToHclTerraform() interface{} {
	var returns interface{}
