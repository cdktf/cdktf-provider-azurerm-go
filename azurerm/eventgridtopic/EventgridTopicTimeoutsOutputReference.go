...
func NewEventgridTopicTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) EventgridTopicTimeoutsOutputReference {
	...
	if err := validateNewEventgridTopicTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_EventgridTopicTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_EventgridTopicTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
