...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/monitoractivitylogalert/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.104.2/docs/resources/monitor_activity_log_alert azurerm_monitor_activity_log_alert}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.104.2/docs/resources/monitor_activity_log_alert azurerm_monitor_activity_log_alert} Resource.
func NewMonitorActivityLogAlert(scope constructs.Construct, id *string, config *MonitorActivityLogAlertConfig) MonitorActivityLogAlert {
	...
	if err := validateNewMonitorActivityLogAlertParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func MonitorActivityLogAlert_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateMonitorActivityLogAlert_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func MonitorActivityLogAlert_IsConstruct(x interface{}) *bool {
	...
	if err := validateMonitorActivityLogAlert_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func MonitorActivityLogAlert_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateMonitorActivityLogAlert_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func MonitorActivityLogAlert_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateMonitorActivityLogAlert_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (m *jsiiProxy_MonitorActivityLogAlert) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_MonitorActivityLogAlert) HasResourceMove() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_MonitorActivityLogAlert) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (m *jsiiProxy_MonitorActivityLogAlert) MoveFromId(id *string) {
...
func (m *jsiiProxy_MonitorActivityLogAlert) MoveTo(moveTarget *string, index interface{}) {
...
func (m *jsiiProxy_MonitorActivityLogAlert) MoveToId(id *string) {
...
func (m *jsiiProxy_MonitorActivityLogAlert) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (m *jsiiProxy_MonitorActivityLogAlert) ToHclTerraform() interface{} {
	var returns interface{}
