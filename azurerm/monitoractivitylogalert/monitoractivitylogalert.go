...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*MonitorActivityLogAlert)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurerm.monitorActivityLogAlert.MonitorActivityLogAlertAction",
		reflect.TypeOf((*MonitorActivityLogAlertAction)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-azurerm.monitorActivityLogAlert.MonitorActivityLogAlertActionList",
		reflect.TypeOf((*MonitorActivityLogAlertActionList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*MonitorActivityLogAlertActionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "actionGroupId", GoGetter: "ActionGroupId"},
			_jsii_.MemberProperty{JsiiProperty: "actionGroupIdInput", GoGetter: "ActionGroupIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetWebhookProperties", GoMethod: "ResetWebhookProperties"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
			_jsii_.MemberProperty{JsiiProperty: "webhookProperties", GoGetter: "WebhookProperties"},
			_jsii_.MemberProperty{JsiiProperty: "webhookPropertiesInput", GoGetter: "WebhookPropertiesInput"},
		},
		func() interface{} {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurerm.monitorActivityLogAlert.MonitorActivityLogAlertConfig",
		reflect.TypeOf((*MonitorActivityLogAlertConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurerm.monitorActivityLogAlert.MonitorActivityLogAlertCriteria",
		reflect.TypeOf((*MonitorActivityLogAlertCriteria)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-azurerm.monitorActivityLogAlert.MonitorActivityLogAlertCriteriaOutputReference",
		reflect.TypeOf((*MonitorActivityLogAlertCriteriaOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "caller", GoGetter: "Caller"},
			_jsii_.MemberProperty{JsiiProperty: "callerInput", GoGetter: "CallerInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putResourceHealth", GoMethod: "PutResourceHealth"},
			_jsii_.MemberMethod{JsiiMethod: "putServiceHealth", GoMethod: "PutServiceHealth"},
			_jsii_.MemberProperty{JsiiProperty: "recommendationCategory", GoGetter: "RecommendationCategory"},
			_jsii_.MemberProperty{JsiiProperty: "recommendationCategoryInput", GoGetter: "RecommendationCategoryInput"},
			_jsii_.MemberProperty{JsiiProperty: "recommendationImpact", GoGetter: "RecommendationImpact"},
			_jsii_.MemberProperty{JsiiProperty: "recommendationImpactInput", GoGetter: "RecommendationImpactInput"},
			_jsii_.MemberProperty{JsiiProperty: "recommendationType", GoGetter: "RecommendationType"},
			_jsii_.MemberProperty{JsiiProperty: "recommendationTypeInput", GoGetter: "RecommendationTypeInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetCaller", GoMethod: "ResetCaller"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetRecommendationCategory", GoMethod: "ResetRecommendationCategory"},
			_jsii_.MemberMethod{JsiiMethod: "resetRecommendationImpact", GoMethod: "ResetRecommendationImpact"},
			_jsii_.MemberMethod{JsiiMethod: "resetRecommendationType", GoMethod: "ResetRecommendationType"},
			_jsii_.MemberMethod{JsiiMethod: "resetResourceGroup", GoMethod: "ResetResourceGroup"},
			_jsii_.MemberMethod{JsiiMethod: "resetResourceHealth", GoMethod: "ResetResourceHealth"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetServiceHealth", GoMethod: "ResetServiceHealth"},
			...
			_jsii_.MemberProperty{JsiiProperty: "resourceHealth", GoGetter: "ResourceHealth"},
			_jsii_.MemberProperty{JsiiProperty: "resourceHealthInput", GoGetter: "ResourceHealthInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "serviceHealth", GoGetter: "ServiceHealth"},
			_jsii_.MemberProperty{JsiiProperty: "serviceHealthInput", GoGetter: "ServiceHealthInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurerm.monitorActivityLogAlert.MonitorActivityLogAlertCriteriaResourceHealth",
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "current", GoGetter: "Current"},
			_jsii_.MemberProperty{JsiiProperty: "currentInput", GoGetter: "CurrentInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "previous", GoGetter: "Previous"},
			_jsii_.MemberProperty{JsiiProperty: "previousInput", GoGetter: "PreviousInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetCurrent", GoMethod: "ResetCurrent"},
			_jsii_.MemberMethod{JsiiMethod: "resetPrevious", GoMethod: "ResetPrevious"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*MonitorActivityLogAlertCriteriaServiceHealthOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurerm.monitorActivityLogAlert.MonitorActivityLogAlertTimeouts",
		reflect.TypeOf((*MonitorActivityLogAlertTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-azurerm.monitorActivityLogAlert.MonitorActivityLogAlertTimeoutsOutputReference",
		reflect.TypeOf((*MonitorActivityLogAlertTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
