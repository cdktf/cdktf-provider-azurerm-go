...
func (s *jsiiProxy_SubscriptionPolicyAssignmentResourceSelectorsSelectorsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SubscriptionPolicyAssignmentResourceSelectorsSelectorsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
