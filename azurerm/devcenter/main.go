...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "projectCatalogItemSyncEnabled", GoGetter: "ProjectCatalogItemSyncEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "projectCatalogItemSyncEnabledInput", GoGetter: "ProjectCatalogItemSyncEnabledInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetProjectCatalogItemSyncEnabled", GoMethod: "ResetProjectCatalogItemSyncEnabled"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_DevCenterIdentityOutputReference{}
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_DevCenterTimeoutsOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
