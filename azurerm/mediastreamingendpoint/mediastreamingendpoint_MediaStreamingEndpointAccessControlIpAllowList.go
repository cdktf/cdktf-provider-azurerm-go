...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/mediastreamingendpoint/internal"
...
func NewMediaStreamingEndpointAccessControlIpAllowList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MediaStreamingEndpointAccessControlIpAllowList {
	...
	if err := validateNewMediaStreamingEndpointAccessControlIpAllowListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
