...
func (d *jsiiProxy_DataAzurermNginxDeploymentAutoScaleProfileList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}

func (d *jsiiProxy_DataAzurermNginxDeploymentAutoScaleProfileList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_DataAzurermNginxDeploymentAutoScaleProfileList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_DataAzurermNginxDeploymentAutoScaleProfileList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
