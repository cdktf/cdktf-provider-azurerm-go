...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putValueFromKeyVault", GoMethod: "PutValueFromKeyVault"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetValueFromKeyVault", GoMethod: "ResetValueFromKeyVault"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_ApiManagementNamedValueTimeoutsOutputReference{}
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_ApiManagementNamedValueValueFromKeyVaultOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
