...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v3/mediacontentkeypolicy/internal"
...
func NewMediaContentKeyPolicyPolicyOptionPlayreadyConfigurationLicenseList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MediaContentKeyPolicyPolicyOptionPlayreadyConfigurationLicenseList {
	...
	if err := validateNewMediaContentKeyPolicyPolicyOptionPlayreadyConfigurationLicenseListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
