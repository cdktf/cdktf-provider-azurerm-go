...
func (m *jsiiProxy_MediaContentKeyPolicyPolicyOptionTokenRestrictionAlternateKeyList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
