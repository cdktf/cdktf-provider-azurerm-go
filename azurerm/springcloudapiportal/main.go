...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "gatewayIds", GoGetter: "GatewayIds"},
			_jsii_.MemberProperty{JsiiProperty: "gatewayIdsInput", GoGetter: "GatewayIdsInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "httpsOnlyEnabled", GoGetter: "HttpsOnlyEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "httpsOnlyEnabledInput", GoGetter: "HttpsOnlyEnabledInput"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_SpringCloudApiPortalSsoOutputReference{}
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_SpringCloudApiPortalTimeoutsOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
