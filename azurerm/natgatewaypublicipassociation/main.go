...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*NatGatewayPublicIpAssociation)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurerm.natGatewayPublicIpAssociation.NatGatewayPublicIpAssociationConfig",
		reflect.TypeOf((*NatGatewayPublicIpAssociationConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurerm.natGatewayPublicIpAssociation.NatGatewayPublicIpAssociationTimeouts",
		reflect.TypeOf((*NatGatewayPublicIpAssociationTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-azurerm.natGatewayPublicIpAssociation.NatGatewayPublicIpAssociationTimeoutsOutputReference",
		reflect.TypeOf((*NatGatewayPublicIpAssociationTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
