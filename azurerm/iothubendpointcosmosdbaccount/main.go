...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IothubEndpointCosmosdbAccount)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "partitionKeyName", GoGetter: "PartitionKeyName"},
			_jsii_.MemberProperty{JsiiProperty: "partitionKeyNameInput", GoGetter: "PartitionKeyNameInput"},
			_jsii_.MemberProperty{JsiiProperty: "partitionKeyTemplate", GoGetter: "PartitionKeyTemplate"},
			_jsii_.MemberProperty{JsiiProperty: "partitionKeyTemplateInput", GoGetter: "PartitionKeyTemplateInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPartitionKeyName", GoMethod: "ResetPartitionKeyName"},
			_jsii_.MemberMethod{JsiiMethod: "resetPartitionKeyTemplate", GoMethod: "ResetPartitionKeyTemplate"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurerm.iothubEndpointCosmosdbAccount.IothubEndpointCosmosdbAccountConfig",
		reflect.TypeOf((*IothubEndpointCosmosdbAccountConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurerm.iothubEndpointCosmosdbAccount.IothubEndpointCosmosdbAccountTimeouts",
		reflect.TypeOf((*IothubEndpointCosmosdbAccountTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-azurerm.iothubEndpointCosmosdbAccount.IothubEndpointCosmosdbAccountTimeoutsOutputReference",
		reflect.TypeOf((*IothubEndpointCosmosdbAccountTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
