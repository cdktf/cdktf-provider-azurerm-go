...
func NewCognitiveAccountStorageOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) CognitiveAccountStorageOutputReference {
	...
	if err := validateNewCognitiveAccountStorageOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CognitiveAccountStorageOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CognitiveAccountStorageOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
