...
func (c *jsiiProxy_CognitiveAccountNetworkAclsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CognitiveAccountNetworkAclsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
