...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v3/cognitiveaccount/internal"
...
func NewCognitiveAccountTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) CognitiveAccountTimeoutsOutputReference {
	...
	if err := validateNewCognitiveAccountTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
