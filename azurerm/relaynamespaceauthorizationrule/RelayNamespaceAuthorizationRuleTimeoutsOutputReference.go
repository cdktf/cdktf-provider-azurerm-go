...
func NewRelayNamespaceAuthorizationRuleTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) RelayNamespaceAuthorizationRuleTimeoutsOutputReference {
	...
	if err := validateNewRelayNamespaceAuthorizationRuleTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_RelayNamespaceAuthorizationRuleTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_RelayNamespaceAuthorizationRuleTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
