...
func (d *jsiiProxy_DataAzurermArcMachineOsProfileWindowsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermArcMachineOsProfileWindowsList) Resolve(context cdktf.IResolveContext) interface{} {
