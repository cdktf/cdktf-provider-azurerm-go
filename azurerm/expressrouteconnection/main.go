...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "enableInternetSecurity", GoGetter: "EnableInternetSecurity"},
			_jsii_.MemberProperty{JsiiProperty: "enableInternetSecurityInput", GoGetter: "EnableInternetSecurityInput"},
			_jsii_.MemberProperty{JsiiProperty: "expressRouteCircuitPeeringId", GoGetter: "ExpressRouteCircuitPeeringId"},
			_jsii_.MemberProperty{JsiiProperty: "expressRouteCircuitPeeringIdInput", GoGetter: "ExpressRouteCircuitPeeringIdInput"},
			_jsii_.MemberProperty{JsiiProperty: "expressRouteGatewayBypassEnabled", GoGetter: "ExpressRouteGatewayBypassEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "expressRouteGatewayBypassEnabledInput", GoGetter: "ExpressRouteGatewayBypassEnabledInput"},
			_jsii_.MemberProperty{JsiiProperty: "expressRouteGatewayId", GoGetter: "ExpressRouteGatewayId"},
			_jsii_.MemberProperty{JsiiProperty: "expressRouteGatewayIdInput", GoGetter: "ExpressRouteGatewayIdInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "privateLinkFastPathEnabled", GoGetter: "PrivateLinkFastPathEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "privateLinkFastPathEnabledInput", GoGetter: "PrivateLinkFastPathEnabledInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAssociatedRouteTableId", GoMethod: "ResetAssociatedRouteTableId"},
