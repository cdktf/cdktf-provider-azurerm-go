...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.107.0/docs/resources/resource_policy_assignment azurerm_resource_policy_assignment}.
...
func (j *jsiiProxy_ResourcePolicyAssignment) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.107.0/docs/resources/resource_policy_assignment azurerm_resource_policy_assignment} Resource.
func NewResourcePolicyAssignment(scope constructs.Construct, id *string, config *ResourcePolicyAssignmentConfig) ResourcePolicyAssignment {
	...
	if err := validateNewResourcePolicyAssignmentParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_ResourcePolicyAssignment)SetCount(val interface{}) {
...
func ResourcePolicyAssignment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateResourcePolicyAssignment_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func ResourcePolicyAssignment_IsConstruct(x interface{}) *bool {
	...
	if err := validateResourcePolicyAssignment_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ResourcePolicyAssignment_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateResourcePolicyAssignment_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ResourcePolicyAssignment_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateResourcePolicyAssignment_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (r *jsiiProxy_ResourcePolicyAssignment) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_ResourcePolicyAssignment) HasResourceMove() interface{} {
	var returns interface{}
...
func (r *jsiiProxy_ResourcePolicyAssignment) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (r *jsiiProxy_ResourcePolicyAssignment) MoveFromId(id *string) {
...
func (r *jsiiProxy_ResourcePolicyAssignment) MoveTo(moveTarget *string, index interface{}) {
...
func (r *jsiiProxy_ResourcePolicyAssignment) MoveToId(id *string) {
...
func (r *jsiiProxy_ResourcePolicyAssignment) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (r *jsiiProxy_ResourcePolicyAssignment) ToHclTerraform() interface{} {
	var returns interface{}
