...
func NewIothubEnrichmentOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) IothubEnrichmentOutputReference {
	...
	if err := validateNewIothubEnrichmentOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (i *jsiiProxy_IothubEnrichmentOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IothubEnrichmentOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
