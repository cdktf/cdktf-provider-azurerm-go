...
func NewIothubEnrichmentList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) IothubEnrichmentList {
	...
	if err := validateNewIothubEnrichmentListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (i *jsiiProxy_IothubEnrichmentList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (i *jsiiProxy_IothubEnrichmentList) Resolve(context cdktf.IResolveContext) interface{} {
