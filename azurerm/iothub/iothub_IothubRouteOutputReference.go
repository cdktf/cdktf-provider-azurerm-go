...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/iothub/internal"
...
func NewIothubRouteOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) IothubRouteOutputReference {
	...
	if err := validateNewIothubRouteOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
