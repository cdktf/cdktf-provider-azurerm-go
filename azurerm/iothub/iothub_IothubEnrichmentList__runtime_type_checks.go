...
func (j *jsiiProxy_IothubEnrichmentList) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*IothubEnrichment:
		val := val.(*[]*IothubEnrichment)
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*IothubEnrichment; received %#v (a %T)", val, val)
		}
	}
