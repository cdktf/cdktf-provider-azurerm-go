...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*MysqlServer)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurerm.mysqlServer.MysqlServerConfig",
		reflect.TypeOf((*MysqlServerConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurerm.mysqlServer.MysqlServerIdentity",
		reflect.TypeOf((*MysqlServerIdentity)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-azurerm.mysqlServer.MysqlServerIdentityOutputReference",
		reflect.TypeOf((*MysqlServerIdentityOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurerm.mysqlServer.MysqlServerThreatDetectionPolicy",
		reflect.TypeOf((*MysqlServerThreatDetectionPolicy)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-azurerm.mysqlServer.MysqlServerThreatDetectionPolicyOutputReference",
		reflect.TypeOf((*MysqlServerThreatDetectionPolicyOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurerm.mysqlServer.MysqlServerTimeouts",
		reflect.TypeOf((*MysqlServerTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-azurerm.mysqlServer.MysqlServerTimeoutsOutputReference",
		reflect.TypeOf((*MysqlServerTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
