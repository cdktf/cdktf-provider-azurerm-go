...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/mysqlserver/internal"
...
func NewMysqlServerIdentityOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) MysqlServerIdentityOutputReference {
	...
	if err := validateNewMysqlServerIdentityOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
