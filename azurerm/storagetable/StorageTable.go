...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/storagetable/internal"
...
func (j *jsiiProxy_StorageTable) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.112.0/docs/resources/storage_table azurerm_storage_table} Resource.
func NewStorageTable(scope constructs.Construct, id *string, config *StorageTableConfig) StorageTable {
	_init_.Initialize()

	if err := validateNewStorageTableParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_StorageTable)SetCount(val interface{}) {
...
func StorageTable_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateStorageTable_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func StorageTable_IsConstruct(x interface{}) *bool {
	...
	if err := validateStorageTable_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func StorageTable_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateStorageTable_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func StorageTable_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateStorageTable_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_StorageTable) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_StorageTable) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_StorageTable) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_StorageTable) MoveFromId(id *string) {
...
func (s *jsiiProxy_StorageTable) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_StorageTable) MoveToId(id *string) {
...
func (s *jsiiProxy_StorageTable) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_StorageTable) ToHclTerraform() interface{} {
	var returns interface{}
