...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/storagetable/internal"
...
func NewStorageTableAclOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) StorageTableAclOutputReference {
	...
	if err := validateNewStorageTableAclOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_StorageTableAclOutputReference) PutAccessPolicy(value interface{}) {
	if err := s.validatePutAccessPolicyParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		s,
