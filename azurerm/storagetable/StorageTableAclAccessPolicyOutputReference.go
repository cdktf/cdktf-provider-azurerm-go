...
func NewStorageTableAclAccessPolicyOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) StorageTableAclAccessPolicyOutputReference {
	...
	if err := validateNewStorageTableAclAccessPolicyOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_StorageTableAclAccessPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StorageTableAclAccessPolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
