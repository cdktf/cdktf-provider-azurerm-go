...
func (m *jsiiProxy_ManagementGroupPolicySetDefinitionPolicyDefinitionReferenceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_ManagementGroupPolicySetDefinitionPolicyDefinitionReferenceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
