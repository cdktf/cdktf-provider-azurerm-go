...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/mssqlelasticpool/internal"
...
func NewMssqlElasticpoolPerDatabaseSettingsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) MssqlElasticpoolPerDatabaseSettingsOutputReference {
	...
	if err := validateNewMssqlElasticpoolPerDatabaseSettingsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
