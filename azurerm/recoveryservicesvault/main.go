...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "classicVmwareReplicationEnabled", GoGetter: "ClassicVmwareReplicationEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "classicVmwareReplicationEnabledInput", GoGetter: "ClassicVmwareReplicationEnabledInput"},
			_jsii_.MemberProperty{JsiiProperty: "connection", GoGetter: "Connection"},
			_jsii_.MemberProperty{JsiiProperty: "constructNodeMetadata", GoGetter: "ConstructNodeMetadata"},
			_jsii_.MemberProperty{JsiiProperty: "count", GoGetter: "Count"},
			_jsii_.MemberProperty{JsiiProperty: "crossRegionRestoreEnabled", GoGetter: "CrossRegionRestoreEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "crossRegionRestoreEnabledInput", GoGetter: "CrossRegionRestoreEnabledInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "immutability", GoGetter: "Immutability"},
			_jsii_.MemberProperty{JsiiProperty: "immutabilityInput", GoGetter: "ImmutabilityInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetClassicVmwareReplicationEnabled", GoMethod: "ResetClassicVmwareReplicationEnabled"},
			_jsii_.MemberMethod{JsiiMethod: "resetCrossRegionRestoreEnabled", GoMethod: "ResetCrossRegionRestoreEnabled"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetImmutability", GoMethod: "ResetImmutability"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSoftDeleteEnabled", GoMethod: "ResetSoftDeleteEnabled"},
			_jsii_.MemberMethod{JsiiMethod: "resetStorageModeType", GoMethod: "ResetStorageModeType"},
			...
			_jsii_.MemberProperty{JsiiProperty: "softDeleteEnabled", GoGetter: "SoftDeleteEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "softDeleteEnabledInput", GoGetter: "SoftDeleteEnabledInput"},
			_jsii_.MemberProperty{JsiiProperty: "storageModeType", GoGetter: "StorageModeType"},
			_jsii_.MemberProperty{JsiiProperty: "storageModeTypeInput", GoGetter: "StorageModeTypeInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetUseSystemAssignedIdentity", GoMethod: "ResetUseSystemAssignedIdentity"},
			...
			_jsii_.MemberProperty{JsiiProperty: "useSystemAssignedIdentity", GoGetter: "UseSystemAssignedIdentity"},
			_jsii_.MemberProperty{JsiiProperty: "useSystemAssignedIdentityInput", GoGetter: "UseSystemAssignedIdentityInput"},
		},
		func() interface{} {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "alertsForAllJobFailuresEnabledInput", GoGetter: "AlertsForAllJobFailuresEnabledInput"},
			_jsii_.MemberProperty{JsiiProperty: "alertsForCriticalOperationFailuresEnabled", GoGetter: "AlertsForCriticalOperationFailuresEnabled"},
			_jsii_.MemberProperty{JsiiProperty: "alertsForCriticalOperationFailuresEnabledInput", GoGetter: "AlertsForCriticalOperationFailuresEnabledInput"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetAlertsForAllJobFailuresEnabled", GoMethod: "ResetAlertsForAllJobFailuresEnabled"},
			_jsii_.MemberMethod{JsiiMethod: "resetAlertsForCriticalOperationFailuresEnabled", GoMethod: "ResetAlertsForCriticalOperationFailuresEnabled"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
