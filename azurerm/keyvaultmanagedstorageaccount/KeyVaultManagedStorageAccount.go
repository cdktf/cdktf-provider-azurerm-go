...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/keyvaultmanagedstorageaccount/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.104.2/docs/resources/key_vault_managed_storage_account azurerm_key_vault_managed_storage_account}.
...
func (j *jsiiProxy_KeyVaultManagedStorageAccount) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.104.2/docs/resources/key_vault_managed_storage_account azurerm_key_vault_managed_storage_account} Resource.
func NewKeyVaultManagedStorageAccount(scope constructs.Construct, id *string, config *KeyVaultManagedStorageAccountConfig) KeyVaultManagedStorageAccount {
	...
	if err := validateNewKeyVaultManagedStorageAccountParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_KeyVaultManagedStorageAccount)SetCount(val interface{}) {
...
func (j *jsiiProxy_KeyVaultManagedStorageAccount)SetRegenerateKeyAutomatically(val interface{}) {
	if err := j.validateSetRegenerateKeyAutomaticallyParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_KeyVaultManagedStorageAccount)SetRegenerationPeriod(val *string) {
	if err := j.validateSetRegenerationPeriodParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func KeyVaultManagedStorageAccount_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateKeyVaultManagedStorageAccount_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func KeyVaultManagedStorageAccount_IsConstruct(x interface{}) *bool {
	...
	if err := validateKeyVaultManagedStorageAccount_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func KeyVaultManagedStorageAccount_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateKeyVaultManagedStorageAccount_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func KeyVaultManagedStorageAccount_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateKeyVaultManagedStorageAccount_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (k *jsiiProxy_KeyVaultManagedStorageAccount) AddMoveTarget(moveTarget *string) {
...
func (k *jsiiProxy_KeyVaultManagedStorageAccount) HasResourceMove() interface{} {
	var returns interface{}
...
func (k *jsiiProxy_KeyVaultManagedStorageAccount) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (k *jsiiProxy_KeyVaultManagedStorageAccount) MoveFromId(id *string) {
...
func (k *jsiiProxy_KeyVaultManagedStorageAccount) MoveTo(moveTarget *string, index interface{}) {
...
func (k *jsiiProxy_KeyVaultManagedStorageAccount) MoveToId(id *string) {
...
func (k *jsiiProxy_KeyVaultManagedStorageAccount) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (k *jsiiProxy_KeyVaultManagedStorageAccount) ToHclTerraform() interface{} {
	var returns interface{}
