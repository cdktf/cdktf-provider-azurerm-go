...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "dedicatedHostCount", GoGetter: "DedicatedHostCount"},
			_jsii_.MemberProperty{JsiiProperty: "dedicatedHostCountInput", GoGetter: "DedicatedHostCountInput"},
			_jsii_.MemberProperty{JsiiProperty: "dependsOn", GoGetter: "DependsOn"},
			_jsii_.MemberProperty{JsiiProperty: "dnsSuffix", GoGetter: "DnsSuffix"},
			_jsii_.MemberProperty{JsiiProperty: "externalInboundIpAddresses", GoGetter: "ExternalInboundIpAddresses"},
			...
			_jsii_.MemberProperty{JsiiProperty: "ipSslAddressCount", GoGetter: "IpSslAddressCount"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAllowNewPrivateEndpointConnections", GoMethod: "ResetAllowNewPrivateEndpointConnections"},
			_jsii_.MemberMethod{JsiiMethod: "resetClusterSetting", GoMethod: "ResetClusterSetting"},
			_jsii_.MemberMethod{JsiiMethod: "resetDedicatedHostCount", GoMethod: "ResetDedicatedHostCount"},
			...
			_jsii_.MemberProperty{JsiiProperty: "windowsOutboundIpAddresses", GoGetter: "WindowsOutboundIpAddresses"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_AppServiceEnvironmentV3ClusterSettingList{}
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_AppServiceEnvironmentV3InboundNetworkDependenciesOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
