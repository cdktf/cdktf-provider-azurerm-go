...
func NewKubernetesClusterIdentityOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) KubernetesClusterIdentityOutputReference {
	...
	if err := validateNewKubernetesClusterIdentityOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (k *jsiiProxy_KubernetesClusterIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (k *jsiiProxy_KubernetesClusterIdentityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
