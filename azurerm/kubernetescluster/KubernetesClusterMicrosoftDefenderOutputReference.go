...
func NewKubernetesClusterMicrosoftDefenderOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) KubernetesClusterMicrosoftDefenderOutputReference {
	...
	if err := validateNewKubernetesClusterMicrosoftDefenderOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (k *jsiiProxy_KubernetesClusterMicrosoftDefenderOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (k *jsiiProxy_KubernetesClusterMicrosoftDefenderOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
