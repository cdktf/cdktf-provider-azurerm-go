...
func (k *jsiiProxy_KubernetesClusterStorageProfileOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (k *jsiiProxy_KubernetesClusterStorageProfileOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
