...
type KubernetesClusterLinuxProfile struct {
	...
	// ssh_key block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.42.0/docs/resources/kubernetes_cluster#ssh_key KubernetesCluster#ssh_key}
