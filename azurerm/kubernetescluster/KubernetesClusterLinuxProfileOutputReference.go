...
func NewKubernetesClusterLinuxProfileOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) KubernetesClusterLinuxProfileOutputReference {
	...
	if err := validateNewKubernetesClusterLinuxProfileOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (k *jsiiProxy_KubernetesClusterLinuxProfileOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (k *jsiiProxy_KubernetesClusterLinuxProfileOutputReference) PutSshKey(value *KubernetesClusterLinuxProfileSshKey) {
	if err := k.validatePutSshKeyParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		k,
...
func (k *jsiiProxy_KubernetesClusterLinuxProfileOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
