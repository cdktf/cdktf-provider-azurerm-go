...
func NewKubernetesClusterMaintenanceWindowNotAllowedOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) KubernetesClusterMaintenanceWindowNotAllowedOutputReference {
	...
	if err := validateNewKubernetesClusterMaintenanceWindowNotAllowedOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (k *jsiiProxy_KubernetesClusterMaintenanceWindowNotAllowedOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (k *jsiiProxy_KubernetesClusterMaintenanceWindowNotAllowedOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
