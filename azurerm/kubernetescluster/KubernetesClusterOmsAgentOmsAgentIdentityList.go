...
func (k *jsiiProxy_KubernetesClusterOmsAgentOmsAgentIdentityList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (k *jsiiProxy_KubernetesClusterOmsAgentOmsAgentIdentityList) Resolve(context cdktf.IResolveContext) interface{} {
