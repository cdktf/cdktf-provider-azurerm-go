...
func NewPrivateDnsZoneTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) PrivateDnsZoneTimeoutsOutputReference {
	...
	if err := validateNewPrivateDnsZoneTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (p *jsiiProxy_PrivateDnsZoneTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PrivateDnsZoneTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
