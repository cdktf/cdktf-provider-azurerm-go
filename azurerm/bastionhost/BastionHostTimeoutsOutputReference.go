...
func NewBastionHostTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) BastionHostTimeoutsOutputReference {
	...
	if err := validateNewBastionHostTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (b *jsiiProxy_BastionHostTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BastionHostTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
