...
func (m *jsiiProxy_MobileNetworkServicePccRuleQosPolicyGuaranteedBitRateOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MobileNetworkServicePccRuleQosPolicyGuaranteedBitRateOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
