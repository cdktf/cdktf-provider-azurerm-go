...
func NewEventgridSystemTopicEventSubscriptionRetryPolicyOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) EventgridSystemTopicEventSubscriptionRetryPolicyOutputReference {
	...
	if err := validateNewEventgridSystemTopicEventSubscriptionRetryPolicyOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_EventgridSystemTopicEventSubscriptionRetryPolicyOutputReference)SetEventTimeToLive(val *float64) {
	if err := j.validateSetEventTimeToLiveParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (e *jsiiProxy_EventgridSystemTopicEventSubscriptionRetryPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_EventgridSystemTopicEventSubscriptionRetryPolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
