...
func NewEventgridSystemTopicEventSubscriptionAdvancedFilterNumberNotInList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) EventgridSystemTopicEventSubscriptionAdvancedFilterNumberNotInList {
	...
	if err := validateNewEventgridSystemTopicEventSubscriptionAdvancedFilterNumberNotInListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_EventgridSystemTopicEventSubscriptionAdvancedFilterNumberNotInList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (e *jsiiProxy_EventgridSystemTopicEventSubscriptionAdvancedFilterNumberNotInList) Resolve(context cdktf.IResolveContext) interface{} {
