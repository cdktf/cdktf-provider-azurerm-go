...
func NewEventgridSystemTopicEventSubscriptionDeliveryPropertyList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) EventgridSystemTopicEventSubscriptionDeliveryPropertyList {
	...
	if err := validateNewEventgridSystemTopicEventSubscriptionDeliveryPropertyListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_EventgridSystemTopicEventSubscriptionDeliveryPropertyList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (e *jsiiProxy_EventgridSystemTopicEventSubscriptionDeliveryPropertyList) Resolve(context cdktf.IResolveContext) interface{} {
