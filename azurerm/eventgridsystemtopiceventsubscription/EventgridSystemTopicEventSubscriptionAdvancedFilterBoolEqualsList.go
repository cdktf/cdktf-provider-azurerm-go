...
func (e *jsiiProxy_EventgridSystemTopicEventSubscriptionAdvancedFilterBoolEqualsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (e *jsiiProxy_EventgridSystemTopicEventSubscriptionAdvancedFilterBoolEqualsList) Resolve(context cdktf.IResolveContext) interface{} {
