...
func NewEventgridSystemTopicEventSubscriptionAdvancedFilterStringNotInOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) EventgridSystemTopicEventSubscriptionAdvancedFilterStringNotInOutputReference {
	...
	if err := validateNewEventgridSystemTopicEventSubscriptionAdvancedFilterStringNotInOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_EventgridSystemTopicEventSubscriptionAdvancedFilterStringNotInOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_EventgridSystemTopicEventSubscriptionAdvancedFilterStringNotInOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
