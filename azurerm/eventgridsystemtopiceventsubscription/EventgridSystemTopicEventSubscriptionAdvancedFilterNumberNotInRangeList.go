...
func NewEventgridSystemTopicEventSubscriptionAdvancedFilterNumberNotInRangeList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) EventgridSystemTopicEventSubscriptionAdvancedFilterNumberNotInRangeList {
	...
	if err := validateNewEventgridSystemTopicEventSubscriptionAdvancedFilterNumberNotInRangeListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_EventgridSystemTopicEventSubscriptionAdvancedFilterNumberNotInRangeList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (e *jsiiProxy_EventgridSystemTopicEventSubscriptionAdvancedFilterNumberNotInRangeList) Resolve(context cdktf.IResolveContext) interface{} {
