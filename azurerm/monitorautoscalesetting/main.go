...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "predictive", GoGetter: "Predictive"},
			_jsii_.MemberProperty{JsiiProperty: "predictiveInput", GoGetter: "PredictiveInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putPredictive", GoMethod: "PutPredictive"},
			_jsii_.MemberMethod{JsiiMethod: "putProfile", GoMethod: "PutProfile"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPredictive", GoMethod: "ResetPredictive"},
			...
			_jsii_.MemberProperty{JsiiProperty: "targetResourceId", GoGetter: "TargetResourceId"},
			_jsii_.MemberProperty{JsiiProperty: "targetResourceIdInput", GoGetter: "TargetResourceIdInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "customEmails", GoGetter: "CustomEmails"},
			_jsii_.MemberProperty{JsiiProperty: "customEmailsInput", GoGetter: "CustomEmailsInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetCustomEmails", GoMethod: "ResetCustomEmails"},
			_jsii_.MemberMethod{JsiiMethod: "resetSendToSubscriptionAdministrator", GoMethod: "ResetSendToSubscriptionAdministrator"},
			_jsii_.MemberMethod{JsiiMethod: "resetSendToSubscriptionCoAdministrator", GoMethod: "ResetSendToSubscriptionCoAdministrator"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "sendToSubscriptionAdministrator", GoGetter: "SendToSubscriptionAdministrator"},
			_jsii_.MemberProperty{JsiiProperty: "sendToSubscriptionAdministratorInput", GoGetter: "SendToSubscriptionAdministratorInput"},
			_jsii_.MemberProperty{JsiiProperty: "sendToSubscriptionCoAdministrator", GoGetter: "SendToSubscriptionCoAdministrator"},
			_jsii_.MemberProperty{JsiiProperty: "sendToSubscriptionCoAdministratorInput", GoGetter: "SendToSubscriptionCoAdministratorInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "lookAheadTime", GoGetter: "LookAheadTime"},
			_jsii_.MemberProperty{JsiiProperty: "lookAheadTimeInput", GoGetter: "LookAheadTimeInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetLookAheadTime", GoMethod: "ResetLookAheadTime"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "scaleMode", GoGetter: "ScaleMode"},
			_jsii_.MemberProperty{JsiiProperty: "scaleModeInput", GoGetter: "ScaleModeInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		},
		func() interface{} {
			j := jsiiProxy_MonitorAutoscaleSettingPredictiveOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fixedDate", GoGetter: "FixedDate"},
			_jsii_.MemberProperty{JsiiProperty: "fixedDateInput", GoGetter: "FixedDateInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putFixedDate", GoMethod: "PutFixedDate"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetFixedDate", GoMethod: "ResetFixedDate"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "divideByInstanceCount", GoGetter: "DivideByInstanceCount"},
			_jsii_.MemberProperty{JsiiProperty: "divideByInstanceCountInput", GoGetter: "DivideByInstanceCountInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			...
			_jsii_.MemberProperty{JsiiProperty: "metricResourceId", GoGetter: "MetricResourceId"},
			_jsii_.MemberProperty{JsiiProperty: "metricResourceIdInput", GoGetter: "MetricResourceIdInput"},
			_jsii_.MemberProperty{JsiiProperty: "operator", GoGetter: "Operator"},
			_jsii_.MemberProperty{JsiiProperty: "operatorInput", GoGetter: "OperatorInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDivideByInstanceCount", GoMethod: "ResetDivideByInstanceCount"},
			_jsii_.MemberMethod{JsiiMethod: "resetMetricNamespace", GoMethod: "ResetMetricNamespace"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			...
			_jsii_.MemberProperty{JsiiProperty: "timeAggregation", GoGetter: "TimeAggregation"},
			_jsii_.MemberProperty{JsiiProperty: "timeAggregationInput", GoGetter: "TimeAggregationInput"},
			_jsii_.MemberProperty{JsiiProperty: "timeGrain", GoGetter: "TimeGrain"},
			_jsii_.MemberProperty{JsiiProperty: "timeGrainInput", GoGetter: "TimeGrainInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putScaleAction", GoMethod: "PutScaleAction"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "scaleAction", GoGetter: "ScaleAction"},
			_jsii_.MemberProperty{JsiiProperty: "scaleActionInput", GoGetter: "ScaleActionInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		},
