...
func (m *jsiiProxy_MonitorAutoscaleSettingProfileCapacityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MonitorAutoscaleSettingProfileCapacityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
