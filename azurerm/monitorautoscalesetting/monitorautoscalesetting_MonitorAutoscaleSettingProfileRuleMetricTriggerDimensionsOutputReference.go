...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/monitorautoscalesetting/internal"
...
func NewMonitorAutoscaleSettingProfileRuleMetricTriggerDimensionsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) MonitorAutoscaleSettingProfileRuleMetricTriggerDimensionsOutputReference {
	...
	if err := validateNewMonitorAutoscaleSettingProfileRuleMetricTriggerDimensionsOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
