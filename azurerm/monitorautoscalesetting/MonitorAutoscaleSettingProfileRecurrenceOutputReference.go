...
func NewMonitorAutoscaleSettingProfileRecurrenceOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) MonitorAutoscaleSettingProfileRecurrenceOutputReference {
	...
	if err := validateNewMonitorAutoscaleSettingProfileRecurrenceOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_MonitorAutoscaleSettingProfileRecurrenceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MonitorAutoscaleSettingProfileRecurrenceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
