...
func NewMonitorMetricAlertActionList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MonitorMetricAlertActionList {
	...
	if err := validateNewMonitorMetricAlertActionListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_MonitorMetricAlertActionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MonitorMetricAlertActionList) Resolve(context cdktf.IResolveContext) interface{} {
