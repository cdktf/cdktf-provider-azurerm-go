...
func NewMonitorMetricAlertDynamicCriteriaDimensionList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MonitorMetricAlertDynamicCriteriaDimensionList {
	...
	if err := validateNewMonitorMetricAlertDynamicCriteriaDimensionListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_MonitorMetricAlertDynamicCriteriaDimensionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MonitorMetricAlertDynamicCriteriaDimensionList) Resolve(context cdktf.IResolveContext) interface{} {
