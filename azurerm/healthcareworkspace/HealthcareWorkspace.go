...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/healthcareworkspace/internal"
...
func (j *jsiiProxy_HealthcareWorkspace) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_HealthcareWorkspace)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
