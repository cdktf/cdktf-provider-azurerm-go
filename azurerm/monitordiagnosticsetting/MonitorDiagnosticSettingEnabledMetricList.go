...
func (j *jsiiProxy_MonitorDiagnosticSettingEnabledMetricList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewMonitorDiagnosticSettingEnabledMetricList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MonitorDiagnosticSettingEnabledMetricList {
	_init_.Initialize()
...
func NewMonitorDiagnosticSettingEnabledMetricList_Override(m MonitorDiagnosticSettingEnabledMetricList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_MonitorDiagnosticSettingEnabledMetricList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (m *jsiiProxy_MonitorDiagnosticSettingEnabledMetricList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MonitorDiagnosticSettingEnabledMetricList) Resolve(_context cdktf.IResolveContext) interface{} {
