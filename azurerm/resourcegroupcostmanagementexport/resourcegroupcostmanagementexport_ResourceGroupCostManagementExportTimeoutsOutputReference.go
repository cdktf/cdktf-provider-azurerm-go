...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/resourcegroupcostmanagementexport/internal"
...
func NewResourceGroupCostManagementExportTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) ResourceGroupCostManagementExportTimeoutsOutputReference {
	...
	if err := validateNewResourceGroupCostManagementExportTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
