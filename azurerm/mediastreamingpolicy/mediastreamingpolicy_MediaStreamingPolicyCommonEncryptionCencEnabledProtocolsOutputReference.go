...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v3/mediastreamingpolicy/internal"
...
func NewMediaStreamingPolicyCommonEncryptionCencEnabledProtocolsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) MediaStreamingPolicyCommonEncryptionCencEnabledProtocolsOutputReference {
	...
	if err := validateNewMediaStreamingPolicyCommonEncryptionCencEnabledProtocolsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
