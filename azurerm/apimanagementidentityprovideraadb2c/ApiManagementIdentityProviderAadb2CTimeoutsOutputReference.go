...
func NewApiManagementIdentityProviderAadb2CTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) ApiManagementIdentityProviderAadb2CTimeoutsOutputReference {
	...
	if err := validateNewApiManagementIdentityProviderAadb2CTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApiManagementIdentityProviderAadb2CTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApiManagementIdentityProviderAadb2CTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
