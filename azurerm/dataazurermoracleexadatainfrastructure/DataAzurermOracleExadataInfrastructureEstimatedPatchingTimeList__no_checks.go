...
func (d *jsiiProxy_DataAzurermOracleExadataInfrastructureEstimatedPatchingTimeList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_DataAzurermOracleExadataInfrastructureEstimatedPatchingTimeList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_DataAzurermOracleExadataInfrastructureEstimatedPatchingTimeList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
