...
func (j *jsiiProxy_IothubDpsCertificate) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_IothubDpsCertificate) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_IothubDpsCertificate) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_IothubDpsCertificate) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_IothubDpsCertificate) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func NewIothubDpsCertificate(scope constructs.Construct, id *string, config *IothubDpsCertificateConfig) IothubDpsCertificate {
	...
	_jsii_.Create(
		"@cdktf/provider-azurerm.iothubDpsCertificate.IothubDpsCertificate",
...
func (j *jsiiProxy_IothubDpsCertificate)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
...
func (j *jsiiProxy_IothubDpsCertificate)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IothubDpsCertificate)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_IothubDpsCertificate)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (i *jsiiProxy_IothubDpsCertificate) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IothubDpsCertificate) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
