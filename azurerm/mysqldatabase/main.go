...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*MysqlDatabase)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_MysqlDatabase{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfTerraformResource)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurerm.mysqlDatabase.MysqlDatabaseConfig",
		reflect.TypeOf((*MysqlDatabaseConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurerm.mysqlDatabase.MysqlDatabaseTimeouts",
		reflect.TypeOf((*MysqlDatabaseTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-azurerm.mysqlDatabase.MysqlDatabaseTimeoutsOutputReference",
		reflect.TypeOf((*MysqlDatabaseTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_MysqlDatabaseTimeoutsOutputReference{}
