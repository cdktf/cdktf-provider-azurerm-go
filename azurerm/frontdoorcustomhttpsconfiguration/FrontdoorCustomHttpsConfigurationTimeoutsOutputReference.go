...
func NewFrontdoorCustomHttpsConfigurationTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) FrontdoorCustomHttpsConfigurationTimeoutsOutputReference {
	...
	if err := validateNewFrontdoorCustomHttpsConfigurationTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (f *jsiiProxy_FrontdoorCustomHttpsConfigurationTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FrontdoorCustomHttpsConfigurationTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
