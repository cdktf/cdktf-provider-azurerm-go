...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/virtualhubroutetableroute/internal"
...
func NewVirtualHubRouteTableRouteTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) VirtualHubRouteTableRouteTimeoutsOutputReference {
	...
	if err := validateNewVirtualHubRouteTableRouteTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (v *jsiiProxy_VirtualHubRouteTableRouteTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VirtualHubRouteTableRouteTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
