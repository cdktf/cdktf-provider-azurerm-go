...
func (m *jsiiProxy_MaintenanceAssignmentDynamicScopeFilterOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MaintenanceAssignmentDynamicScopeFilterOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
