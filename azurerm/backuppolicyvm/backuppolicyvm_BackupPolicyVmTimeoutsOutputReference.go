...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/backuppolicyvm/internal"
...
func NewBackupPolicyVmTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) BackupPolicyVmTimeoutsOutputReference {
	...
	if err := validateNewBackupPolicyVmTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
