...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "instantRestoreResourceGroup", GoGetter: "InstantRestoreResourceGroup"},
			_jsii_.MemberProperty{JsiiProperty: "instantRestoreResourceGroupInput", GoGetter: "InstantRestoreResourceGroupInput"},
			_jsii_.MemberProperty{JsiiProperty: "instantRestoreRetentionDays", GoGetter: "InstantRestoreRetentionDays"},
			_jsii_.MemberProperty{JsiiProperty: "instantRestoreRetentionDaysInput", GoGetter: "InstantRestoreRetentionDaysInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putInstantRestoreResourceGroup", GoMethod: "PutInstantRestoreResourceGroup"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetInstantRestoreResourceGroup", GoMethod: "ResetInstantRestoreResourceGroup"},
			_jsii_.MemberMethod{JsiiMethod: "resetInstantRestoreRetentionDays", GoMethod: "ResetInstantRestoreRetentionDays"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "getStringAttribute", GoMethod: "GetStringAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getStringMapAttribute", GoMethod: "GetStringMapAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "hourDuration", GoGetter: "HourDuration"},
			_jsii_.MemberProperty{JsiiProperty: "hourDurationInput", GoGetter: "HourDurationInput"},
			_jsii_.MemberProperty{JsiiProperty: "hourInterval", GoGetter: "HourInterval"},
			_jsii_.MemberProperty{JsiiProperty: "hourIntervalInput", GoGetter: "HourIntervalInput"},
			_jsii_.MemberProperty{JsiiProperty: "internalValue", GoGetter: "InternalValue"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetHourDuration", GoMethod: "ResetHourDuration"},
			_jsii_.MemberMethod{JsiiMethod: "resetHourInterval", GoMethod: "ResetHourInterval"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_BackupPolicyVmInstantRestoreResourceGroupOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "getStringAttribute", GoMethod: "GetStringAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getStringMapAttribute", GoMethod: "GetStringMapAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "includeLastDays", GoGetter: "IncludeLastDays"},
			_jsii_.MemberProperty{JsiiProperty: "includeLastDaysInput", GoGetter: "IncludeLastDaysInput"},
			_jsii_.MemberProperty{JsiiProperty: "internalValue", GoGetter: "InternalValue"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetDays", GoMethod: "ResetDays"},
			_jsii_.MemberMethod{JsiiMethod: "resetIncludeLastDays", GoMethod: "ResetIncludeLastDays"},
			_jsii_.MemberMethod{JsiiMethod: "resetWeekdays", GoMethod: "ResetWeekdays"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_BackupPolicyVmTieringPolicyArchivedRestorePointOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "archivedRestorePointInput", GoGetter: "ArchivedRestorePointInput"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "putArchivedRestorePoint", GoMethod: "PutArchivedRestorePoint"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		...
		func() interface{} {
			j := jsiiProxy_BackupPolicyVmTieringPolicyOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
