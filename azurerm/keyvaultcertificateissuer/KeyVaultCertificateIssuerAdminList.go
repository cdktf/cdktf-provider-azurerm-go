...
func (k *jsiiProxy_KeyVaultCertificateIssuerAdminList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (k *jsiiProxy_KeyVaultCertificateIssuerAdminList) Resolve(context cdktf.IResolveContext) interface{} {
