...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/keyvaultcertificateissuer/internal"
...
func (j *jsiiProxy_KeyVaultCertificateIssuer) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.49.0/docs/resources/key_vault_certificate_issuer azurerm_key_vault_certificate_issuer} Resource.
func NewKeyVaultCertificateIssuer(scope constructs.Construct, id *string, config *KeyVaultCertificateIssuerConfig) KeyVaultCertificateIssuer {
	...
	if err := validateNewKeyVaultCertificateIssuerParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_KeyVaultCertificateIssuer)SetCount(val interface{}) {
...
func KeyVaultCertificateIssuer_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateKeyVaultCertificateIssuer_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func KeyVaultCertificateIssuer_IsConstruct(x interface{}) *bool {
	...
	if err := validateKeyVaultCertificateIssuer_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func KeyVaultCertificateIssuer_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateKeyVaultCertificateIssuer_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func KeyVaultCertificateIssuer_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateKeyVaultCertificateIssuer_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (k *jsiiProxy_KeyVaultCertificateIssuer) AddMoveTarget(moveTarget *string) {
...
func (k *jsiiProxy_KeyVaultCertificateIssuer) HasResourceMove() interface{} {
	var returns interface{}
...
func (k *jsiiProxy_KeyVaultCertificateIssuer) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (k *jsiiProxy_KeyVaultCertificateIssuer) MoveFromId(id *string) {
...
func (k *jsiiProxy_KeyVaultCertificateIssuer) MoveTo(moveTarget *string, index interface{}) {
...
func (k *jsiiProxy_KeyVaultCertificateIssuer) MoveToId(id *string) {
...
func (k *jsiiProxy_KeyVaultCertificateIssuer) PutAdmin(value interface{}) {
	if err := k.validatePutAdminParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		k,
...
func (k *jsiiProxy_KeyVaultCertificateIssuer) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (k *jsiiProxy_KeyVaultCertificateIssuer) ToHclTerraform() interface{} {
	var returns interface{}
