...
func NewMonitorScheduledQueryRulesLogCriteriaDimensionList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MonitorScheduledQueryRulesLogCriteriaDimensionList {
	...
	if err := validateNewMonitorScheduledQueryRulesLogCriteriaDimensionListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_MonitorScheduledQueryRulesLogCriteriaDimensionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MonitorScheduledQueryRulesLogCriteriaDimensionList) Resolve(context cdktf.IResolveContext) interface{} {
