...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.112.0/docs/resources/monitor_scheduled_query_rules_log azurerm_monitor_scheduled_query_rules_log}.
...
func (j *jsiiProxy_MonitorScheduledQueryRulesLog) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.112.0/docs/resources/monitor_scheduled_query_rules_log azurerm_monitor_scheduled_query_rules_log} Resource.
func NewMonitorScheduledQueryRulesLog(scope constructs.Construct, id *string, config *MonitorScheduledQueryRulesLogConfig) MonitorScheduledQueryRulesLog {
	...
	if err := validateNewMonitorScheduledQueryRulesLogParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_MonitorScheduledQueryRulesLog)SetCount(val interface{}) {
...
func MonitorScheduledQueryRulesLog_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateMonitorScheduledQueryRulesLog_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func MonitorScheduledQueryRulesLog_IsConstruct(x interface{}) *bool {
	...
	if err := validateMonitorScheduledQueryRulesLog_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (m *jsiiProxy_MonitorScheduledQueryRulesLog) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_MonitorScheduledQueryRulesLog) HasResourceMove() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_MonitorScheduledQueryRulesLog) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (m *jsiiProxy_MonitorScheduledQueryRulesLog) MoveFromId(id *string) {
...
func (m *jsiiProxy_MonitorScheduledQueryRulesLog) MoveTo(moveTarget *string, index interface{}) {
...
func (m *jsiiProxy_MonitorScheduledQueryRulesLog) MoveToId(id *string) {
...
func (m *jsiiProxy_MonitorScheduledQueryRulesLog) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (m *jsiiProxy_MonitorScheduledQueryRulesLog) ToHclTerraform() interface{} {
	var returns interface{}
