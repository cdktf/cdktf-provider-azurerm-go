...
func NewWebPubsubIdentityOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) WebPubsubIdentityOutputReference {
	...
	if err := validateNewWebPubsubIdentityOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (w *jsiiProxy_WebPubsubIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WebPubsubIdentityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
