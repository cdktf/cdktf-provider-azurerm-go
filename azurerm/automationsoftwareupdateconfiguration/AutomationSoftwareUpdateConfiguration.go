...
func AutomationSoftwareUpdateConfiguration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateAutomationSoftwareUpdateConfiguration_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AutomationSoftwareUpdateConfiguration) AddMoveTarget(moveTarget *string) {
...
func (a *jsiiProxy_AutomationSoftwareUpdateConfiguration) HasResourceMove() interface{} {
	var returns interface{}
...
func (a *jsiiProxy_AutomationSoftwareUpdateConfiguration) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_AutomationSoftwareUpdateConfiguration) MoveFromId(id *string) {
...
func (a *jsiiProxy_AutomationSoftwareUpdateConfiguration) MoveTo(moveTarget *string, index interface{}) {
...
func (a *jsiiProxy_AutomationSoftwareUpdateConfiguration) MoveToId(id *string) {
...
func (a *jsiiProxy_AutomationSoftwareUpdateConfiguration) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (a *jsiiProxy_AutomationSoftwareUpdateConfiguration) ToHclTerraform() interface{} {
	var returns interface{}
