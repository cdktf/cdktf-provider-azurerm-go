...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v3/automationsoftwareupdateconfiguration/internal"
...
func NewAutomationSoftwareUpdateConfigurationTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) AutomationSoftwareUpdateConfigurationTimeoutsOutputReference {
	...
	if err := validateNewAutomationSoftwareUpdateConfigurationTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
