...
func NewAutomationSoftwareUpdateConfigurationTargetNonAzureQueryOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) AutomationSoftwareUpdateConfigurationTargetNonAzureQueryOutputReference {
	...
	if err := validateNewAutomationSoftwareUpdateConfigurationTargetNonAzureQueryOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_AutomationSoftwareUpdateConfigurationTargetNonAzureQueryOutputReference)SetFunctionAlias(val *string) {
	if err := j.validateSetFunctionAliasParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (a *jsiiProxy_AutomationSoftwareUpdateConfigurationTargetNonAzureQueryOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AutomationSoftwareUpdateConfigurationTargetNonAzureQueryOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
