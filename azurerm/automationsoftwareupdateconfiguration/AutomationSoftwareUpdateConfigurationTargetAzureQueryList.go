...
func NewAutomationSoftwareUpdateConfigurationTargetAzureQueryList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) AutomationSoftwareUpdateConfigurationTargetAzureQueryList {
	...
	if err := validateNewAutomationSoftwareUpdateConfigurationTargetAzureQueryListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_AutomationSoftwareUpdateConfigurationTargetAzureQueryList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_AutomationSoftwareUpdateConfigurationTargetAzureQueryList) Resolve(context cdktf.IResolveContext) interface{} {
