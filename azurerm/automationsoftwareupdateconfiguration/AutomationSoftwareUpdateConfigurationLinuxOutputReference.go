...
func (j *jsiiProxy_AutomationSoftwareUpdateConfigurationLinuxOutputReference)SetExcludedPackages(val *[]*string) {
	if err := j.validateSetExcludedPackagesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_AutomationSoftwareUpdateConfigurationLinuxOutputReference)SetIncludedPackages(val *[]*string) {
	if err := j.validateSetIncludedPackagesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (a *jsiiProxy_AutomationSoftwareUpdateConfigurationLinuxOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AutomationSoftwareUpdateConfigurationLinuxOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
