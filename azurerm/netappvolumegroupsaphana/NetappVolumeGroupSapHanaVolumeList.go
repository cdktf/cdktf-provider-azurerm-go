...
func (n *jsiiProxy_NetappVolumeGroupSapHanaVolumeList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (n *jsiiProxy_NetappVolumeGroupSapHanaVolumeList) Resolve(context cdktf.IResolveContext) interface{} {
