...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/dataazurermdataprotectionbackupvault/internal"
...
func NewDataAzurermDataProtectionBackupVault(scope constructs.Construct, id *string, config *DataAzurermDataProtectionBackupVaultConfig) DataAzurermDataProtectionBackupVault {
	...
	if err := validateNewDataAzurermDataProtectionBackupVaultParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAzurermDataProtectionBackupVault_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAzurermDataProtectionBackupVault_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAzurermDataProtectionBackupVault_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAzurermDataProtectionBackupVault_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAzurermDataProtectionBackupVault_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAzurermDataProtectionBackupVault_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
