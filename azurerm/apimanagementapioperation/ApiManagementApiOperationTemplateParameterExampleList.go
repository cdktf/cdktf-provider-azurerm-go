...
func NewApiManagementApiOperationTemplateParameterExampleList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiManagementApiOperationTemplateParameterExampleList {
	...
	if err := validateNewApiManagementApiOperationTemplateParameterExampleListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApiManagementApiOperationTemplateParameterExampleList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementApiOperationTemplateParameterExampleList) Resolve(context cdktf.IResolveContext) interface{} {
