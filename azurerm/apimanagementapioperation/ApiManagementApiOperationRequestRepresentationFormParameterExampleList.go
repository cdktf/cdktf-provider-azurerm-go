...
func NewApiManagementApiOperationRequestRepresentationFormParameterExampleList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiManagementApiOperationRequestRepresentationFormParameterExampleList {
	...
	if err := validateNewApiManagementApiOperationRequestRepresentationFormParameterExampleListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApiManagementApiOperationRequestRepresentationFormParameterExampleList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementApiOperationRequestRepresentationFormParameterExampleList) Resolve(context cdktf.IResolveContext) interface{} {
