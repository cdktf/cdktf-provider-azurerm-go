...
func NewApiManagementApiOperationResponseRepresentationFormParameterExampleOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ApiManagementApiOperationResponseRepresentationFormParameterExampleOutputReference {
	...
	if err := validateNewApiManagementApiOperationResponseRepresentationFormParameterExampleOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_ApiManagementApiOperationResponseRepresentationFormParameterExampleOutputReference)SetExternalValue(val *string) {
	if err := j.validateSetExternalValueParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (a *jsiiProxy_ApiManagementApiOperationResponseRepresentationFormParameterExampleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApiManagementApiOperationResponseRepresentationFormParameterExampleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
