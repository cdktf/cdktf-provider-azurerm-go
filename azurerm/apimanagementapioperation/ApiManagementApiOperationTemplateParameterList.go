...
func NewApiManagementApiOperationTemplateParameterList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiManagementApiOperationTemplateParameterList {
	...
	if err := validateNewApiManagementApiOperationTemplateParameterListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApiManagementApiOperationTemplateParameterList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementApiOperationTemplateParameterList) Resolve(context cdktf.IResolveContext) interface{} {
