...
func NewApiManagementApiOperationResponseHeaderExampleOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ApiManagementApiOperationResponseHeaderExampleOutputReference {
	...
	if err := validateNewApiManagementApiOperationResponseHeaderExampleOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApiManagementApiOperationResponseHeaderExampleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApiManagementApiOperationResponseHeaderExampleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
