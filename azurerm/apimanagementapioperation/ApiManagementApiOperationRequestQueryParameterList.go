...
func NewApiManagementApiOperationRequestQueryParameterList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiManagementApiOperationRequestQueryParameterList {
	...
	if err := validateNewApiManagementApiOperationRequestQueryParameterListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApiManagementApiOperationRequestQueryParameterList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementApiOperationRequestQueryParameterList) Resolve(context cdktf.IResolveContext) interface{} {
