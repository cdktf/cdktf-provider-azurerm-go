...
func NewApiManagementApiOperationRequestRepresentationExampleOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ApiManagementApiOperationRequestRepresentationExampleOutputReference {
	...
	if err := validateNewApiManagementApiOperationRequestRepresentationExampleOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApiManagementApiOperationRequestRepresentationExampleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApiManagementApiOperationRequestRepresentationExampleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
