...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/firewallnetworkrulecollection/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.37.0/docs/resources/firewall_network_rule_collection azurerm_firewall_network_rule_collection}.
...
func (j *jsiiProxy_FirewallNetworkRuleCollection) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_FirewallNetworkRuleCollection) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_FirewallNetworkRuleCollection) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_FirewallNetworkRuleCollection) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_FirewallNetworkRuleCollection) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.37.0/docs/resources/firewall_network_rule_collection azurerm_firewall_network_rule_collection} Resource.
...
func (j *jsiiProxy_FirewallNetworkRuleCollection)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_FirewallNetworkRuleCollection)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_FirewallNetworkRuleCollection)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func FirewallNetworkRuleCollection_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (f *jsiiProxy_FirewallNetworkRuleCollection) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FirewallNetworkRuleCollection) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
