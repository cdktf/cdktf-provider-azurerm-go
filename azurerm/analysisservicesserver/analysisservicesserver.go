...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "backupBlobContainerUri", GoGetter: "BackupBlobContainerUri"},
			_jsii_.MemberProperty{JsiiProperty: "backupBlobContainerUriInput", GoGetter: "BackupBlobContainerUriInput"},
			_jsii_.MemberProperty{JsiiProperty: "cdktfStack", GoGetter: "CdktfStack"},
			_jsii_.MemberProperty{JsiiProperty: "connection", GoGetter: "Connection"},
			_jsii_.MemberProperty{JsiiProperty: "constructNodeMetadata", GoGetter: "ConstructNodeMetadata"},
			_jsii_.MemberProperty{JsiiProperty: "count", GoGetter: "Count"},
			_jsii_.MemberProperty{JsiiProperty: "dependsOn", GoGetter: "DependsOn"},
			_jsii_.MemberProperty{JsiiProperty: "enablePowerBiService", GoGetter: "EnablePowerBiService"},
			_jsii_.MemberProperty{JsiiProperty: "enablePowerBiServiceInput", GoGetter: "EnablePowerBiServiceInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "ipv4FirewallRule", GoGetter: "Ipv4FirewallRule"},
			_jsii_.MemberProperty{JsiiProperty: "ipv4FirewallRuleInput", GoGetter: "Ipv4FirewallRuleInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putIpv4FirewallRule", GoMethod: "PutIpv4FirewallRule"},
			_jsii_.MemberMethod{JsiiMethod: "putTimeouts", GoMethod: "PutTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "querypoolConnectionMode", GoGetter: "QuerypoolConnectionMode"},
			_jsii_.MemberProperty{JsiiProperty: "querypoolConnectionModeInput", GoGetter: "QuerypoolConnectionModeInput"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetAdminUsers", GoMethod: "ResetAdminUsers"},
			_jsii_.MemberMethod{JsiiMethod: "resetBackupBlobContainerUri", GoMethod: "ResetBackupBlobContainerUri"},
			_jsii_.MemberMethod{JsiiMethod: "resetEnablePowerBiService", GoMethod: "ResetEnablePowerBiService"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetIpv4FirewallRule", GoMethod: "ResetIpv4FirewallRule"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetQuerypoolConnectionMode", GoMethod: "ResetQuerypoolConnectionMode"},
			_jsii_.MemberMethod{JsiiMethod: "resetTags", GoMethod: "ResetTags"},
			_jsii_.MemberMethod{JsiiMethod: "resetTimeouts", GoMethod: "ResetTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "resourceGroupName", GoGetter: "ResourceGroupName"},
			_jsii_.MemberProperty{JsiiProperty: "resourceGroupNameInput", GoGetter: "ResourceGroupNameInput"},
			_jsii_.MemberProperty{JsiiProperty: "serverFullName", GoGetter: "ServerFullName"},
