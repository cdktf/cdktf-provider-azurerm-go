...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LogAnalyticsLinkedStorageAccount)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "storageAccountIdsInput", GoGetter: "StorageAccountIdsInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurerm.logAnalyticsLinkedStorageAccount.LogAnalyticsLinkedStorageAccountConfig",
		reflect.TypeOf((*LogAnalyticsLinkedStorageAccountConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurerm.logAnalyticsLinkedStorageAccount.LogAnalyticsLinkedStorageAccountTimeouts",
		reflect.TypeOf((*LogAnalyticsLinkedStorageAccountTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-azurerm.logAnalyticsLinkedStorageAccount.LogAnalyticsLinkedStorageAccountTimeoutsOutputReference",
		reflect.TypeOf((*LogAnalyticsLinkedStorageAccountTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
