...
func (d *jsiiProxy_DataAzurermNetappVolumeGroupOracleVolumeExportPolicyRuleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAzurermNetappVolumeGroupOracleVolumeExportPolicyRuleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
