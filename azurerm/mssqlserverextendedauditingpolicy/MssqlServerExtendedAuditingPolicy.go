...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/mssqlserverextendedauditingpolicy/internal"
...
func (j *jsiiProxy_MssqlServerExtendedAuditingPolicy) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_MssqlServerExtendedAuditingPolicy)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
