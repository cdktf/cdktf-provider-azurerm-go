...
func NewFunctionAppFunctionFileOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) FunctionAppFunctionFileOutputReference {
	...
	if err := validateNewFunctionAppFunctionFileOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (f *jsiiProxy_FunctionAppFunctionFileOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FunctionAppFunctionFileOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
