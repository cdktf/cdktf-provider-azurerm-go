...
func (s *jsiiProxy_StackHciDeploymentSettingScaleUnitHostNetworkOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StackHciDeploymentSettingScaleUnitHostNetworkOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
