...
func (d *jsiiProxy_DataAzurermConfidentialLedgerCertificateBasedSecurityPrincipalList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermConfidentialLedgerCertificateBasedSecurityPrincipalList) Resolve(context cdktf.IResolveContext) interface{} {
