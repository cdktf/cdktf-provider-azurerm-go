...
func (r *jsiiProxy_RoleDefinitionPermissionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_RoleDefinitionPermissionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
