...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAssignableScopes", GoMethod: "ResetAssignableScopes"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "notDataActions", GoGetter: "NotDataActions"},
			_jsii_.MemberProperty{JsiiProperty: "notDataActionsInput", GoGetter: "NotDataActionsInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetActions", GoMethod: "ResetActions"},
			_jsii_.MemberMethod{JsiiMethod: "resetDataActions", GoMethod: "ResetDataActions"},
			_jsii_.MemberMethod{JsiiMethod: "resetNotActions", GoMethod: "ResetNotActions"},
			_jsii_.MemberMethod{JsiiMethod: "resetNotDataActions", GoMethod: "ResetNotDataActions"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_RoleDefinitionTimeoutsOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
