...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v11/medialiveeventoutput/internal"
...
func NewMediaLiveEventOutputTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) MediaLiveEventOutputTimeoutsOutputReference {
	...
	if err := validateNewMediaLiveEventOutputTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
