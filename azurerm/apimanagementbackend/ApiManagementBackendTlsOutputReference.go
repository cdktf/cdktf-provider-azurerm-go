...
func NewApiManagementBackendTlsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) ApiManagementBackendTlsOutputReference {
	...
	if err := validateNewApiManagementBackendTlsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_ApiManagementBackendTlsOutputReference)SetValidateCertificateChain(val interface{}) {
	if err := j.validateSetValidateCertificateChainParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_ApiManagementBackendTlsOutputReference)SetValidateCertificateName(val interface{}) {
	if err := j.validateSetValidateCertificateNameParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (a *jsiiProxy_ApiManagementBackendTlsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApiManagementBackendTlsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
