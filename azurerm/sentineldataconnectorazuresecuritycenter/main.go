...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SentinelDataConnectorAzureSecurityCenter)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurerm.sentinelDataConnectorAzureSecurityCenter.SentinelDataConnectorAzureSecurityCenterConfig",
		reflect.TypeOf((*SentinelDataConnectorAzureSecurityCenterConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurerm.sentinelDataConnectorAzureSecurityCenter.SentinelDataConnectorAzureSecurityCenterTimeouts",
		reflect.TypeOf((*SentinelDataConnectorAzureSecurityCenterTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SentinelDataConnectorAzureSecurityCenterTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
