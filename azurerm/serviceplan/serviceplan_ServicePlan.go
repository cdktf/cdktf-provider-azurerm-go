...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/serviceplan/internal"
...
func NewServicePlan(scope constructs.Construct, id *string, config *ServicePlanConfig) ServicePlan {
	...
	if err := validateNewServicePlanParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_ServicePlan)SetAppServiceEnvironmentId(val *string) {
	if err := j.validateSetAppServiceEnvironmentIdParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_ServicePlan)SetMaximumElasticWorkerCount(val *float64) {
	if err := j.validateSetMaximumElasticWorkerCountParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_ServicePlan)SetPerSiteScalingEnabled(val interface{}) {
	if err := j.validateSetPerSiteScalingEnabledParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func ServicePlan_IsConstruct(x interface{}) *bool {
	...
	if err := validateServicePlan_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ServicePlan_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateServicePlan_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ServicePlan_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateServicePlan_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
