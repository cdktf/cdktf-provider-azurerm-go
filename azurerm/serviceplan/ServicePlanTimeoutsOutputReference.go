...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/serviceplan/internal"
...
func NewServicePlanTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) ServicePlanTimeoutsOutputReference {
	...
	if err := validateNewServicePlanTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_ServicePlanTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_ServicePlanTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
