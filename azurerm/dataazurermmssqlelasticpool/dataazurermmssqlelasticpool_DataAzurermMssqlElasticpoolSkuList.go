...
import (
	...
	"github.com/hashicorp/cdktf-provider-azurerm-go/azurerm/v3/dataazurermmssqlelasticpool/internal"
...
func (j *jsiiProxy_DataAzurermMssqlElasticpoolSkuList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataAzurermMssqlElasticpoolSkuList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermMssqlElasticpoolSkuList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktf/provider-azurerm.dataAzurermMssqlElasticpool.DataAzurermMssqlElasticpoolSkuList",
...
func NewDataAzurermMssqlElasticpoolSkuList_Override(d DataAzurermMssqlElasticpoolSkuList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermMssqlElasticpoolSkuList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermMssqlElasticpoolSkuList) Resolve(_context cdktf.IResolveContext) interface{} {
