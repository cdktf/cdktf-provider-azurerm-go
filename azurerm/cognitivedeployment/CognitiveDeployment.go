...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v11/cognitivedeployment/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.84.0/docs/resources/cognitive_deployment azurerm_cognitive_deployment}.
...
func (j *jsiiProxy_CognitiveDeployment) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_CognitiveDeployment) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_CognitiveDeployment) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_CognitiveDeployment) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_CognitiveDeployment) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.84.0/docs/resources/cognitive_deployment azurerm_cognitive_deployment} Resource.
...
func (j *jsiiProxy_CognitiveDeployment)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_CognitiveDeployment)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_CognitiveDeployment)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func CognitiveDeployment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_CognitiveDeployment) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CognitiveDeployment) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_CognitiveDeployment) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
