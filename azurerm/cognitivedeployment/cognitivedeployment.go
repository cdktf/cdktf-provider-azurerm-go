...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "cognitiveAccountId", GoGetter: "CognitiveAccountId"},
			_jsii_.MemberProperty{JsiiProperty: "cognitiveAccountIdInput", GoGetter: "CognitiveAccountIdInput"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_CognitiveDeploymentModelOutputReference{}
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_CognitiveDeploymentTimeoutsOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
