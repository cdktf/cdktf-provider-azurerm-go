...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/springcloudbuilddeployment/internal"
...
func NewSpringCloudBuildDeploymentQuotaOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) SpringCloudBuildDeploymentQuotaOutputReference {
	...
	if err := validateNewSpringCloudBuildDeploymentQuotaOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
