...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/functionapp/internal"
...
func NewFunctionAppAuthSettingsActiveDirectoryOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) FunctionAppAuthSettingsActiveDirectoryOutputReference {
	...
	if err := validateNewFunctionAppAuthSettingsActiveDirectoryOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
