...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/functionapp/internal"
...
func NewFunctionAppSiteConfigScmIpRestrictionList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FunctionAppSiteConfigScmIpRestrictionList {
	...
	if err := validateNewFunctionAppSiteConfigScmIpRestrictionListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (f *jsiiProxy_FunctionAppSiteConfigScmIpRestrictionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FunctionAppSiteConfigScmIpRestrictionList) Resolve(context cdktf.IResolveContext) interface{} {
