...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v3/springcloudgateway/internal"
...
func NewSpringCloudGatewayTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) SpringCloudGatewayTimeoutsOutputReference {
	...
	if err := validateNewSpringCloudGatewayTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
