...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/springcloudgateway/internal"
...
func NewSpringCloudGatewaySsoOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) SpringCloudGatewaySsoOutputReference {
	...
	if err := validateNewSpringCloudGatewaySsoOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
