...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.104.0/docs/resources/spring_cloud_gateway azurerm_spring_cloud_gateway}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.104.0/docs/resources/spring_cloud_gateway azurerm_spring_cloud_gateway} Resource.
...
func (s *jsiiProxy_SpringCloudGateway) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SpringCloudGateway) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SpringCloudGateway) MoveFromId(id *string) {
...
func (s *jsiiProxy_SpringCloudGateway) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_SpringCloudGateway) MoveToId(id *string) {
...
func (s *jsiiProxy_SpringCloudGateway) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SpringCloudGateway) ToHclTerraform() interface{} {
	var returns interface{}
