...
func (c *jsiiProxy_CosmosdbPostgresqlClusterMaintenanceWindowOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CosmosdbPostgresqlClusterMaintenanceWindowOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
