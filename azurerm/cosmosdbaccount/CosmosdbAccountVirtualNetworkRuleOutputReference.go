...
func NewCosmosdbAccountVirtualNetworkRuleOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) CosmosdbAccountVirtualNetworkRuleOutputReference {
	...
	if err := validateNewCosmosdbAccountVirtualNetworkRuleOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CosmosdbAccountVirtualNetworkRuleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CosmosdbAccountVirtualNetworkRuleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
