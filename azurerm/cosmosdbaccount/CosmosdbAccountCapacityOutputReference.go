...
func NewCosmosdbAccountCapacityOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) CosmosdbAccountCapacityOutputReference {
	...
	if err := validateNewCosmosdbAccountCapacityOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_CosmosdbAccountCapacityOutputReference)SetTotalThroughputLimit(val *float64) {
	if err := j.validateSetTotalThroughputLimitParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (c *jsiiProxy_CosmosdbAccountCapacityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CosmosdbAccountCapacityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
