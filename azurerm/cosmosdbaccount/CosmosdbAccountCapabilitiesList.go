...
func NewCosmosdbAccountCapabilitiesList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CosmosdbAccountCapabilitiesList {
	...
	if err := validateNewCosmosdbAccountCapabilitiesListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CosmosdbAccountCapabilitiesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CosmosdbAccountCapabilitiesList) Resolve(context cdktf.IResolveContext) interface{} {
