...
func NewCosmosdbAccountVirtualNetworkRuleList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CosmosdbAccountVirtualNetworkRuleList {
	...
	if err := validateNewCosmosdbAccountVirtualNetworkRuleListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CosmosdbAccountVirtualNetworkRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CosmosdbAccountVirtualNetworkRuleList) Resolve(context cdktf.IResolveContext) interface{} {
