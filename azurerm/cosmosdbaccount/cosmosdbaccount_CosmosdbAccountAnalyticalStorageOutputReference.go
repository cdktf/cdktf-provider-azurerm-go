...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/cosmosdbaccount/internal"
...
func NewCosmosdbAccountAnalyticalStorageOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) CosmosdbAccountAnalyticalStorageOutputReference {
	...
	if err := validateNewCosmosdbAccountAnalyticalStorageOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
