...
func NewCosmosdbAccountCapabilitiesOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) CosmosdbAccountCapabilitiesOutputReference {
	...
	if err := validateNewCosmosdbAccountCapabilitiesOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CosmosdbAccountCapabilitiesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CosmosdbAccountCapabilitiesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
