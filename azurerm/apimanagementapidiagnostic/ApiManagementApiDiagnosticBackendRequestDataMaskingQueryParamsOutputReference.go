...
func NewApiManagementApiDiagnosticBackendRequestDataMaskingQueryParamsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ApiManagementApiDiagnosticBackendRequestDataMaskingQueryParamsOutputReference {
	...
	if err := validateNewApiManagementApiDiagnosticBackendRequestDataMaskingQueryParamsOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApiManagementApiDiagnosticBackendRequestDataMaskingQueryParamsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApiManagementApiDiagnosticBackendRequestDataMaskingQueryParamsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
