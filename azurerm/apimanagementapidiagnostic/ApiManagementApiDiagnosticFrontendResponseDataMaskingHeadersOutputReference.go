...
func NewApiManagementApiDiagnosticFrontendResponseDataMaskingHeadersOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ApiManagementApiDiagnosticFrontendResponseDataMaskingHeadersOutputReference {
	...
	if err := validateNewApiManagementApiDiagnosticFrontendResponseDataMaskingHeadersOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApiManagementApiDiagnosticFrontendResponseDataMaskingHeadersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApiManagementApiDiagnosticFrontendResponseDataMaskingHeadersOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
