...
func NewApiManagementApiDiagnosticBackendRequestDataMaskingHeadersOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ApiManagementApiDiagnosticBackendRequestDataMaskingHeadersOutputReference {
	...
	if err := validateNewApiManagementApiDiagnosticBackendRequestDataMaskingHeadersOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApiManagementApiDiagnosticBackendRequestDataMaskingHeadersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApiManagementApiDiagnosticBackendRequestDataMaskingHeadersOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
