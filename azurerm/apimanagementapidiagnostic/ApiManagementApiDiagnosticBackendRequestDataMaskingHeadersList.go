...
func NewApiManagementApiDiagnosticBackendRequestDataMaskingHeadersList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ApiManagementApiDiagnosticBackendRequestDataMaskingHeadersList {
	...
	if err := validateNewApiManagementApiDiagnosticBackendRequestDataMaskingHeadersListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApiManagementApiDiagnosticBackendRequestDataMaskingHeadersList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_ApiManagementApiDiagnosticBackendRequestDataMaskingHeadersList) Resolve(context cdktf.IResolveContext) interface{} {
