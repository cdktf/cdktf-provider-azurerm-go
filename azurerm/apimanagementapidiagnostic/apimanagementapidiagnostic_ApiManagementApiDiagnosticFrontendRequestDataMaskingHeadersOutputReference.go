...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/apimanagementapidiagnostic/internal"
...
func NewApiManagementApiDiagnosticFrontendRequestDataMaskingHeadersOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ApiManagementApiDiagnosticFrontendRequestDataMaskingHeadersOutputReference {
	...
	if err := validateNewApiManagementApiDiagnosticFrontendRequestDataMaskingHeadersOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
