...
func (v *jsiiProxy_VirtualMachineExtensionProtectedSettingsFromKeyVaultOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VirtualMachineExtensionProtectedSettingsFromKeyVaultOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
