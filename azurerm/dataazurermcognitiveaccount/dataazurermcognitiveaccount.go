...
import (
	...
	"github.com/hashicorp/cdktf-provider-azurerm-go/azurerm/v3/dataazurermcognitiveaccount/internal"
...
func (j *jsiiProxy_DataAzurermCognitiveAccount) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_DataAzurermCognitiveAccount) SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
...
func NewDataAzurermCognitiveAccountTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DataAzurermCognitiveAccountTimeoutsOutputReference {
	...
	_jsii_.Create(
		"@cdktf/provider-azurerm.dataAzurermCognitiveAccount.DataAzurermCognitiveAccountTimeoutsOutputReference",
