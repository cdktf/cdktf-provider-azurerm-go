...
func NewMssqlDatabaseTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) MssqlDatabaseTimeoutsOutputReference {
	...
	if err := validateNewMssqlDatabaseTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_MssqlDatabaseTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MssqlDatabaseTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
