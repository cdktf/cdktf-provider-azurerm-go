...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/datafactorylinkedservicekeyvault/internal"
...
func NewDataFactoryLinkedServiceKeyVaultTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DataFactoryLinkedServiceKeyVaultTimeoutsOutputReference {
	...
	if err := validateNewDataFactoryLinkedServiceKeyVaultTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataFactoryLinkedServiceKeyVaultTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataFactoryLinkedServiceKeyVaultTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
