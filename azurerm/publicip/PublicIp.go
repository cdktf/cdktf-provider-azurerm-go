...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/publicip/internal"
...
func (j *jsiiProxy_PublicIp) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.115.0/docs/resources/public_ip azurerm_public_ip} Resource.
func NewPublicIp(scope constructs.Construct, id *string, config *PublicIpConfig) PublicIp {
	_init_.Initialize()

	if err := validateNewPublicIpParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_PublicIp)SetAllocationMethod(val *string) {
	if err := j.validateSetAllocationMethodParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_PublicIp)SetCount(val interface{}) {
...
func (j *jsiiProxy_PublicIp)SetIpTags(val *map[string]*string) {
	if err := j.validateSetIpTagsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_PublicIp)SetReverseFqdn(val *string) {
	if err := j.validateSetReverseFqdnParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func PublicIp_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validatePublicIp_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func PublicIp_IsConstruct(x interface{}) *bool {
	...
	if err := validatePublicIp_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (p *jsiiProxy_PublicIp) AddMoveTarget(moveTarget *string) {
...
func (p *jsiiProxy_PublicIp) HasResourceMove() interface{} {
	var returns interface{}
...
func (p *jsiiProxy_PublicIp) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (p *jsiiProxy_PublicIp) MoveFromId(id *string) {
...
func (p *jsiiProxy_PublicIp) MoveTo(moveTarget *string, index interface{}) {
...
func (p *jsiiProxy_PublicIp) MoveToId(id *string) {
...
func (p *jsiiProxy_PublicIp) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (p *jsiiProxy_PublicIp) ToHclTerraform() interface{} {
	var returns interface{}
