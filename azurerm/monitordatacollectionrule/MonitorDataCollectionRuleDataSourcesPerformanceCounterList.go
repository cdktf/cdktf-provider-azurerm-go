...
func NewMonitorDataCollectionRuleDataSourcesPerformanceCounterList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MonitorDataCollectionRuleDataSourcesPerformanceCounterList {
	...
	if err := validateNewMonitorDataCollectionRuleDataSourcesPerformanceCounterListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_MonitorDataCollectionRuleDataSourcesPerformanceCounterList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MonitorDataCollectionRuleDataSourcesPerformanceCounterList) Resolve(context cdktf.IResolveContext) interface{} {
