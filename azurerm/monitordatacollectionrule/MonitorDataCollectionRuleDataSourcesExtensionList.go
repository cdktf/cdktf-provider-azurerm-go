...
func NewMonitorDataCollectionRuleDataSourcesExtensionList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) MonitorDataCollectionRuleDataSourcesExtensionList {
	...
	if err := validateNewMonitorDataCollectionRuleDataSourcesExtensionListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_MonitorDataCollectionRuleDataSourcesExtensionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (m *jsiiProxy_MonitorDataCollectionRuleDataSourcesExtensionList) Resolve(context cdktf.IResolveContext) interface{} {
