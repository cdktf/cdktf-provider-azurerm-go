...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.100.0/docs/resources/monitor_data_collection_rule azurerm_monitor_data_collection_rule}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.100.0/docs/resources/monitor_data_collection_rule azurerm_monitor_data_collection_rule} Resource.
...
func MonitorDataCollectionRule_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateMonitorDataCollectionRule_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_MonitorDataCollectionRule) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_MonitorDataCollectionRule) HasResourceMove() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_MonitorDataCollectionRule) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (m *jsiiProxy_MonitorDataCollectionRule) MoveFromId(id *string) {
...
func (m *jsiiProxy_MonitorDataCollectionRule) MoveTo(moveTarget *string, index interface{}) {
...
func (m *jsiiProxy_MonitorDataCollectionRule) MoveToId(id *string) {
...
func (m *jsiiProxy_MonitorDataCollectionRule) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (m *jsiiProxy_MonitorDataCollectionRule) ToHclTerraform() interface{} {
	var returns interface{}
