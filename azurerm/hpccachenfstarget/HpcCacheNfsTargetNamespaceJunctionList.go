...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/hpccachenfstarget/internal"
...
func NewHpcCacheNfsTargetNamespaceJunctionList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) HpcCacheNfsTargetNamespaceJunctionList {
	...
	if err := validateNewHpcCacheNfsTargetNamespaceJunctionListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (h *jsiiProxy_HpcCacheNfsTargetNamespaceJunctionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (h *jsiiProxy_HpcCacheNfsTargetNamespaceJunctionList) Resolve(context cdktf.IResolveContext) interface{} {
