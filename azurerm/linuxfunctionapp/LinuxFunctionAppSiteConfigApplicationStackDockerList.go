...
func NewLinuxFunctionAppSiteConfigApplicationStackDockerList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LinuxFunctionAppSiteConfigApplicationStackDockerList {
	...
	if err := validateNewLinuxFunctionAppSiteConfigApplicationStackDockerListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LinuxFunctionAppSiteConfigApplicationStackDockerList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LinuxFunctionAppSiteConfigApplicationStackDockerList) Resolve(context cdktf.IResolveContext) interface{} {
