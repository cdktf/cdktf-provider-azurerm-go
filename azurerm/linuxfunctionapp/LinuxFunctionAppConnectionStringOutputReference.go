...
func NewLinuxFunctionAppConnectionStringOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) LinuxFunctionAppConnectionStringOutputReference {
	...
	if err := validateNewLinuxFunctionAppConnectionStringOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LinuxFunctionAppConnectionStringOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LinuxFunctionAppConnectionStringOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
