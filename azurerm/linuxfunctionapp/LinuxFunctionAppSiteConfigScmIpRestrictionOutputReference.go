...
func (j *jsiiProxy_LinuxFunctionAppSiteConfigScmIpRestrictionOutputReference) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_LinuxFunctionAppSiteConfigScmIpRestrictionOutputReference) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_LinuxFunctionAppSiteConfigScmIpRestrictionOutputReference)SetDescription(val *string) {
...
func (l *jsiiProxy_LinuxFunctionAppSiteConfigScmIpRestrictionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LinuxFunctionAppSiteConfigScmIpRestrictionOutputReference) ResetDescription() {
	_jsii_.InvokeVoid(
		l,
		"resetDescription",
		nil, // no parameters
...
func (l *jsiiProxy_LinuxFunctionAppSiteConfigScmIpRestrictionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
