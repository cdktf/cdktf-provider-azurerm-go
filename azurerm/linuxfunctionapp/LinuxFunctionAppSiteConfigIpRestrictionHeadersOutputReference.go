...
func NewLinuxFunctionAppSiteConfigIpRestrictionHeadersOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) LinuxFunctionAppSiteConfigIpRestrictionHeadersOutputReference {
	...
	if err := validateNewLinuxFunctionAppSiteConfigIpRestrictionHeadersOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LinuxFunctionAppSiteConfigIpRestrictionHeadersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LinuxFunctionAppSiteConfigIpRestrictionHeadersOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
