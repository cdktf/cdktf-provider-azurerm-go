...
func NewLinuxFunctionAppSiteCredentialList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LinuxFunctionAppSiteCredentialList {
	...
	if err := validateNewLinuxFunctionAppSiteCredentialListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LinuxFunctionAppSiteCredentialList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LinuxFunctionAppSiteCredentialList) Resolve(context cdktf.IResolveContext) interface{} {
