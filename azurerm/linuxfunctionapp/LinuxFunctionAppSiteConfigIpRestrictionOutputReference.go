...
func (j *jsiiProxy_LinuxFunctionAppSiteConfigIpRestrictionOutputReference) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_LinuxFunctionAppSiteConfigIpRestrictionOutputReference) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func NewLinuxFunctionAppSiteConfigIpRestrictionOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) LinuxFunctionAppSiteConfigIpRestrictionOutputReference {
	...
	if err := validateNewLinuxFunctionAppSiteConfigIpRestrictionOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_LinuxFunctionAppSiteConfigIpRestrictionOutputReference)SetDescription(val *string) {
...
func (l *jsiiProxy_LinuxFunctionAppSiteConfigIpRestrictionOutputReference) ResetDescription() {
	_jsii_.InvokeVoid(
		l,
		"resetDescription",
		nil, // no parameters
