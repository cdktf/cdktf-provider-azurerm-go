...
func (l *jsiiProxy_LinuxFunctionAppConnectionStringList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}
...
func (l *jsiiProxy_LinuxFunctionAppConnectionStringList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
