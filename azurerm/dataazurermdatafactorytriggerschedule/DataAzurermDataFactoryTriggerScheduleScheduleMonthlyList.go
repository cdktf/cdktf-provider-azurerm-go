...
func (j *jsiiProxy_DataAzurermDataFactoryTriggerScheduleScheduleMonthlyList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataAzurermDataFactoryTriggerScheduleScheduleMonthlyList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataAzurermDataFactoryTriggerScheduleScheduleMonthlyList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktf/provider-azurerm.dataAzurermDataFactoryTriggerSchedule.DataAzurermDataFactoryTriggerScheduleScheduleMonthlyList",
...
func NewDataAzurermDataFactoryTriggerScheduleScheduleMonthlyList_Override(d DataAzurermDataFactoryTriggerScheduleScheduleMonthlyList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataAzurermDataFactoryTriggerScheduleScheduleMonthlyList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataAzurermDataFactoryTriggerScheduleScheduleMonthlyList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermDataFactoryTriggerScheduleScheduleMonthlyList) Resolve(_context cdktf.IResolveContext) interface{} {
