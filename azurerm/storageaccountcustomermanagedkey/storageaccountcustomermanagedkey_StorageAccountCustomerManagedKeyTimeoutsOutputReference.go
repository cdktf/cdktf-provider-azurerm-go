...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/storageaccountcustomermanagedkey/internal"
...
func NewStorageAccountCustomerManagedKeyTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) StorageAccountCustomerManagedKeyTimeoutsOutputReference {
	...
	if err := validateNewStorageAccountCustomerManagedKeyTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
