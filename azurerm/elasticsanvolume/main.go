...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "createSource", GoGetter: "CreateSource"},
			_jsii_.MemberProperty{JsiiProperty: "createSourceInput", GoGetter: "CreateSourceInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putCreateSource", GoMethod: "PutCreateSource"},
			_jsii_.MemberMethod{JsiiMethod: "putTimeouts", GoMethod: "PutTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetCreateSource", GoMethod: "ResetCreateSource"},
			...
			_jsii_.MemberProperty{JsiiProperty: "targetIqn", GoGetter: "TargetIqn"},
			_jsii_.MemberProperty{JsiiProperty: "targetPortalHostname", GoGetter: "TargetPortalHostname"},
			_jsii_.MemberProperty{JsiiProperty: "targetPortalPort", GoGetter: "TargetPortalPort"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_ElasticSanVolumeTimeoutsOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
