...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/springcloudapp/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.113.0/docs/resources/spring_cloud_app azurerm_spring_cloud_app}.
...
func (j *jsiiProxy_SpringCloudApp) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.113.0/docs/resources/spring_cloud_app azurerm_spring_cloud_app} Resource.
func NewSpringCloudApp(scope constructs.Construct, id *string, config *SpringCloudAppConfig) SpringCloudApp {
	_init_.Initialize()

	if err := validateNewSpringCloudAppParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_SpringCloudApp)SetCount(val interface{}) {
...
func SpringCloudApp_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSpringCloudApp_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func SpringCloudApp_IsConstruct(x interface{}) *bool {
	...
	if err := validateSpringCloudApp_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func SpringCloudApp_IsTerraformElement(x interface{}) *bool {
	...
	if err := validateSpringCloudApp_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func SpringCloudApp_IsTerraformResource(x interface{}) *bool {
	...
	if err := validateSpringCloudApp_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_SpringCloudApp) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SpringCloudApp) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SpringCloudApp) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SpringCloudApp) MoveFromId(id *string) {
...
func (s *jsiiProxy_SpringCloudApp) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_SpringCloudApp) MoveToId(id *string) {
...
func (s *jsiiProxy_SpringCloudApp) PutCustomPersistentDisk(value interface{}) {
	if err := s.validatePutCustomPersistentDiskParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		s,
...
func (s *jsiiProxy_SpringCloudApp) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SpringCloudApp) ToHclTerraform() interface{} {
	var returns interface{}
