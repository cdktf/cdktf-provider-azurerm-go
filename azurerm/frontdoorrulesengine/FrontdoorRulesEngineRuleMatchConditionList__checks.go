...
func (j *jsiiProxy_FrontdoorRulesEngineRuleMatchConditionList) validateSetInternalValueParameters(val interface{}) error {
	switch val.(type) {
	case cdktf.IResolvable:
		// ok
	case *[]*FrontdoorRulesEngineRuleMatchCondition:
		val := val.(*[]*FrontdoorRulesEngineRuleMatchCondition)
	...
	case []*FrontdoorRulesEngineRuleMatchCondition:
		val_ := val.([]*FrontdoorRulesEngineRuleMatchCondition)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*FrontdoorRulesEngineRuleMatchCondition; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_FrontdoorRulesEngineRuleMatchConditionList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_FrontdoorRulesEngineRuleMatchConditionList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
