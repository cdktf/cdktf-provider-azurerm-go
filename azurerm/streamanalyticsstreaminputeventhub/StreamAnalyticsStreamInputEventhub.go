...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/streamanalyticsstreaminputeventhub/internal"
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.102.0/docs/resources/stream_analytics_stream_input_eventhub azurerm_stream_analytics_stream_input_eventhub} Resource.
func NewStreamAnalyticsStreamInputEventhub(scope constructs.Construct, id *string, config *StreamAnalyticsStreamInputEventhubConfig) StreamAnalyticsStreamInputEventhub {
	...
	if err := validateNewStreamAnalyticsStreamInputEventhubParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func StreamAnalyticsStreamInputEventhub_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateStreamAnalyticsStreamInputEventhub_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func StreamAnalyticsStreamInputEventhub_IsConstruct(x interface{}) *bool {
	...
	if err := validateStreamAnalyticsStreamInputEventhub_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func StreamAnalyticsStreamInputEventhub_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateStreamAnalyticsStreamInputEventhub_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func StreamAnalyticsStreamInputEventhub_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateStreamAnalyticsStreamInputEventhub_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_StreamAnalyticsStreamInputEventhub) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_StreamAnalyticsStreamInputEventhub) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_StreamAnalyticsStreamInputEventhub) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_StreamAnalyticsStreamInputEventhub) MoveFromId(id *string) {
...
func (s *jsiiProxy_StreamAnalyticsStreamInputEventhub) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_StreamAnalyticsStreamInputEventhub) MoveToId(id *string) {
...
func (s *jsiiProxy_StreamAnalyticsStreamInputEventhub) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_StreamAnalyticsStreamInputEventhub) ToHclTerraform() interface{} {
	var returns interface{}
