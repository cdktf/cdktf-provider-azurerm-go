...
import (
	...
	"github.com/hashicorp/cdktf-provider-azurerm-go/azurerm/v3/virtualnetwork/internal"
...
func (j *jsiiProxy_VirtualNetwork) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_VirtualNetwork)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
