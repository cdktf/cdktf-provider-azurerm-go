...
func NewOrchestratedVirtualMachineScaleSetIdentityOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) OrchestratedVirtualMachineScaleSetIdentityOutputReference {
	...
	if err := validateNewOrchestratedVirtualMachineScaleSetIdentityOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (o *jsiiProxy_OrchestratedVirtualMachineScaleSetIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (o *jsiiProxy_OrchestratedVirtualMachineScaleSetIdentityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
