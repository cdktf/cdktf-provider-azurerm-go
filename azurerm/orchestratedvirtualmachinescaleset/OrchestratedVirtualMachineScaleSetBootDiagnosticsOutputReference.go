...
func NewOrchestratedVirtualMachineScaleSetBootDiagnosticsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) OrchestratedVirtualMachineScaleSetBootDiagnosticsOutputReference {
	...
	if err := validateNewOrchestratedVirtualMachineScaleSetBootDiagnosticsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (o *jsiiProxy_OrchestratedVirtualMachineScaleSetBootDiagnosticsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (o *jsiiProxy_OrchestratedVirtualMachineScaleSetBootDiagnosticsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
