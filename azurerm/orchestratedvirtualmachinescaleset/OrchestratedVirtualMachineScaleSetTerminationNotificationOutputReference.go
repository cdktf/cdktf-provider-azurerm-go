...
func NewOrchestratedVirtualMachineScaleSetTerminationNotificationOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) OrchestratedVirtualMachineScaleSetTerminationNotificationOutputReference {
	...
	if err := validateNewOrchestratedVirtualMachineScaleSetTerminationNotificationOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (o *jsiiProxy_OrchestratedVirtualMachineScaleSetTerminationNotificationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (o *jsiiProxy_OrchestratedVirtualMachineScaleSetTerminationNotificationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
