...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/iotsecuritydevicegroup/internal"
...
func NewIotSecurityDeviceGroup(scope constructs.Construct, id *string, config *IotSecurityDeviceGroupConfig) IotSecurityDeviceGroup {
	...
	if err := validateNewIotSecurityDeviceGroupParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func IotSecurityDeviceGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateIotSecurityDeviceGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func IotSecurityDeviceGroup_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateIotSecurityDeviceGroup_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func IotSecurityDeviceGroup_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateIotSecurityDeviceGroup_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (i *jsiiProxy_IotSecurityDeviceGroup) PutAllowRule(value *IotSecurityDeviceGroupAllowRule) {
	if err := i.validatePutAllowRuleParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		i,
...
func (i *jsiiProxy_IotSecurityDeviceGroup) PutRangeRule(value interface{}) {
	if err := i.validatePutRangeRuleParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		i,
