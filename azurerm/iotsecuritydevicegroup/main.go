...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "allowRule", GoGetter: "AllowRule"},
			_jsii_.MemberProperty{JsiiProperty: "allowRuleInput", GoGetter: "AllowRuleInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putAllowRule", GoMethod: "PutAllowRule"},
			_jsii_.MemberMethod{JsiiMethod: "putRangeRule", GoMethod: "PutRangeRule"},
			_jsii_.MemberMethod{JsiiMethod: "putTimeouts", GoMethod: "PutTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "rangeRule", GoGetter: "RangeRule"},
			_jsii_.MemberProperty{JsiiProperty: "rangeRuleInput", GoGetter: "RangeRuleInput"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetAllowRule", GoMethod: "ResetAllowRule"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetRangeRule", GoMethod: "ResetRangeRule"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "connectionFromIpsNotAllowed", GoGetter: "ConnectionFromIpsNotAllowed"},
			_jsii_.MemberProperty{JsiiProperty: "connectionFromIpsNotAllowedInput", GoGetter: "ConnectionFromIpsNotAllowedInput"},
			_jsii_.MemberProperty{JsiiProperty: "connectionToIpsNotAllowed", GoGetter: "ConnectionToIpsNotAllowed"},
			_jsii_.MemberProperty{JsiiProperty: "connectionToIpsNotAllowedInput", GoGetter: "ConnectionToIpsNotAllowedInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "localUsersNotAllowed", GoGetter: "LocalUsersNotAllowed"},
			_jsii_.MemberProperty{JsiiProperty: "localUsersNotAllowedInput", GoGetter: "LocalUsersNotAllowedInput"},
			_jsii_.MemberProperty{JsiiProperty: "processesNotAllowed", GoGetter: "ProcessesNotAllowed"},
			_jsii_.MemberProperty{JsiiProperty: "processesNotAllowedInput", GoGetter: "ProcessesNotAllowedInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetConnectionFromIpsNotAllowed", GoMethod: "ResetConnectionFromIpsNotAllowed"},
			_jsii_.MemberMethod{JsiiMethod: "resetConnectionToIpsNotAllowed", GoMethod: "ResetConnectionToIpsNotAllowed"},
			_jsii_.MemberMethod{JsiiMethod: "resetLocalUsersNotAllowed", GoMethod: "ResetLocalUsersNotAllowed"},
			_jsii_.MemberMethod{JsiiMethod: "resetProcessesNotAllowed", GoMethod: "ResetProcessesNotAllowed"},
