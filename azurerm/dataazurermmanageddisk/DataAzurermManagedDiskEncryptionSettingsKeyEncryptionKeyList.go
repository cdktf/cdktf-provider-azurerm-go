...
func (d *jsiiProxy_DataAzurermManagedDiskEncryptionSettingsKeyEncryptionKeyList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermManagedDiskEncryptionSettingsKeyEncryptionKeyList) Resolve(context cdktf.IResolveContext) interface{} {
