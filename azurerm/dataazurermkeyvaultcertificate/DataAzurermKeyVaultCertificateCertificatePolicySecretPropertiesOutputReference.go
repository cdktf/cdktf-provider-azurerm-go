...
func NewDataAzurermKeyVaultCertificateCertificatePolicySecretPropertiesOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataAzurermKeyVaultCertificateCertificatePolicySecretPropertiesOutputReference {
	...
	if err := validateNewDataAzurermKeyVaultCertificateCertificatePolicySecretPropertiesOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAzurermKeyVaultCertificateCertificatePolicySecretPropertiesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataAzurermKeyVaultCertificateCertificatePolicySecretPropertiesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
