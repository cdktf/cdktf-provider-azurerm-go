...
func (d *jsiiProxy_DataAzurermKeyVaultCertificateCertificatePolicySecretPropertiesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataAzurermKeyVaultCertificateCertificatePolicySecretPropertiesList) Resolve(context cdktf.IResolveContext) interface{} {
