...
import (
	...
	"github.com/hashicorp/cdktf-provider-azurerm-go/azurerm/v3/streamanalyticsfunctionjavascriptuda/internal"
...
func NewStreamAnalyticsFunctionJavascriptUdaInputList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) StreamAnalyticsFunctionJavascriptUdaInputList {
	...
	_jsii_.Create(
		"@cdktf/provider-azurerm.streamAnalyticsFunctionJavascriptUda.StreamAnalyticsFunctionJavascriptUdaInputList",
