...
func (c *jsiiProxy_ContainerGroupInitContainerVolumeGitRepoOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ContainerGroupInitContainerVolumeGitRepoOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
