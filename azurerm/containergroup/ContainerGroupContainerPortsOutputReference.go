...
func NewContainerGroupContainerPortsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ContainerGroupContainerPortsOutputReference {
	...
	if err := validateNewContainerGroupContainerPortsOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_ContainerGroupContainerPortsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ContainerGroupContainerPortsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
