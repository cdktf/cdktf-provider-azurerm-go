...
func NewContainerGroupDiagnosticsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) ContainerGroupDiagnosticsOutputReference {
	...
	if err := validateNewContainerGroupDiagnosticsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_ContainerGroupDiagnosticsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ContainerGroupDiagnosticsOutputReference) PutLogAnalytics(value *ContainerGroupDiagnosticsLogAnalytics) {
	if err := c.validatePutLogAnalyticsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		c,
...
func (c *jsiiProxy_ContainerGroupDiagnosticsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
