...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/containergroup/internal"
...
func NewContainerGroupInitContainerVolumeOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ContainerGroupInitContainerVolumeOutputReference {
	...
	if err := validateNewContainerGroupInitContainerVolumeOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_ContainerGroupInitContainerVolumeOutputReference)SetEmptyDir(val interface{}) {
	if err := j.validateSetEmptyDirParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
