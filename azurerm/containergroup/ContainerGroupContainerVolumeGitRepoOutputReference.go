...
func NewContainerGroupContainerVolumeGitRepoOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) ContainerGroupContainerVolumeGitRepoOutputReference {
	...
	if err := validateNewContainerGroupContainerVolumeGitRepoOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_ContainerGroupContainerVolumeGitRepoOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ContainerGroupContainerVolumeGitRepoOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
