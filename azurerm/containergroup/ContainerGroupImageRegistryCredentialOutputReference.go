...
func NewContainerGroupImageRegistryCredentialOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ContainerGroupImageRegistryCredentialOutputReference {
	...
	if err := validateNewContainerGroupImageRegistryCredentialOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_ContainerGroupImageRegistryCredentialOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ContainerGroupImageRegistryCredentialOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
