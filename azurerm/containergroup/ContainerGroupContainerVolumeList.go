...
func NewContainerGroupContainerVolumeList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ContainerGroupContainerVolumeList {
	...
	if err := validateNewContainerGroupContainerVolumeListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_ContainerGroupContainerVolumeList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ContainerGroupContainerVolumeList) Resolve(context cdktf.IResolveContext) interface{} {
