...
func NewContainerGroupDnsConfigOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) ContainerGroupDnsConfigOutputReference {
	...
	if err := validateNewContainerGroupDnsConfigOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_ContainerGroupDnsConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ContainerGroupDnsConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
