...
func (s *jsiiProxy_StackHciLogicalNetworkSubnetOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StackHciLogicalNetworkSubnetOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
