...
func NewSpringCloudAppCosmosdbAssociationTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) SpringCloudAppCosmosdbAssociationTimeoutsOutputReference {
	...
	if err := validateNewSpringCloudAppCosmosdbAssociationTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SpringCloudAppCosmosdbAssociationTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SpringCloudAppCosmosdbAssociationTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
