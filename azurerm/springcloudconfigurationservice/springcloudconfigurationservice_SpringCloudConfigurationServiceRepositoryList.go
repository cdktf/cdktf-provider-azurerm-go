...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/springcloudconfigurationservice/internal"
...
func NewSpringCloudConfigurationServiceRepositoryList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SpringCloudConfigurationServiceRepositoryList {
	...
	if err := validateNewSpringCloudConfigurationServiceRepositoryListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
