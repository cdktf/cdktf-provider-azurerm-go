...
func (n *jsiiProxy_NetworkInterfaceIpConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NetworkInterfaceIpConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
