...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v11/networkinterface/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.79.0/docs/resources/network_interface azurerm_network_interface}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.79.0/docs/resources/network_interface azurerm_network_interface} Resource.
...
func (j *jsiiProxy_NetworkInterface)SetInternalDnsNameLabel(val *string) {
	if err := j.validateSetInternalDnsNameLabelParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
