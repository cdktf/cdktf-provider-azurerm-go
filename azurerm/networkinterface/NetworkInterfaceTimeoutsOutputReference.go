...
func NewNetworkInterfaceTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) NetworkInterfaceTimeoutsOutputReference {
	...
	if err := validateNewNetworkInterfaceTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (n *jsiiProxy_NetworkInterfaceTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NetworkInterfaceTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
