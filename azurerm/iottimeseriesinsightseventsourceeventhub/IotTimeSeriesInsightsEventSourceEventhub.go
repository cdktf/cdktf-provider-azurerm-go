...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/iottimeseriesinsightseventsourceeventhub/internal"
...
func (j *jsiiProxy_IotTimeSeriesInsightsEventSourceEventhub) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func NewIotTimeSeriesInsightsEventSourceEventhub(scope constructs.Construct, id *string, config *IotTimeSeriesInsightsEventSourceEventhubConfig) IotTimeSeriesInsightsEventSourceEventhub {
	...
	if err := validateNewIotTimeSeriesInsightsEventSourceEventhubParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_IotTimeSeriesInsightsEventSourceEventhub)SetCount(val interface{}) {
...
func IotTimeSeriesInsightsEventSourceEventhub_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateIotTimeSeriesInsightsEventSourceEventhub_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func IotTimeSeriesInsightsEventSourceEventhub_IsConstruct(x interface{}) *bool {
	...
	if err := validateIotTimeSeriesInsightsEventSourceEventhub_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func IotTimeSeriesInsightsEventSourceEventhub_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateIotTimeSeriesInsightsEventSourceEventhub_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func IotTimeSeriesInsightsEventSourceEventhub_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateIotTimeSeriesInsightsEventSourceEventhub_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (i *jsiiProxy_IotTimeSeriesInsightsEventSourceEventhub) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_IotTimeSeriesInsightsEventSourceEventhub) HasResourceMove() interface{} {
	var returns interface{}
...
func (i *jsiiProxy_IotTimeSeriesInsightsEventSourceEventhub) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (i *jsiiProxy_IotTimeSeriesInsightsEventSourceEventhub) MoveFromId(id *string) {
...
func (i *jsiiProxy_IotTimeSeriesInsightsEventSourceEventhub) MoveTo(moveTarget *string, index interface{}) {
...
func (i *jsiiProxy_IotTimeSeriesInsightsEventSourceEventhub) MoveToId(id *string) {
...
func (i *jsiiProxy_IotTimeSeriesInsightsEventSourceEventhub) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (i *jsiiProxy_IotTimeSeriesInsightsEventSourceEventhub) ToHclTerraform() interface{} {
	var returns interface{}
