...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/paloaltolocalrulestackoutbounduntrustcertificateassociation/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.113.0/docs/resources/palo_alto_local_rulestack_outbound_untrust_certificate_association azurerm_palo_alto_local_rulestack_outbound_untrust_certificate_association}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.113.0/docs/resources/palo_alto_local_rulestack_outbound_untrust_certificate_association azurerm_palo_alto_local_rulestack_outbound_untrust_certificate_association} Resource.
...
func PaloAltoLocalRulestackOutboundUntrustCertificateAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validatePaloAltoLocalRulestackOutboundUntrustCertificateAssociation_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (p *jsiiProxy_PaloAltoLocalRulestackOutboundUntrustCertificateAssociation) AddMoveTarget(moveTarget *string) {
...
func (p *jsiiProxy_PaloAltoLocalRulestackOutboundUntrustCertificateAssociation) HasResourceMove() interface{} {
	var returns interface{}
...
func (p *jsiiProxy_PaloAltoLocalRulestackOutboundUntrustCertificateAssociation) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (p *jsiiProxy_PaloAltoLocalRulestackOutboundUntrustCertificateAssociation) MoveFromId(id *string) {
...
func (p *jsiiProxy_PaloAltoLocalRulestackOutboundUntrustCertificateAssociation) MoveTo(moveTarget *string, index interface{}) {
...
func (p *jsiiProxy_PaloAltoLocalRulestackOutboundUntrustCertificateAssociation) MoveToId(id *string) {
...
func (p *jsiiProxy_PaloAltoLocalRulestackOutboundUntrustCertificateAssociation) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (p *jsiiProxy_PaloAltoLocalRulestackOutboundUntrustCertificateAssociation) ToHclTerraform() interface{} {
	var returns interface{}
