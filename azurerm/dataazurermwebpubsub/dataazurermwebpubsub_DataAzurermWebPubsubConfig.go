...
type DataAzurermWebPubsubConfig struct {
	// Experimental.
	...
	// Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/d/web_pubsub#id DataAzurermWebPubsub#id}.
	//
	...
	Timeouts *DataAzurermWebPubsubTimeouts `field:"optional" json:"timeouts" yaml:"timeouts"`
}
