...
func NewWebApplicationFirewallPolicyCustomRulesMatchConditionsMatchVariablesList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WebApplicationFirewallPolicyCustomRulesMatchConditionsMatchVariablesList {
	...
	if err := validateNewWebApplicationFirewallPolicyCustomRulesMatchConditionsMatchVariablesListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (w *jsiiProxy_WebApplicationFirewallPolicyCustomRulesMatchConditionsMatchVariablesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WebApplicationFirewallPolicyCustomRulesMatchConditionsMatchVariablesList) Resolve(context cdktf.IResolveContext) interface{} {
