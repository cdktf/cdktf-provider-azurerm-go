...
func NewWebApplicationFirewallPolicyManagedRulesExclusionOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) WebApplicationFirewallPolicyManagedRulesExclusionOutputReference {
	...
	if err := validateNewWebApplicationFirewallPolicyManagedRulesExclusionOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (w *jsiiProxy_WebApplicationFirewallPolicyManagedRulesExclusionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WebApplicationFirewallPolicyManagedRulesExclusionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
