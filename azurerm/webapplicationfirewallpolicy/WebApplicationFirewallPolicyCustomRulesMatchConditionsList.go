...
func NewWebApplicationFirewallPolicyCustomRulesMatchConditionsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WebApplicationFirewallPolicyCustomRulesMatchConditionsList {
	...
	if err := validateNewWebApplicationFirewallPolicyCustomRulesMatchConditionsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (w *jsiiProxy_WebApplicationFirewallPolicyCustomRulesMatchConditionsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WebApplicationFirewallPolicyCustomRulesMatchConditionsList) Resolve(context cdktf.IResolveContext) interface{} {
