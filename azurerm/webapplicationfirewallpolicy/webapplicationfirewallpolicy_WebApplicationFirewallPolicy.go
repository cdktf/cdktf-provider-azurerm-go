...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/webapplicationfirewallpolicy/internal"
...
func NewWebApplicationFirewallPolicy(scope constructs.Construct, id *string, config *WebApplicationFirewallPolicyConfig) WebApplicationFirewallPolicy {
	...
	if err := validateNewWebApplicationFirewallPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func WebApplicationFirewallPolicy_IsConstruct(x interface{}) *bool {
	...
	if err := validateWebApplicationFirewallPolicy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func WebApplicationFirewallPolicy_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateWebApplicationFirewallPolicy_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func WebApplicationFirewallPolicy_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateWebApplicationFirewallPolicy_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (w *jsiiProxy_WebApplicationFirewallPolicy) PutCustomRules(value interface{}) {
	if err := w.validatePutCustomRulesParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		w,
...
func (w *jsiiProxy_WebApplicationFirewallPolicy) PutManagedRules(value *WebApplicationFirewallPolicyManagedRules) {
	if err := w.validatePutManagedRulesParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		w,
...
func (w *jsiiProxy_WebApplicationFirewallPolicy) PutPolicySettings(value *WebApplicationFirewallPolicyPolicySettings) {
	if err := w.validatePutPolicySettingsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		w,
