...
func NewWebApplicationFirewallPolicyManagedRulesManagedRuleSetList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WebApplicationFirewallPolicyManagedRulesManagedRuleSetList {
	...
	if err := validateNewWebApplicationFirewallPolicyManagedRulesManagedRuleSetListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (w *jsiiProxy_WebApplicationFirewallPolicyManagedRulesManagedRuleSetList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WebApplicationFirewallPolicyManagedRulesManagedRuleSetList) Resolve(context cdktf.IResolveContext) interface{} {
