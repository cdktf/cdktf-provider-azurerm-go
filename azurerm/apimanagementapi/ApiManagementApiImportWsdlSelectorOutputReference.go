...
func NewApiManagementApiImportWsdlSelectorOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) ApiManagementApiImportWsdlSelectorOutputReference {
	...
	if err := validateNewApiManagementApiImportWsdlSelectorOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApiManagementApiImportWsdlSelectorOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApiManagementApiImportWsdlSelectorOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
