...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/expressroutecircuit/internal"
...
func NewExpressRouteCircuitTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) ExpressRouteCircuitTimeoutsOutputReference {
	...
	if err := validateNewExpressRouteCircuitTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
