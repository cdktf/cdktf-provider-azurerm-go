...
func (m *jsiiProxy_MaintenanceConfigurationWindowOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MaintenanceConfigurationWindowOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
