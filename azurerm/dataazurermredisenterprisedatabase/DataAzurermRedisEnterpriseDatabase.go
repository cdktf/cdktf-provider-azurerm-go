...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/dataazurermredisenterprisedatabase/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.48.0/docs/data-sources/redis_enterprise_database azurerm_redis_enterprise_database}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.48.0/docs/data-sources/redis_enterprise_database azurerm_redis_enterprise_database} Data Source.
func NewDataAzurermRedisEnterpriseDatabase(scope constructs.Construct, id *string, config *DataAzurermRedisEnterpriseDatabaseConfig) DataAzurermRedisEnterpriseDatabase {
	...
	if err := validateNewDataAzurermRedisEnterpriseDatabaseParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataAzurermRedisEnterpriseDatabase_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataAzurermRedisEnterpriseDatabase_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAzurermRedisEnterpriseDatabase_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAzurermRedisEnterpriseDatabase_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataAzurermRedisEnterpriseDatabase_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataAzurermRedisEnterpriseDatabase_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataAzurermRedisEnterpriseDatabase) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAzurermRedisEnterpriseDatabase) ToHclTerraform() interface{} {
	var returns interface{}
