...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "elasticSanId", GoGetter: "ElasticSanId"},
			_jsii_.MemberProperty{JsiiProperty: "elasticSanIdInput", GoGetter: "ElasticSanIdInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "networkRule", GoGetter: "NetworkRule"},
			_jsii_.MemberProperty{JsiiProperty: "networkRuleInput", GoGetter: "NetworkRuleInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putNetworkRule", GoMethod: "PutNetworkRule"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetNetworkRule", GoMethod: "ResetNetworkRule"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "currentVersionedKeyExpirationTimestamp", GoGetter: "CurrentVersionedKeyExpirationTimestamp"},
			_jsii_.MemberProperty{JsiiProperty: "currentVersionedKeyId", GoGetter: "CurrentVersionedKeyId"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			...
			_jsii_.MemberProperty{JsiiProperty: "lastKeyRotationTimestamp", GoGetter: "LastKeyRotationTimestamp"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_ElasticSanVolumeGroupIdentityOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_ElasticSanVolumeGroupNetworkRuleList{}
