...
func (w *jsiiProxy_WindowsFunctionAppSiteCredentialList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}
...
func (w *jsiiProxy_WindowsFunctionAppSiteCredentialList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
