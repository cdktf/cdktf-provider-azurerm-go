...
func NewWindowsFunctionAppIdentityOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) WindowsFunctionAppIdentityOutputReference {
	...
	if err := validateNewWindowsFunctionAppIdentityOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (w *jsiiProxy_WindowsFunctionAppIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WindowsFunctionAppIdentityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
