...
func NewWindowsFunctionAppConnectionStringOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) WindowsFunctionAppConnectionStringOutputReference {
	...
	if err := validateNewWindowsFunctionAppConnectionStringOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (w *jsiiProxy_WindowsFunctionAppConnectionStringOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WindowsFunctionAppConnectionStringOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
