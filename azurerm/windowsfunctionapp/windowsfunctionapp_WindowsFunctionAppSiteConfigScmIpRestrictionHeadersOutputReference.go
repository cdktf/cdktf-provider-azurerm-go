...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v3/windowsfunctionapp/internal"
...
func NewWindowsFunctionAppSiteConfigScmIpRestrictionHeadersOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) WindowsFunctionAppSiteConfigScmIpRestrictionHeadersOutputReference {
	...
	if err := validateNewWindowsFunctionAppSiteConfigScmIpRestrictionHeadersOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
