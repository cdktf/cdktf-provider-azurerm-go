...
func NewWindowsFunctionAppBackupOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) WindowsFunctionAppBackupOutputReference {
	...
	if err := validateNewWindowsFunctionAppBackupOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (w *jsiiProxy_WindowsFunctionAppBackupOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WindowsFunctionAppBackupOutputReference) PutSchedule(value *WindowsFunctionAppBackupSchedule) {
	if err := w.validatePutScheduleParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		w,
...
func (w *jsiiProxy_WindowsFunctionAppBackupOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
