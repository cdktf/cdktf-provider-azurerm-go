...
func NewOrbitalSpacecraftLinksOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) OrbitalSpacecraftLinksOutputReference {
	...
	if err := validateNewOrbitalSpacecraftLinksOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_OrbitalSpacecraftLinksOutputReference)SetBandwidthMhz(val *float64) {
	if err := j.validateSetBandwidthMhzParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_OrbitalSpacecraftLinksOutputReference)SetCenterFrequencyMhz(val *float64) {
	if err := j.validateSetCenterFrequencyMhzParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (o *jsiiProxy_OrbitalSpacecraftLinksOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (o *jsiiProxy_OrbitalSpacecraftLinksOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
