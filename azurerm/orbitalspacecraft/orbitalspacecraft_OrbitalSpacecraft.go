...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/orbitalspacecraft/internal"
...
func NewOrbitalSpacecraft(scope constructs.Construct, id *string, config *OrbitalSpacecraftConfig) OrbitalSpacecraft {
	...
	if err := validateNewOrbitalSpacecraftParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_OrbitalSpacecraft)SetNoradId(val *string) {
	if err := j.validateSetNoradIdParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_OrbitalSpacecraft)SetTitleLine(val *string) {
	if err := j.validateSetTitleLineParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_OrbitalSpacecraft)SetTwoLineElements(val *[]*string) {
	if err := j.validateSetTwoLineElementsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func OrbitalSpacecraft_IsConstruct(x interface{}) *bool {
	...
	if err := validateOrbitalSpacecraft_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func OrbitalSpacecraft_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateOrbitalSpacecraft_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func OrbitalSpacecraft_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateOrbitalSpacecraft_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
