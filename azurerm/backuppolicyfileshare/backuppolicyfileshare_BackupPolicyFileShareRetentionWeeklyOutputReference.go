...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/backuppolicyfileshare/internal"
...
func NewBackupPolicyFileShareRetentionWeeklyOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) BackupPolicyFileShareRetentionWeeklyOutputReference {
	...
	if err := validateNewBackupPolicyFileShareRetentionWeeklyOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
