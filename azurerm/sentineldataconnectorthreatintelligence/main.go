...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "lookbackDate", GoGetter: "LookbackDate"},
			_jsii_.MemberProperty{JsiiProperty: "lookbackDateInput", GoGetter: "LookbackDateInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetLookbackDate", GoMethod: "ResetLookbackDate"},
