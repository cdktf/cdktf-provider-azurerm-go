...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/appconfigurationfeature/internal"
...
func NewAppConfigurationFeatureTimewindowFilterList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) AppConfigurationFeatureTimewindowFilterList {
	...
	if err := validateNewAppConfigurationFeatureTimewindowFilterListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
