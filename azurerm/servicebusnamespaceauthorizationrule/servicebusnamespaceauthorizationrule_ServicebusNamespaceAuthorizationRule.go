...
import (
	...
	"github.com/hashicorp/cdktf-provider-azurerm-go/azurerm/v3/servicebusnamespaceauthorizationrule/internal"
...
func (j *jsiiProxy_ServicebusNamespaceAuthorizationRule) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_ServicebusNamespaceAuthorizationRule) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ServicebusNamespaceAuthorizationRule) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ServicebusNamespaceAuthorizationRule) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_ServicebusNamespaceAuthorizationRule) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_ServicebusNamespaceAuthorizationRule)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ServicebusNamespaceAuthorizationRule)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ServicebusNamespaceAuthorizationRule)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (s *jsiiProxy_ServicebusNamespaceAuthorizationRule) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_ServicebusNamespaceAuthorizationRule) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
