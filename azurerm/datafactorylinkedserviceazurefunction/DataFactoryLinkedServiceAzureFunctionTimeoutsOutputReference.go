...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/datafactorylinkedserviceazurefunction/internal"
...
func NewDataFactoryLinkedServiceAzureFunctionTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DataFactoryLinkedServiceAzureFunctionTimeoutsOutputReference {
	...
	if err := validateNewDataFactoryLinkedServiceAzureFunctionTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataFactoryLinkedServiceAzureFunctionTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataFactoryLinkedServiceAzureFunctionTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
