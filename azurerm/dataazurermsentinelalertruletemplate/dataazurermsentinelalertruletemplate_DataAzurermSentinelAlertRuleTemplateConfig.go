...
type DataAzurermSentinelAlertRuleTemplateConfig struct {
	// Experimental.
	...
	Timeouts *DataAzurermSentinelAlertRuleTemplateTimeouts `field:"optional" json:"timeouts" yaml:"timeouts"`
}
