...
func (a *jsiiProxy_ArcKubernetesProvisionedClusterAzureActiveDirectoryOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ArcKubernetesProvisionedClusterAzureActiveDirectoryOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
