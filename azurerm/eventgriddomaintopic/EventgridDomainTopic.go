...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/eventgriddomaintopic/internal"
...
func (j *jsiiProxy_EventgridDomainTopic) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.104.2/docs/resources/eventgrid_domain_topic azurerm_eventgrid_domain_topic} Resource.
func NewEventgridDomainTopic(scope constructs.Construct, id *string, config *EventgridDomainTopicConfig) EventgridDomainTopic {
	_init_.Initialize()

	if err := validateNewEventgridDomainTopicParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_EventgridDomainTopic)SetCount(val interface{}) {
...
func EventgridDomainTopic_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateEventgridDomainTopic_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func EventgridDomainTopic_IsConstruct(x interface{}) *bool {
	...
	if err := validateEventgridDomainTopic_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func EventgridDomainTopic_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateEventgridDomainTopic_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func EventgridDomainTopic_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateEventgridDomainTopic_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (e *jsiiProxy_EventgridDomainTopic) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_EventgridDomainTopic) HasResourceMove() interface{} {
	var returns interface{}
...
func (e *jsiiProxy_EventgridDomainTopic) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (e *jsiiProxy_EventgridDomainTopic) MoveFromId(id *string) {
...
func (e *jsiiProxy_EventgridDomainTopic) MoveTo(moveTarget *string, index interface{}) {
...
func (e *jsiiProxy_EventgridDomainTopic) MoveToId(id *string) {
...
func (e *jsiiProxy_EventgridDomainTopic) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (e *jsiiProxy_EventgridDomainTopic) ToHclTerraform() interface{} {
	var returns interface{}
