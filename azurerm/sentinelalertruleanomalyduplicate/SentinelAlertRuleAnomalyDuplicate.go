...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/sentinelalertruleanomalyduplicate/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.103.0/docs/resources/sentinel_alert_rule_anomaly_duplicate azurerm_sentinel_alert_rule_anomaly_duplicate}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.103.0/docs/resources/sentinel_alert_rule_anomaly_duplicate azurerm_sentinel_alert_rule_anomaly_duplicate} Resource.
...
func (s *jsiiProxy_SentinelAlertRuleAnomalyDuplicate) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SentinelAlertRuleAnomalyDuplicate) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SentinelAlertRuleAnomalyDuplicate) MoveFromId(id *string) {
...
func (s *jsiiProxy_SentinelAlertRuleAnomalyDuplicate) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_SentinelAlertRuleAnomalyDuplicate) MoveToId(id *string) {
...
func (s *jsiiProxy_SentinelAlertRuleAnomalyDuplicate) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SentinelAlertRuleAnomalyDuplicate) ToHclTerraform() interface{} {
	var returns interface{}
