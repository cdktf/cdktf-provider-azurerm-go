...
func (s *jsiiProxy_SharedImageGallerySharingOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SharedImageGallerySharingOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
