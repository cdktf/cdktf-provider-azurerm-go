...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v3/appserviceenvironment/internal"
...
func NewAppServiceEnvironmentClusterSettingList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) AppServiceEnvironmentClusterSettingList {
	...
	if err := validateNewAppServiceEnvironmentClusterSettingListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
