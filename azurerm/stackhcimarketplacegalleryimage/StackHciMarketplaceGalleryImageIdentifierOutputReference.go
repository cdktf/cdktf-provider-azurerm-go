...
func (s *jsiiProxy_StackHciMarketplaceGalleryImageIdentifierOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StackHciMarketplaceGalleryImageIdentifierOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
