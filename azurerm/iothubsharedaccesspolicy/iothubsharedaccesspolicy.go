...
import (
	...
	"github.com/hashicorp/cdktf-provider-azurerm-go/azurerm/v3/iothubsharedaccesspolicy/internal"
...
func (j *jsiiProxy_IothubSharedAccessPolicyA) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_IothubSharedAccessPolicyA) SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
