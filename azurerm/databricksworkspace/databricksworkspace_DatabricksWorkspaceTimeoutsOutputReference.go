...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/databricksworkspace/internal"
...
func NewDatabricksWorkspaceTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DatabricksWorkspaceTimeoutsOutputReference {
	...
	if err := validateNewDatabricksWorkspaceTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
