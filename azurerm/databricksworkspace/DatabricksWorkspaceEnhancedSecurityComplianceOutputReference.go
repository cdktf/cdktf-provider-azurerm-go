...
func (d *jsiiProxy_DatabricksWorkspaceEnhancedSecurityComplianceOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DatabricksWorkspaceEnhancedSecurityComplianceOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
