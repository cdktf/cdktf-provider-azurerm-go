...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/digitaltwinsendpointservicebus/internal"
...
func NewDigitalTwinsEndpointServicebusTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DigitalTwinsEndpointServicebusTimeoutsOutputReference {
	...
	if err := validateNewDigitalTwinsEndpointServicebusTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
