...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.103.1/docs/resources/dashboard azurerm_dashboard}.
type Dashboard interface {
	...
	Timeouts() DashboardTimeoutsOutputReference
	...
	PutTimeouts(value *DashboardTimeouts)
...
func (j *jsiiProxy_Dashboard) DashboardProperties() *string {
	var returns *string
	_jsii_.Get(
		j,
		"dashboardProperties",
...
func (j *jsiiProxy_Dashboard) DashboardPropertiesInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Dashboard) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_Dashboard) LocationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationInput",
...
func (j *jsiiProxy_Dashboard) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_Dashboard) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_Dashboard) ResourceGroupName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"resourceGroupName",
...
func (j *jsiiProxy_Dashboard) ResourceGroupNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Dashboard) Tags() *map[string]*string {
...
func (j *jsiiProxy_Dashboard) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_Dashboard) Timeouts() DashboardTimeoutsOutputReference {
	var returns DashboardTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_Dashboard) TimeoutsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"timeoutsInput",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.103.1/docs/resources/dashboard azurerm_dashboard} Resource.
func NewDashboard(scope constructs.Construct, id *string, config *DashboardConfig) Dashboard {
	...
	_jsii_.Create(
		"@cdktf/provider-azurerm.dashboard.Dashboard",
...
func (j *jsiiProxy_Dashboard)SetDashboardProperties(val *string) {
...
func (j *jsiiProxy_Dashboard)SetLocation(val *string) {
...
func (j *jsiiProxy_Dashboard)SetResourceGroupName(val *string) {
...
func (j *jsiiProxy_Dashboard)SetTags(val *map[string]*string) {
...
func (d *jsiiProxy_Dashboard) PutTimeouts(value *DashboardTimeouts) {
...
func (d *jsiiProxy_Dashboard) ResetDashboardProperties() {
	_jsii_.InvokeVoid(
		d,
		"resetDashboardProperties",
		nil, // no parameters
...
func (d *jsiiProxy_Dashboard) ResetTimeouts() {
	_jsii_.InvokeVoid(
		d,
		"resetTimeouts",
		nil, // no parameters
