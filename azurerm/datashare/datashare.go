...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putSnapshotSchedule", GoMethod: "PutSnapshotSchedule"},
			_jsii_.MemberMethod{JsiiMethod: "putTimeouts", GoMethod: "PutTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetDescription", GoMethod: "ResetDescription"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetSnapshotSchedule", GoMethod: "ResetSnapshotSchedule"},
			_jsii_.MemberMethod{JsiiMethod: "resetTerms", GoMethod: "ResetTerms"},
			_jsii_.MemberMethod{JsiiMethod: "resetTimeouts", GoMethod: "ResetTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "snapshotSchedule", GoGetter: "SnapshotSchedule"},
			_jsii_.MemberProperty{JsiiProperty: "snapshotScheduleInput", GoGetter: "SnapshotScheduleInput"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_DataShareSnapshotScheduleOutputReference{}
