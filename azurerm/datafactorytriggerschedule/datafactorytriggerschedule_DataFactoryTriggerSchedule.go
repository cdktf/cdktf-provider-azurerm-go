...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/datafactorytriggerschedule/internal"
...
func NewDataFactoryTriggerSchedule(scope constructs.Construct, id *string, config *DataFactoryTriggerScheduleConfig) DataFactoryTriggerSchedule {
	...
	if err := validateNewDataFactoryTriggerScheduleParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataFactoryTriggerSchedule)SetPipelineParameters(val *map[string]*string) {
	if err := j.validateSetPipelineParametersParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func DataFactoryTriggerSchedule_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataFactoryTriggerSchedule_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataFactoryTriggerSchedule_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataFactoryTriggerSchedule_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataFactoryTriggerSchedule_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataFactoryTriggerSchedule_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
