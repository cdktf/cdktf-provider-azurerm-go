...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/windowsfunctionappslot/internal"
...
func NewWindowsFunctionAppSlotSiteConfigIpRestrictionHeadersList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WindowsFunctionAppSlotSiteConfigIpRestrictionHeadersList {
	...
	if err := validateNewWindowsFunctionAppSlotSiteConfigIpRestrictionHeadersListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
