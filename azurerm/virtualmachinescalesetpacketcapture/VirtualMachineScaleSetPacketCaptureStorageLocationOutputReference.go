...
func (v *jsiiProxy_VirtualMachineScaleSetPacketCaptureStorageLocationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VirtualMachineScaleSetPacketCaptureStorageLocationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
