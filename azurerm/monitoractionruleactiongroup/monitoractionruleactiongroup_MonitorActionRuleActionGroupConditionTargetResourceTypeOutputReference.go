...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/monitoractionruleactiongroup/internal"
...
func NewMonitorActionRuleActionGroupConditionTargetResourceTypeOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) MonitorActionRuleActionGroupConditionTargetResourceTypeOutputReference {
	...
	if err := validateNewMonitorActionRuleActionGroupConditionTargetResourceTypeOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
