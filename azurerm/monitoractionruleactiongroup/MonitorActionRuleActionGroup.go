...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/monitoractionruleactiongroup/internal"
...
func (j *jsiiProxy_MonitorActionRuleActionGroup) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func NewMonitorActionRuleActionGroup(scope constructs.Construct, id *string, config *MonitorActionRuleActionGroupConfig) MonitorActionRuleActionGroup {
	...
	if err := validateNewMonitorActionRuleActionGroupParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_MonitorActionRuleActionGroup)SetCount(val interface{}) {
...
func MonitorActionRuleActionGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateMonitorActionRuleActionGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func MonitorActionRuleActionGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateMonitorActionRuleActionGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func MonitorActionRuleActionGroup_IsTerraformElement(x interface{}) *bool {
	...
	if err := validateMonitorActionRuleActionGroup_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func MonitorActionRuleActionGroup_IsTerraformResource(x interface{}) *bool {
	...
	if err := validateMonitorActionRuleActionGroup_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (m *jsiiProxy_MonitorActionRuleActionGroup) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_MonitorActionRuleActionGroup) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (m *jsiiProxy_MonitorActionRuleActionGroup) ToHclTerraform() interface{} {
	var returns interface{}
