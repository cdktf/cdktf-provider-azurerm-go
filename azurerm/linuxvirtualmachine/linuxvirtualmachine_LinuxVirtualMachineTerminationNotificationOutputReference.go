...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/linuxvirtualmachine/internal"
...
func NewLinuxVirtualMachineTerminationNotificationOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) LinuxVirtualMachineTerminationNotificationOutputReference {
	...
	if err := validateNewLinuxVirtualMachineTerminationNotificationOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
