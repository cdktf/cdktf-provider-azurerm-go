...
func (l *jsiiProxy_LinuxVirtualMachineOsDiskOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LinuxVirtualMachineOsDiskOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
