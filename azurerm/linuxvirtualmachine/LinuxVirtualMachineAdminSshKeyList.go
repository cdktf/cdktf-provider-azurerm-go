...
func NewLinuxVirtualMachineAdminSshKeyList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LinuxVirtualMachineAdminSshKeyList {
	...
	if err := validateNewLinuxVirtualMachineAdminSshKeyListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LinuxVirtualMachineAdminSshKeyList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LinuxVirtualMachineAdminSshKeyList) Resolve(context cdktf.IResolveContext) interface{} {
