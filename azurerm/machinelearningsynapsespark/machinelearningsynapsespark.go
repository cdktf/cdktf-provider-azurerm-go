...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*MachineLearningSynapseSpark)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "synapseSparkPoolId", GoGetter: "SynapseSparkPoolId"},
			_jsii_.MemberProperty{JsiiProperty: "synapseSparkPoolIdInput", GoGetter: "SynapseSparkPoolIdInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurerm.machineLearningSynapseSpark.MachineLearningSynapseSparkConfig",
		reflect.TypeOf((*MachineLearningSynapseSparkConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurerm.machineLearningSynapseSpark.MachineLearningSynapseSparkIdentity",
		reflect.TypeOf((*MachineLearningSynapseSparkIdentity)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-azurerm.machineLearningSynapseSpark.MachineLearningSynapseSparkIdentityOutputReference",
		reflect.TypeOf((*MachineLearningSynapseSparkIdentityOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurerm.machineLearningSynapseSpark.MachineLearningSynapseSparkTimeouts",
		reflect.TypeOf((*MachineLearningSynapseSparkTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-azurerm.machineLearningSynapseSpark.MachineLearningSynapseSparkTimeoutsOutputReference",
		reflect.TypeOf((*MachineLearningSynapseSparkTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
