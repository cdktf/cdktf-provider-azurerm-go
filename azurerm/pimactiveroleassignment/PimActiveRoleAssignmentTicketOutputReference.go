...
func (p *jsiiProxy_PimActiveRoleAssignmentTicketOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PimActiveRoleAssignmentTicketOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
