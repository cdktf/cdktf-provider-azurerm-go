...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/applicationinsightswebtest/internal"
...
func (j *jsiiProxy_ApplicationInsightsWebTest) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_ApplicationInsightsWebTest)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
