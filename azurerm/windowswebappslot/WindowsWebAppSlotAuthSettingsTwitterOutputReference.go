...
func NewWindowsWebAppSlotAuthSettingsTwitterOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) WindowsWebAppSlotAuthSettingsTwitterOutputReference {
	...
	if err := validateNewWindowsWebAppSlotAuthSettingsTwitterOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (w *jsiiProxy_WindowsWebAppSlotAuthSettingsTwitterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WindowsWebAppSlotAuthSettingsTwitterOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
