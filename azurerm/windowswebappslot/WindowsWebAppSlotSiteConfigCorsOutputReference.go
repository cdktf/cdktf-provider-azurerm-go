...
func (w *jsiiProxy_WindowsWebAppSlotSiteConfigCorsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WindowsWebAppSlotSiteConfigCorsOutputReference) ResetAllowedOrigins() {
	_jsii_.InvokeVoid(
		w,
		"resetAllowedOrigins",
		nil, // no parameters
...
func (w *jsiiProxy_WindowsWebAppSlotSiteConfigCorsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
