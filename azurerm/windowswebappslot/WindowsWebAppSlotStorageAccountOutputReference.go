...
func NewWindowsWebAppSlotStorageAccountOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) WindowsWebAppSlotStorageAccountOutputReference {
	...
	if err := validateNewWindowsWebAppSlotStorageAccountOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (w *jsiiProxy_WindowsWebAppSlotStorageAccountOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WindowsWebAppSlotStorageAccountOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
