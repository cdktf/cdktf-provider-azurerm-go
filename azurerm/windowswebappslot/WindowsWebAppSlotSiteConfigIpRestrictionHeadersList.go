...
func NewWindowsWebAppSlotSiteConfigIpRestrictionHeadersList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) WindowsWebAppSlotSiteConfigIpRestrictionHeadersList {
	...
	if err := validateNewWindowsWebAppSlotSiteConfigIpRestrictionHeadersListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (w *jsiiProxy_WindowsWebAppSlotSiteConfigIpRestrictionHeadersList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (w *jsiiProxy_WindowsWebAppSlotSiteConfigIpRestrictionHeadersList) Resolve(context cdktf.IResolveContext) interface{} {
