...
func (w *jsiiProxy_WindowsWebAppSlotLogsApplicationLogsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WindowsWebAppSlotLogsApplicationLogsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
