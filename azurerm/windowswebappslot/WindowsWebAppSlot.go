...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.54.0/docs/resources/windows_web_app_slot azurerm_windows_web_app_slot}.
type WindowsWebAppSlot interface {
	...
	VirtualNetworkImagePullEnabled() interface{}
	SetVirtualNetworkImagePullEnabled(val interface{})
	VirtualNetworkImagePullEnabledInput() interface{}
	...
	ResetVirtualNetworkImagePullEnabled()
...
func (j *jsiiProxy_WindowsWebAppSlot) ClientCertificateExclusionPaths() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_WindowsWebAppSlot) ClientCertificateExclusionPathsInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_WindowsWebAppSlot) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_WindowsWebAppSlot) FtpPublishBasicAuthenticationEnabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_WindowsWebAppSlot) FtpPublishBasicAuthenticationEnabledInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_WindowsWebAppSlot) PublicNetworkAccessEnabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_WindowsWebAppSlot) PublicNetworkAccessEnabledInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_WindowsWebAppSlot) VirtualNetworkImagePullEnabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_WindowsWebAppSlot) VirtualNetworkImagePullEnabledInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"virtualNetworkImagePullEnabledInput",
		&returns,
	)
	return returns
}
...
func (j *jsiiProxy_WindowsWebAppSlot) WebdeployPublishBasicAuthenticationEnabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_WindowsWebAppSlot) WebdeployPublishBasicAuthenticationEnabledInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.54.0/docs/resources/windows_web_app_slot azurerm_windows_web_app_slot} Resource.
...
func (j *jsiiProxy_WindowsWebAppSlot)SetClientCertificateExclusionPaths(val *string) {
...
func (j *jsiiProxy_WindowsWebAppSlot)SetCount(val interface{}) {
...
func (j *jsiiProxy_WindowsWebAppSlot)SetFtpPublishBasicAuthenticationEnabled(val interface{}) {
...
func (j *jsiiProxy_WindowsWebAppSlot)SetPublicNetworkAccessEnabled(val interface{}) {
...
func (j *jsiiProxy_WindowsWebAppSlot)SetVirtualNetworkImagePullEnabled(val interface{}) {
	if err := j.validateSetVirtualNetworkImagePullEnabledParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_WindowsWebAppSlot)SetWebdeployPublishBasicAuthenticationEnabled(val interface{}) {
...
func WindowsWebAppSlot_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateWindowsWebAppSlot_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (w *jsiiProxy_WindowsWebAppSlot) AddMoveTarget(moveTarget *string) {
...
func (w *jsiiProxy_WindowsWebAppSlot) HasResourceMove() interface{} {
	var returns interface{}
...
func (w *jsiiProxy_WindowsWebAppSlot) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (w *jsiiProxy_WindowsWebAppSlot) MoveFromId(id *string) {
...
func (w *jsiiProxy_WindowsWebAppSlot) MoveTo(moveTarget *string, index interface{}) {
...
func (w *jsiiProxy_WindowsWebAppSlot) MoveToId(id *string) {
...
func (w *jsiiProxy_WindowsWebAppSlot) ResetClientCertificateExclusionPaths() {
	_jsii_.InvokeVoid(
		w,
		"resetClientCertificateExclusionPaths",
		nil, // no parameters
...
func (w *jsiiProxy_WindowsWebAppSlot) ResetFtpPublishBasicAuthenticationEnabled() {
	_jsii_.InvokeVoid(
		w,
		"resetFtpPublishBasicAuthenticationEnabled",
		nil, // no parameters
...
func (w *jsiiProxy_WindowsWebAppSlot) ResetPublicNetworkAccessEnabled() {
	_jsii_.InvokeVoid(
		w,
		"resetPublicNetworkAccessEnabled",
		nil, // no parameters
...
func (w *jsiiProxy_WindowsWebAppSlot) ResetVirtualNetworkImagePullEnabled() {
	_jsii_.InvokeVoid(
		w,
		"resetVirtualNetworkImagePullEnabled",
		nil, // no parameters
...
func (w *jsiiProxy_WindowsWebAppSlot) ResetWebdeployPublishBasicAuthenticationEnabled() {
	_jsii_.InvokeVoid(
		w,
		"resetWebdeployPublishBasicAuthenticationEnabled",
		nil, // no parameters
...
func (w *jsiiProxy_WindowsWebAppSlot) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (w *jsiiProxy_WindowsWebAppSlot) ToHclTerraform() interface{} {
	var returns interface{}
