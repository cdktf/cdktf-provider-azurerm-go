...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "networkConnectionIdInput", GoGetter: "NetworkConnectionIdInput"},
		...
		func() interface{} {
			j := jsiiProxy_DevCenterAttachedNetwork{}
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_DevCenterAttachedNetworkTimeoutsOutputReference{}
