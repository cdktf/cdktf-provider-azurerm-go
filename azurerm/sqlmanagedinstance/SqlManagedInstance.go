...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/sqlmanagedinstance/internal"
...
func (j *jsiiProxy_SqlManagedInstance) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.103.0/docs/resources/sql_managed_instance azurerm_sql_managed_instance} Resource.
func NewSqlManagedInstance(scope constructs.Construct, id *string, config *SqlManagedInstanceConfig) SqlManagedInstance {
	_init_.Initialize()

	if err := validateNewSqlManagedInstanceParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_SqlManagedInstance)SetCount(val interface{}) {
...
func SqlManagedInstance_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSqlManagedInstance_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func SqlManagedInstance_IsConstruct(x interface{}) *bool {
	...
	if err := validateSqlManagedInstance_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func SqlManagedInstance_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSqlManagedInstance_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func SqlManagedInstance_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSqlManagedInstance_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_SqlManagedInstance) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SqlManagedInstance) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SqlManagedInstance) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SqlManagedInstance) MoveFromId(id *string) {
...
func (s *jsiiProxy_SqlManagedInstance) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_SqlManagedInstance) MoveToId(id *string) {
...
func (s *jsiiProxy_SqlManagedInstance) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SqlManagedInstance) ToHclTerraform() interface{} {
	var returns interface{}
