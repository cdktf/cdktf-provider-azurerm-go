...
func (s *jsiiProxy_ServicebusNamespaceNetworkRuleSetNetworkRulesList) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_ServicebusNamespaceNetworkRuleSetNetworkRulesList) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*ServicebusNamespaceNetworkRuleSetNetworkRules; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_ServicebusNamespaceNetworkRuleSetNetworkRulesList) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewServicebusNamespaceNetworkRuleSetNetworkRulesListParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
