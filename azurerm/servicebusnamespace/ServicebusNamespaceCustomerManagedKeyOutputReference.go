...
func (s *jsiiProxy_ServicebusNamespaceCustomerManagedKeyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_ServicebusNamespaceCustomerManagedKeyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
