...
func NewServicebusNamespaceNetworkRuleSetNetworkRulesList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ServicebusNamespaceNetworkRuleSetNetworkRulesList {
	...
	if err := validateNewServicebusNamespaceNetworkRuleSetNetworkRulesListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_ServicebusNamespaceNetworkRuleSetNetworkRulesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_ServicebusNamespaceNetworkRuleSetNetworkRulesList) Resolve(context cdktf.IResolveContext) interface{} {
