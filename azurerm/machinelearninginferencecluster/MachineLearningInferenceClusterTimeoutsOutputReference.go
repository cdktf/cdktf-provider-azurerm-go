...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/machinelearninginferencecluster/internal"
...
func NewMachineLearningInferenceClusterTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) MachineLearningInferenceClusterTimeoutsOutputReference {
	...
	if err := validateNewMachineLearningInferenceClusterTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_MachineLearningInferenceClusterTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MachineLearningInferenceClusterTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
