...
func NewFirewallNatRuleCollectionRuleList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FirewallNatRuleCollectionRuleList {
	...
	if err := validateNewFirewallNatRuleCollectionRuleListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (f *jsiiProxy_FirewallNatRuleCollectionRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FirewallNatRuleCollectionRuleList) Resolve(context cdktf.IResolveContext) interface{} {
