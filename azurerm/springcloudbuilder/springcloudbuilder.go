...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "buildPackGroup", GoGetter: "BuildPackGroup"},
			_jsii_.MemberProperty{JsiiProperty: "buildPackGroupInput", GoGetter: "BuildPackGroupInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putBuildPackGroup", GoMethod: "PutBuildPackGroup"},
			_jsii_.MemberMethod{JsiiMethod: "putStack", GoMethod: "PutStack"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_SpringCloudBuilderBuildPackGroupList{}
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "buildPackIdsInput", GoGetter: "BuildPackIdsInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "name", GoGetter: "Name"},
			_jsii_.MemberProperty{JsiiProperty: "nameInput", GoGetter: "NameInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetBuildPackIds", GoMethod: "ResetBuildPackIds"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
