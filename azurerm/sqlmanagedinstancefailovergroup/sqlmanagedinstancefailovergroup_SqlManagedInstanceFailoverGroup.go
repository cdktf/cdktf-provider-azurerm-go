...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/sqlmanagedinstancefailovergroup/internal"
...
func NewSqlManagedInstanceFailoverGroup(scope constructs.Construct, id *string, config *SqlManagedInstanceFailoverGroupConfig) SqlManagedInstanceFailoverGroup {
	...
	if err := validateNewSqlManagedInstanceFailoverGroupParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func SqlManagedInstanceFailoverGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateSqlManagedInstanceFailoverGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func SqlManagedInstanceFailoverGroup_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSqlManagedInstanceFailoverGroup_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func SqlManagedInstanceFailoverGroup_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSqlManagedInstanceFailoverGroup_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
