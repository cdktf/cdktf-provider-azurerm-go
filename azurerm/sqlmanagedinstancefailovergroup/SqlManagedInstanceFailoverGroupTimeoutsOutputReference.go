...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/sqlmanagedinstancefailovergroup/internal"
...
func NewSqlManagedInstanceFailoverGroupTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) SqlManagedInstanceFailoverGroupTimeoutsOutputReference {
	...
	if err := validateNewSqlManagedInstanceFailoverGroupTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
