...
import (
	...
	"github.com/hashicorp/cdktf-provider-azurerm-go/azurerm/v3/dataazurermapplicationgateway/internal"
...
func (j *jsiiProxy_DataAzurermApplicationGateway) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_DataAzurermApplicationGateway)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
