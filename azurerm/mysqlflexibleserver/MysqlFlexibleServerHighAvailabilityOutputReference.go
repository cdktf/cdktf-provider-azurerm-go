...
func NewMysqlFlexibleServerHighAvailabilityOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) MysqlFlexibleServerHighAvailabilityOutputReference {
	...
	if err := validateNewMysqlFlexibleServerHighAvailabilityOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_MysqlFlexibleServerHighAvailabilityOutputReference)SetStandbyAvailabilityZone(val *string) {
	if err := j.validateSetStandbyAvailabilityZoneParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (m *jsiiProxy_MysqlFlexibleServerHighAvailabilityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MysqlFlexibleServerHighAvailabilityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
