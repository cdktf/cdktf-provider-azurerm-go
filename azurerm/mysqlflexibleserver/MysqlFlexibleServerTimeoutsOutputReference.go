...
func NewMysqlFlexibleServerTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) MysqlFlexibleServerTimeoutsOutputReference {
	...
	if err := validateNewMysqlFlexibleServerTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_MysqlFlexibleServerTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MysqlFlexibleServerTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
