...
func NewSynapseSparkPoolAutoScaleOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) SynapseSparkPoolAutoScaleOutputReference {
	...
	if err := validateNewSynapseSparkPoolAutoScaleOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SynapseSparkPoolAutoScaleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SynapseSparkPoolAutoScaleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
