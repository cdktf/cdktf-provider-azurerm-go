...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/synapsesparkpool/internal"
...
func NewSynapseSparkPoolLibraryRequirementOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) SynapseSparkPoolLibraryRequirementOutputReference {
	...
	if err := validateNewSynapseSparkPoolLibraryRequirementOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SynapseSparkPoolLibraryRequirementOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SynapseSparkPoolLibraryRequirementOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
