...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v3/synapsesparkpool/internal"
...
func NewSynapseSparkPoolSparkConfigOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) SynapseSparkPoolSparkConfigOutputReference {
	...
	if err := validateNewSynapseSparkPoolSparkConfigOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
