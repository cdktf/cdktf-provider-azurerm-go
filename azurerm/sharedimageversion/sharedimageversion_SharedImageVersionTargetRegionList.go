...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v3/sharedimageversion/internal"
...
func NewSharedImageVersionTargetRegionList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SharedImageVersionTargetRegionList {
	...
	if err := validateNewSharedImageVersionTargetRegionListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
