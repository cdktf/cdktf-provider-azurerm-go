...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/dataazurermvpngateway/internal"
...
func NewDataAzurermVpnGatewayTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DataAzurermVpnGatewayTimeoutsOutputReference {
	...
	if err := validateNewDataAzurermVpnGatewayTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
