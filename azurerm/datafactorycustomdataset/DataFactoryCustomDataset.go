...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.103.1/docs/resources/data_factory_custom_dataset azurerm_data_factory_custom_dataset}.
...
func (j *jsiiProxy_DataFactoryCustomDataset) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.103.1/docs/resources/data_factory_custom_dataset azurerm_data_factory_custom_dataset} Resource.
func NewDataFactoryCustomDataset(scope constructs.Construct, id *string, config *DataFactoryCustomDatasetConfig) DataFactoryCustomDataset {
	...
	if err := validateNewDataFactoryCustomDatasetParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataFactoryCustomDataset)SetCount(val interface{}) {
...
func (j *jsiiProxy_DataFactoryCustomDataset)SetTypePropertiesJson(val *string) {
	if err := j.validateSetTypePropertiesJsonParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func DataFactoryCustomDataset_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataFactoryCustomDataset_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataFactoryCustomDataset_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataFactoryCustomDataset_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataFactoryCustomDataset_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataFactoryCustomDataset_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataFactoryCustomDataset) AddMoveTarget(moveTarget *string) {
...
func (d *jsiiProxy_DataFactoryCustomDataset) HasResourceMove() interface{} {
	var returns interface{}
...
func (d *jsiiProxy_DataFactoryCustomDataset) MoveFromId(id *string) {
...
func (d *jsiiProxy_DataFactoryCustomDataset) MoveTo(moveTarget *string, index interface{}) {
...
func (d *jsiiProxy_DataFactoryCustomDataset) MoveToId(id *string) {
...
func (d *jsiiProxy_DataFactoryCustomDataset) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataFactoryCustomDataset) ToHclTerraform() interface{} {
	var returns interface{}
