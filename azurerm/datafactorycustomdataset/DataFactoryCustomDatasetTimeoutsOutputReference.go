...
func NewDataFactoryCustomDatasetTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DataFactoryCustomDatasetTimeoutsOutputReference {
	...
	if err := validateNewDataFactoryCustomDatasetTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataFactoryCustomDatasetTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataFactoryCustomDatasetTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
