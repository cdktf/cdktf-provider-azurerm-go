...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataFactoryLinkedServiceKusto)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "kustoDatabaseName", GoGetter: "KustoDatabaseName"},
			_jsii_.MemberProperty{JsiiProperty: "kustoDatabaseNameInput", GoGetter: "KustoDatabaseNameInput"},
			_jsii_.MemberProperty{JsiiProperty: "kustoEndpoint", GoGetter: "KustoEndpoint"},
			_jsii_.MemberProperty{JsiiProperty: "kustoEndpointInput", GoGetter: "KustoEndpointInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetServicePrincipalKey", GoMethod: "ResetServicePrincipalKey"},
			...
			_jsii_.MemberProperty{JsiiProperty: "servicePrincipalKey", GoGetter: "ServicePrincipalKey"},
			_jsii_.MemberProperty{JsiiProperty: "servicePrincipalKeyInput", GoGetter: "ServicePrincipalKeyInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurerm.dataFactoryLinkedServiceKusto.DataFactoryLinkedServiceKustoConfig",
		reflect.TypeOf((*DataFactoryLinkedServiceKustoConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-azurerm.dataFactoryLinkedServiceKusto.DataFactoryLinkedServiceKustoTimeouts",
		reflect.TypeOf((*DataFactoryLinkedServiceKustoTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-azurerm.dataFactoryLinkedServiceKusto.DataFactoryLinkedServiceKustoTimeoutsOutputReference",
		reflect.TypeOf((*DataFactoryLinkedServiceKustoTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
