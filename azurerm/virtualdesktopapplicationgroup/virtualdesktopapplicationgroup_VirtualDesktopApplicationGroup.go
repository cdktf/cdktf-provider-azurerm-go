...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/virtualdesktopapplicationgroup/internal"
...
func NewVirtualDesktopApplicationGroup(scope constructs.Construct, id *string, config *VirtualDesktopApplicationGroupConfig) VirtualDesktopApplicationGroup {
	...
	if err := validateNewVirtualDesktopApplicationGroupParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_VirtualDesktopApplicationGroup)SetDefaultDesktopDisplayName(val *string) {
	if err := j.validateSetDefaultDesktopDisplayNameParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func VirtualDesktopApplicationGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateVirtualDesktopApplicationGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func VirtualDesktopApplicationGroup_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateVirtualDesktopApplicationGroup_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func VirtualDesktopApplicationGroup_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateVirtualDesktopApplicationGroup_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
