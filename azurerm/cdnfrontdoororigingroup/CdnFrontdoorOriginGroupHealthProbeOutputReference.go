...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/cdnfrontdoororigingroup/internal"
...
func NewCdnFrontdoorOriginGroupHealthProbeOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) CdnFrontdoorOriginGroupHealthProbeOutputReference {
	...
	if err := validateNewCdnFrontdoorOriginGroupHealthProbeOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CdnFrontdoorOriginGroupHealthProbeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CdnFrontdoorOriginGroupHealthProbeOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
