...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v3/cdnfrontdoororigingroup/internal"
...
func NewCdnFrontdoorOriginGroupTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) CdnFrontdoorOriginGroupTimeoutsOutputReference {
	...
	if err := validateNewCdnFrontdoorOriginGroupTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
