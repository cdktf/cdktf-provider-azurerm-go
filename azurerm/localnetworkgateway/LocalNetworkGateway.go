...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/localnetworkgateway/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.112.0/docs/resources/local_network_gateway azurerm_local_network_gateway}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.112.0/docs/resources/local_network_gateway azurerm_local_network_gateway} Resource.
func NewLocalNetworkGateway(scope constructs.Construct, id *string, config *LocalNetworkGatewayConfig) LocalNetworkGateway {
	_init_.Initialize()

	if err := validateNewLocalNetworkGatewayParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_LocalNetworkGateway)SetGatewayFqdn(val *string) {
	if err := j.validateSetGatewayFqdnParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func LocalNetworkGateway_IsConstruct(x interface{}) *bool {
	...
	if err := validateLocalNetworkGateway_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func LocalNetworkGateway_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateLocalNetworkGateway_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func LocalNetworkGateway_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateLocalNetworkGateway_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (l *jsiiProxy_LocalNetworkGateway) AddMoveTarget(moveTarget *string) {
...
func (l *jsiiProxy_LocalNetworkGateway) HasResourceMove() interface{} {
	var returns interface{}
...
func (l *jsiiProxy_LocalNetworkGateway) MoveFromId(id *string) {
...
func (l *jsiiProxy_LocalNetworkGateway) MoveTo(moveTarget *string, index interface{}) {
...
func (l *jsiiProxy_LocalNetworkGateway) MoveToId(id *string) {
...
func (l *jsiiProxy_LocalNetworkGateway) PutBgpSettings(value *LocalNetworkGatewayBgpSettings) {
	if err := l.validatePutBgpSettingsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		l,
...
func (l *jsiiProxy_LocalNetworkGateway) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (l *jsiiProxy_LocalNetworkGateway) ToHclTerraform() interface{} {
	var returns interface{}
