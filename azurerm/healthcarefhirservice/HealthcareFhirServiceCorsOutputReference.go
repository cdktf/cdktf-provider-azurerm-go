...
func (h *jsiiProxy_HealthcareFhirServiceCorsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HealthcareFhirServiceCorsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
