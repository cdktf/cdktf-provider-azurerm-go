...
func (h *jsiiProxy_HealthcareFhirServiceOciArtifactOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HealthcareFhirServiceOciArtifactOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
