...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "redisAccessKey", GoGetter: "RedisAccessKey"},
			_jsii_.MemberProperty{JsiiProperty: "redisAccessKeyInput", GoGetter: "RedisAccessKeyInput"},
