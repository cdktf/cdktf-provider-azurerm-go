...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "maximumBytesPerPacket", GoGetter: "MaximumBytesPerPacket"},
			_jsii_.MemberProperty{JsiiProperty: "maximumBytesPerPacketInput", GoGetter: "MaximumBytesPerPacketInput"},
			_jsii_.MemberProperty{JsiiProperty: "maximumBytesPerSession", GoGetter: "MaximumBytesPerSession"},
			_jsii_.MemberProperty{JsiiProperty: "maximumBytesPerSessionInput", GoGetter: "MaximumBytesPerSessionInput"},
			_jsii_.MemberProperty{JsiiProperty: "maximumCaptureDurationInSeconds", GoGetter: "MaximumCaptureDurationInSeconds"},
			_jsii_.MemberProperty{JsiiProperty: "maximumCaptureDurationInSecondsInput", GoGetter: "MaximumCaptureDurationInSecondsInput"},
			_jsii_.MemberProperty{JsiiProperty: "name", GoGetter: "Name"},
			_jsii_.MemberProperty{JsiiProperty: "nameInput", GoGetter: "NameInput"},
			_jsii_.MemberProperty{JsiiProperty: "networkWatcherId", GoGetter: "NetworkWatcherId"},
			_jsii_.MemberProperty{JsiiProperty: "networkWatcherIdInput", GoGetter: "NetworkWatcherIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetMaximumBytesPerPacket", GoMethod: "ResetMaximumBytesPerPacket"},
			_jsii_.MemberMethod{JsiiMethod: "resetMaximumBytesPerSession", GoMethod: "ResetMaximumBytesPerSession"},
			_jsii_.MemberMethod{JsiiMethod: "resetMaximumCaptureDurationInSeconds", GoMethod: "ResetMaximumCaptureDurationInSeconds"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_VirtualMachinePacketCaptureFilterList{}
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "localPort", GoGetter: "LocalPort"},
			_jsii_.MemberProperty{JsiiProperty: "localPortInput", GoGetter: "LocalPortInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "remotePort", GoGetter: "RemotePort"},
			_jsii_.MemberProperty{JsiiProperty: "remotePortInput", GoGetter: "RemotePortInput"},
			_jsii_.MemberMethod{JsiiMethod: "resetLocalIpAddress", GoMethod: "ResetLocalIpAddress"},
			_jsii_.MemberMethod{JsiiMethod: "resetLocalPort", GoMethod: "ResetLocalPort"},
			_jsii_.MemberMethod{JsiiMethod: "resetRemoteIpAddress", GoMethod: "ResetRemoteIpAddress"},
			_jsii_.MemberMethod{JsiiMethod: "resetRemotePort", GoMethod: "ResetRemotePort"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_VirtualMachinePacketCaptureStorageLocationOutputReference{}
			_jsii_.InitJsiiProxy(&j.Type__cdktfComplexObject)
			return &j
		},
	)
