...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/virtualmachine/internal"
...
func NewVirtualMachineOsProfileWindowsConfigAdditionalUnattendConfigOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) VirtualMachineOsProfileWindowsConfigAdditionalUnattendConfigOutputReference {
	...
	if err := validateNewVirtualMachineOsProfileWindowsConfigAdditionalUnattendConfigOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (v *jsiiProxy_VirtualMachineOsProfileWindowsConfigAdditionalUnattendConfigOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VirtualMachineOsProfileWindowsConfigAdditionalUnattendConfigOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
