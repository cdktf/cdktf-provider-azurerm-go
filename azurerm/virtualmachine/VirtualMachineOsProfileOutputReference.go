...
func NewVirtualMachineOsProfileOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) VirtualMachineOsProfileOutputReference {
	...
	if err := validateNewVirtualMachineOsProfileOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (v *jsiiProxy_VirtualMachineOsProfileOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VirtualMachineOsProfileOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
