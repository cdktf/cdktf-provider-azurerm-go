...
func NewVirtualMachineOsProfileSecretsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VirtualMachineOsProfileSecretsList {
	...
	if err := validateNewVirtualMachineOsProfileSecretsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (v *jsiiProxy_VirtualMachineOsProfileSecretsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VirtualMachineOsProfileSecretsList) Resolve(context cdktf.IResolveContext) interface{} {
