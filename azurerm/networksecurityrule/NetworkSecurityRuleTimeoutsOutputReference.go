...
func NewNetworkSecurityRuleTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) NetworkSecurityRuleTimeoutsOutputReference {
	...
	if err := validateNewNetworkSecurityRuleTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (n *jsiiProxy_NetworkSecurityRuleTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NetworkSecurityRuleTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
