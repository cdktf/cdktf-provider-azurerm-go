...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v3/image/internal"
...
func (j *jsiiProxy_Image)SetZoneResilient(val interface{}) {
	if err := j.validateSetZoneResilientParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (i *jsiiProxy_Image) PutDataDisk(value interface{}) {
	if err := i.validatePutDataDiskParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		i,
...
func (i *jsiiProxy_Image) PutOsDisk(value *ImageOsDisk) {
	if err := i.validatePutOsDiskParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		i,
