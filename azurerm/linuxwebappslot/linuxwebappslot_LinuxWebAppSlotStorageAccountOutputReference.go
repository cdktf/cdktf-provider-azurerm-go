...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/linuxwebappslot/internal"
...
func NewLinuxWebAppSlotStorageAccountOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) LinuxWebAppSlotStorageAccountOutputReference {
	...
	if err := validateNewLinuxWebAppSlotStorageAccountOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
