...
func NewLinuxWebAppSlotConnectionStringOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) LinuxWebAppSlotConnectionStringOutputReference {
	...
	if err := validateNewLinuxWebAppSlotConnectionStringOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LinuxWebAppSlotConnectionStringOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LinuxWebAppSlotConnectionStringOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
