...
func NewLinuxWebAppSlotLogsApplicationLogsAzureBlobStorageOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) LinuxWebAppSlotLogsApplicationLogsAzureBlobStorageOutputReference {
	...
	if err := validateNewLinuxWebAppSlotLogsApplicationLogsAzureBlobStorageOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LinuxWebAppSlotLogsApplicationLogsAzureBlobStorageOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LinuxWebAppSlotLogsApplicationLogsAzureBlobStorageOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
