...
func NewLinuxWebAppSlotSiteConfigAutoHealSettingTriggerRequestsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) LinuxWebAppSlotSiteConfigAutoHealSettingTriggerRequestsOutputReference {
	...
	if err := validateNewLinuxWebAppSlotSiteConfigAutoHealSettingTriggerRequestsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LinuxWebAppSlotSiteConfigAutoHealSettingTriggerRequestsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LinuxWebAppSlotSiteConfigAutoHealSettingTriggerRequestsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
