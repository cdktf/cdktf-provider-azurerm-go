...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.110.0/docs/resources/lab_service_lab azurerm_lab_service_lab}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.110.0/docs/resources/lab_service_lab azurerm_lab_service_lab} Resource.
...
func LabServiceLab_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateLabServiceLab_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LabServiceLab) AddMoveTarget(moveTarget *string) {
...
func (l *jsiiProxy_LabServiceLab) HasResourceMove() interface{} {
	var returns interface{}
...
func (l *jsiiProxy_LabServiceLab) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (l *jsiiProxy_LabServiceLab) MoveFromId(id *string) {
...
func (l *jsiiProxy_LabServiceLab) MoveTo(moveTarget *string, index interface{}) {
...
func (l *jsiiProxy_LabServiceLab) MoveToId(id *string) {
...
func (l *jsiiProxy_LabServiceLab) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (l *jsiiProxy_LabServiceLab) ToHclTerraform() interface{} {
	var returns interface{}
