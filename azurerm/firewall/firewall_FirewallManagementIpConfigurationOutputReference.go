...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/firewall/internal"
...
func NewFirewallManagementIpConfigurationOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) FirewallManagementIpConfigurationOutputReference {
	...
	if err := validateNewFirewallManagementIpConfigurationOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
