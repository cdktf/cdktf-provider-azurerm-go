...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "eventSystemProperties", GoGetter: "EventSystemProperties"},
			_jsii_.MemberProperty{JsiiProperty: "eventSystemPropertiesInput", GoGetter: "EventSystemPropertiesInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetEventSystemProperties", GoMethod: "ResetEventSystemProperties"},
