...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v3/windowsvirtualmachine/internal"
...
func NewWindowsVirtualMachineSecretCertificateOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) WindowsVirtualMachineSecretCertificateOutputReference {
	...
	if err := validateNewWindowsVirtualMachineSecretCertificateOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
