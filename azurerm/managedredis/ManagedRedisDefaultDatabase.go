...
type ManagedRedisDefaultDatabase struct {
	...
	PersistenceAppendOnlyFileBackupFrequency *string `field:"optional" json:"persistenceAppendOnlyFileBackupFrequency" yaml:"persistenceAppendOnlyFileBackupFrequency"`
	...
	PersistenceRedisDatabaseBackupFrequency *string `field:"optional" json:"persistenceRedisDatabaseBackupFrequency" yaml:"persistenceRedisDatabaseBackupFrequency"`
}
