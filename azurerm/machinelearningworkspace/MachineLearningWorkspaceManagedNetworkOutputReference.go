...
func (m *jsiiProxy_MachineLearningWorkspaceManagedNetworkOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MachineLearningWorkspaceManagedNetworkOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
