...
func NewMachineLearningWorkspaceIdentityOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) MachineLearningWorkspaceIdentityOutputReference {
	...
	if err := validateNewMachineLearningWorkspaceIdentityOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_MachineLearningWorkspaceIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MachineLearningWorkspaceIdentityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
