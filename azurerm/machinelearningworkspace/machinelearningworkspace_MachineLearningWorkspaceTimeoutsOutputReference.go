...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v3/machinelearningworkspace/internal"
...
func NewMachineLearningWorkspaceTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) MachineLearningWorkspaceTimeoutsOutputReference {
	...
	if err := validateNewMachineLearningWorkspaceTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
