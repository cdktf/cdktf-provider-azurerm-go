...
func NewMachineLearningWorkspaceEncryptionOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) MachineLearningWorkspaceEncryptionOutputReference {
	...
	if err := validateNewMachineLearningWorkspaceEncryptionOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (m *jsiiProxy_MachineLearningWorkspaceEncryptionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MachineLearningWorkspaceEncryptionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
