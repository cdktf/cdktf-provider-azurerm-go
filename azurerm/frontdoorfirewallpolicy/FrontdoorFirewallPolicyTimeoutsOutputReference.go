...
func NewFrontdoorFirewallPolicyTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) FrontdoorFirewallPolicyTimeoutsOutputReference {
	...
	if err := validateNewFrontdoorFirewallPolicyTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (f *jsiiProxy_FrontdoorFirewallPolicyTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FrontdoorFirewallPolicyTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
