...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/frontdoorfirewallpolicy/internal"
...
func NewFrontdoorFirewallPolicyManagedRuleExclusionOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) FrontdoorFirewallPolicyManagedRuleExclusionOutputReference {
	...
	if err := validateNewFrontdoorFirewallPolicyManagedRuleExclusionOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (f *jsiiProxy_FrontdoorFirewallPolicyManagedRuleExclusionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FrontdoorFirewallPolicyManagedRuleExclusionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
