...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v3/storagemanagementpolicy/internal"
...
func NewStorageManagementPolicyRuleOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) StorageManagementPolicyRuleOutputReference {
	...
	if err := validateNewStorageManagementPolicyRuleOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_StorageManagementPolicyRuleOutputReference) PutFilters(value *StorageManagementPolicyRuleFilters) {
	if err := s.validatePutFiltersParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		s,
