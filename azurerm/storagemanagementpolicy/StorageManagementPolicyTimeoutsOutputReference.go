...
func NewStorageManagementPolicyTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) StorageManagementPolicyTimeoutsOutputReference {
	...
	if err := validateNewStorageManagementPolicyTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_StorageManagementPolicyTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StorageManagementPolicyTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
