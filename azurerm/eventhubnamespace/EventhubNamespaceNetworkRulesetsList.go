...
func NewEventhubNamespaceNetworkRulesetsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) EventhubNamespaceNetworkRulesetsList {
	...
	if err := validateNewEventhubNamespaceNetworkRulesetsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_EventhubNamespaceNetworkRulesetsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (e *jsiiProxy_EventhubNamespaceNetworkRulesetsList) Resolve(context cdktf.IResolveContext) interface{} {
