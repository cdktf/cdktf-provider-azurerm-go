...
func NewEventhubNamespaceNetworkRulesetsIpRuleOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) EventhubNamespaceNetworkRulesetsIpRuleOutputReference {
	...
	if err := validateNewEventhubNamespaceNetworkRulesetsIpRuleOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_EventhubNamespaceNetworkRulesetsIpRuleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_EventhubNamespaceNetworkRulesetsIpRuleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
