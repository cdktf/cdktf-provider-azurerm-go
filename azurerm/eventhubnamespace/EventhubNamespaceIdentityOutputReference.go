...
func NewEventhubNamespaceIdentityOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) EventhubNamespaceIdentityOutputReference {
	...
	if err := validateNewEventhubNamespaceIdentityOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_EventhubNamespaceIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (e *jsiiProxy_EventhubNamespaceIdentityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
