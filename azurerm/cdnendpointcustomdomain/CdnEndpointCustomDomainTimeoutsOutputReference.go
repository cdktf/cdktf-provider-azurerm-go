...
func NewCdnEndpointCustomDomainTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) CdnEndpointCustomDomainTimeoutsOutputReference {
	...
	if err := validateNewCdnEndpointCustomDomainTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CdnEndpointCustomDomainTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CdnEndpointCustomDomainTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
