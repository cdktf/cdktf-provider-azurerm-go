...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/streamanalyticsoutputcosmosdb/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.113.0/docs/resources/stream_analytics_output_cosmosdb azurerm_stream_analytics_output_cosmosdb}.
...
func (j *jsiiProxy_StreamAnalyticsOutputCosmosdb) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.113.0/docs/resources/stream_analytics_output_cosmosdb azurerm_stream_analytics_output_cosmosdb} Resource.
...
func (j *jsiiProxy_StreamAnalyticsOutputCosmosdb)SetCount(val interface{}) {
...
func StreamAnalyticsOutputCosmosdb_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateStreamAnalyticsOutputCosmosdb_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_StreamAnalyticsOutputCosmosdb) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_StreamAnalyticsOutputCosmosdb) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_StreamAnalyticsOutputCosmosdb) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_StreamAnalyticsOutputCosmosdb) MoveFromId(id *string) {
...
func (s *jsiiProxy_StreamAnalyticsOutputCosmosdb) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_StreamAnalyticsOutputCosmosdb) MoveToId(id *string) {
...
func (s *jsiiProxy_StreamAnalyticsOutputCosmosdb) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_StreamAnalyticsOutputCosmosdb) ToHclTerraform() interface{} {
	var returns interface{}
