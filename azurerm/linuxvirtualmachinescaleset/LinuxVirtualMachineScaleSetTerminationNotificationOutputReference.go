...
func NewLinuxVirtualMachineScaleSetTerminationNotificationOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) LinuxVirtualMachineScaleSetTerminationNotificationOutputReference {
	...
	if err := validateNewLinuxVirtualMachineScaleSetTerminationNotificationOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LinuxVirtualMachineScaleSetTerminationNotificationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LinuxVirtualMachineScaleSetTerminationNotificationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
