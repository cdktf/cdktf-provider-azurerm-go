...
func NewLinuxVirtualMachineScaleSetDataDiskList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LinuxVirtualMachineScaleSetDataDiskList {
	...
	if err := validateNewLinuxVirtualMachineScaleSetDataDiskListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LinuxVirtualMachineScaleSetDataDiskList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LinuxVirtualMachineScaleSetDataDiskList) Resolve(context cdktf.IResolveContext) interface{} {
