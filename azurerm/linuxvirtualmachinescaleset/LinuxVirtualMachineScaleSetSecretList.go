...
func NewLinuxVirtualMachineScaleSetSecretList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) LinuxVirtualMachineScaleSetSecretList {
	...
	if err := validateNewLinuxVirtualMachineScaleSetSecretListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LinuxVirtualMachineScaleSetSecretList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (l *jsiiProxy_LinuxVirtualMachineScaleSetSecretList) Resolve(context cdktf.IResolveContext) interface{} {
