...
func NewLinuxVirtualMachineScaleSetAdminSshKeyOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) LinuxVirtualMachineScaleSetAdminSshKeyOutputReference {
	...
	if err := validateNewLinuxVirtualMachineScaleSetAdminSshKeyOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (l *jsiiProxy_LinuxVirtualMachineScaleSetAdminSshKeyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LinuxVirtualMachineScaleSetAdminSshKeyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
