...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/devtestschedule/internal"
...
func NewDevTestScheduleHourlyRecurrenceOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DevTestScheduleHourlyRecurrenceOutputReference {
	...
	if err := validateNewDevTestScheduleHourlyRecurrenceOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
