...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "hourlyRecurrence", GoGetter: "HourlyRecurrence"},
			_jsii_.MemberProperty{JsiiProperty: "hourlyRecurrenceInput", GoGetter: "HourlyRecurrenceInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putHourlyRecurrence", GoMethod: "PutHourlyRecurrence"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetHourlyRecurrence", GoMethod: "ResetHourlyRecurrence"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetStatus", GoMethod: "ResetStatus"},
			_jsii_.MemberMethod{JsiiMethod: "resetTimeInMinutes", GoMethod: "ResetTimeInMinutes"},
			...
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberProperty{JsiiProperty: "timeInMinutes", GoGetter: "TimeInMinutes"},
			_jsii_.MemberProperty{JsiiProperty: "timeInMinutesInput", GoGetter: "TimeInMinutesInput"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
