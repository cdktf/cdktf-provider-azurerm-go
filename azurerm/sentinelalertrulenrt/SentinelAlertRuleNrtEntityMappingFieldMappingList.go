...
func NewSentinelAlertRuleNrtEntityMappingFieldMappingList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) SentinelAlertRuleNrtEntityMappingFieldMappingList {
	...
	if err := validateNewSentinelAlertRuleNrtEntityMappingFieldMappingListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SentinelAlertRuleNrtEntityMappingFieldMappingList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_SentinelAlertRuleNrtEntityMappingFieldMappingList) Resolve(context cdktf.IResolveContext) interface{} {
