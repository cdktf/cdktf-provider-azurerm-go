...
func NewSentinelAlertRuleNrtTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) SentinelAlertRuleNrtTimeoutsOutputReference {
	...
	if err := validateNewSentinelAlertRuleNrtTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SentinelAlertRuleNrtTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SentinelAlertRuleNrtTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
