...
func NewSentinelAlertRuleNrtEntityMappingOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) SentinelAlertRuleNrtEntityMappingOutputReference {
	...
	if err := validateNewSentinelAlertRuleNrtEntityMappingOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SentinelAlertRuleNrtEntityMappingOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SentinelAlertRuleNrtEntityMappingOutputReference) PutFieldMapping(value interface{}) {
	if err := s.validatePutFieldMappingParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		s,
...
func (s *jsiiProxy_SentinelAlertRuleNrtEntityMappingOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
