...
func (s *jsiiProxy_SignalrServiceLiveTraceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SignalrServiceLiveTraceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
