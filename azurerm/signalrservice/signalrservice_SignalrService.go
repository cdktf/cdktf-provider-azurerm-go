...
import (
	...
	"github.com/hashicorp/cdktf-provider-azurerm-go/azurerm/v3/signalrservice/internal"
...
func (j *jsiiProxy_SignalrService) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_SignalrService)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
