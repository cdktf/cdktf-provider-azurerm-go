...
func (d *jsiiProxy_DynatraceMonitorUserOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DynatraceMonitorUserOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
