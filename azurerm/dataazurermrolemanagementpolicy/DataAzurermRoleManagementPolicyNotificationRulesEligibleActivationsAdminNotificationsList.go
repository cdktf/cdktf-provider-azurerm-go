...
func (d *jsiiProxy_DataAzurermRoleManagementPolicyNotificationRulesEligibleActivationsAdminNotificationsList) Resolve(context cdktf.IResolveContext) interface{} {
