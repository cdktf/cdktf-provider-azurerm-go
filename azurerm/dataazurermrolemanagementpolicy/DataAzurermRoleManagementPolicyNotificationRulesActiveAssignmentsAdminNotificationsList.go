...
func (d *jsiiProxy_DataAzurermRoleManagementPolicyNotificationRulesActiveAssignmentsAdminNotificationsList) Resolve(context cdktf.IResolveContext) interface{} {
