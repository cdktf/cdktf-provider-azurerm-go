...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "dedicatedHostGroupName", GoGetter: "DedicatedHostGroupName"},
			_jsii_.MemberProperty{JsiiProperty: "dedicatedHostGroupNameInput", GoGetter: "DedicatedHostGroupNameInput"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_DataAzurermDedicatedHostTimeoutsOutputReference{}
