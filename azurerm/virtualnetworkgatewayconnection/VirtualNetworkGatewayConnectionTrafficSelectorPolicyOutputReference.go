...
func (j *jsiiProxy_VirtualNetworkGatewayConnectionTrafficSelectorPolicyOutputReference)SetLocalAddressCidrs(val *[]*string) {
	if err := j.validateSetLocalAddressCidrsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_VirtualNetworkGatewayConnectionTrafficSelectorPolicyOutputReference)SetRemoteAddressCidrs(val *[]*string) {
	if err := j.validateSetRemoteAddressCidrsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (v *jsiiProxy_VirtualNetworkGatewayConnectionTrafficSelectorPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VirtualNetworkGatewayConnectionTrafficSelectorPolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
