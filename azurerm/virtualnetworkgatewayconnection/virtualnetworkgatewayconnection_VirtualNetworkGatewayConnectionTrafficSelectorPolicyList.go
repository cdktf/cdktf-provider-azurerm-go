...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v3/virtualnetworkgatewayconnection/internal"
...
func NewVirtualNetworkGatewayConnectionTrafficSelectorPolicyList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VirtualNetworkGatewayConnectionTrafficSelectorPolicyList {
	...
	if err := validateNewVirtualNetworkGatewayConnectionTrafficSelectorPolicyListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
