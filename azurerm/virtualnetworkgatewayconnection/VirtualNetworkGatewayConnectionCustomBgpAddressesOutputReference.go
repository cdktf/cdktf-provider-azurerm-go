...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/virtualnetworkgatewayconnection/internal"
...
func NewVirtualNetworkGatewayConnectionCustomBgpAddressesOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) VirtualNetworkGatewayConnectionCustomBgpAddressesOutputReference {
	...
	if err := validateNewVirtualNetworkGatewayConnectionCustomBgpAddressesOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (v *jsiiProxy_VirtualNetworkGatewayConnectionCustomBgpAddressesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VirtualNetworkGatewayConnectionCustomBgpAddressesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
