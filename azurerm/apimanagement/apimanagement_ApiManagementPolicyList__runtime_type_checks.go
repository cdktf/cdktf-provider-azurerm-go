...
func (j *jsiiProxy_ApiManagementPolicyList) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*ApiManagementPolicy:
		val := val.(*[]*ApiManagementPolicy)
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*ApiManagementPolicy; received %#v (a %T)", val, val)
		}
	}
