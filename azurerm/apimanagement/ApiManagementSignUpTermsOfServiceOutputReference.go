...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/apimanagement/internal"
...
func NewApiManagementSignUpTermsOfServiceOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) ApiManagementSignUpTermsOfServiceOutputReference {
	...
	if err := validateNewApiManagementSignUpTermsOfServiceOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_ApiManagementSignUpTermsOfServiceOutputReference)SetConsentRequired(val interface{}) {
	if err := j.validateSetConsentRequiredParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
