...
func NewApiManagementTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) ApiManagementTimeoutsOutputReference {
	...
	if err := validateNewApiManagementTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (a *jsiiProxy_ApiManagementTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApiManagementTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
