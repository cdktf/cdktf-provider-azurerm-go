...
func (n *jsiiProxy_NetworkManagerAdminRule) validateAddMoveTargetParameters(moveTarget *string) error {
	return nil
}
...
func (n *jsiiProxy_NetworkManagerAdminRule) validateImportFromParameters(id *string) error {
	return nil
}
...
func (n *jsiiProxy_NetworkManagerAdminRule) validateMoveFromIdParameters(id *string) error {
	return nil
}

func (n *jsiiProxy_NetworkManagerAdminRule) validateMoveToParameters(moveTarget *string, index interface{}) error {
	return nil
}

func (n *jsiiProxy_NetworkManagerAdminRule) validateMoveToIdParameters(id *string) error {
	return nil
}
...
func validateNetworkManagerAdminRule_GenerateConfigForImportParameters(scope constructs.Construct, importToId *string, importFromId *string) error {
	return nil
}
