...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "managementGroupName", GoGetter: "ManagementGroupName"},
			_jsii_.MemberProperty{JsiiProperty: "managementGroupNameInput", GoGetter: "ManagementGroupNameInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetManagementGroupName", GoMethod: "ResetManagementGroupName"},
			_jsii_.MemberMethod{JsiiMethod: "resetName", GoMethod: "ResetName"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetTimeouts", GoMethod: "ResetTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "roleDefinitionIds", GoGetter: "RoleDefinitionIds"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			j := jsiiProxy_DataAzurermPolicyDefinitionTimeoutsOutputReference{}
