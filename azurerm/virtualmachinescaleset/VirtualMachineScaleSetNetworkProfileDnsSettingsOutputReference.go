...
func NewVirtualMachineScaleSetNetworkProfileDnsSettingsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) VirtualMachineScaleSetNetworkProfileDnsSettingsOutputReference {
	...
	if err := validateNewVirtualMachineScaleSetNetworkProfileDnsSettingsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (v *jsiiProxy_VirtualMachineScaleSetNetworkProfileDnsSettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VirtualMachineScaleSetNetworkProfileDnsSettingsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
