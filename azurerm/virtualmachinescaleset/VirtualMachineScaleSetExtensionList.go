...
func NewVirtualMachineScaleSetExtensionList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VirtualMachineScaleSetExtensionList {
	...
	if err := validateNewVirtualMachineScaleSetExtensionListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (v *jsiiProxy_VirtualMachineScaleSetExtensionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VirtualMachineScaleSetExtensionList) Resolve(context cdktf.IResolveContext) interface{} {
