...
func NewVirtualMachineScaleSetOsProfileWindowsConfigWinrmOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) VirtualMachineScaleSetOsProfileWindowsConfigWinrmOutputReference {
	...
	if err := validateNewVirtualMachineScaleSetOsProfileWindowsConfigWinrmOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (v *jsiiProxy_VirtualMachineScaleSetOsProfileWindowsConfigWinrmOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (v *jsiiProxy_VirtualMachineScaleSetOsProfileWindowsConfigWinrmOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
