...
func NewVirtualMachineScaleSetNetworkProfileList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VirtualMachineScaleSetNetworkProfileList {
	...
	if err := validateNewVirtualMachineScaleSetNetworkProfileListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (v *jsiiProxy_VirtualMachineScaleSetNetworkProfileList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VirtualMachineScaleSetNetworkProfileList) Resolve(context cdktf.IResolveContext) interface{} {
