...
func NewBatchPoolMountList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BatchPoolMountList {
	...
	if err := validateNewBatchPoolMountListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (b *jsiiProxy_BatchPoolMountList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BatchPoolMountList) Resolve(context cdktf.IResolveContext) interface{} {
