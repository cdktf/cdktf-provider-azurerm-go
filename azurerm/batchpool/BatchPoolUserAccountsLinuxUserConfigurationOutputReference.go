...
func NewBatchPoolUserAccountsLinuxUserConfigurationOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) BatchPoolUserAccountsLinuxUserConfigurationOutputReference {
	...
	if err := validateNewBatchPoolUserAccountsLinuxUserConfigurationOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (b *jsiiProxy_BatchPoolUserAccountsLinuxUserConfigurationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BatchPoolUserAccountsLinuxUserConfigurationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
