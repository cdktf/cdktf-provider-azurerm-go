...
func NewBatchPoolIdentityOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) BatchPoolIdentityOutputReference {
	...
	if err := validateNewBatchPoolIdentityOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (b *jsiiProxy_BatchPoolIdentityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BatchPoolIdentityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
