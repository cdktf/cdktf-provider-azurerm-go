...
func NewBatchPoolCertificateList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BatchPoolCertificateList {
	...
	if err := validateNewBatchPoolCertificateListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (b *jsiiProxy_BatchPoolCertificateList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BatchPoolCertificateList) Resolve(context cdktf.IResolveContext) interface{} {
