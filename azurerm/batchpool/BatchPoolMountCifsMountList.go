...
func NewBatchPoolMountCifsMountList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BatchPoolMountCifsMountList {
	...
	if err := validateNewBatchPoolMountCifsMountListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (b *jsiiProxy_BatchPoolMountCifsMountList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BatchPoolMountCifsMountList) Resolve(context cdktf.IResolveContext) interface{} {
