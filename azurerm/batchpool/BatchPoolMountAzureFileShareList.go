...
func NewBatchPoolMountAzureFileShareList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BatchPoolMountAzureFileShareList {
	...
	if err := validateNewBatchPoolMountAzureFileShareListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (b *jsiiProxy_BatchPoolMountAzureFileShareList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BatchPoolMountAzureFileShareList) Resolve(context cdktf.IResolveContext) interface{} {
