...
func NewBatchPoolNodePlacementOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) BatchPoolNodePlacementOutputReference {
	...
	if err := validateNewBatchPoolNodePlacementOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (b *jsiiProxy_BatchPoolNodePlacementOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BatchPoolNodePlacementOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
