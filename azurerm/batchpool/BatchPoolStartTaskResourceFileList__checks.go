...
func (j *jsiiProxy_BatchPoolStartTaskResourceFileList) validateSetInternalValueParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*BatchPoolStartTaskResourceFile:
		val := val.(*[]*BatchPoolStartTaskResourceFile)
	...
	case []*BatchPoolStartTaskResourceFile:
		val_ := val.([]*BatchPoolStartTaskResourceFile)
		val := &val_
		for idx_97dfc6, v := range *val {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*BatchPoolStartTaskResourceFile; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_BatchPoolStartTaskResourceFileList) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewBatchPoolStartTaskResourceFileListParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
