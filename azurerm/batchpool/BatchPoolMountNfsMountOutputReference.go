...
func NewBatchPoolMountNfsMountOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) BatchPoolMountNfsMountOutputReference {
	...
	if err := validateNewBatchPoolMountNfsMountOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (b *jsiiProxy_BatchPoolMountNfsMountOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BatchPoolMountNfsMountOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
