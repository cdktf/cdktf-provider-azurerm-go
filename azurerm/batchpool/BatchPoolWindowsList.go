...
func NewBatchPoolWindowsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BatchPoolWindowsList {
	...
	if err := validateNewBatchPoolWindowsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (b *jsiiProxy_BatchPoolWindowsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BatchPoolWindowsList) Resolve(context cdktf.IResolveContext) interface{} {
