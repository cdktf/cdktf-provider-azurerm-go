...
func NewCdnFrontdoorCustomDomainTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) CdnFrontdoorCustomDomainTimeoutsOutputReference {
	...
	if err := validateNewCdnFrontdoorCustomDomainTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (c *jsiiProxy_CdnFrontdoorCustomDomainTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CdnFrontdoorCustomDomainTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
