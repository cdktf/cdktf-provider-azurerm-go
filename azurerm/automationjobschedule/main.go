...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "jobScheduleId", GoGetter: "JobScheduleId"},
			_jsii_.MemberProperty{JsiiProperty: "jobScheduleIdInput", GoGetter: "JobScheduleIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetJobScheduleId", GoMethod: "ResetJobScheduleId"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetParameters", GoMethod: "ResetParameters"},
			_jsii_.MemberMethod{JsiiMethod: "resetRunOn", GoMethod: "ResetRunOn"},
			...
			_jsii_.MemberProperty{JsiiProperty: "runOnInput", GoGetter: "RunOnInput"},
			_jsii_.MemberProperty{JsiiProperty: "scheduleName", GoGetter: "ScheduleName"},
			_jsii_.MemberProperty{JsiiProperty: "scheduleNameInput", GoGetter: "ScheduleNameInput"},
