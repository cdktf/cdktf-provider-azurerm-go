...
func NewKeyVaultContactList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) KeyVaultContactList {
	...
	if err := validateNewKeyVaultContactListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (k *jsiiProxy_KeyVaultContactList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (k *jsiiProxy_KeyVaultContactList) Resolve(context cdktf.IResolveContext) interface{} {
