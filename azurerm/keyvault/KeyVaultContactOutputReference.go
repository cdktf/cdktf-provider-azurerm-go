...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/keyvault/internal"
...
func NewKeyVaultContactOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) KeyVaultContactOutputReference {
	...
	if err := validateNewKeyVaultContactOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (k *jsiiProxy_KeyVaultContactOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (k *jsiiProxy_KeyVaultContactOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
