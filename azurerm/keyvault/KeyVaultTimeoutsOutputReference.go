...
func NewKeyVaultTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) KeyVaultTimeoutsOutputReference {
	...
	if err := validateNewKeyVaultTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (k *jsiiProxy_KeyVaultTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (k *jsiiProxy_KeyVaultTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
