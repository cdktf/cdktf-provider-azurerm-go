...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v3/streamanalyticsfunctionjavascriptudf/internal"
...
func NewStreamAnalyticsFunctionJavascriptUdfInputOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) StreamAnalyticsFunctionJavascriptUdfInputOutputReference {
	...
	if err := validateNewStreamAnalyticsFunctionJavascriptUdfInputOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
