...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putRetentionDescription", GoMethod: "PutRetentionDescription"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetMessageRetention", GoMethod: "ResetMessageRetention"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetRetentionDescription", GoMethod: "ResetRetentionDescription"},
			_jsii_.MemberMethod{JsiiMethod: "resetStatus", GoMethod: "ResetStatus"},
			_jsii_.MemberMethod{JsiiMethod: "resetTimeouts", GoMethod: "ResetTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "resourceGroupName", GoGetter: "ResourceGroupName"},
			_jsii_.MemberProperty{JsiiProperty: "resourceGroupNameInput", GoGetter: "ResourceGroupNameInput"},
			_jsii_.MemberProperty{JsiiProperty: "retentionDescription", GoGetter: "RetentionDescription"},
			_jsii_.MemberProperty{JsiiProperty: "retentionDescriptionInput", GoGetter: "RetentionDescriptionInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetRetentionTimeInHours", GoMethod: "ResetRetentionTimeInHours"},
			_jsii_.MemberMethod{JsiiMethod: "resetTombstoneRetentionTimeInHours", GoMethod: "ResetTombstoneRetentionTimeInHours"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "retentionTimeInHours", GoGetter: "RetentionTimeInHours"},
			_jsii_.MemberProperty{JsiiProperty: "retentionTimeInHoursInput", GoGetter: "RetentionTimeInHoursInput"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberProperty{JsiiProperty: "tombstoneRetentionTimeInHours", GoGetter: "TombstoneRetentionTimeInHours"},
			_jsii_.MemberProperty{JsiiProperty: "tombstoneRetentionTimeInHoursInput", GoGetter: "TombstoneRetentionTimeInHoursInput"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
		},
		func() interface{} {
