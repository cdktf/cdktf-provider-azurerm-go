...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/subscriptioncostmanagementexport/internal"
...
func NewSubscriptionCostManagementExportExportDataOptionsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) SubscriptionCostManagementExportExportDataOptionsOutputReference {
	...
	if err := validateNewSubscriptionCostManagementExportExportDataOptionsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SubscriptionCostManagementExportExportDataOptionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SubscriptionCostManagementExportExportDataOptionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
