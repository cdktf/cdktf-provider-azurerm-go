...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v3/kubernetesclusternodepool/internal"
...
func NewKubernetesClusterNodePoolTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) KubernetesClusterNodePoolTimeoutsOutputReference {
	...
	if err := validateNewKubernetesClusterNodePoolTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
