...
func (s *jsiiProxy_StorageAccountLocalUserPermissionScopePermissionsOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StorageAccountLocalUserPermissionScopePermissionsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
