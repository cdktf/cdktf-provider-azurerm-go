...
func NewDatadogMonitor(scope constructs.Construct, id *string, config *DatadogMonitorConfig) DatadogMonitor {
	...
	if err := validateNewDatadogMonitorParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DatadogMonitor_IsConstruct(x interface{}) *bool {
	...
	if err := validateDatadogMonitor_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func DatadogMonitor_IsTerraformElement(x interface{}) *bool {
	...
	if err := validateDatadogMonitor_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func DatadogMonitor_IsTerraformResource(x interface{}) *bool {
	...
	if err := validateDatadogMonitor_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DatadogMonitor) PutDatadogOrganization(value *DatadogMonitorDatadogOrganization) {
	if err := d.validatePutDatadogOrganizationParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		d,
