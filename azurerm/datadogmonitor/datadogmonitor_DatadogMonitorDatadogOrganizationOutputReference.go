...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v4/datadogmonitor/internal"
...
func NewDatadogMonitorDatadogOrganizationOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DatadogMonitorDatadogOrganizationOutputReference {
	...
	if err := validateNewDatadogMonitorDatadogOrganizationOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DatadogMonitorDatadogOrganizationOutputReference)SetLinkingAuthCode(val *string) {
	if err := j.validateSetLinkingAuthCodeParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_DatadogMonitorDatadogOrganizationOutputReference)SetLinkingClientId(val *string) {
	if err := j.validateSetLinkingClientIdParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
