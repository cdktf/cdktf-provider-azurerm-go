...
func NewStorageObjectReplicationRulesList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) StorageObjectReplicationRulesList {
	...
	if err := validateNewStorageObjectReplicationRulesListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_StorageObjectReplicationRulesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (s *jsiiProxy_StorageObjectReplicationRulesList) Resolve(context cdktf.IResolveContext) interface{} {
