...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v3/firewallpolicyrulecollectiongroup/internal"
...
func NewFirewallPolicyRuleCollectionGroupApplicationRuleCollectionOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) FirewallPolicyRuleCollectionGroupApplicationRuleCollectionOutputReference {
	...
	if err := validateNewFirewallPolicyRuleCollectionGroupApplicationRuleCollectionOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
