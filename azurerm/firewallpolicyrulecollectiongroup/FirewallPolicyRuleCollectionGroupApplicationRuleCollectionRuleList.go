...
func NewFirewallPolicyRuleCollectionGroupApplicationRuleCollectionRuleList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FirewallPolicyRuleCollectionGroupApplicationRuleCollectionRuleList {
	...
	if err := validateNewFirewallPolicyRuleCollectionGroupApplicationRuleCollectionRuleListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (f *jsiiProxy_FirewallPolicyRuleCollectionGroupApplicationRuleCollectionRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FirewallPolicyRuleCollectionGroupApplicationRuleCollectionRuleList) Resolve(context cdktf.IResolveContext) interface{} {
