...
func NewFirewallPolicyRuleCollectionGroupNetworkRuleCollectionRuleList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FirewallPolicyRuleCollectionGroupNetworkRuleCollectionRuleList {
	...
	if err := validateNewFirewallPolicyRuleCollectionGroupNetworkRuleCollectionRuleListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (f *jsiiProxy_FirewallPolicyRuleCollectionGroupNetworkRuleCollectionRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FirewallPolicyRuleCollectionGroupNetworkRuleCollectionRuleList) Resolve(context cdktf.IResolveContext) interface{} {
