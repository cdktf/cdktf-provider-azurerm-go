...
func NewFirewallPolicyRuleCollectionGroupNatRuleCollectionList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FirewallPolicyRuleCollectionGroupNatRuleCollectionList {
	...
	if err := validateNewFirewallPolicyRuleCollectionGroupNatRuleCollectionListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (f *jsiiProxy_FirewallPolicyRuleCollectionGroupNatRuleCollectionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FirewallPolicyRuleCollectionGroupNatRuleCollectionList) Resolve(context cdktf.IResolveContext) interface{} {
