...
func NewFirewallPolicyRuleCollectionGroupNetworkRuleCollectionList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FirewallPolicyRuleCollectionGroupNetworkRuleCollectionList {
	...
	if err := validateNewFirewallPolicyRuleCollectionGroupNetworkRuleCollectionListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (f *jsiiProxy_FirewallPolicyRuleCollectionGroupNetworkRuleCollectionList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FirewallPolicyRuleCollectionGroupNetworkRuleCollectionList) Resolve(context cdktf.IResolveContext) interface{} {
