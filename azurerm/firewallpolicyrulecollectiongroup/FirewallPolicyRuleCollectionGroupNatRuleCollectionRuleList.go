...
func NewFirewallPolicyRuleCollectionGroupNatRuleCollectionRuleList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) FirewallPolicyRuleCollectionGroupNatRuleCollectionRuleList {
	...
	if err := validateNewFirewallPolicyRuleCollectionGroupNatRuleCollectionRuleListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (f *jsiiProxy_FirewallPolicyRuleCollectionGroupNatRuleCollectionRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (f *jsiiProxy_FirewallPolicyRuleCollectionGroupNatRuleCollectionRuleList) Resolve(context cdktf.IResolveContext) interface{} {
