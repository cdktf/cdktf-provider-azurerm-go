...
import (
	...
	"github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/sentinelalertrulemachinelearningbehavioranalytics/internal"
...
func NewSentinelAlertRuleMachineLearningBehaviorAnalyticsTimeoutsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) SentinelAlertRuleMachineLearningBehaviorAnalyticsTimeoutsOutputReference {
	...
	if err := validateNewSentinelAlertRuleMachineLearningBehaviorAnalyticsTimeoutsOutputReferenceParameters(terraformResource, terraformAttribute); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SentinelAlertRuleMachineLearningBehaviorAnalyticsTimeoutsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SentinelAlertRuleMachineLearningBehaviorAnalyticsTimeoutsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
